...
/*
 * Generator क्रम SIMPLE_IPA pass related boilerplate code/data
 *
 * Supports gcc 4.5-6
 *
 * Usage:
...
class _PASS_NAME_PASS : खुला simple_ipa_opt_pass अणु
खुला:
	_PASS_NAME_PASS() : simple_ipa_opt_pass(_PASS_NAME_PASS_DATA, g) अणुपूर्ण
