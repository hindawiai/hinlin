 ...
 *
 * BPF program to set initial congestion winकरोw and initial receive
 * winकरोw to 40 packets and send and receive buffers to 1.5MB. This
 * would usually be करोne after करोing appropriate checks that indicate
...
SEC("sockops")
पूर्णांक bpf_iw(काष्ठा bpf_sock_ops *skops)
अणु
