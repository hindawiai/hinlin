...
#अगर_अघोषित __TOOLS_LINUX_PERF_RBTREE_H
#घोषणा __TOOLS_LINUX_PERF_RBTREE_H
...
अटल अंतरभूत व्योम rb_erase_init(काष्ठा rb_node *n, काष्ठा rb_root *root)
अणु
	rb_erase(n, root);
	RB_CLEAR_NODE(n);
पूर्ण
...
अटल अंतरभूत व्योम rb_erase_cached(काष्ठा rb_node *node,
				   काष्ठा rb_root_cached *root)
अणु
...
#पूर्ण_अगर	/* __TOOLS_LINUX_PERF_RBTREE_H */
