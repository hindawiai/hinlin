...
#घोषणा TCP_MEM_LOOPS 20  /* because 30 करोesn't fit पूर्णांकo 512 bytes of stack */
#घोषणा MAX_ULONG_STR_LEN 7
#घोषणा MAX_VALUE_STR_LEN (TCP_MEM_LOOPS * MAX_ULONG_STR_LEN)

स्थिर अक्षर tcp_mem_name[] = "net/ipv4/tcp_mem/very_very_very_very_long_pointless_string_to_stress_byte_loop";
अटल __attribute__((noअंतरभूत)) पूर्णांक is_tcp_mem(काष्ठा bpf_sysctl *ctx)
अणु
	अचिन्हित अक्षर i;
