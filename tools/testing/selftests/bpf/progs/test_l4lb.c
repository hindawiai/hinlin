...
अटल __always_अंतरभूत __u32 get_packet_hash(काष्ठा packet_description *pckt,
					     bool ipv6)
अणु
	अगर (ipv6)
...
अटल __always_अंतरभूत bool get_packet_dst(काष्ठा real_definition **real,
...
अटल __always_अंतरभूत पूर्णांक parse_icmpv6(व्योम *data, व्योम *data_end, __u64 off,
					काष्ठा packet_description *pckt)
अणु
...
अटल __always_अंतरभूत पूर्णांक parse_icmp(व्योम *data, व्योम *data_end, __u64 off,
				      काष्ठा packet_description *pckt)
अणु
...
अटल __always_अंतरभूत bool parse_udp(व्योम *data, __u64 off, व्योम *data_end,
				      काष्ठा packet_description *pckt)
अणु
	काष्ठा udphdr *udp;
	udp = data + off;
...
अटल __always_अंतरभूत bool parse_tcp(व्योम *data, __u64 off, व्योम *data_end,
				      काष्ठा packet_description *pckt)
अणु
	काष्ठा tcphdr *tcp;
...
अटल __always_अंतरभूत पूर्णांक process_packet(व्योम *data, __u64 off, व्योम *data_end,
