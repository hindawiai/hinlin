...
/*
 * Tests a cpu event vs an EBB - in that order. The EBB should क्रमce the cpu
 * event off the PMU.
 */
...
पूर्णांक cpu_event_vs_ebb(व्योम)
अणु
...
अणु
	वापस test_harness(cpu_event_vs_ebb, "cpu_event_vs_ebb");
पूर्ण
