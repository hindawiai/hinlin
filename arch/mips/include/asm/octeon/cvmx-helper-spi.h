 ...
 * and monitoring.
 */
#अगर_अघोषित __CVMX_HELPER_SPI_H__
#घोषणा __CVMX_HELPER_SPI_H__
 ...
 */
बाह्य पूर्णांक __cvmx_helper_spi_probe(पूर्णांक पूर्णांकerface);
बाह्य पूर्णांक __cvmx_helper_spi_क्रमागतerate(पूर्णांक पूर्णांकerface);
 ...
 */
बाह्य पूर्णांक __cvmx_helper_spi_enable(पूर्णांक पूर्णांकerface);
 ...
 * Returns Link state
 */
बाह्य जोड़ cvmx_helper_link_info __cvmx_helper_spi_link_get(पूर्णांक ipd_port);
 ...
 * Returns Zero on success, negative on failure
 */
बाह्य पूर्णांक __cvmx_helper_spi_link_set(पूर्णांक ipd_port,
