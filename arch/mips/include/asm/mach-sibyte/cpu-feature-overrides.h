 ...
 */
#अगर_अघोषित __ASM_MACH_SIBYTE_CPU_FEATURE_OVERRIDES_H
#घोषणा __ASM_MACH_SIBYTE_CPU_FEATURE_OVERRIDES_H

/*
 * Sibyte are MIPS64 processors wired to a specअगरic configuration
 */
...
#पूर्ण_अगर /* __ASM_MACH_SIBYTE_CPU_FEATURE_OVERRIDES_H */
