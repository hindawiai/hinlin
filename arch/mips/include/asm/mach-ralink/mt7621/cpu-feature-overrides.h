...
/*
 * Ralink MT7621 specअगरic CPU feature overrides
 *
 * Copyright (C) 2008-2009 Gabor Juhos <juhosg@खोलोwrt.org>
 * Copyright (C) 2008 Imre Kaloz <kaloz@खोलोwrt.org>
 * Copyright (C) 2015 Felix Fietkau <nbd@खोलोwrt.org>
 *
 * This file was derived from: include/यंत्र-mips/cpu-features.h
 *	Copyright (C) 2003, 2004 Ralf Baechle
 *	Copyright (C) 2004 Maciej W. Rozycki
 */
#अगर_अघोषित _MT7621_CPU_FEATURE_OVERRIDES_H
#घोषणा _MT7621_CPU_FEATURE_OVERRIDES_H
...
#पूर्ण_अगर /* _MT7621_CPU_FEATURE_OVERRIDES_H */
