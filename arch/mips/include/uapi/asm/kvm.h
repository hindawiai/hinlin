 ...
 *  bits[15..8]  - COP0 रेजिस्टर set.
 *
 *  COP0 रेजिस्टर set = 0: Main CP0 रेजिस्टरs.
 *   bits[7..3]   - Register 'rd'  index.
 *   bits[2..0]   - Register 'sel' index.
 *
 *  COP0 रेजिस्टर set = 1: MAARs.
 *   bits[7..0]   - MAAR index.
 *
...
/*
 * KVM_REG_MIPS_CP0 - Coprocessor 0 रेजिस्टरs.
 */

#घोषणा KVM_REG_MIPS_MAAR	(KVM_REG_MIPS_CP0 | (1 << 8))
#घोषणा KVM_REG_MIPS_CP0_MAAR(n)	(KVM_REG_MIPS_MAAR | \
					 KVM_REG_SIZE_U64 | (n))
