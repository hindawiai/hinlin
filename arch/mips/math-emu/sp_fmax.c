 ...
 * single precision: MAXअणु,Aपूर्ण.f
 * MAX : Scalar Floating-Poपूर्णांक Maximum
 * MAXA: Scalar Floating-Poपूर्णांक argument with Maximum Absolute Value
 *
...
अणु
	...
	/* Signs of inमाला_दो are equal, let's compare exponents */
	अगर (xs == 0) अणु
