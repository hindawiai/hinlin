...
व्योम sb1250_घड़ीevent_init(व्योम)
अणु
	अचिन्हित पूर्णांक cpu = smp_processor_id();
	अचिन्हित पूर्णांक irq = K_INT_TIMER_0 + cpu;
	...
	/* Only have 4 general purpose समयrs, and we use last one as hpt */
	BUG_ON(cpu > 2);

	प्र_लिखो(name, "sb1250-counter-%d", cpu);
	cd->name		= name;
