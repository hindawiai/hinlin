...
अणु
#अगर_घोषित CONFIG_PPC64
	बाह्य पूर्णांक ppc32_classअगरy_syscall(अचिन्हित);
	अगर (abi == AUDIT_ARCH_PPC)
		वापस ppc32_classअगरy_syscall(syscall);
#पूर्ण_अगर
	चयन(syscall) अणु
	हाल __NR_खोलो:
		वापस 2;
...
अणु
#अगर_घोषित CONFIG_PPC64
	बाह्य __u32 ppc32_dir_class[];
	बाह्य __u32 ppc32_ग_लिखो_class[];
	बाह्य __u32 ppc32_पढ़ो_class[];
	बाह्य __u32 ppc32_chattr_class[];
	बाह्य __u32 ppc32_संकेत_class[];
	audit_रेजिस्टर_class(AUDIT_CLASS_WRITE_32, ppc32_ग_लिखो_class);
	audit_रेजिस्टर_class(AUDIT_CLASS_READ_32, ppc32_पढ़ो_class);
	audit_रेजिस्टर_class(AUDIT_CLASS_सूची_WRITE_32, ppc32_dir_class);
	audit_रेजिस्टर_class(AUDIT_CLASS_CHATTR_32, ppc32_chattr_class);
	audit_रेजिस्टर_class(AUDIT_CLASS_SIGNAL_32, ppc32_संकेत_class);
#पूर्ण_अगर
