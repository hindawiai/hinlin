...
पूर्णांक
fmuls(व्योम *frD, व्योम *frA, व्योम *frB)
अणु
	FP_DECL_D(A);
	FP_DECL_D(B);
	FP_DECL_D(R);
...
#अगर_घोषित DEBUG
	prपूर्णांकk("A: %ld %lu %lu %ld (%ld) [%08lx.%08lx %lx]\n",
	       A_s, A_f1, A_f0, A_e, A_c, A_f1, A_f0, A_e + 1023);
	prपूर्णांकk("B: %ld %lu %lu %ld (%ld) [%08lx.%08lx %lx]\n",
	       B_s, B_f1, B_f0, B_e, B_c, B_f1, B_f0, B_e + 1023);
#पूर्ण_अगर

	अगर ((A_c == FP_CLS_INF && B_c == FP_CLS_ZERO) ||
...
#अगर_घोषित DEBUG
	prपूर्णांकk("D: %ld %lu %lu %ld (%ld) [%08lx.%08lx %lx]\n",
