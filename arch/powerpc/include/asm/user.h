...
#अगर_अघोषित _ASM_POWERPC_USER_H
#घोषणा _ASM_POWERPC_USER_H

#समावेश <यंत्र/ptrace.h>
#समावेश <यंत्र/page.h>

/*
 * Adapted from <यंत्र-alpha/user.h>
 *
 ...
 */
काष्ठा user अणु
	काष्ठा user_pt_regs regs;		/* entire machine state */
