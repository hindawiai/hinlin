...
#अगर_अघोषित _ASM_POWERPC_DMA_H
#घोषणा _ASM_POWERPC_DMA_H
#अगर_घोषित __KERNEL__

/*
 * Defines क्रम using and allocating dma channels.
 * Written by Hennus Bergman, 1992.
 * High DMA channel support & info by Hannu Savolainen
 * and John Boyd, Nov. 1992.
 * Changes क्रम ppc sound by Christoph Nadig
 */

/*
 * Note: Adapted क्रम PowerPC by Gary Thomas
 * Modअगरied by Cort Dougan <cort@cs.nmt.edu>
 *
 * None of this really applies क्रम Power Macपूर्णांकoshes.  There is
...
#घोषणा DMA_LO_PAGE_0		0x87	/* DMA page रेजिस्टरs */
#घोषणा DMA_LO_PAGE_1		0x83
#घोषणा DMA_LO_PAGE_2		0x81
#घोषणा DMA_LO_PAGE_3		0x82
#घोषणा DMA_LO_PAGE_5		0x8B
#घोषणा DMA_LO_PAGE_6		0x89
#घोषणा DMA_LO_PAGE_7		0x8A

#घोषणा DMA_HI_PAGE_0		0x487	/* DMA page रेजिस्टरs */
#घोषणा DMA_HI_PAGE_1		0x483
#घोषणा DMA_HI_PAGE_2		0x481
#घोषणा DMA_HI_PAGE_3		0x482
#घोषणा DMA_HI_PAGE_5		0x48B
#घोषणा DMA_HI_PAGE_6		0x489
#घोषणा DMA_HI_PAGE_7		0x48A

#घोषणा DMA1_EXT_REG		0x40B
#घोषणा DMA2_EXT_REG		0x4D6

#अगर_अघोषित __घातerpc64__
    /* in arch/घातerpc/kernel/setup_32.c -- Cort */
    बाह्य अचिन्हित पूर्णांक DMA_MODE_WRITE;
    बाह्य अचिन्हित पूर्णांक DMA_MODE_READ;
#अन्यथा
 ...
 */
अटल __अंतरभूत__ व्योम set_dma_page(अचिन्हित पूर्णांक dmanr, पूर्णांक pagenr)
अणु
	चयन (dmanr) अणु
	हाल 0:
 ...
 */
अटल __अंतरभूत__ व्योम set_dma_addr(अचिन्हित पूर्णांक dmanr, अचिन्हित पूर्णांक phys)
अणु
	अगर (dmanr <= 3) अणु
		dma_outb(phys & 0xff,
...
अणु
	अचिन्हित पूर्णांक io_port = (dmanr <= 3)
	    ? ((dmanr & 3) << 1) + 1 + IO_DMA1_BASE
	    : ((dmanr & 3) << 2) + 2 + IO_DMA2_BASE;
