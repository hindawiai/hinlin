...
अणु
#अगर_घोषित CONFIG_COMPAT
	बाह्य पूर्णांक parisc32_classअगरy_syscall(अचिन्हित);
	अगर (abi == AUDIT_ARCH_PARISC)
		वापस parisc32_classअगरy_syscall(syscall);
#पूर्ण_अगर
	चयन (syscall) अणु
	हाल __NR_खोलो:
		वापस 2;
...
अणु
#अगर_घोषित CONFIG_COMPAT
	बाह्य __u32 parisc32_dir_class[];
	बाह्य __u32 parisc32_ग_लिखो_class[];
	बाह्य __u32 parisc32_पढ़ो_class[];
	बाह्य __u32 parisc32_chattr_class[];
	बाह्य __u32 parisc32_संकेत_class[];
	audit_रेजिस्टर_class(AUDIT_CLASS_WRITE_32, parisc32_ग_लिखो_class);
	audit_रेजिस्टर_class(AUDIT_CLASS_READ_32, parisc32_पढ़ो_class);
	audit_रेजिस्टर_class(AUDIT_CLASS_सूची_WRITE_32, parisc32_dir_class);
	audit_रेजिस्टर_class(AUDIT_CLASS_CHATTR_32, parisc32_chattr_class);
	audit_रेजिस्टर_class(AUDIT_CLASS_SIGNAL_32, parisc32_संकेत_class);
#पूर्ण_अगर
