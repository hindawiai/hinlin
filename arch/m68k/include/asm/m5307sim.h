...
/****************************************************************************/
#अगर_अघोषित	m5307sim_h
#घोषणा	m5307sim_h
/****************************************************************************/

#घोषणा	CPU_NAME		"COLDFIRE(m5307)"
...
/*
 *	Define the 5307 SIM रेजिस्टर set addresses.
 */
#घोषणा	MCFSIM_RSR		(MCF_MBAR + 0x00)	/* Reset Status reg */
...
#घोषणा	MCFSIM_IRQPAR		(MCF_MBAR + 0x06)	/* Itr Assignment */
#घोषणा	MCFSIM_PLLCR		(MCF_MBAR + 0x08)	/* PLL Ctrl Reg */
#घोषणा	MCFSIM_MPARK		(MCF_MBAR + 0x0C)	/* BUS Master Ctrl */
#घोषणा	MCFSIM_IPR		(MCF_MBAR + 0x40)	/* Interrupt Pend */
...
#अगर_घोषित CONFIG_OLDMASK
#घोषणा MCFSIM_CSBAR		(MCF_MBAR + 0x98)	/* CS Base Address */
#घोषणा MCFSIM_CSBAMR		(MCF_MBAR + 0x9c)	/* CS Base Mask */
#घोषणा MCFSIM_CSMR2		(MCF_MBAR + 0x9e)	/* CS 2 Mask reg */
#घोषणा MCFSIM_CSCR2		(MCF_MBAR + 0xa2)	/* CS 2 Control reg */
#घोषणा MCFSIM_CSMR3		(MCF_MBAR + 0xaa)	/* CS 3 Mask reg */
#घोषणा MCFSIM_CSCR3		(MCF_MBAR + 0xae)	/* CS 3 Control reg */
#घोषणा MCFSIM_CSMR4		(MCF_MBAR + 0xb6)	/* CS 4 Mask reg */
#घोषणा MCFSIM_CSCR4		(MCF_MBAR + 0xba)	/* CS 4 Control reg */
#घोषणा MCFSIM_CSMR5		(MCF_MBAR + 0xc2)	/* CS 5 Mask reg */
#घोषणा MCFSIM_CSCR5		(MCF_MBAR + 0xc6)	/* CS 5 Control reg */
#घोषणा MCFSIM_CSMR6		(MCF_MBAR + 0xce)	/* CS 6 Mask reg */
#घोषणा MCFSIM_CSCR6		(MCF_MBAR + 0xd2)	/* CS 6 Control reg */
#घोषणा MCFSIM_CSMR7		(MCF_MBAR + 0xda)	/* CS 7 Mask reg */
...
#घोषणा MCFSIM_CSCR7		(MCF_MBAR + 0xde)	/* CS 7 Control reg */
#पूर्ण_अगर /* CONFIG_OLDMASK */

#घोषणा MCFSIM_DCR		(MCF_MBAR + 0x100)	/* DRAM Control */
#घोषणा MCFSIM_DACR0		(MCF_MBAR + 0x108)	/* DRAM Addr/Ctrl 0 */
#घोषणा MCFSIM_DMR0		(MCF_MBAR + 0x10c)	/* DRAM Mask 0 */
#घोषणा MCFSIM_DACR1		(MCF_MBAR + 0x110)	/* DRAM Addr/Ctrl 1 */
#घोषणा MCFSIM_DMR1		(MCF_MBAR + 0x114)	/* DRAM Mask 1 */
 ...
 *  UART module.
 */
#अगर defined(CONFIG_NETtel) || defined(CONFIG_SECUREEDGEMP3)
#घोषणा MCFUART_BASE0		(MCF_MBAR + 0x200)	/* Base address UART0 */
#घोषणा MCFUART_BASE1		(MCF_MBAR + 0x1c0)	/* Base address UART1 */
#अन्यथा
...
/* Definition offset address क्रम CS2-7  -- old mask 5307 */

#घोषणा	MCF5307_CS2		(0x400000)
#घोषणा	MCF5307_CS3		(0x600000)
#घोषणा	MCF5307_CS4		(0x800000)
#घोषणा	MCF5307_CS5		(0xA00000)
#घोषणा	MCF5307_CS6		(0xC00000)
#घोषणा	MCF5307_CS7		(0xE00000)
