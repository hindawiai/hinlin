...
#समावेश <माला.स>
#पूर्ण_अगर
#समावेश <यंत्र/inat.h> /*__ignore_sync_check__ */
#समावेश <यंत्र/insn.h> /* __ignore_sync_check__ */

#समावेश <linux/त्रुटिसं.स>
#समावेश <linux/kconfig.h>

#समावेश <यंत्र/emulate_prefix.h> /* __ignore_sync_check__ */
...
/* #घोषणा INSN_MODE_KERN	-1 __ignore_sync_check__ mode is only valid in the kernel */
