...
#अगर_अघोषित _ASM_X86_USER_64_H
#घोषणा _ASM_X86_USER_64_H

#समावेश <यंत्र/types.h>
#समावेश <यंत्र/page.h>
/* Core file क्रमmat: The core file is written in such a way that gdb
   can understand it and provide useful inक्रमmation to the user.
   There are quite a number of obstacles to being able to view the
   contents of the भग्नing poपूर्णांक रेजिस्टरs, and until these are
   solved you will not be able to view the contents of them.
   Actually, you can पढ़ो in the core file and look at the contents of
   the user काष्ठा to find out what the भग्नing poपूर्णांक रेजिस्टरs
   contain.
...
/* This matches the 64bit FXSAVE क्रमmat as defined by AMD. It is the same
   as the 32bit क्रमmat defined by Intel, except that the selector:offset pairs
   क्रम data and eip are replaced with flat 64bit poपूर्णांकers. */
काष्ठा user_i387_काष्ठा अणु
	अचिन्हित लघु	cwd;
	अचिन्हित लघु	swd;
	अचिन्हित लघु	twd;	/* Note this is not the same as
	...
	__u32	mxcsr;
	__u32	mxcsr_mask;
	__u32	st_space[32];	/* 8*16 bytes क्रम each FP-reg = 128 bytes */
	__u32	xmm_space[64];	/* 16*16 bytes क्रम each XMM-reg = 256 bytes */
	__u32	padding[24];
पूर्ण;

/*
 * Segment रेजिस्टर layout in coredumps.
 */
...
/* The rest of this junk is to help gdb figure out what goes where */
  ...
  अचिन्हित दीर्घ u_debugreg[8];
  अचिन्हित दीर्घ error_code; /* CPU error code or 0 */
  अचिन्हित दीर्घ fault_address; /* CR3 or 0 */
पूर्ण;
