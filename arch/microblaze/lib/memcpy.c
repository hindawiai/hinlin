...
#अगर_घोषित __HAVE_ARCH_MEMCPY
#अगर_अघोषित CONFIG_OPT_LIB_FUNCTION
व्योम *स_नकल(व्योम *v_dst, स्थिर व्योम *v_src, __kernel_माप_प्रकार c)
अणु
	स्थिर अक्षर *src = v_src;
	अक्षर *dst = v_dst;

	/* Simple, byte oriented स_नकल. */
	जबतक (c--)
		*dst++ = *src++;
...
अणु
	...
	अगर (likely(c >= 4)) अणु
		...
		हाल 0x1:	/* Unaligned - Off by 1 */
			...
			i_src = (स्थिर व्योम *) ((अचिन्हित)src & ~3);
