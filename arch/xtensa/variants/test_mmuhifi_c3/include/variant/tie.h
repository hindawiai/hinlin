...
#घोषणा XCHAL_CP_MAX			2	/* max CP ID + 1 (0 अगर none) */
#घोषणा XCHAL_CP_MASK			0x02	/* biपंचांगask of all CPs by ID */
...
#घोषणा XCHAL_CP1_SA_SIZE		112	/* size of state save area */
...
#घोषणा XCHAL_NCP_SA_SIZE		12
#घोषणा XCHAL_NCP_SA_ALIGN		4

/*  Total save area क्रम optional and custom state (NCP + CPn):  */
#घोषणा XCHAL_TOTAL_SA_SIZE		128	/* with 16-byte align padding */
