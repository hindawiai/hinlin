 ...
 */
	...
	l32i	\चt2, \ptr, .Lxchal_ofs_ + 4
	wsr	\चt1, ACCLO		// MAC16 accumulator
	wsr	\चt2, ACCHI
	.set	.Lxchal_ofs_, .Lxchal_ofs_ + 8
	.endअगर
	.अगरeq (XTHAL_SAS_OPT | XTHAL_SAS_NOCC | XTHAL_SAS_CALR) & ~\select
	...
	l32i	\चt1, \ptr, .Lxchal_ofs_ + 0
	l32i	\चt2, \ptr, .Lxchal_ofs_ + 4
	wsr	\चt1, M0		// MAC16 रेजिस्टरs
	wsr	\चt2, M1
	l32i	\चt1, \ptr, .Lxchal_ofs_ + 8
	l32i	\चt2, \ptr, .Lxchal_ofs_ + 12
	wsr	\चt1, M2
	wsr	\चt2, M3
	.set	.Lxchal_ofs_, .Lxchal_ofs_ + 16
	.endअगर
...
#घोषणा XCHAL_NCP_NUM_ATMPS	2


#घोषणा XCHAL_SA_NUM_ATMPS	2
