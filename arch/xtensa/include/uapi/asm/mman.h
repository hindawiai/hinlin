...
#अगर_अघोषित _XTENSA_MMAN_H
#घोषणा _XTENSA_MMAN_H
...
#घोषणा PROT_GROWSUP	0x02000000	/* mprotect flag: extend change to end fo growsup vma */
