...
#अगर_अघोषित _XTENSA_IOCTLS_H
#घोषणा _XTENSA_IOCTLS_H
...
#घोषणा TIOCEXCL	_IO('T', 12)
#घोषणा TIOCNXCL	_IO('T', 13)
#घोषणा TIOCSCTTY	_IO('T', 14)

#घोषणा TIOCSTI		_IOW('T', 18, अक्षर)
#घोषणा TIOCMGET	_IOR('T', 21, अचिन्हित पूर्णांक)
#घोषणा TIOCMBIS	_IOW('T', 22, अचिन्हित पूर्णांक)
#घोषणा TIOCMBIC	_IOW('T', 23, अचिन्हित पूर्णांक)
#घोषणा TIOCMSET	_IOW('T', 24, अचिन्हित पूर्णांक)
...
#घोषणा TIOCGSOFTCAR	_IOR('T', 25, अचिन्हित पूर्णांक)
#घोषणा TIOCSSOFTCAR	_IOW('T', 26, अचिन्हित पूर्णांक)
#घोषणा TIOCLINUX	_IOW('T', 28, अक्षर)
#घोषणा TIOCCONS	_IO('T', 29)
#घोषणा TIOCGSERIAL	0x803C541E	/*_IOR('T', 30, काष्ठा serial_काष्ठा)*/
#घोषणा TIOCSSERIAL	0x403C541F	/*_IOW('T', 31, काष्ठा serial_काष्ठा)*/
#घोषणा TIOCPKT		_IOW('T', 32, पूर्णांक)
...
#घोषणा TIOCNOTTY	_IO('T', 34)
#घोषणा TIOCSETD	_IOW('T', 35, पूर्णांक)
#घोषणा TIOCGETD	_IOR('T', 36, पूर्णांक)
#घोषणा TCSBRKP		_IOW('T', 37, पूर्णांक)   /* Needed क्रम POSIX tcsendअवरोध()*/
#घोषणा TIOCSBRK	_IO('T', 39) 	     /* BSD compatibility */
#घोषणा TIOCCBRK	_IO('T', 40)	     /* BSD compatibility */
#घोषणा TIOCGSID	_IOR('T', 41, pid_t) /* Return the session ID of FD*/
...
#घोषणा TIOCSERCONFIG	_IO('T', 83)
#घोषणा TIOCSERGWILD	_IOR('T', 84,  पूर्णांक)
#घोषणा TIOCSERSWILD	_IOW('T', 85,  पूर्णांक)
#घोषणा TIOCGLCKTRMIOS	0x5456
#घोषणा TIOCSLCKTRMIOS	0x5457
#घोषणा TIOCSERGSTRUCT	0x5458		     /* For debugging only */
#घोषणा TIOCSERGETLSR   _IOR('T', 89, अचिन्हित पूर्णांक) /* Get line status reg. */
  /* ioctl (fd, TIOCSERGETLSR, &result) where result may be as below */
# define TIOCSER_TEMT    0x01		     /* Transmitter physically empty */
#घोषणा TIOCSERGETMULTI 0x80a8545a /* Get multiport config  */
			/* _IOR('T', 90, काष्ठा serial_multiport_काष्ठा) */
#घोषणा TIOCSERSETMULTI 0x40a8545b /* Set multiport config */
			/* _IOW('T', 91, काष्ठा serial_multiport_काष्ठा) */

#घोषणा TIOCMIWAIT	_IO('T', 92) /* रुको क्रम a change on serial input line(s) */
#घोषणा TIOCGICOUNT	0x545D	/* पढ़ो serial port अंतरभूत पूर्णांकerrupt counts */

#पूर्ण_अगर /* _XTENSA_IOCTLS_H */
