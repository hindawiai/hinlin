...
#अगर_अघोषित _UAPI_ASMARM_SIGNAL_H
#घोषणा _UAPI_ASMARM_SIGNAL_H
...
/*
 * SA_THIRTYTWO historically meant deliver the संकेत in 32-bit mode, even अगर
 * the task is running in 26-bit. But since the kernel no दीर्घer supports
 * 26-bit mode, the flag has no effect.
 */
#घोषणा SA_THIRTYTWO	0x02000000
...
#पूर्ण_अगर /* _UAPI_ASMARM_SIGNAL_H */
