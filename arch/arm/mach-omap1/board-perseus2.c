...
अटल स्थिर अचिन्हित पूर्णांक p2_keymap[] = अणु
	KEY(0, 0, KEY_UP),
	KEY(1, 0, KEY_RIGHT),
	KEY(2, 0, KEY_LEFT),
	KEY(3, 0, KEY_DOWN),
...
#घोषणा P2_न_अंकD_RB_GPIO_PIN	62

अटल पूर्णांक nand_dev_पढ़ोy(काष्ठा nand_chip *chip)
अणु
	वापस gpio_get_value(P2_न_अंकD_RB_GPIO_PIN);
पूर्ण
...
अटल स्थिर काष्ठा matrix_keymap_data p2_keymap_data = अणु
	.keymap		= p2_keymap,
...
अटल स्थिर काष्ठा omap_lcd_config perseus2_lcd_config __initस्थिर = अणु
	.ctrl_name	= "internal",
पूर्ण;

अटल व्योम __init perseus2_init_smc91x(व्योम)
अणु
...
अटल व्योम __init omap_perseus2_init(व्योम)
अणु
	...
	BUG_ON(gpio_request(P2_न_अंकD_RB_GPIO_PIN, "NAND ready") < 0);
	gpio_direction_input(P2_न_अंकD_RB_GPIO_PIN);
...
अटल काष्ठा map_desc omap_perseus2_io_desc[] __initdata = अणु
	अणु
...
अटल व्योम __init omap_perseus2_map_io(व्योम)
अणु
	omap7xx_map_io();
...
MACHINE_START(OMAP_PERSEUS2, "OMAP730 Perseus2")
	/* Maपूर्णांकainer: Kevin Hilman <kjh@hilman.org> */
	.atag_offset	= 0x100,
