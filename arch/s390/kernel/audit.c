...
अणु
#अगर_घोषित CONFIG_COMPAT
	अगर (abi == AUDIT_ARCH_S390)
		वापस s390_classअगरy_syscall(syscall);
#पूर्ण_अगर
	चयन(syscall) अणु
	हाल __NR_खोलो:
		वापस 2;
...
अणु
#अगर_घोषित CONFIG_COMPAT
	audit_रेजिस्टर_class(AUDIT_CLASS_WRITE_32, s390_ग_लिखो_class);
	audit_रेजिस्टर_class(AUDIT_CLASS_READ_32, s390_पढ़ो_class);
	audit_रेजिस्टर_class(AUDIT_CLASS_सूची_WRITE_32, s390_dir_class);
	audit_रेजिस्टर_class(AUDIT_CLASS_CHATTR_32, s390_chattr_class);
	audit_रेजिस्टर_class(AUDIT_CLASS_SIGNAL_32, s390_संकेत_class);
#पूर्ण_अगर
