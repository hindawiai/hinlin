...
/*
 * arch/sh/kernel/cpu/sh2a/घड़ी-sh7206.c
 *
 * SH7206 support क्रम the घड़ी framework
 *
...
अणु
	clk->rate *= pll2_mult * pll1rate[(__raw_पढ़ोw(FREQCR) >> 8) & 0x0007];
पूर्ण

अटल काष्ठा sh_clk_ops sh7206_master_clk_ops = अणु
...
अटल काष्ठा sh_clk_ops sh7206_module_clk_ops = अणु
	.recalc		= module_clk_recalc,
पूर्ण;

अटल अचिन्हित दीर्घ bus_clk_recalc(काष्ठा clk *clk)
अणु
	वापस clk->parent->rate / pll1rate[(__raw_पढ़ोw(FREQCR) >> 8) & 0x0007];
पूर्ण

अटल काष्ठा sh_clk_ops sh7206_bus_clk_ops = अणु
...
अटल काष्ठा sh_clk_ops sh7206_cpu_clk_ops = अणु
	.recalc		= cpu_clk_recalc,
पूर्ण;

अटल काष्ठा sh_clk_ops *sh7206_clk_ops[] = अणु
...
अणु
	अगर (test_mode_pin(MODE_PIN2 | MODE_PIN1 | MODE_PIN0))
		pll2_mult = 1;
	अन्यथा अगर (test_mode_pin(MODE_PIN2 | MODE_PIN1))
		pll2_mult = 2;
	अन्यथा अगर (test_mode_pin(MODE_PIN1))
		pll2_mult = 4;

	अगर (idx < ARRAY_SIZE(sh7206_clk_ops))
