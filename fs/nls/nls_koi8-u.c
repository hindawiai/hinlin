...
अटल स्थिर अचिन्हित अक्षर page04[256] = अणु
...
अटल स्थिर अचिन्हित अक्षर page23[256] = अणु
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* 0x00-0x07 */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* 0x08-0x0f */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* 0x10-0x17 */
...
अटल स्थिर अचिन्हित अक्षर *स्थिर page_uni2अक्षरset[256] = अणु
	page00, शून्य,   शून्य,   शून्य,   page04, शून्य,   शून्य,   शून्य,   
	शून्य,   शून्य,   शून्य,   शून्य,   शून्य,   शून्य,   शून्य,   शून्य,   
	शून्य,   शून्य,   शून्य,   शून्य,   शून्य,   शून्य,   शून्य,   शून्य,   
	शून्य,   शून्य,   शून्य,   शून्य,   शून्य,   शून्य,   शून्य,   शून्य,   
	शून्य,   शून्य,   page22, page23, शून्य,   page25, शून्य,   शून्य,   
पूर्ण;
...
अटल पूर्णांक __init init_nls_koi8_u(व्योम)
अणु
	वापस रेजिस्टर_nls(&table);
पूर्ण

अटल व्योम __निकास निकास_nls_koi8_u(व्योम)
अणु
	unरेजिस्टर_nls(&table);
पूर्ण

module_init(init_nls_koi8_u)
module_निकास(निकास_nls_koi8_u)
