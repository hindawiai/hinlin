...
अटल स्थिर अचिन्हित अक्षर *स्थिर page_uni2अक्षरset[256] = अणु
	page00, शून्य,   शून्य,   page03, शून्य,   शून्य,   शून्य,   शून्य,   
...
अटल पूर्णांक __init init_nls_cp860(व्योम)
अणु
	वापस रेजिस्टर_nls(&table);
पूर्ण

अटल व्योम __निकास निकास_nls_cp860(व्योम)
अणु
	unरेजिस्टर_nls(&table);
पूर्ण

module_init(init_nls_cp860)
module_निकास(निकास_nls_cp860)
