...
#घोषणा INDIGO_FAMILY
#घोषणा ECHOCARD_INDIGO_IOX
#घोषणा ECHOCARD_NAME "Indigo IOx"
...
#घोषणा BX_DIGITAL_OUT	2	/* 0 */
#घोषणा BX_ANALOG_IN	2	/* 2 */
