...
/*
 * Apple Onboard Audio driver क्रम Onyx codec (header)
 *
 * Copyright 2006 Johannes Berg <johannes@sipsolutions.net>
 */
#अगर_अघोषित __SND_AOA_CODEC_ONYX_H
#घोषणा __SND_AOA_CODEC_ONYX_H
#समावेश <मानकघोष.स>
#समावेश <linux/i2c.h>
#समावेश <यंत्र/pmac_low_i2c.h>
#समावेश <यंत्र/prom.h>

/* PCM3052 रेजिस्टर definitions */

/* the attenuation रेजिस्टरs take values from
 * -1 (0dB) to -127 (-63.0 dB) or others (muted) */
#घोषणा ONYX_REG_DAC_ATTEN_LEFT		65
#घोषणा FIRSTREGISTER			ONYX_REG_DAC_ATTEN_LEFT
#घोषणा ONYX_REG_DAC_ATTEN_RIGHT	66
...
#पूर्ण_अगर /* __SND_AOA_CODEC_ONYX_H */
