...
/*
 * Hardware पूर्णांकerface क्रम audio DSP on Apollolake and GeminiLake
 */
...
अटल स्थिर काष्ठा snd_sof_debugfs_map apl_dsp_debugfs[] = अणु
...
/* apollolake ops */
स्थिर काष्ठा snd_sof_dsp_ops sof_apl_ops = अणु
	...
	/* करोorbell */
	.irq_thपढ़ो	= hda_dsp_ipc_irq_thपढ़ो,
...
स्थिर काष्ठा sof_पूर्णांकel_dsp_desc apl_chip_info = अणु
	/* Apollolake */
	.cores_num = 2,
	.init_core_mask = 1,
