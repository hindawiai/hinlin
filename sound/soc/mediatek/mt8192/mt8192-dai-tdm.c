...
अणु
	अगर (mode == TDM_OUT_DSP_A || mode == TDM_OUT_DSP_B)
...
अटल पूर्णांक get_tdm_id_by_name(स्थिर अक्षर *name)
अणु
	वापस MT8192_DAI_TDM;
पूर्ण

अटल पूर्णांक mtk_tdm_en_event(काष्ठा snd_soc_dapm_widget *w,
...
अणु
	...
	पूर्णांक dai_id = get_tdm_id_by_name(w->name);
	काष्ठा mtk_afe_tdm_priv *tdm_priv = afe_priv->dai_priv[dai_id];
...
अणु
	...
	पूर्ण अन्यथा अगर (tdm_priv->tdm_out_mode == TDM_OUT_DSP_A) अणु
		tdm_con |= 0 << DELAY_DATA_SFT;
		tdm_con |= 0 << LRCK_TDM_WIDTH_SFT;
	पूर्ण अन्यथा अगर (tdm_priv->tdm_out_mode == TDM_OUT_DSP_B) अणु
		tdm_con |= 1 << DELAY_DATA_SFT;
		tdm_con |= 0 << LRCK_TDM_WIDTH_SFT;
	पूर्ण
...
अटल काष्ठा mtk_afe_tdm_priv *init_tdm_priv_data(काष्ठा mtk_base_afe *afe)
अणु
	काष्ठा mtk_afe_tdm_priv *tdm_priv;
