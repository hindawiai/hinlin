...
अटल स्थिर काष्ठा snd_soc_dapm_widget mt8173_rt5650_rt5676_widमाला_लो[] = अणु
...
अटल स्थिर काष्ठा snd_soc_dapm_route mt8173_rt5650_rt5676_routes[] = अणु
	अणु"Speaker", शून्य, "SPOL"पूर्ण,
	अणु"Speaker", शून्य, "SPOR"पूर्ण,
	अणु"Speaker", शून्य, "Sub AIF2TX"पूर्ण, /* IF2 ADC to 5650  */
	अणु"Sub DMIC L1", शून्य, "Int Mic"पूर्ण, /* DMIC from 5676 */
	अणु"Sub DMIC R1", शून्य, "Int Mic"पूर्ण,
	अणु"Headphone", शून्य, "HPOL"पूर्ण,
	अणु"Headphone", शून्य, "HPOR"पूर्ण,
	अणु"Headphone", शून्य, "Sub AIF2TX"पूर्ण, /* IF2 ADC to 5650  */
	अणु"IN1P", शून्य, "Headset Mic"पूर्ण,
	अणु"IN1N", शून्य, "Headset Mic"पूर्ण,
	अणु"Sub AIF2RX", शून्य, "Headset Mic"पूर्ण, /* IF2 DAC from 5650  */
पूर्ण;

अटल स्थिर काष्ठा snd_kcontrol_new mt8173_rt5650_rt5676_controls[] = अणु
...
अटल पूर्णांक mt8173_rt5650_rt5676_hw_params(काष्ठा snd_pcm_substream *substream,
...
अटल स्थिर काष्ठा snd_soc_ops mt8173_rt5650_rt5676_ops = अणु
	.hw_params = mt8173_rt5650_rt5676_hw_params,
पूर्ण;

अटल काष्ठा snd_soc_jack mt8173_rt5650_rt5676_jack;

अटल पूर्णांक mt8173_rt5650_rt5676_init(काष्ठा snd_soc_pcm_runसमय *runसमय)
अणु
	काष्ठा snd_soc_card *card = runसमय->card;
	काष्ठा snd_soc_component *component = asoc_rtd_to_codec(runसमय, 0)->component;
	काष्ठा snd_soc_component *component_sub = asoc_rtd_to_codec(runसमय, 1)->component;
	पूर्णांक ret;
	...
	ret = snd_soc_card_jack_new(card, "Headset Jack",
				    ...
				    &mt8173_rt5650_rt5676_jack, शून्य, 0);
	अगर (ret) अणु
...
SND_SOC_DAILINK_DEFS(पूर्णांकercodec,
	DAILINK_COMP_ARRAY(COMP_DUMMY()),
	DAILINK_COMP_ARRAY(COMP_CODEC(शून्य, "rt5677-aif2")),
	DAILINK_COMP_ARRAY(COMP_DUMMY()));

/* Digital audio पूर्णांकerface glue - connects codec <---> CPU */
अटल काष्ठा snd_soc_dai_link mt8173_rt5650_rt5676_dais[] = अणु
	/* Front End DAI links */
	...
	पूर्ण,
	/* rt5676 <-> rt5650 पूर्णांकercodec link: Sets rt5676 I2S2 as master */
	[DAI_LINK_INTERCODEC] = अणु
		.name = "rt5650_rt5676 intercodec",
		.stream_name = "rt5650_rt5676 intercodec",
		.no_pcm = 1,
		.dai_fmt = SND_SOC_DAIFMT_I2S | SND_SOC_DAIFMT_NB_NF |
			   SND_SOC_DAIFMT_CBM_CFM,
		SND_SOC_DAILINK_REG(पूर्णांकercodec),
	पूर्ण,
पूर्ण;

अटल काष्ठा snd_soc_codec_conf mt8173_rt5650_rt5676_codec_conf[] = अणु
	अणु
		.name_prefix = "Sub",
	पूर्ण,
पूर्ण;

अटल काष्ठा snd_soc_card mt8173_rt5650_rt5676_card = अणु
	...
	.dapm_widमाला_लो = mt8173_rt5650_rt5676_widमाला_लो,
	.num_dapm_widमाला_लो = ARRAY_SIZE(mt8173_rt5650_rt5676_widमाला_लो),
	.dapm_routes = mt8173_rt5650_rt5676_routes,
	.num_dapm_routes = ARRAY_SIZE(mt8173_rt5650_rt5676_routes),
पूर्ण;

अटल पूर्णांक mt8173_rt5650_rt5676_dev_probe(काष्ठा platक्रमm_device *pdev)
अणु
	काष्ठा snd_soc_card *card = &mt8173_rt5650_rt5676_card;
	...
	अगर (!mt8173_rt5650_rt5676_dais[DAI_LINK_CODEC_I2S].codecs[0].of_node) अणु
		dev_err(&pdev->dev,
	...
	अगर (!mt8173_rt5650_rt5676_dais[DAI_LINK_CODEC_I2S].codecs[1].of_node) अणु
		dev_err(&pdev->dev,
			"Property 'audio-codec' missing or invalid\n");
		वापस -EINVAL;
	पूर्ण
	...
	अगर (!mt8173_rt5650_rt5676_dais[DAI_LINK_HDMI_I2S].codecs->of_node) अणु
		dev_err(&pdev->dev,
			"Property 'audio-codec' missing or invalid\n");
		वापस -EINVAL;
	पूर्ण
...
अटल स्थिर काष्ठा of_device_id mt8173_rt5650_rt5676_dt_match[] = अणु
	अणु .compatible = "mediatek,mt8173-rt5650-rt5676", पूर्ण,
	अणु पूर्ण
पूर्ण;
MODULE_DEVICE_TABLE(of, mt8173_rt5650_rt5676_dt_match);

अटल काष्ठा platक्रमm_driver mt8173_rt5650_rt5676_driver = अणु
	.driver = अणु
		   .name = "mtk-rt5650-rt5676",
...
module_platक्रमm_driver(mt8173_rt5650_rt5676_driver);
