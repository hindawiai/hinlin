...
#घोषणा SKL_MAXIM_CODEC_DAI "HiFi"
...
अणु
	काष्ठा skl_nau8825_निजी *ctx = snd_soc_card_get_drvdata(rtd->card);
...
अणु
	काष्ठा skl_nau8825_निजी *ctx = snd_soc_card_get_drvdata(card);
	काष्ठा skl_hdmi_pcm *pcm;
...
अटल स्थिर काष्ठा platक्रमm_device_id skl_board_ids[] = अणु
	अणु .name = "skl_n88l25_m98357a" पूर्ण,
	अणु .name = "kbl_n88l25_m98357a" पूर्ण,
	अणु पूर्ण
पूर्ण;
