...
#समावेश <sound/sta350.h>
#समावेश "sta350.h"

#घोषणा STA350_RATES (SNDRV_PCM_RATE_32000 | \
...
अटल स्थिर काष्ठा reg_शेष sta350_regs[] = अणु
	अणु  0x0, 0x63 पूर्ण,
	अणु  0x1, 0x80 पूर्ण,
	अणु  0x2, 0xdf पूर्ण,
	अणु  0x3, 0x40 पूर्ण,
...
अटल स्थिर काष्ठा regmap_range sta350_ग_लिखो_regs_range[] = अणु
...
अटल स्थिर काष्ठा regmap_range sta350_पढ़ो_regs_range[] = अणु
	regmap_reg_range(STA350_CONFA,  STA350_AUTO2),
...
अटल स्थिर काष्ठा regmap_range sta350_अस्थिर_regs_range[] = अणु
	regmap_reg_range(STA350_CFADDR2, STA350_CFUD),
	regmap_reg_range(STA350_STATUS,  STA350_STATUS),
पूर्ण;

अटल स्थिर काष्ठा regmap_access_table sta350_ग_लिखो_regs = अणु
	.yes_ranges =	sta350_ग_लिखो_regs_range,
	.n_yes_ranges =	ARRAY_SIZE(sta350_ग_लिखो_regs_range),
पूर्ण;

अटल स्थिर काष्ठा regmap_access_table sta350_पढ़ो_regs = अणु
	.yes_ranges =	sta350_पढ़ो_regs_range,
	.n_yes_ranges =	ARRAY_SIZE(sta350_पढ़ो_regs_range),
पूर्ण;

अटल स्थिर काष्ठा regmap_access_table sta350_अस्थिर_regs = अणु
	.yes_ranges =	sta350_अस्थिर_regs_range,
	.n_yes_ranges =	ARRAY_SIZE(sta350_अस्थिर_regs_range),
पूर्ण;

/* regulator घातer supply names */
अटल स्थिर अक्षर * स्थिर sta350_supply_names[] = अणु
	"vdd-dig",	/* digital supply, 3.3V */
	"vdd-pll",	/* pll supply, 3.3V */
	"vcc"		/* घातer amp supply, 5V - 26V */
पूर्ण;

/* codec निजी data */
काष्ठा sta350_priv अणु
	काष्ठा regmap *regmap;
	काष्ठा regulator_bulk_data supplies[ARRAY_SIZE(sta350_supply_names)];
	काष्ठा sta350_platक्रमm_data *pdata;

	अचिन्हित पूर्णांक mclk;
	अचिन्हित पूर्णांक क्रमmat;

	u32 coef_shaकरोw[STA350_COEF_COUNT];
	पूर्णांक shutकरोwn;

	काष्ठा gpio_desc *gpiod_nreset;
	काष्ठा gpio_desc *gpiod_घातer_करोwn;

	काष्ठा mutex coeff_lock;
पूर्ण;

अटल स्थिर DECLARE_TLV_DB_SCALE(mvol_tlv, -12750, 50, 1);
अटल स्थिर DECLARE_TLV_DB_SCALE(chvol_tlv, -7950, 50, 1);
अटल स्थिर DECLARE_TLV_DB_SCALE(tone_tlv, -1200, 200, 0);

अटल स्थिर अक्षर * स्थिर sta350_drc_ac[] = अणु
	"Anti-Clipping", "Dynamic Range Compression"
पूर्ण;
अटल स्थिर अक्षर * स्थिर sta350_स्वतः_gc_mode[] = अणु
	"User", "AC no clipping", "AC limited clipping (10%)",
	"DRC nighttime listening mode"
पूर्ण;
अटल स्थिर अक्षर * स्थिर sta350_स्वतः_xo_mode[] = अणु
	"User", "80Hz", "100Hz", "120Hz", "140Hz", "160Hz", "180Hz",
	"200Hz", "220Hz", "240Hz", "260Hz", "280Hz", "300Hz", "320Hz",
	"340Hz", "360Hz"
पूर्ण;
अटल स्थिर अक्षर * स्थिर sta350_binary_output[] = अणु
	"FFX 3-state output - normal operation", "Binary output"
पूर्ण;
अटल स्थिर अक्षर * स्थिर sta350_limiter_select[] = अणु
	"Limiter Disabled", "Limiter #1", "Limiter #2"
पूर्ण;
अटल स्थिर अक्षर * स्थिर sta350_limiter_attack_rate[] = अणु
	"3.1584", "2.7072", "2.2560", "1.8048", "1.3536", "0.9024",
	"0.4512", "0.2256", "0.1504", "0.1123", "0.0902", "0.0752",
	"0.0645", "0.0564", "0.0501", "0.0451"
पूर्ण;
अटल स्थिर अक्षर * स्थिर sta350_limiter_release_rate[] = अणु
	"0.5116", "0.1370", "0.0744", "0.0499", "0.0360", "0.0299",
	"0.0264", "0.0208", "0.0198", "0.0172", "0.0147", "0.0137",
	"0.0134", "0.0117", "0.0110", "0.0104"
पूर्ण;
अटल स्थिर अक्षर * स्थिर sta350_noise_shaper_type[] = अणु
	"Third order", "Fourth order"
पूर्ण;

अटल DECLARE_TLV_DB_RANGE(sta350_limiter_ac_attack_tlv,
	0, 7, TLV_DB_SCALE_ITEM(-1200, 200, 0),
	8, 16, TLV_DB_SCALE_ITEM(300, 100, 0),
);

अटल DECLARE_TLV_DB_RANGE(sta350_limiter_ac_release_tlv,
...
अटल DECLARE_TLV_DB_RANGE(sta350_limiter_drc_attack_tlv,
	0, 7, TLV_DB_SCALE_ITEM(-3100, 200, 0),
	8, 13, TLV_DB_SCALE_ITEM(-1600, 100, 0),
	14, 16, TLV_DB_SCALE_ITEM(-1000, 300, 0),
);

अटल DECLARE_TLV_DB_RANGE(sta350_limiter_drc_release_tlv,
	0, 0, TLV_DB_SCALE_ITEM(TLV_DB_GAIN_MUTE, 0, 0),
...
अटल SOC_ENUM_SINGLE_DECL(sta350_drc_ac_क्रमागत,
			    STA350_CONFD, STA350_CONFD_DRC_SHIFT,
			    sta350_drc_ac);
अटल SOC_ENUM_SINGLE_DECL(sta350_noise_shaper_क्रमागत,
			    STA350_CONFE, STA350_CONFE_NSBW_SHIFT,
			    sta350_noise_shaper_type);
अटल SOC_ENUM_SINGLE_DECL(sta350_स्वतः_gc_क्रमागत,
			    STA350_AUTO1, STA350_AUTO1_AMGC_SHIFT,
			    sta350_स्वतः_gc_mode);
अटल SOC_ENUM_SINGLE_DECL(sta350_स्वतः_xo_क्रमागत,
			    STA350_AUTO2, STA350_AUTO2_XO_SHIFT,
			    sta350_स्वतः_xo_mode);
अटल SOC_ENUM_SINGLE_DECL(sta350_binary_output_ch1_क्रमागत,
			    STA350_C1CFG, STA350_CxCFG_BO_SHIFT,
			    sta350_binary_output);
अटल SOC_ENUM_SINGLE_DECL(sta350_binary_output_ch2_क्रमागत,
			    STA350_C2CFG, STA350_CxCFG_BO_SHIFT,
			    sta350_binary_output);
अटल SOC_ENUM_SINGLE_DECL(sta350_binary_output_ch3_क्रमागत,
			    STA350_C3CFG, STA350_CxCFG_BO_SHIFT,
			    sta350_binary_output);
अटल SOC_ENUM_SINGLE_DECL(sta350_limiter_ch1_क्रमागत,
			    STA350_C1CFG, STA350_CxCFG_LS_SHIFT,
			    sta350_limiter_select);
अटल SOC_ENUM_SINGLE_DECL(sta350_limiter_ch2_क्रमागत,
			    STA350_C2CFG, STA350_CxCFG_LS_SHIFT,
			    sta350_limiter_select);
अटल SOC_ENUM_SINGLE_DECL(sta350_limiter_ch3_क्रमागत,
			    STA350_C3CFG, STA350_CxCFG_LS_SHIFT,
			    sta350_limiter_select);
अटल SOC_ENUM_SINGLE_DECL(sta350_limiter1_attack_rate_क्रमागत,
			    STA350_L1AR, STA350_LxA_SHIFT,
			    sta350_limiter_attack_rate);
अटल SOC_ENUM_SINGLE_DECL(sta350_limiter2_attack_rate_क्रमागत,
			    STA350_L2AR, STA350_LxA_SHIFT,
			    sta350_limiter_attack_rate);
अटल SOC_ENUM_SINGLE_DECL(sta350_limiter1_release_rate_क्रमागत,
			    STA350_L1AR, STA350_LxR_SHIFT,
			    sta350_limiter_release_rate);
अटल SOC_ENUM_SINGLE_DECL(sta350_limiter2_release_rate_क्रमागत,
...
अटल पूर्णांक sta350_coefficient_info(काष्ठा snd_kcontrol *kcontrol,
...
अटल पूर्णांक sta350_coefficient_get(काष्ठा snd_kcontrol *kcontrol,
				  काष्ठा snd_ctl_elem_value *ucontrol)
अणु
	काष्ठा snd_soc_component *component = snd_soc_kcontrol_component(kcontrol);
	काष्ठा sta350_priv *sta350 = snd_soc_component_get_drvdata(component);
	पूर्णांक numcoef = kcontrol->निजी_value >> 16;
	...
	regmap_पढ़ो(sta350->regmap, STA350_CFUD, &cfud);
	cfud &= 0xf0;
	/*
	 * chip करोcumentation करोes not say अगर the bits are self clearing,
	 * so करो it explicitly
	 */
	regmap_ग_लिखो(sta350->regmap, STA350_CFUD, cfud);

	regmap_ग_लिखो(sta350->regmap, STA350_CFADDR2, index);
	अगर (numcoef == 1) अणु
		regmap_ग_लिखो(sta350->regmap, STA350_CFUD, cfud | 0x04);
	पूर्ण अन्यथा अगर (numcoef == 5) अणु
		regmap_ग_लिखो(sta350->regmap, STA350_CFUD, cfud | 0x08);
	पूर्ण अन्यथा अणु
		ret = -EINVAL;
		जाओ निकास_unlock;
	पूर्ण
	...
	क्रम (i = 0; i < 3 * numcoef; i++) अणु
		regmap_पढ़ो(sta350->regmap, STA350_B1CF1 + i, &val);
...
अटल पूर्णांक sta350_coefficient_put(काष्ठा snd_kcontrol *kcontrol,
				  काष्ठा snd_ctl_elem_value *ucontrol)
अणु
	काष्ठा snd_soc_component *component = snd_soc_kcontrol_component(kcontrol);
	काष्ठा sta350_priv *sta350 = snd_soc_component_get_drvdata(component);
	...
	regmap_ग_लिखो(sta350->regmap, STA350_CFADDR2, index);
	क्रम (i = 0; i < numcoef && (index + i < STA350_COEF_COUNT); i++)
		sta350->coef_shaकरोw[index + i] =
			  (ucontrol->value.bytes.data[3 * i] << 16)
			| (ucontrol->value.bytes.data[3 * i + 1] << 8)
			| (ucontrol->value.bytes.data[3 * i + 2]);
	क्रम (i = 0; i < 3 * numcoef; i++)
		regmap_ग_लिखो(sta350->regmap, STA350_B1CF1 + i,
			     ucontrol->value.bytes.data[i]);
	अगर (numcoef == 1)
		regmap_ग_लिखो(sta350->regmap, STA350_CFUD, cfud | 0x01);
	अन्यथा अगर (numcoef == 5)
		regmap_ग_लिखो(sta350->regmap, STA350_CFUD, cfud | 0x02);
	अन्यथा
		वापस -EINVAL;
...
अटल पूर्णांक sta350_sync_coef_shaकरोw(काष्ठा snd_soc_component *component)
अणु
	काष्ठा sta350_priv *sta350 = snd_soc_component_get_drvdata(component);
	अचिन्हित पूर्णांक cfud;
	पूर्णांक i;
	...
	क्रम (i = 0; i < STA350_COEF_COUNT; i++) अणु
		regmap_ग_लिखो(sta350->regmap, STA350_CFADDR2, i);
		regmap_ग_लिखो(sta350->regmap, STA350_B1CF1,
			     (sta350->coef_shaकरोw[i] >> 16) & 0xff);
		regmap_ग_लिखो(sta350->regmap, STA350_B1CF2,
			     (sta350->coef_shaकरोw[i] >> 8) & 0xff);
		regmap_ग_लिखो(sta350->regmap, STA350_B1CF3,
			     (sta350->coef_shaकरोw[i]) & 0xff);
		/*
...
अटल पूर्णांक sta350_cache_sync(काष्ठा snd_soc_component *component)
अणु
	काष्ठा sta350_priv *sta350 = snd_soc_component_get_drvdata(component);
	...
	regmap_पढ़ो(sta350->regmap, STA350_CFUD, &mute);
	regmap_ग_लिखो(sta350->regmap, STA350_MMUTE, mute | STA350_MMUTE_MMUTE);
	sta350_sync_coef_shaकरोw(component);
	rc = regcache_sync(sta350->regmap);
	regmap_ग_लिखो(sta350->regmap, STA350_MMUTE, mute);
	वापस rc;
पूर्ण
...
अटल स्थिर काष्ठा snd_kcontrol_new sta350_snd_controls[] = अणु
...
SOC_ENUM("Compressor/Limiter Switch", sta350_drc_ac_क्रमागत),
SOC_ENUM("Noise Shaper Bandwidth", sta350_noise_shaper_क्रमागत),
...
/* AUTOx */
SOC_ENUM("Automode GC", sta350_स्वतः_gc_क्रमागत),
SOC_ENUM("Automode XO", sta350_स्वतः_xo_क्रमागत),
/* CxCFG */
...
SOC_SINGLE("Ch3 Master Volume Bypass Switch",
	   STA350_C1CFG, STA350_CxCFG_VBP_SHIFT, 1, 0),
SOC_ENUM("Ch1 Binary Output Select", sta350_binary_output_ch1_क्रमागत),
SOC_ENUM("Ch2 Binary Output Select", sta350_binary_output_ch2_क्रमागत),
SOC_ENUM("Ch3 Binary Output Select", sta350_binary_output_ch3_क्रमागत),
SOC_ENUM("Ch1 Limiter Select", sta350_limiter_ch1_क्रमागत),
SOC_ENUM("Ch2 Limiter Select", sta350_limiter_ch2_क्रमागत),
SOC_ENUM("Ch3 Limiter Select", sta350_limiter_ch3_क्रमागत),
/* TONE */
...
SOC_ENUM("Limiter1 Attack Rate (dB/ms)", sta350_limiter1_attack_rate_क्रमागत),
SOC_ENUM("Limiter2 Attack Rate (dB/ms)", sta350_limiter2_attack_rate_क्रमागत),
SOC_ENUM("Limiter1 Release Rate (dB/ms)", sta350_limiter1_release_rate_क्रमागत),
SOC_ENUM("Limiter2 Release Rate (dB/ms)", sta350_limiter2_release_rate_क्रमागत),
...
अटल स्थिर काष्ठा snd_soc_dapm_widget sta350_dapm_widमाला_लो[] = अणु
...
अटल स्थिर काष्ठा snd_soc_dapm_route sta350_dapm_routes[] = अणु
...
अटल पूर्णांक mcs_ratio_table[3][6] = अणु
	अणु 768, 512, 384, 256, 128, 576 पूर्ण,
	अणु 384, 256, 192, 128,  64,   0 पूर्ण,
	अणु 192, 128,  96,  64,  32,   0 पूर्ण,
पूर्ण;
 ...
 * समय क्रम ALSA.
 */
अटल पूर्णांक sta350_set_dai_sysclk(काष्ठा snd_soc_dai *codec_dai,
...
/**
 * sta350_set_dai_fmt - configure the codec क्रम the selected audio क्रमmat
 * @codec_dai: the codec DAI
 ...
 * codec accordingly.
 */
अटल पूर्णांक sta350_set_dai_fmt(काष्ठा snd_soc_dai *codec_dai,
			      अचिन्हित पूर्णांक fmt)
अणु
	काष्ठा snd_soc_component *component = codec_dai->component;
	काष्ठा sta350_priv *sta350 = snd_soc_component_get_drvdata(component);
	अचिन्हित पूर्णांक confb = 0;
	...
	हाल SND_SOC_DAIFMT_LEFT_J:
		sta350->क्रमmat = fmt & SND_SOC_DAIFMT_FORMAT_MASK;
		अवरोध;
	शेष:
		वापस -EINVAL;
	पूर्ण
	...
	वापस regmap_update_bits(sta350->regmap, STA350_CONFB,
 ...
 */
अटल पूर्णांक sta350_hw_params(काष्ठा snd_pcm_substream *substream,
...
अटल पूर्णांक sta350_startup_sequence(काष्ठा sta350_priv *sta350)
अणु
	अगर (sta350->gpiod_घातer_करोwn)
		gpiod_set_value(sta350->gpiod_घातer_करोwn, 1);

	अगर (sta350->gpiod_nreset) अणु
 ...
 */
अटल पूर्णांक sta350_set_bias_level(काष्ठा snd_soc_component *component,
...
अणु
	...
	हाल SND_SOC_BIAS_OFF:
		...
		/* घातer करोwn: low */
		अगर (sta350->gpiod_घातer_करोwn)
			gpiod_set_value(sta350->gpiod_घातer_करोwn, 0);

		अगर (sta350->gpiod_nreset)
			gpiod_set_value(sta350->gpiod_nreset, 0);
...
अटल स्थिर काष्ठा snd_soc_dai_ops sta350_dai_ops = अणु
	.hw_params	= sta350_hw_params,
	.set_sysclk	= sta350_set_dai_sysclk,
	.set_fmt	= sta350_set_dai_fmt,
पूर्ण;

अटल काष्ठा snd_soc_dai_driver sta350_dai = अणु
	.name = "sta350-hifi",
	.playback = अणु
		...
		.channels_max = 2,
		.rates = STA350_RATES,
		.क्रमmats = STA350_FORMATS,
	पूर्ण,
	.ops = &sta350_dai_ops,
पूर्ण;

अटल पूर्णांक sta350_probe(काष्ठा snd_soc_component *component)
अणु
	काष्ठा sta350_priv *sta350 = snd_soc_component_get_drvdata(component);
	काष्ठा sta350_platक्रमm_data *pdata = sta350->pdata;
	...
	regmap_update_bits(sta350->regmap,
			   STA350_CONFC,
			   STA350_CONFC_OCRB,
			   pdata->oc_warning_adjusपंचांगent ?
				STA350_CONFC_OCRB : 0);
	...
	regmap_update_bits(sta350->regmap, STA350_MISC1,
			   STA350_MISC1_RPDNEN,
			   pdata->घातerकरोwn_master_vol ?
				STA350_MISC1_RPDNEN: 0);

	regmap_update_bits(sta350->regmap, STA350_MISC2,
			   STA350_MISC2_PNDLSL_MASK,
			   pdata->घातerकरोwn_delay_भागider
				<< STA350_MISC2_PNDLSL_SHIFT);

	/* initialize coefficient shaकरोw RAM with reset values */
	क्रम (i = 4; i <= 49; i += 5)
		sta350->coef_shaकरोw[i] = 0x400000;
	क्रम (i = 50; i <= 54; i++)
		sta350->coef_shaकरोw[i] = 0x7fffff;
	sta350->coef_shaकरोw[55] = 0x5a9df7;
	sta350->coef_shaकरोw[56] = 0x7fffff;
	sta350->coef_shaकरोw[59] = 0x7fffff;
	sta350->coef_shaकरोw[60] = 0x400000;
	sta350->coef_shaकरोw[61] = 0x400000;
...
अटल व्योम sta350_हटाओ(काष्ठा snd_soc_component *component)
अणु
	काष्ठा sta350_priv *sta350 = snd_soc_component_get_drvdata(component);
...
अटल स्थिर काष्ठा snd_soc_component_driver sta350_component = अणु
	.probe			= sta350_probe,
	.हटाओ			= sta350_हटाओ,
	.set_bias_level		= sta350_set_bias_level,
	.controls		= sta350_snd_controls,
	.num_controls		= ARRAY_SIZE(sta350_snd_controls),
	.dapm_widमाला_लो		= sta350_dapm_widमाला_लो,
	.num_dapm_widमाला_लो	= ARRAY_SIZE(sta350_dapm_widमाला_लो),
...
अटल स्थिर काष्ठा regmap_config sta350_regmap = अणु
	.reg_bits =		8,
	.val_bits =		8,
	.max_रेजिस्टर =		STA350_MISC2,
	.reg_शेषs =		sta350_regs,
	.num_reg_शेषs =	ARRAY_SIZE(sta350_regs),
	.cache_type =		REGCACHE_RBTREE,
	.wr_table =		&sta350_ग_लिखो_regs,
	.rd_table =		&sta350_पढ़ो_regs,
	.अस्थिर_table =	&sta350_अस्थिर_regs,
पूर्ण;

#अगर_घोषित CONFIG_OF
अटल स्थिर काष्ठा of_device_id st350_dt_ids[] = अणु
	अणु .compatible = "st,sta350", पूर्ण,
	अणु पूर्ण
पूर्ण;
MODULE_DEVICE_TABLE(of, st350_dt_ids);

अटल स्थिर अक्षर * स्थिर sta350_ffx_modes[] = अणु
...
अटल पूर्णांक sta350_probe_dt(काष्ठा device *dev, काष्ठा sta350_priv *sta350)
अणु
	काष्ठा device_node *np = dev->of_node;
	काष्ठा sta350_platक्रमm_data *pdata;
	स्थिर अक्षर *ffx_घातer_mode;
	u16 पंचांगp;
	u8 पंचांगp8;
	...
	pdata->ffx_घातer_output_mode = STA350_FFX_PM_VARIABLE_DROP_COMP;
	अगर (!of_property_पढ़ो_string(np, "st,ffx-power-output-mode",
				     &ffx_घातer_mode)) अणु
		पूर्णांक i, mode = -EINVAL;

		क्रम (i = 0; i < ARRAY_SIZE(sta350_ffx_modes); i++)
			अगर (!strहालcmp(ffx_घातer_mode, sta350_ffx_modes[i]))
				mode = i;
		...
		अगर (mode < 0)
			dev_warn(dev, "Unsupported ffx output mode: %s\n",
				 ffx_घातer_mode);
		अन्यथा
			pdata->ffx_घातer_output_mode = mode;
	पूर्ण
	...
	अगर (of_get_property(np, "st,overcurrent-warning-adjustment", शून्य))
		pdata->oc_warning_adjusपंचांगent = 1;
	...
	अगर (of_get_property(np, "st,distortion-compensation", शून्य))
	...
	/* MISC */
	अगर (of_get_property(np, "st,activate-mute-output", शून्य))
		pdata->activate_mute_output = 1;

	अगर (of_get_property(np, "st,bridge-immediate-off", शून्य))
		pdata->bridge_immediate_off = 1;

	अगर (of_get_property(np, "st,noise-shape-dc-cut", शून्य))
		pdata->noise_shape_dc_cut = 1;

	अगर (of_get_property(np, "st,powerdown-master-volume", शून्य))
		pdata->घातerकरोwn_master_vol = 1;

	अगर (!of_property_पढ़ो_u8(np, "st,powerdown-delay-divider", &पंचांगp8)) अणु
		अगर (is_घातer_of_2(पंचांगp8) && पंचांगp8 >= 1 && पंचांगp8 <= 128)
			pdata->घातerकरोwn_delay_भागider = ilog2(पंचांगp8);
		अन्यथा
...
अटल पूर्णांक sta350_i2c_probe(काष्ठा i2c_client *i2c,
			    स्थिर काष्ठा i2c_device_id *id)
अणु
	काष्ठा device *dev = &i2c->dev;
	काष्ठा sta350_priv *sta350;
	पूर्णांक ret, i;

	sta350 = devm_kzalloc(dev, माप(काष्ठा sta350_priv), GFP_KERNEL);
	अगर (!sta350)
		वापस -ENOMEM;
...
#पूर्ण_अगर
	...
	sta350->gpiod_nreset = devm_gpiod_get_optional(dev, "reset",
						       GPIOD_OUT_LOW);
	अगर (IS_ERR(sta350->gpiod_nreset))
		वापस PTR_ERR(sta350->gpiod_nreset);

	sta350->gpiod_घातer_करोwn = devm_gpiod_get_optional(dev, "power-down",
							   GPIOD_OUT_LOW);
	अगर (IS_ERR(sta350->gpiod_घातer_करोwn))
		वापस PTR_ERR(sta350->gpiod_घातer_करोwn);

	/* regulators */
	क्रम (i = 0; i < ARRAY_SIZE(sta350->supplies); i++)
	...
	ret = devm_snd_soc_रेजिस्टर_component(dev, &sta350_component, &sta350_dai, 1);
	अगर (ret < 0)
...
अटल पूर्णांक sta350_i2c_हटाओ(काष्ठा i2c_client *client)
अणु
	वापस 0;
पूर्ण

अटल स्थिर काष्ठा i2c_device_id sta350_i2c_id[] = अणु
	अणु "sta350", 0 पूर्ण,
	अणु पूर्ण
पूर्ण;
MODULE_DEVICE_TABLE(i2c, sta350_i2c_id);

अटल काष्ठा i2c_driver sta350_i2c_driver = अणु
	.driver = अणु
		.name = "sta350",
		.of_match_table = of_match_ptr(st350_dt_ids),
	पूर्ण,
	.probe =    sta350_i2c_probe,
	.हटाओ =   sta350_i2c_हटाओ,
