 ...
 */
अटल पूर्णांक p1022_ds_machine_probe(काष्ठा snd_soc_card *card)
अणु
 ...
 * transport drivers.
 */
अटल पूर्णांक p1022_ds_startup(काष्ठा snd_pcm_substream *substream)
अणु
...
/**
 * p1022_ds_machine_हटाओ: Remove the sound device
 *
 * This function is called to हटाओ the sound device क्रम one SSI.  We
 * de-program the DMACR and PMUXCR रेजिस्टर.
 */
अटल पूर्णांक p1022_ds_machine_हटाओ(काष्ठा snd_soc_card *card)
अणु
	काष्ठा machine_data *mdata =
		container_of(card, काष्ठा machine_data, card);
	काष्ठा ccsr_guts __iomem *guts;
 ...
 */
अटल स्थिर काष्ठा snd_soc_ops p1022_ds_ops = अणु
	.startup = p1022_ds_startup,
पूर्ण;

/**
 * p1022_ds_probe: platक्रमm probe function क्रम the machine driver
 *
 ...
 */
अटल पूर्णांक p1022_ds_probe(काष्ठा platक्रमm_device *pdev)
अणु
	...
	mdata->card.हटाओ = p1022_ds_machine_हटाओ;
...
/**
 * p1022_ds_हटाओ: हटाओ the platक्रमm device
 *
 * This function is called when the platक्रमm device is हटाओd.
 */
अटल पूर्णांक p1022_ds_हटाओ(काष्ठा platक्रमm_device *pdev)
अणु
...
अटल काष्ठा platक्रमm_driver p1022_ds_driver = अणु
 ...
 */
अटल पूर्णांक __init p1022_ds_init(व्योम)
अणु
	...
	वापस platक्रमm_driver_रेजिस्टर(&p1022_ds_driver);
पूर्ण

/**
 * p1022_ds_निकास: machine driver निकास
 *
 * This function is called when this driver is unloaded.
 */
अटल व्योम __निकास p1022_ds_निकास(व्योम)
अणु
	platक्रमm_driver_unरेजिस्टर(&p1022_ds_driver);
पूर्ण

module_init(p1022_ds_init);
module_निकास(p1022_ds_निकास);
