 ...
 *
 * This file is partially स्वतःgenerated.
 */

#समावेश "ti-thermal.h"
#समावेश "ti-bandgap.h"
#समावेश "dra752-bandgap.h"

/*
 * DRA752 has five instances of thermal sensor: MPU, GPU, CORE,
 * IVA and DSPEVE need to describe the inभागidual रेजिस्टरs and
 * bit fields.
 */

/*
 * DRA752 CORE thermal sensor रेजिस्टर offsets and bit-fields
 */
अटल काष्ठा temp_sensor_रेजिस्टरs
dra752_core_temp_sensor_रेजिस्टरs = अणु
	...
	.mask_मुक्तze_mask = DRA752_BANDGAP_CTRL_1_FREEZE_CORE_MASK,
...
/*
 * DRA752 IVA thermal sensor रेजिस्टर offsets and bit-fields
 */
अटल काष्ठा temp_sensor_रेजिस्टरs
dra752_iva_temp_sensor_रेजिस्टरs = अणु
	...
	.mask_counter_delay_mask = DRA752_BANDGAP_CTRL_1_COUNTER_DELAY_MASK,
	.mask_मुक्तze_mask = DRA752_BANDGAP_CTRL_2_FREEZE_IVA_MASK,
...
/*
 * DRA752 MPU thermal sensor रेजिस्टर offsets and bit-fields
 */
अटल काष्ठा temp_sensor_रेजिस्टरs
dra752_mpu_temp_sensor_रेजिस्टरs = अणु
	...
	.mask_counter_delay_mask = DRA752_BANDGAP_CTRL_1_COUNTER_DELAY_MASK,
	.mask_मुक्तze_mask = DRA752_BANDGAP_CTRL_1_FREEZE_MPU_MASK,
...
/*
 * DRA752 DSPEVE thermal sensor रेजिस्टर offsets and bit-fields
 */
अटल काष्ठा temp_sensor_रेजिस्टरs
dra752_dspeve_temp_sensor_रेजिस्टरs = अणु
	...
	.mask_counter_delay_mask = DRA752_BANDGAP_CTRL_1_COUNTER_DELAY_MASK,
	.mask_मुक्तze_mask = DRA752_BANDGAP_CTRL_2_FREEZE_DSPEVE_MASK,
...
/*
 * DRA752 GPU thermal sensor रेजिस्टर offsets and bit-fields
 */
अटल काष्ठा temp_sensor_रेजिस्टरs
dra752_gpu_temp_sensor_रेजिस्टरs = अणु
	...
	.mask_counter_delay_mask = DRA752_BANDGAP_CTRL_1_COUNTER_DELAY_MASK,
	.mask_मुक्तze_mask = DRA752_BANDGAP_CTRL_1_FREEZE_GPU_MASK,
...
/* Thresholds and limits क्रम DRA752 MPU temperature sensor */
अटल काष्ठा temp_sensor_data dra752_mpu_temp_sensor_data = अणु
...
/* Thresholds and limits क्रम DRA752 GPU temperature sensor */
अटल काष्ठा temp_sensor_data dra752_gpu_temp_sensor_data = अणु
...
/* Thresholds and limits क्रम DRA752 CORE temperature sensor */
अटल काष्ठा temp_sensor_data dra752_core_temp_sensor_data = अणु
...
/* Thresholds and limits क्रम DRA752 DSPEVE temperature sensor */
अटल काष्ठा temp_sensor_data dra752_dspeve_temp_sensor_data = अणु
...
/* Thresholds and limits क्रम DRA752 IVA temperature sensor */
अटल काष्ठा temp_sensor_data dra752_iva_temp_sensor_data = अणु
 ...
 */
अटल
पूर्णांक dra752_adc_to_temp[DRA752_ADC_END_VALUE - DRA752_ADC_START_VALUE + 1] = अणु
	/* Index 540 - 549 */
...
/* DRA752 data */
स्थिर काष्ठा ti_bandgap_data dra752_data = अणु
	.features = TI_BANDGAP_FEATURE_FREEZE_BIT |
			TI_BANDGAP_FEATURE_TALERT |
			TI_BANDGAP_FEATURE_COUNTER_DELAY |
			TI_BANDGAP_FEATURE_HISTORY_BUFFER |
			TI_BANDGAP_FEATURE_ERRATA_814,
	.fघड़ी_name = "l3instr_ts_gclk_div",
	.भाग_ck_name = "l3instr_ts_gclk_div",
	...
	.sensors = अणु
		अणु
		.रेजिस्टरs = &dra752_mpu_temp_sensor_रेजिस्टरs,
		...
		.स्थिरant_pcb = DRA752_GRADIENT_CONST_W_PCB,
		पूर्ण,
		अणु
		.रेजिस्टरs = &dra752_gpu_temp_sensor_रेजिस्टरs,
		...
		पूर्ण,
		अणु
		.रेजिस्टरs = &dra752_core_temp_sensor_रेजिस्टरs,
		...
		पूर्ण,
		अणु
		.रेजिस्टरs = &dra752_dspeve_temp_sensor_रेजिस्टरs,
		...
		पूर्ण,
		अणु
		.रेजिस्टरs = &dra752_iva_temp_sensor_रेजिस्टरs,
