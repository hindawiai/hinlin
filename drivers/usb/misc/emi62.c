...
#घोषणा SPDIF	/* अगर you want SPDIF comment next line */
//#अघोषित SPDIF	/* अगर you want MIDI uncomment this line */ 

#अगर_घोषित SPDIF
#घोषणा FIRMWARE_FW "emi62/spdif.fw"
#अन्यथा
#घोषणा FIRMWARE_FW "emi62/midi.fw"
#पूर्ण_अगर

#घोषणा EMI62_VENDOR_ID 		0x086a  /* Emagic Soft-und Hardware GmBH */
#घोषणा EMI62_PRODUCT_ID		0x0110	/* EMI 6|2m without firmware */
...
अटल पूर्णांक emi62_ग_लिखोmemory(काष्ठा usb_device *dev, पूर्णांक address,
			     स्थिर अचिन्हित अक्षर *data, पूर्णांक length,
			     __u8 bRequest);
अटल पूर्णांक emi62_set_reset(काष्ठा usb_device *dev, अचिन्हित अक्षर reset_bit);
अटल पूर्णांक emi62_load_firmware (काष्ठा usb_device *dev);
अटल पूर्णांक emi62_probe(काष्ठा usb_पूर्णांकerface *पूर्णांकf, स्थिर काष्ठा usb_device_id *id);
अटल व्योम emi62_disconnect(काष्ठा usb_पूर्णांकerface *पूर्णांकf);
...
अणु
	...
	response = emi62_ग_लिखोmemory (dev, CPUCS_REG, &reset_bit, 1, 0xa0);
	अगर (response < 0)
...
अणु
	...
	जबतक (rec) अणु
		err = emi62_ग_लिखोmemory(dev, be32_to_cpu(rec->addr),
	...
	करो अणु
		...
		जबतक (rec && (i + be16_to_cpu(rec->len) < FW_LOAD_SIZE)) अणु
			...
			rec = ihex_next_binrec(rec);
		पूर्ण
		err = emi62_ग_लिखोmemory(dev, addr, buf, i, ANCHOR_LOAD_FPGA);
		अगर (err < 0)
			जाओ wraperr;
	पूर्ण जबतक (rec);
...
अटल स्थिर काष्ठा usb_device_id id_table[] = अणु
	अणु USB_DEVICE(EMI62_VENDOR_ID, EMI62_PRODUCT_ID) पूर्ण,
...
अणु
	...
	dev_dbg(&पूर्णांकf->dev, "emi62_probe\n");
...
अटल काष्ठा usb_driver emi62_driver = अणु
