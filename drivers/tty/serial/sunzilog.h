...
#घोषणा	NUM_ZSREGS	17
#घोषणा	R7p		16 /* Written as R7 with P15 bit 0 set */
...
#घोषणा	AUTO_TxFLAG	1	/* Automatic Tx SDLC Flag */
#घोषणा	AUTO_EOM_RST	2	/* Automatic EOM Reset */
#घोषणा	AUTOnRTS	4	/* Automatic /RTS pin deactivation */
#घोषणा	RxFIFO_LVL	8	/* Receive FIFO पूर्णांकerrupt level */
#घोषणा	nDTRnREQ	0x10	/* /DTR/REQ timing */
#घोषणा	TxFIFO_LVL	0x20	/* Transmit FIFO पूर्णांकerrupt level */
#घोषणा	EXT_RD_EN	0x40	/* Extended पढ़ो रेजिस्टर enable */
...
#घोषणा	SWIACK  0x20    /* Software Interrupt Ack (not on NMOS) */
...
#घोषणा	WR7pEN	1	/* WR7' Enable (ESCC only) */
#घोषणा	ZCIE	2	/* Zero count IE */
#घोषणा	FIFOEN	4	/* FIFO Enable (ESCC only) */
...
/* Misc macros */
#घोषणा ZS_CLEARERR(channel)    करो अणु sbus_ग_लिखोb(ERR_RES, &channel->control); \
				     udelay(5); पूर्ण जबतक(0)

#घोषणा ZS_CLEARSTAT(channel)   करो अणु sbus_ग_लिखोb(RES_EXT_INT, &channel->control); \
				     udelay(5); पूर्ण जबतक(0)

#घोषणा ZS_CLEARFIFO(channel)   करो अणु sbus_पढ़ोb(&channel->data); \
				     udelay(2); \
				     sbus_पढ़ोb(&channel->data); \
				     udelay(2); \
				     sbus_पढ़ोb(&channel->data); \
				     udelay(2); पूर्ण जबतक(0)

#पूर्ण_अगर /* _SUNZILOG_H */
