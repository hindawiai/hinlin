...
अटल स्थिर काष्ठा reg_sequence wm8997_reva_patch[] = अणु
	अणु 0x80, 0x0003 पूर्ण,
	अणु 0x214, 0x0008 पूर्ण,
	अणु 0x458, 0x0000 पूर्ण,
	अणु 0x0081, 0xE022 पूर्ण,
	अणु 0x294, 0x0000 पूर्ण,
...
अटल स्थिर काष्ठा regmap_irq wm8997_aod_irqs[ARIZONA_NUM_IRQ] = अणु
...
स्थिर काष्ठा regmap_irq_chip wm8997_aod = अणु
	.name = "wm8997 AOD",
...
अटल स्थिर काष्ठा regmap_irq wm8997_irqs[ARIZONA_NUM_IRQ] = अणु
...
स्थिर काष्ठा regmap_irq_chip wm8997_irq = अणु
	.name = "wm8997 IRQ",
...
अटल स्थिर काष्ठा reg_शेष wm8997_reg_शेष[] = अणु
	अणु 0x00000009, 0x0001 पूर्ण,    /* R9     - Ctrl IF I2C1 CFG 1 */
	अणु 0x00000016, 0x0000 पूर्ण,    /* R22    - Write Sequencer Ctrl 0 */
	अणु 0x00000017, 0x0000 पूर्ण,    /* R23    - Write Sequencer Ctrl 1 */
	अणु 0x00000018, 0x0000 पूर्ण,    /* R24    - Write Sequencer Ctrl 2 */
	...
	अणु 0x00000068, 0x01FF पूर्ण,    /* R104   - AlwaysOn Triggers Seq Select 3 */
	अणु 0x00000069, 0x01FF पूर्ण,    /* R105   - AlwaysOn Triggers Seq Select 4 */
	अणु 0x0000006A, 0x01FF पूर्ण,    /* R106   - AlwaysOn Triggers Seq Select 5 */
	अणु 0x0000006B, 0x01FF पूर्ण,    /* R107   - AlwaysOn Triggers Seq Select 6 */
	...
	अणु 0x00000177, 0x0181 पूर्ण,    /* R375   - FLL1 Loop Filter Test 1 */
	...
	अणु 0x00000197, 0x0000 पूर्ण,    /* R407   - FLL2 Loop Filter Test 1 */
	...
	अणु 0x00000412, 0x0080 पूर्ण,    /* R1042  - DAC Volume Limit 1L */
	...
	अणु 0x00000416, 0x0080 पूर्ण,    /* R1046  - DAC Volume Limit 1R */
	...
	अणु 0x00000422, 0x0080 पूर्ण,    /* R1058  - DAC Volume Limit 3L */
	...
	अणु 0x0000042A, 0x0080 पूर्ण,    /* R1066  - Out Volume 4L */
...
अटल bool wm8997_पढ़ोable_रेजिस्टर(काष्ठा device *dev, अचिन्हित पूर्णांक reg)
अणु
	चयन (reg) अणु
	...
	हाल ARIZONA_FLL1_LOOP_FILTER_TEST_1:
	हाल ARIZONA_FLL1_NCO_TEST_0:
	...
	हाल ARIZONA_FLL2_LOOP_FILTER_TEST_1:
	हाल ARIZONA_FLL2_NCO_TEST_0:
...
अटल bool wm8997_अस्थिर_रेजिस्टर(काष्ठा device *dev, अचिन्हित पूर्णांक reg)
अणु
	चयन (reg) अणु
	हाल ARIZONA_SOFTWARE_RESET:
	हाल ARIZONA_DEVICE_REVISION:
...
#घोषणा WM8997_MAX_REGISTER 0x31ff

स्थिर काष्ठा regmap_config wm8997_i2c_regmap = अणु
	.reg_bits = 32,
	.val_bits = 16,
	.reg_क्रमmat_endian = REGMAP_ENDIAN_BIG,
	.val_क्रमmat_endian = REGMAP_ENDIAN_BIG,

	.max_रेजिस्टर = WM8997_MAX_REGISTER,
	.पढ़ोable_reg = wm8997_पढ़ोable_रेजिस्टर,
	.अस्थिर_reg = wm8997_अस्थिर_रेजिस्टर,

	.cache_type = REGCACHE_RBTREE,
	.reg_शेषs = wm8997_reg_शेष,
	.num_reg_शेषs = ARRAY_SIZE(wm8997_reg_शेष),
पूर्ण;
