...
SOLOS_ATTR_RO(INPकरोwn)
SOLOS_ATTR_RO(INPup)
SOLOS_ATTR_RO(ShowसमयStart)
SOLOS_ATTR_RO(ATURVenकरोr)
...
SOLOS_ATTR_RO(RecentShowसमयStart)
