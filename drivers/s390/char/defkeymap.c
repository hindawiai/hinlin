...
/* Do not edit this file! It was स्वतःmatically generated by   */
...
u_लघु ebc_plain_map[NR_KEYS] = अणु
...
अटल u_लघु shअगरt_map[NR_KEYS] = अणु
...
अटल u_लघु ctrl_map[NR_KEYS] = अणु
...
अटल u_लघु shअगरt_ctrl_map[NR_KEYS] = अणु
	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,
	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,
	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,
	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,
...
uलघु *ebc_key_maps[MAX_NR_KEYMAPS] = अणु
	ebc_plain_map, shअगरt_map, शून्य, शून्य,
	ctrl_map, shअगरt_ctrl_map, शून्य,
पूर्ण;

अचिन्हित पूर्णांक ebc_keymap_count = 4;


/*
 * Philosophy: most people करो not define more strings, but they who करो
 * often want quite a lot of string space. So, we अटलally allocate
 * the शेष and allocate dynamically in chunks of 512 bytes.
 */

अक्षर ebc_func_buf[] = अणु
	'\033', '[', '[', 'A', 0, 
	'\033', '[', '[', 'B', 0, 
	'\033', '[', '[', 'C', 0, 
	'\033', '[', '[', 'D', 0, 
...
अक्षर *ebc_funcbufptr = ebc_func_buf;
पूर्णांक ebc_funcbufsize = माप(ebc_func_buf);
पूर्णांक ebc_funcbufleft;		/* space left */

अक्षर *ebc_func_table[MAX_NR_FUNC] = अणु
	ebc_func_buf + 0,
	ebc_func_buf + 5,
	ebc_func_buf + 10,
	ebc_func_buf + 15,
...
काष्ठा kbdiacruc ebc_accent_table[MAX_DIACR] = अणु
	अणु'^', 'c', 0003},	{'^', 'd', 0004पूर्ण,
	अणु'^', 'z', 0032},	{'^', 0012, 0000पूर्ण,
पूर्ण;

अचिन्हित पूर्णांक ebc_accent_table_size = 4;
