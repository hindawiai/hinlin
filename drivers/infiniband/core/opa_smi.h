...
बाह्य क्रमागत smi_क्रमward_action opa_smi_check_क्रमward_dr_smp(काष्ठा opa_smp *smp);
बाह्य क्रमागत smi_action opa_smi_handle_dr_smp_send(काष्ठा opa_smp *smp,
 ...
 * via process_mad
 */
अटल अंतरभूत क्रमागत smi_action opa_smi_check_local_smp(काष्ठा opa_smp *smp,
 ...
 * via process_mad
 */
अटल अंतरभूत क्रमागत smi_action opa_smi_check_local_वापसing_smp(काष्ठा opa_smp *smp,
								काष्ठा ib_device *device)
अणु
