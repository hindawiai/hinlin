...
#समावेश "adf_c62x_hw_data.h"
#समावेश "icp_qat_hw.h"

/* Worker thपढ़ो to service arbiter mappings */
अटल स्थिर u32 thrd_to_arb_map[ADF_C62X_MAX_ACCELENGINES] = अणु
	0x12222AAA, 0x11222AAA, 0x12222AAA, 0x11222AAA, 0x12222AAA,
	0x11222AAA, 0x12222AAA, 0x11222AAA, 0x12222AAA, 0x11222AAA
पूर्ण;

अटल काष्ठा adf_hw_device_class c62x_class = अणु
...
अणु
	...
	क्रम_each_set_bit(accel, &disabled, ADF_C62X_MAX_ACCELERATORS)
		straps |= ae_disable << (accel << 1);

	वापस ~(fuses | straps) & ADF_C62X_ACCELENGINES_MASK;
पूर्ण
...
अणु
	...
	क्रम (i = 0; i < ADF_C62X_MAX_ACCELERATORS; i++) अणु
...
अणु
	...
	क्रम (i = 0; i < ADF_C62X_MAX_ACCELENGINES; i++) अणु
...
अणु
	वापस ADF_C62X_PF2VF_OFFSET(i);
पूर्ण

अटल u32 get_vपूर्णांकmsk_offset(u32 i)
अणु
	वापस ADF_C62X_VINTMSK_OFFSET(i);
पूर्ण
...
अणु
	...
	काष्ठा adf_bar *misc_bar = &GET_BARS(accel_dev)[ADF_C62X_PMISC_BAR];
	...
	क्रम_each_set_bit(i, &accel_mask, ADF_C62X_MAX_ACCELERATORS) अणु
