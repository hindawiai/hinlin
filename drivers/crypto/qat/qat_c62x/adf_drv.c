...
अटल स्थिर काष्ठा pci_device_id adf_pci_tbl[] = अणु
	अणु PCI_VDEVICE(INTEL, PCI_DEVICE_ID_INTEL_QAT_C62X), पूर्ण,
	अणु पूर्ण
पूर्ण;
...
अणु
	...
	pci_पढ़ो_config_dword(pdev, ADF_DEVICE_FUSECTL_OFFSET,
			      &hw_data->fuses);
	pci_पढ़ो_config_dword(pdev, ADF_C62X_SOFTSTRAP_CSR_OFFSET,
			      &hw_data->straps);
	...
	अगर (pci_request_regions(pdev, ADF_C62X_DEVICE_NAME)) अणु
		ret = -EFAULT;
		जाओ out_err_disable;
	पूर्ण
