...
#समावेश "adf_c62xvf_hw_data.h"

अटल काष्ठा adf_hw_device_class c62xiov_class = अणु
...
अणु
	वापस ADF_C62XIOV_PF2VF_OFFSET;
पूर्ण

अटल u32 get_vपूर्णांकmsk_offset(u32 i)
अणु
	वापस ADF_C62XIOV_VINTMSK_OFFSET;
पूर्ण
...
व्योम adf_init_hw_data_c62xiov(काष्ठा adf_hw_device_data *hw_data)
अणु
...
व्योम adf_clean_hw_data_c62xiov(काष्ठा adf_hw_device_data *hw_data)
अणु
	hw_data->dev_class->instances--;
	adf_devmgr_update_class_index(hw_data);
पूर्ण
