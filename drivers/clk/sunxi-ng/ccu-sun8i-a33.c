 ...
 */
#घोषणा SUN8I_A33_PLL_AUDIO_REG	0x008
 ...
 */
#घोषणा SUN8I_A33_PLL_MIPI_REG	0x040
...
अटल काष्ठा ccu_mult pll_ddr1_clk = अणु
	.enable	= BIT(31),
	.lock	= BIT(28),
...
अटल SUNXI_CCU_GATE(bus_drc_clk,	"bus-drc",	"ahb1",
		      0x064, BIT(25), 0);
अटल SUNXI_CCU_GATE(bus_sat_clk,	"bus-sat",	"ahb1",
		      0x064, BIT(26), 0);
...
अटल SUNXI_CCU_M(dram_clk, "dram", "pll-ddr",
		   0x0f4, 0, 4, CLK_IS_CRITICAL);

अटल स्थिर अक्षर * स्थिर pll_ddr_parents[] = अणु "pll-ddr0", "pll-ddr1" पूर्ण;
अटल SUNXI_CCU_MUX(pll_ddr_clk, "pll-ddr", pll_ddr_parents,
		     0x0f8, 16, 1, 0);
...
अटल SUNXI_CCU_GATE(dram_csi_clk,	"dram-csi",	"dram",
		      0x100, BIT(1), 0);
अटल SUNXI_CCU_GATE(dram_drc_clk,	"dram-drc",	"dram",
		      0x100, BIT(16), 0);
अटल SUNXI_CCU_GATE(dram_de_fe_clk,	"dram-de-fe",	"dram",
		      0x100, BIT(24), 0);
अटल SUNXI_CCU_GATE(dram_de_be_clk,	"dram-de-be",	"dram",
		      0x100, BIT(26), 0);
...
अटल काष्ठा ccu_common *sun8i_a33_ccu_clks[] = अणु
	&pll_cpux_clk.common,
...
अटल काष्ठा clk_hw_onecell_data sun8i_a33_hw_clks = अणु
	.hws	= अणु
...
अटल काष्ठा ccu_reset_map sun8i_a33_ccu_resets[] = अणु
	...
	[RST_BUS_SAT]		=  अणु 0x2c4, BIT(26) पूर्ण,
...
अटल स्थिर काष्ठा sunxi_ccu_desc sun8i_a33_ccu_desc = अणु
...
अटल काष्ठा ccu_pll_nb sun8i_a33_pll_cpu_nb = अणु
...
अटल काष्ठा ccu_mux_nb sun8i_a33_cpu_nb = अणु
...
अटल व्योम __init sun8i_a33_ccu_setup(काष्ठा device_node *node)
अणु
	व्योम __iomem *reg;
	u32 val;
	...
	val = पढ़ोl(reg + SUN8I_A33_PLL_AUDIO_REG);
	val &= ~GENMASK(19, 16);
	ग_लिखोl(val | (0 << 16), reg + SUN8I_A33_PLL_AUDIO_REG);

	/* Force PLL-MIPI to MIPI mode */
	val = पढ़ोl(reg + SUN8I_A33_PLL_MIPI_REG);
	val &= ~BIT(16);
	ग_लिखोl(val, reg + SUN8I_A33_PLL_MIPI_REG);

	sunxi_ccu_probe(node, reg, &sun8i_a33_ccu_desc);

	/* Gate then ungate PLL CPU after any rate changes */
	ccu_pll_notअगरier_रेजिस्टर(&sun8i_a33_pll_cpu_nb);
