...
अटल स्थिर काष्ठा अणु
	...
	अक्षर *p;
	u8 id;
पूर्ण at91sam9x5_प्रणालीck[] = अणु
...
अटल स्थिर काष्ठा clk_pcr_layout at91sam9x5_pcr_layout = अणु
	.offset = 0x10c,
	.cmd = BIT(12),
...
अटल स्थिर काष्ठा pck at91sam9x5_periphck[] = अणु
	अणु .n = "pioAB_clk",  .id = 2, पूर्ण,
	अणु .n = "pioCD_clk",  .id = 3, पूर्ण,
	अणु .n = "smd_clk",    .id = 4, पूर्ण,
	...
	अणु .n = "dma1_clk",   .id = 21, पूर्ण,
	अणु .n = "uhphs_clk",  .id = 22, पूर्ण,
	अणु .n = "udphs_clk",  .id = 23, पूर्ण,
	अणु .n = "mci1_clk",   .id = 26, पूर्ण,
	अणु .n = "ssc0_clk",   .id = 28, पूर्ण,
पूर्ण;

अटल स्थिर काष्ठा pck at91sam9g15_periphck[] = अणु
	अणु .n = "lcdc_clk", .id = 25, पूर्ण,
	अणु /* sentinel */पूर्ण
पूर्ण;

अटल स्थिर काष्ठा pck at91sam9g25_periphck[] = अणु
...
अटल स्थिर काष्ठा pck at91sam9g35_periphck[] = अणु
	अणु .n = "macb0_clk", .id = 24, पूर्ण,
	अणु .n = "lcdc_clk", .id = 25, पूर्ण,
	अणु /* sentinel */पूर्ण
पूर्ण;

अटल स्थिर काष्ठा pck at91sam9x25_periphck[] = अणु
	अणु .n = "usart3_clk", .id = 8, पूर्ण,
	अणु .n = "macb0_clk", .id = 24, पूर्ण,
...
अटल स्थिर काष्ठा pck at91sam9x35_periphck[] = अणु
	अणु .n = "macb0_clk", .id = 24, पूर्ण,
	अणु .n = "lcdc_clk", .id = 25, पूर्ण,
	अणु .n = "can0_clk", .id = 29, पूर्ण,
	अणु .n = "can1_clk", .id = 30, पूर्ण,
...
अटल व्योम __init at91sam9x5_pmc_setup(काष्ठा device_node *np,
					स्थिर काष्ठा pck *extra_pcks,
					bool has_lcdck)
अणु
	काष्ठा clk_range range = CLK_RANGE(0, 0);
	स्थिर अक्षर *slck_name, *मुख्यxtal_name;
	काष्ठा pmc_data *at91sam9x5_pmc;
	...
	at91sam9x5_pmc = pmc_data_allocate(PMC_PLLACK + 1,
					   nck(at91sam9x5_प्रणालीck), 31, 0, 2);
	अगर (!at91sam9x5_pmc)
		वापस;
	...
	क्रम (i = 0; i < ARRAY_SIZE(at91sam9x5_प्रणालीck); i++) अणु
		hw = at91_clk_रेजिस्टर_प्रणाली(regmap, at91sam9x5_प्रणालीck[i].n,
					      at91sam9x5_प्रणालीck[i].p,
					      at91sam9x5_प्रणालीck[i].id);
		अगर (IS_ERR(hw))
			जाओ err_मुक्त;

		at91sam9x5_pmc->shws[at91sam9x5_प्रणालीck[i].id] = hw;
	पूर्ण

	अगर (has_lcdck) अणु
		hw = at91_clk_रेजिस्टर_प्रणाली(regmap, "lcdck", "masterck_div", 3);
		अगर (IS_ERR(hw))
			जाओ err_मुक्त;
	...
	क्रम (i = 0; i < ARRAY_SIZE(at91sam9x5_periphck); i++) अणु
	...
	क्रम (i = 0; extra_pcks[i].id; i++) अणु
		hw = at91_clk_रेजिस्टर_sam9x5_peripheral(regmap, &pmc_pcr_lock,
							 &at91sam9x5_pcr_layout,
							 extra_pcks[i].n,
							 "masterck_div",
...
err_मुक्त:
	kमुक्त(at91sam9x5_pmc);
पूर्ण

अटल व्योम __init at91sam9g15_pmc_setup(काष्ठा device_node *np)
अणु
...
अटल व्योम __init at91sam9g25_pmc_setup(काष्ठा device_node *np)
अणु
...
अटल व्योम __init at91sam9g35_pmc_setup(काष्ठा device_node *np)
अणु
...
अटल व्योम __init at91sam9x25_pmc_setup(काष्ठा device_node *np)
अणु
...
अटल व्योम __init at91sam9x35_pmc_setup(काष्ठा device_node *np)
अणु
