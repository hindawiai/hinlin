...
#समावेश <dt-bindings/घड़ी/imx8mn-घड़ी.h>
...
अटल स्थिर अक्षर * स्थिर imx8mn_a53_sels[] = अणु"osc_24m", "arm_pll_out", "sys_pll2_500m",
					       "sys_pll2_1000m", "sys_pll1_800m", "sys_pll1_400m",
					       "audio_pll1_out", "sys_pll3_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_a53_core_sels[] = अणु"arm_a53_div", "arm_pll_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_gpu_core_sels[] = अणु"osc_24m", "gpu_pll_out", "sys_pll1_800m",
						    "sys_pll3_out", "sys_pll2_1000m", "audio_pll1_out",
						    "video_pll1_out", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_gpu_shader_sels[] = अणु"osc_24m", "gpu_pll_out", "sys_pll1_800m",
						      "sys_pll3_out", "sys_pll2_1000m", "audio_pll1_out",
						      "video_pll1_out", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_मुख्य_axi_sels[] = अणु"osc_24m", "sys_pll2_333m", "sys_pll1_800m",
						    "sys_pll2_250m", "sys_pll2_1000m", "audio_pll1_out",
						    "video_pll1_out", "sys_pll1_100m",पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_enet_axi_sels[] = अणु"osc_24m", "sys_pll1_266m", "sys_pll1_800m",
						    "sys_pll2_250m", "sys_pll2_200m", "audio_pll1_out",
						    "video_pll1_out", "sys_pll3_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_nand_usdhc_sels[] = अणु"osc_24m", "sys_pll1_266m", "sys_pll1_800m",
						      "sys_pll2_200m", "sys_pll1_133m", "sys_pll3_out",
						      "sys_pll2_250m", "audio_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_disp_axi_sels[] = अणु"osc_24m", "sys_pll2_1000m", "sys_pll1_800m",
						    "sys_pll3_out", "sys_pll1_40m", "audio_pll2_out",
						    "clk_ext1", "clk_ext4", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_disp_apb_sels[] = अणु"osc_24m", "sys_pll2_125m", "sys_pll1_800m",
						    "sys_pll3_out", "sys_pll1_40m", "audio_pll2_out",
						    "clk_ext1", "clk_ext3", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_usb_bus_sels[] = अणु"osc_24m", "sys_pll2_500m", "sys_pll1_800m",
						   "sys_pll2_100m", "sys_pll2_200m", "clk_ext2",
						   "clk_ext4", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_gpu_axi_sels[] = अणु"osc_24m", "sys_pll1_800m", "gpu_pll_out",
						   "sys_pll3_out", "sys_pll2_1000m", "audio_pll1_out",
						   "video_pll1_out", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_gpu_ahb_sels[] = अणु"osc_24m", "sys_pll1_800m", "gpu_pll_out",
						   "sys_pll3_out", "sys_pll2_1000m", "audio_pll1_out",
						   "video_pll1_out", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_noc_sels[] = अणु"osc_24m", "sys_pll1_800m", "sys_pll3_out",
					       "sys_pll2_1000m", "sys_pll2_500m", "audio_pll1_out",
					       "video_pll1_out", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_ahb_sels[] = अणु"osc_24m", "sys_pll1_133m", "sys_pll1_800m",
					       "sys_pll1_400m", "sys_pll2_125m", "sys_pll3_out",
					       "audio_pll1_out", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_audio_ahb_sels[] = अणु"osc_24m", "sys_pll2_500m", "sys_pll1_800m",
						     "sys_pll2_1000m", "sys_pll2_166m", "sys_pll3_out",
						     "audio_pll1_out", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_dram_alt_sels[] = अणु"osc_24m", "sys_pll1_800m", "sys_pll1_100m",
						    "sys_pll2_500m", "sys_pll2_1000m", "sys_pll3_out",
						    "audio_pll1_out", "sys_pll1_266m", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_dram_apb_sels[] = अणु"osc_24m", "sys_pll2_200m", "sys_pll1_40m",
						    "sys_pll1_160m", "sys_pll1_800m", "sys_pll3_out",
						    "sys_pll2_250m", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_disp_pixel_sels[] = अणु"osc_24m", "video_pll1_out", "audio_pll2_out",
						      "audio_pll1_out", "sys_pll1_800m", "sys_pll2_1000m",
						      "sys_pll3_out", "clk_ext4", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_sai2_sels[] = अणु"osc_24m", "audio_pll1_out", "audio_pll2_out",
						"video_pll1_out", "sys_pll1_133m", "osc_hdmi",
						"clk_ext3", "clk_ext4", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_sai3_sels[] = अणु"osc_24m", "audio_pll1_out", "audio_pll2_out",
						"video_pll1_out", "sys_pll1_133m", "osc_hdmi",
						"clk_ext3", "clk_ext4", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_sai5_sels[] = अणु"osc_24m", "audio_pll1_out", "audio_pll2_out",
						"video_pll1_out", "sys_pll1_133m", "osc_hdmi",
						"clk_ext2", "clk_ext3", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_sai6_sels[] = अणु"osc_24m", "audio_pll1_out", "audio_pll2_out",
						"video_pll1_out", "sys_pll1_133m", "osc_hdmi",
						"clk_ext3", "clk_ext4", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_sai7_sels[] = अणु"osc_24m", "audio_pll1_out", "audio_pll2_out",
						"video_pll1_out", "sys_pll1_133m", "osc_hdmi",
						"clk_ext3", "clk_ext4", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_spdअगर1_sels[] = अणु"osc_24m", "audio_pll1_out", "audio_pll2_out",
						  "video_pll1_out", "sys_pll1_133m", "osc_hdmi",
						  "clk_ext2", "clk_ext3", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_enet_ref_sels[] = अणु"osc_24m", "sys_pll2_125m", "sys_pll2_50m",
						    "sys_pll2_100m", "sys_pll1_160m", "audio_pll1_out",
						    "video_pll1_out", "clk_ext4", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_enet_समयr_sels[] = अणु"osc_24m", "sys_pll2_100m", "audio_pll1_out",
						      "clk_ext1", "clk_ext2", "clk_ext3",
						      "clk_ext4", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_enet_phy_sels[] = अणु"osc_24m", "sys_pll2_50m", "sys_pll2_125m",
						    "sys_pll2_200m", "sys_pll2_500m", "video_pll1_out",
						    "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_nand_sels[] = अणु"osc_24m", "sys_pll2_500m", "audio_pll1_out",
						"sys_pll1_400m", "audio_pll2_out", "sys_pll3_out",
						"sys_pll2_250m", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_qspi_sels[] = अणु"osc_24m", "sys_pll1_400m", "sys_pll2_333m",
						"sys_pll2_500m", "audio_pll2_out", "sys_pll1_266m",
						"sys_pll3_out", "sys_pll1_100m", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_usdhc1_sels[] = अणु"osc_24m", "sys_pll1_400m", "sys_pll1_800m",
						  "sys_pll2_500m", "sys_pll3_out", "sys_pll1_266m",
						  "audio_pll2_out", "sys_pll1_100m", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_usdhc2_sels[] = अणु"osc_24m", "sys_pll1_400m", "sys_pll1_800m",
						  "sys_pll2_500m", "sys_pll3_out", "sys_pll1_266m",
						  "audio_pll2_out", "sys_pll1_100m", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_i2c1_sels[] = अणु"osc_24m", "sys_pll1_160m", "sys_pll2_50m",
						"sys_pll3_out", "audio_pll1_out", "video_pll1_out",
						"audio_pll2_out", "sys_pll1_133m", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_i2c2_sels[] = अणु"osc_24m", "sys_pll1_160m", "sys_pll2_50m",
						"sys_pll3_out", "audio_pll1_out", "video_pll1_out",
						"audio_pll2_out", "sys_pll1_133m", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_i2c3_sels[] = अणु"osc_24m", "sys_pll1_160m", "sys_pll2_50m",
						"sys_pll3_out", "audio_pll1_out", "video_pll1_out",
						"audio_pll2_out", "sys_pll1_133m", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_i2c4_sels[] = अणु"osc_24m", "sys_pll1_160m", "sys_pll2_50m",
						"sys_pll3_out",	"audio_pll1_out", "video_pll1_out",
						"audio_pll2_out", "sys_pll1_133m", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_uart1_sels[] = अणु"osc_24m", "sys_pll1_80m", "sys_pll2_200m",
						 "sys_pll2_100m", "sys_pll3_out", "clk_ext2",
						 "clk_ext4", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_uart2_sels[] = अणु"osc_24m", "sys_pll1_80m", "sys_pll2_200m",
						 "sys_pll2_100m", "sys_pll3_out", "clk_ext2",
						 "clk_ext3", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_uart3_sels[] = अणु"osc_24m", "sys_pll1_80m", "sys_pll2_200m",
						 "sys_pll2_100m", "sys_pll3_out", "clk_ext2",
						 "clk_ext4", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_uart4_sels[] = अणु"osc_24m", "sys_pll1_80m", "sys_pll2_200m",
						 "sys_pll2_100m", "sys_pll3_out", "clk_ext2",
						 "clk_ext3", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_usb_core_sels[] = अणु"osc_24m", "sys_pll1_100m", "sys_pll1_40m",
						    "sys_pll2_100m", "sys_pll2_200m", "clk_ext2",
						    "clk_ext3", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_usb_phy_sels[] = अणु"osc_24m", "sys_pll1_100m", "sys_pll1_40m",
						   "sys_pll2_100m", "sys_pll2_200m", "clk_ext2",
						   "clk_ext3", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_gic_sels[] = अणु"osc_24m", "sys_pll2_200m", "sys_pll1_40m",
					"sys_pll2_100m", "sys_pll1_800m", "clk_ext2",
					"clk_ext4", "audio_pll2_out" पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_ecspi1_sels[] = अणु"osc_24m", "sys_pll2_200m", "sys_pll1_40m",
						  "sys_pll1_160m", "sys_pll1_800m", "sys_pll3_out",
						  "sys_pll2_250m", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_ecspi2_sels[] = अणु"osc_24m", "sys_pll2_200m", "sys_pll1_40m",
						  "sys_pll1_160m", "sys_pll1_800m", "sys_pll3_out",
						  "sys_pll2_250m", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_pwm1_sels[] = अणु"osc_24m", "sys_pll2_100m", "sys_pll1_160m",
						"sys_pll1_40m", "sys_pll3_out", "clk_ext1",
						"sys_pll1_80m", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_pwm2_sels[] = अणु"osc_24m", "sys_pll2_100m", "sys_pll1_160m",
						"sys_pll1_40m", "sys_pll3_out", "clk_ext1",
						"sys_pll1_80m", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_pwm3_sels[] = अणु"osc_24m", "sys_pll2_100m", "sys_pll1_160m",
						"sys_pll1_40m", "sys_pll3_out", "clk_ext2",
						"sys_pll1_80m", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_pwm4_sels[] = अणु"osc_24m", "sys_pll2_100m", "sys_pll1_160m",
						"sys_pll1_40m", "sys_pll3_out", "clk_ext2",
						"sys_pll1_80m", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_wकरोg_sels[] = अणु"osc_24m", "sys_pll1_133m", "sys_pll1_160m",
						"vpu_pll_out", "sys_pll2_125m", "sys_pll3_out",
						"sys_pll1_80m", "sys_pll2_166m", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_wrclk_sels[] = अणु"osc_24m", "sys_pll1_40m", "vpu_pll_out",
						 "sys_pll3_out", "sys_pll2_200m", "sys_pll1_266m",
						 "sys_pll2_500m", "sys_pll1_100m", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_dsi_core_sels[] = अणु"osc_24m", "sys_pll1_266m", "sys_pll2_250m",
						    "sys_pll1_800m", "sys_pll2_1000m", "sys_pll3_out",
						    "audio_pll2_out", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_dsi_phy_sels[] = अणु"osc_24m", "sys_pll2_125m", "sys_pll2_100m",
						   "sys_pll1_800m", "sys_pll2_1000m", "clk_ext2",
						   "audio_pll2_out", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_dsi_dbi_sels[] = अणु"osc_24m", "sys_pll1_266m", "sys_pll2_100m",
						   "sys_pll1_800m", "sys_pll2_1000m", "sys_pll3_out",
						   "audio_pll2_out", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_usdhc3_sels[] = अणु"osc_24m", "sys_pll1_400m", "sys_pll1_800m",
						  "sys_pll2_500m", "sys_pll3_out", "sys_pll1_266m",
						  "audio_pll2_out", "sys_pll1_100m", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_camera_pixel_sels[] = अणु"osc_24m", "sys_pll1_266m", "sys_pll2_250m",
							"sys_pll1_800m", "sys_pll2_1000m", "sys_pll3_out",
							"audio_pll2_out", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_csi1_phy_sels[] = अणु"osc_24m", "sys_pll2_333m", "sys_pll2_100m",
						    "sys_pll1_800m", "sys_pll2_1000m", "clk_ext2",
						    "audio_pll2_out", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_csi2_phy_sels[] = अणु"osc_24m", "sys_pll2_333m", "sys_pll2_100m",
						    "sys_pll1_800m", "sys_pll2_1000m", "clk_ext2",
						    "audio_pll2_out", "video_pll1_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_csi2_esc_sels[] = अणु"osc_24m", "sys_pll2_100m", "sys_pll1_80m",
						    "sys_pll1_800m", "sys_pll2_1000m", "sys_pll3_out",
						    "clk_ext3", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_ecspi3_sels[] = अणु"osc_24m", "sys_pll2_200m", "sys_pll1_40m",
						  "sys_pll1_160m", "sys_pll1_800m", "sys_pll3_out",
						  "sys_pll2_250m", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_pdm_sels[] = अणु"osc_24m", "sys_pll2_100m", "audio_pll1_out",
					       "sys_pll1_800m", "sys_pll2_1000m", "sys_pll3_out",
					       "clk_ext3", "audio_pll2_out", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_dram_core_sels[] = अणु"dram_pll_out", "dram_alt_root", पूर्ण;

अटल स्थिर अक्षर * स्थिर imx8mn_clko1_sels[] = अणु"osc_24m", "sys_pll1_800m", "osc_27m",
						 "sys_pll1_200m", "audio_pll2_out", "vpu_pll",
						 "sys_pll1_80m", पूर्ण;
अटल स्थिर अक्षर * स्थिर imx8mn_clko2_sels[] = अणु"osc_24m", "sys_pll2_200m", "sys_pll1_400m",
...
अटल पूर्णांक imx8mn_घड़ीs_probe(काष्ठा platक्रमm_device *pdev)
अणु
	...
	np = of_find_compatible_node(शून्य, शून्य, "fsl,imx8mn-anatop");
	base = of_iomap(np, 0);
	of_node_put(np);
	अगर (WARN_ON(!base)) अणु
		ret = -ENOMEM;
		जाओ unरेजिस्टर_hws;
	पूर्ण
	...
	hws[IMX8MN_CLK_CLKOUT1_DIV] = imx_clk_hw_भागider("clkout1_div", "clkout1_sel", base + 0x128, 0, 4);
	...
	hws[IMX8MN_CLK_CLKOUT2_DIV] = imx_clk_hw_भागider("clkout2_div", "clkout2_sel", base + 0x128, 16, 4);
	hws[IMX8MN_CLK_CLKOUT2] = imx_clk_hw_gate("clkout2", "clkout2_div", base + 0x128, 24);

	np = dev->of_node;
	base = devm_platक्रमm_ioremap_resource(pdev, 0);
	अगर (WARN_ON(IS_ERR(base))) अणु
		ret = PTR_ERR(base);
		जाओ unरेजिस्टर_hws;
	पूर्ण
	...
	/* BUS */
	hws[IMX8MN_CLK_MAIN_AXI] = imx8m_clk_hw_composite_bus_critical("main_axi", imx8mn_मुख्य_axi_sels, base + 0x8800);
	hws[IMX8MN_CLK_ENET_AXI] = imx8m_clk_hw_composite_bus("enet_axi", imx8mn_enet_axi_sels, base + 0x8880);
	hws[IMX8MN_CLK_न_अंकD_USDHC_BUS] = imx8m_clk_hw_composite_bus("nand_usdhc_bus", imx8mn_nand_usdhc_sels, base + 0x8900);
	...
	hws[IMX8MN_CLK_IPG_ROOT] = imx_clk_hw_भागider2("ipg_root", "ahb", base + 0x9080, 0, 1);
	hws[IMX8MN_CLK_IPG_AUDIO_ROOT] = imx_clk_hw_भागider2("ipg_audio_root", "audio_ahb", base + 0x9180, 0, 1);
	...
	hws[IMX8MN_CLK_SPDIF1] = imx8m_clk_hw_composite("spdif1", imx8mn_spdअगर1_sels, base + 0xa880);
	hws[IMX8MN_CLK_ENET_REF] = imx8m_clk_hw_composite("enet_ref", imx8mn_enet_ref_sels, base + 0xa980);
	hws[IMX8MN_CLK_ENET_TIMER] = imx8m_clk_hw_composite("enet_timer", imx8mn_enet_समयr_sels, base + 0xaa00);
	hws[IMX8MN_CLK_ENET_PHY_REF] = imx8m_clk_hw_composite("enet_phy", imx8mn_enet_phy_sels, base + 0xaa80);
	hws[IMX8MN_CLK_न_अंकD] = imx8m_clk_hw_composite("nand", imx8mn_nand_sels, base + 0xab00);
	...
	hws[IMX8MN_CLK_WDOG] = imx8m_clk_hw_composite("wdog", imx8mn_wकरोg_sels, base + 0xb900);
	...
	hws[IMX8MN_CLK_न_अंकD_ROOT] = imx_clk_hw_gate2_shared2("nand_root_clk", "nand", base + 0x4300, 0, &share_count_nand);
	hws[IMX8MN_CLK_न_अंकD_USDHC_BUS_RAWन_अंकD_CLK] = imx_clk_hw_gate2_shared2("nand_usdhc_rawnand_clk", "nand_usdhc_bus", base + 0x4300, 0, &share_count_nand);
...
unरेजिस्टर_hws:
	imx_unरेजिस्टर_hw_घड़ीs(hws, IMX8MN_CLK_END);

	वापस ret;
पूर्ण

अटल स्थिर काष्ठा of_device_id imx8mn_clk_of_match[] = अणु
	अणु .compatible = "fsl,imx8mn-ccm" पूर्ण,
	अणु /* Sentinel */ पूर्ण,
पूर्ण;
MODULE_DEVICE_TABLE(of, imx8mn_clk_of_match);

अटल काष्ठा platक्रमm_driver imx8mn_clk_driver = अणु
	.probe = imx8mn_घड़ीs_probe,
	.driver = अणु
		.name = "imx8mn-ccm",
		/*
	...
	पूर्ण,
पूर्ण;
module_platक्रमm_driver(imx8mn_clk_driver);
