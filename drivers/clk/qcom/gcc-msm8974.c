...
#समावेश <dt-bindings/घड़ी/qcom,gcc-msm8974.h>
#समावेश <dt-bindings/reset/qcom,gcc-msm8974.h>
...
अटल स्थिर काष्ठा freq_tbl ftbl_gcc_sdcc1_apps_clk_pro[] = अणु
	F(144000, P_XO, 16, 3, 25),
	F(400000, P_XO, 12, 1, 4),
	F(20000000, P_GPLL0, 15, 1, 2),
	F(25000000, P_GPLL0, 12, 1, 2),
...
अटल काष्ठा clk_init_data sdcc1_apps_clk_src_init = अणु
...
अटल काष्ठा clk_regmap gcc_mmss_gpll0_clk_src = अणु
	.enable_reg = 0x1484,
	.enable_mask = BIT(26),
	.hw.init = &(काष्ठा clk_init_data)अणु
...
अटल काष्ठा clk_regmap *gcc_msm8974_घड़ीs[] = अणु
	[GPLL0] = &gpll0.clkr,
	...
	[GPLL4] = शून्य,
	[GPLL4_VOTE] = शून्य,
	[GCC_SDCC1_CDCCAL_SLEEP_CLK] = शून्य,
	[GCC_SDCC1_CDCCAL_FF_CLK] = शून्य,
पूर्ण;

अटल स्थिर काष्ठा qcom_reset_map gcc_msm8974_resets[] = अणु
...
अटल काष्ठा gdsc *gcc_msm8974_gdscs[] = अणु
	[USB_HS_HSIC_GDSC] = &usb_hs_hsic_gdsc,
पूर्ण;

अटल स्थिर काष्ठा regmap_config gcc_msm8974_regmap_config = अणु
	.reg_bits	= 32,
	.reg_stride	= 4,
	.val_bits	= 32,
	.max_रेजिस्टर	= 0x1fc0,
...
अटल स्थिर काष्ठा qcom_cc_desc gcc_msm8974_desc = अणु
	.config = &gcc_msm8974_regmap_config,
	.clks = gcc_msm8974_घड़ीs,
	.num_clks = ARRAY_SIZE(gcc_msm8974_घड़ीs),
...
अटल स्थिर काष्ठा of_device_id gcc_msm8974_match_table[] = अणु
	अणु .compatible = "qcom,gcc-msm8974" पूर्ण,
	अणु .compatible = "qcom,gcc-msm8974pro" , .data = (व्योम *)1UL पूर्ण,
	अणु .compatible = "qcom,gcc-msm8974pro-ac", .data = (व्योम *)1UL पूर्ण,
	अणु पूर्ण
पूर्ण;
MODULE_DEVICE_TABLE(of, gcc_msm8974_match_table);

अटल व्योम msm8974_pro_घड़ी_override(व्योम)
अणु
	...
	gcc_msm8974_घड़ीs[GPLL4] = &gpll4.clkr;
	gcc_msm8974_घड़ीs[GPLL4_VOTE] = &gpll4_vote;
	gcc_msm8974_घड़ीs[GCC_SDCC1_CDCCAL_SLEEP_CLK] =
		&gcc_sdcc1_cdccal_sleep_clk.clkr;
	gcc_msm8974_घड़ीs[GCC_SDCC1_CDCCAL_FF_CLK] =
		&gcc_sdcc1_cdccal_ff_clk.clkr;
पूर्ण

अटल पूर्णांक gcc_msm8974_probe(काष्ठा platक्रमm_device *pdev)
अणु
	पूर्णांक ret;
	...
	वापस qcom_cc_probe(pdev, &gcc_msm8974_desc);
पूर्ण

अटल काष्ठा platक्रमm_driver gcc_msm8974_driver = अणु
...
अटल पूर्णांक __init gcc_msm8974_init(व्योम)
अणु
	वापस platक्रमm_driver_रेजिस्टर(&gcc_msm8974_driver);
पूर्ण
core_initcall(gcc_msm8974_init);

अटल व्योम __निकास gcc_msm8974_निकास(व्योम)
अणु
	platक्रमm_driver_unरेजिस्टर(&gcc_msm8974_driver);
पूर्ण
module_निकास(gcc_msm8974_निकास);
