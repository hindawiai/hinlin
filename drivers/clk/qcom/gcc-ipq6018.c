...
#समावेश <dt-bindings/घड़ी/qcom,gcc-ipq6018.h>
#समावेश <dt-bindings/reset/qcom,gcc-ipq6018.h>
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_gpll0_gpll0_out_मुख्य_भाग2[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll0.clkr.hwपूर्ण,
	अणु .hw = &gpll0_out_मुख्य_भाग2.hwपूर्ण,
पूर्ण;
...
अटल काष्ठा clk_rcg2 pcnoc_bfdcd_clk_src = अणु
	...
	.clkr.hw.init = &(काष्ठा clk_init_data)अणु
		...
		.parent_data = gcc_xo_gpll0_gpll0_out_मुख्य_भाग2,
		.num_parents = 3,
		.ops = &clk_rcg2_ops,
	पूर्ण,
पूर्ण;
...
अटल काष्ठा clk_alpha_pll_postभाग nss_crypto_pll = अणु
	...
	.clkr.hw.init = &(काष्ठा clk_init_data)अणु
		.name = "nss_crypto_pll",
		.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
				&nss_crypto_pll_मुख्य.clkr.hw पूर्ण,
		.num_parents = 1,
		.ops = &clk_alpha_pll_postभाग_ro_ops,
		.flags = CLK_SET_RATE_PARENT,
	पूर्ण,
...
अटल स्थिर काष्ठा freq_tbl ftbl_qdss_tsctr_clk_src[] = अणु
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_gpll4_gpll0_gpll6_gpll0_भाग2[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll4.clkr.hw पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .hw = &gpll6.clkr.hw पूर्ण,
	अणु .hw = &gpll0_out_मुख्य_भाग2.hw पूर्ण,
पूर्ण;

अटल स्थिर काष्ठा parent_map gcc_xo_gpll4_gpll0_gpll6_gpll0_भाग2_map[] = अणु
	अणु P_XO, 0 पूर्ण,
	अणु P_GPLL4, 1 पूर्ण,
	अणु P_GPLL0, 2 पूर्ण,
	अणु P_GPLL6, 3 पूर्ण,
...
अटल काष्ठा clk_rcg2 qdss_tsctr_clk_src = अणु
	.cmd_rcgr = 0x29064,
	.freq_tbl = ftbl_qdss_tsctr_clk_src,
	.hid_width = 5,
	.parent_map = gcc_xo_gpll4_gpll0_gpll6_gpll0_भाग2_map,
	.clkr.hw.init = &(काष्ठा clk_init_data)अणु
		.name = "qdss_tsctr_clk_src",
		.parent_data = gcc_xo_gpll4_gpll0_gpll6_gpll0_भाग2,
		.num_parents = 5,
		.ops = &clk_rcg2_ops,
	पूर्ण,
पूर्ण;

अटल काष्ठा clk_fixed_factor qdss_dap_sync_clk_src = अणु
	.mult = 1,
	.भाग = 4,
	.hw.init = &(काष्ठा clk_init_data)अणु
		.name = "qdss_dap_sync_clk_src",
		.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
				&qdss_tsctr_clk_src.clkr.hw पूर्ण,
		.num_parents = 1,
		.ops = &clk_fixed_factor_ops,
	पूर्ण,
पूर्ण;

अटल स्थिर काष्ठा freq_tbl ftbl_qdss_at_clk_src[] = अणु
	F(66670000, P_GPLL0_DIV2, 6, 0, 0),
	F(240000000, P_GPLL4, 5, 0, 0),
	अणु पूर्ण
पूर्ण;

अटल काष्ठा clk_rcg2 qdss_at_clk_src = अणु
	.cmd_rcgr = 0x2900c,
...
अटल काष्ठा clk_fixed_factor qdss_tsctr_भाग2_clk_src = अणु
	.mult = 1,
	.भाग = 2,
	.hw.init = &(काष्ठा clk_init_data)अणु
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_bias_gpll0_gpll4_nss_ubi32[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .fw_name = "bias_pll_cc_clk" पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .hw = &gpll4.clkr.hw पूर्ण,
	अणु .hw = &nss_crypto_pll.clkr.hw पूर्ण,
	अणु .hw = &ubi32_pll.clkr.hw पूर्ण,
पूर्ण;
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_gpll0[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
पूर्ण;
...
अटल स्थिर काष्ठा freq_tbl ftbl_snoc_nssnoc_bfdcd_clk_src[] = अणु
	F(24000000, P_XO, 1, 0, 0),
...
अटल स्थिर काष्ठा clk_parent_data
			gcc_xo_gpll0_gpll6_gpll0_out_मुख्य_भाग2[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .hw = &gpll6.clkr.hw पूर्ण,
	अणु .hw = &gpll0_out_मुख्य_भाग2.hw पूर्ण,
...
अटल काष्ठा clk_rcg2 snoc_nssnoc_bfdcd_clk_src = अणु
	.cmd_rcgr = 0x76054,
	...
	.clkr.hw.init = &(काष्ठा clk_init_data)अणु
		...
		.parent_data = gcc_xo_gpll0_gpll6_gpll0_out_मुख्य_भाग2,
		.num_parents = 4,
		.ops = &clk_rcg2_ops,
	पूर्ण,
पूर्ण;
...
अटल स्थिर काष्ठा clk_parent_data
gcc_xo_uniphy0_rx_tx_uniphy1_rx_tx_ubi32_bias[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .fw_name = "uniphy0_gcc_rx_clk" पूर्ण,
	अणु .fw_name = "uniphy0_gcc_tx_clk" पूर्ण,
	अणु .fw_name = "uniphy1_gcc_rx_clk" पूर्ण,
	अणु .fw_name = "uniphy1_gcc_tx_clk" पूर्ण,
	अणु .hw = &ubi32_pll.clkr.hw पूर्ण,
	अणु .fw_name = "bias_pll_cc_clk" पूर्ण,
पूर्ण;
...
अटल स्थिर काष्ठा clk_parent_data
gcc_xo_uniphy0_tx_rx_uniphy1_tx_rx_ubi32_bias[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .fw_name = "uniphy0_gcc_tx_clk" पूर्ण,
	अणु .fw_name = "uniphy0_gcc_rx_clk" पूर्ण,
	अणु .fw_name = "uniphy1_gcc_tx_clk" पूर्ण,
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_gpll0_gpll4[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .hw = &gpll4.clkr.hw पूर्ण,
पूर्ण;
...
अटल स्थिर काष्ठा freq_tbl ftbl_usb0_master_clk_src[] = अणु
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_gpll0_out_मुख्य_भाग2_gpll0[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll0_out_मुख्य_भाग2.hw पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
पूर्ण;
...
अटल काष्ठा clk_rcg2 usb0_master_clk_src = अणु
	...
	.clkr.hw.init = &(काष्ठा clk_init_data)अणु
		...
		.parent_data = gcc_xo_gpll0_out_मुख्य_भाग2_gpll0,
		.num_parents = 3,
		.ops = &clk_rcg2_ops,
	पूर्ण,
पूर्ण;

अटल काष्ठा clk_regmap_भाग apss_ahb_postभाग_clk_src = अणु
	.reg = 0x46018,
	.shअगरt = 4,
	.width = 4,
	.clkr = अणु
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&apss_ahb_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_uniphy0_rx_tx_ubi32_bias[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .fw_name = "uniphy0_gcc_rx_clk" पूर्ण,
	अणु .fw_name = "uniphy0_gcc_tx_clk" पूर्ण,
	अणु .hw = &ubi32_pll.clkr.hw पूर्ण,
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_uniphy0_tx_rx_ubi32_bias[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .fw_name = "uniphy0_gcc_tx_clk" पूर्ण,
	अणु .fw_name = "uniphy0_gcc_rx_clk" पूर्ण,
	अणु .hw = &ubi32_pll.clkr.hw पूर्ण,
...
अटल काष्ठा clk_regmap_भाग nss_port5_rx_भाग_clk_src = अणु
	...
	.clkr = अणु
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port5_rx_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.ops = &clk_regmap_भाग_ops,
			.flags = CLK_SET_RATE_PARENT,
		पूर्ण,
...
अटल काष्ठा clk_regmap_भाग nss_port5_tx_भाग_clk_src = अणु
	...
	.clkr = अणु
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port5_tx_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.ops = &clk_regmap_भाग_ops,
			.flags = CLK_SET_RATE_PARENT,
		पूर्ण,
...
अटल स्थिर काष्ठा freq_tbl ftbl_apss_axi_clk_src[] = अणु
	F(24000000, P_XO, 1, 0, 0),
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_gpll0_gpll6_ubi32_gpll0_भाग2[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .hw = &gpll6.clkr.hw पूर्ण,
	अणु .hw = &ubi32_pll.clkr.hw पूर्ण,
...
अटल स्थिर काष्ठा parent_map
gcc_xo_gpll0_gpll6_ubi32_gpll0_भाग2_map[] = अणु
	अणु P_XO, 0 पूर्ण,
	अणु P_GPLL0, 1 पूर्ण,
	अणु P_GPLL6, 2 पूर्ण,
	अणु P_UBI32_PLL, 3 पूर्ण,
	अणु P_GPLL0_DIV2, 6 पूर्ण,
पूर्ण;

अटल काष्ठा clk_rcg2 apss_axi_clk_src = अणु
	.cmd_rcgr = 0x38048,
	.freq_tbl = ftbl_apss_axi_clk_src,
	.hid_width = 5,
	.parent_map = gcc_xo_gpll0_gpll6_ubi32_gpll0_भाग2_map,
	.clkr.hw.init = &(काष्ठा clk_init_data)अणु
		.name = "apss_axi_clk_src",
		.parent_data = gcc_xo_gpll0_gpll6_ubi32_gpll0_भाग2,
		.num_parents = 5,
		.ops = &clk_rcg2_ops,
	पूर्ण,
पूर्ण;
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_nss_crypto_pll_gpll0[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &nss_crypto_pll.clkr.hw पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
पूर्ण;
...
अटल काष्ठा clk_regmap_भाग nss_port1_rx_भाग_clk_src = अणु
	...
	.clkr = अणु
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
				&nss_port1_rx_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.ops = &clk_regmap_भाग_ops,
			.flags = CLK_SET_RATE_PARENT,
		पूर्ण,
...
अटल काष्ठा clk_regmap_भाग nss_port1_tx_भाग_clk_src = अणु
	...
	.clkr = अणु
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port1_tx_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.ops = &clk_regmap_भाग_ops,
			.flags = CLK_SET_RATE_PARENT,
		पूर्ण,
...
अटल काष्ठा clk_regmap_भाग nss_port2_rx_भाग_clk_src = अणु
	...
	.clkr = अणु
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port2_rx_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.ops = &clk_regmap_भाग_ops,
			.flags = CLK_SET_RATE_PARENT,
		पूर्ण,
...
अटल काष्ठा clk_regmap_भाग nss_port2_tx_भाग_clk_src = अणु
	...
	.clkr = अणु
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port2_tx_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.ops = &clk_regmap_भाग_ops,
			.flags = CLK_SET_RATE_PARENT,
		पूर्ण,
...
अटल काष्ठा clk_regmap_भाग nss_port3_rx_भाग_clk_src = अणु
	...
	.clkr = अणु
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port3_rx_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.ops = &clk_regmap_भाग_ops,
			.flags = CLK_SET_RATE_PARENT,
		पूर्ण,
...
अटल काष्ठा clk_regmap_भाग nss_port3_tx_भाग_clk_src = अणु
	...
	.clkr = अणु
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port3_tx_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.ops = &clk_regmap_भाग_ops,
			.flags = CLK_SET_RATE_PARENT,
		पूर्ण,
...
अटल काष्ठा clk_regmap_भाग nss_port4_rx_भाग_clk_src = अणु
	...
	.clkr = अणु
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port4_rx_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.ops = &clk_regmap_भाग_ops,
			.flags = CLK_SET_RATE_PARENT,
		पूर्ण,
...
अटल काष्ठा clk_regmap_भाग nss_port4_tx_भाग_clk_src = अणु
	...
	.clkr = अणु
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port4_tx_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.ops = &clk_regmap_भाग_ops,
			.flags = CLK_SET_RATE_PARENT,
		पूर्ण,
...
अटल स्थिर काष्ठा clk_parent_data
			gcc_xo_ubi32_pll_gpll0_gpll2_gpll4_gpll6[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &ubi32_pll.clkr.hw पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .hw = &gpll2.clkr.hw पूर्ण,
	अणु .hw = &gpll4.clkr.hw पूर्ण,
	अणु .hw = &gpll6.clkr.hw पूर्ण,
पूर्ण;
...
अटल स्थिर काष्ठा freq_tbl ftbl_adss_pwm_clk_src[] = अणु
	F(24000000, P_XO, 1, 0, 0),
	F(100000000, P_GPLL0, 8, 0, 0),
	अणु पूर्ण
पूर्ण;

अटल काष्ठा clk_rcg2 adss_pwm_clk_src = अणु
	.cmd_rcgr = 0x1c008,
...
अटल स्थिर काष्ठा freq_tbl ftbl_crypto_clk_src[] = अणु
...
अटल स्थिर काष्ठा freq_tbl ftbl_gp_clk_src[] = अणु
	F(24000000, P_XO, 1, 0, 0),
	F(50000000, P_GPLL0_DIV2, 8, 0, 0),
	F(100000000, P_GPLL0, 8, 0, 0),
	F(200000000, P_GPLL0, 4, 0, 0),
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_gpll0_gpll6_gpll0_sleep_clk[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .hw = &gpll6.clkr.hw पूर्ण,
	अणु .hw = &gpll0_out_मुख्य_भाग2.hw पूर्ण,
...
अटल काष्ठा clk_regmap_भाग nss_ubi0_भाग_clk_src = अणु
	...
	.clkr = अणु
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
				&nss_ubi0_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_gpll0_core_pi_sleep_clk[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .fw_name = "sleep_clk" पूर्ण,
पूर्ण;

अटल स्थिर काष्ठा parent_map gcc_xo_gpll0_core_pi_sleep_clk_map[] = अणु
	अणु P_XO, 0 पूर्ण,
	अणु P_GPLL0, 2 पूर्ण,
	अणु P_PI_SLEEP, 6 पूर्ण,
पूर्ण;
...
अटल स्थिर काष्ठा clk_parent_data gcc_pcie20_phy0_pipe_clk_xo[] = अणु
	अणु .fw_name = "pcie20_phy0_pipe_clk" पूर्ण,
	अणु .fw_name = "xo" पूर्ण,
पूर्ण;
...
अटल स्थिर काष्ठा clk_parent_data
			gcc_xo_gpll0_gpll2_gpll0_out_मुख्य_भाग2[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .hw = &gpll2.clkr.hw पूर्ण,
	अणु .hw = &gpll0_out_मुख्य_भाग2.hw पूर्ण,
...
अटल काष्ठा clk_rcg2 sdcc1_apps_clk_src = अणु
	...
	.clkr.hw.init = &(काष्ठा clk_init_data)अणु
		...
		.parent_data = gcc_xo_gpll0_gpll2_gpll0_out_मुख्य_भाग2,
		.num_parents = 4,
		.ops = &clk_rcg2_ops,
	पूर्ण,
पूर्ण;
...
अटल स्थिर काष्ठा clk_parent_data
			gcc_xo_gpll6_gpll0_gpll0_out_मुख्य_भाग2[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll6.clkr.hw पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .hw = &gpll0_out_मुख्य_भाग2.hw पूर्ण,
...
अटल काष्ठा clk_rcg2 usb0_mock_uपंचांगi_clk_src = अणु
	...
	.clkr.hw.init = &(काष्ठा clk_init_data)अणु
		...
		.parent_data = gcc_xo_gpll6_gpll0_gpll0_out_मुख्य_भाग2,
		.num_parents = 4,
		.ops = &clk_rcg2_ops,
	पूर्ण,
पूर्ण;

अटल स्थिर काष्ठा clk_parent_data gcc_usb3phy_0_cc_pipe_clk_xo[] = अणु
	अणु .fw_name = "usb3phy_0_cc_pipe_clk" पूर्ण,
	अणु .fw_name = "xo" पूर्ण,
पूर्ण;
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_gpll0_gpll6_gpll0_भाग2[] = अणु
	अणु .fw_name = "xo"पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .hw = &gpll6.clkr.hw पूर्ण,
	अणु .hw = &gpll0_out_मुख्य_भाग2.hw पूर्ण,
...
अटल काष्ठा clk_rcg2 sdcc1_ice_core_clk_src = अणु
	...
	.clkr.hw.init = &(काष्ठा clk_init_data)अणु
		...
		.parent_data = gcc_xo_gpll0_gpll6_gpll0_भाग2,
		.num_parents = 4,
		.ops = &clk_rcg2_ops,
	पूर्ण,
पूर्ण;

अटल स्थिर काष्ठा freq_tbl ftbl_qdss_sपंचांग_clk_src[] = अणु
	F(24000000, P_XO, 1, 0, 0),
	F(50000000, P_GPLL0_DIV2, 8, 0, 0),
	F(100000000, P_GPLL0, 8, 0, 0),
	F(200000000, P_GPLL0, 4, 0, 0),
...
अटल काष्ठा clk_rcg2 qdss_sपंचांग_clk_src = अणु
	.cmd_rcgr = 0x2902C,
	.freq_tbl = ftbl_qdss_sपंचांग_clk_src,
	.hid_width = 5,
	.parent_map = gcc_xo_gpll0_gpll0_out_मुख्य_भाग2_map,
	.clkr.hw.init = &(काष्ठा clk_init_data)अणु
...
अटल स्थिर काष्ठा freq_tbl ftbl_qdss_traceclkin_clk_src[] = अणु
	F(80000000, P_GPLL0_DIV2, 5, 0, 0),
	F(160000000, P_GPLL0, 5, 0, 0),
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_gpll4_gpll0_gpll0_भाग2[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll4.clkr.hw पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .hw = &gpll0_out_मुख्य_भाग2.hw पूर्ण,
...
अटल स्थिर काष्ठा parent_map gcc_xo_gpll4_gpll0_gpll0_भाग2_map[] = अणु
	अणु P_XO, 0 पूर्ण,
	अणु P_GPLL4, 1 पूर्ण,
	अणु P_GPLL0, 2 पूर्ण,
	अणु P_GPLL0_DIV2, 4 पूर्ण,
...
अटल काष्ठा clk_rcg2 qdss_traceclkin_clk_src = अणु
	.cmd_rcgr = 0x29048,
	.freq_tbl = ftbl_qdss_traceclkin_clk_src,
	.hid_width = 5,
	.parent_map = gcc_xo_gpll4_gpll0_gpll0_भाग2_map,
	.clkr.hw.init = &(काष्ठा clk_init_data)अणु
		.name = "qdss_traceclkin_clk_src",
		.parent_data = gcc_xo_gpll4_gpll0_gpll0_भाग2,
		.num_parents = 4,
		.ops = &clk_rcg2_ops,
	पूर्ण,
पूर्ण;
...
अटल काष्ठा clk_branch gcc_adss_pwm_clk = अणु
	.halt_reg = 0x1c020,
	.clkr = अणु
		.enable_reg = 0x1c020,
		.enable_mask = BIT(0),
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&adss_pwm_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_apss_ahb_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&apss_ahb_postभाग_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल स्थिर काष्ठा freq_tbl ftbl_ubi32_mem_noc_bfdcd_clk_src[] = अणु
	F(24000000, P_XO, 1, 0, 0),
...
अटल स्थिर काष्ठा clk_parent_data
			gcc_xo_gpll0_gpll2_bias_pll_nss_noc_clk[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .hw = &gpll2.clkr.hw पूर्ण,
	अणु .fw_name = "bias_pll_nss_noc_clk" पूर्ण,
पूर्ण;

अटल स्थिर काष्ठा parent_map gcc_xo_gpll0_gpll2_bias_pll_nss_noc_clk_map[] = अणु
	अणु P_XO, 0 पूर्ण,
	अणु P_GPLL0, 1 पूर्ण,
	अणु P_GPLL2, 3 पूर्ण,
	अणु P_BIAS_PLL_NSS_NOC, 4 पूर्ण,
पूर्ण;

अटल काष्ठा clk_rcg2 ubi32_mem_noc_bfdcd_clk_src = अणु
	.cmd_rcgr = 0x68088,
...
अटल काष्ठा clk_branch gcc_apss_axi_clk = अणु
	.halt_reg = 0x46020,
	.halt_check = BRANCH_HALT_VOTED,
	.clkr = अणु
		.enable_reg = 0x0b004,
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&apss_axi_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_ahb_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&pcnoc_bfdcd_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_qup1_i2c_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_qup1_i2c_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_qup1_spi_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_qup1_spi_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_qup2_i2c_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_qup2_i2c_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_qup2_spi_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_qup2_spi_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_qup3_i2c_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_qup3_i2c_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_qup3_spi_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_qup3_spi_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_qup4_i2c_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_qup4_i2c_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_qup4_spi_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_qup4_spi_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_qup5_i2c_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_qup5_i2c_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_qup5_spi_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_qup5_spi_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_qup6_spi_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_qup6_spi_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_uart1_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_uart1_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_uart2_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_uart2_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_uart3_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_uart3_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_uart4_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_uart4_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_uart5_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_uart5_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_blsp1_uart6_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&blsp1_uart6_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_xo_clk = अणु
	.halt_reg = 0x30030,
	.clkr = अणु
		.enable_reg = 0x30030,
		.enable_mask = BIT(0),
...
अटल काष्ठा clk_branch gcc_crypto_ppe_clk = अणु
	.halt_reg = 0x68310,
	.clkr = अणु
		.enable_reg = 0x68310,
		.enable_mask = BIT(0),
...
अटल काष्ठा clk_branch gcc_nss_crypto_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_crypto_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_nss_noc_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&snoc_nssnoc_bfdcd_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_ubi0_utcm_clk = अणु
	.halt_reg = 0x2606c,
	.clkr = अणु
		.enable_reg = 0x2606c,
		.enable_mask = BIT(0),
...
अटल काष्ठा clk_branch gcc_snoc_nssnoc_clk = अणु
	.halt_reg = 0x26070,
	.clkr = अणु
		.enable_reg = 0x26070,
		.enable_mask = BIT(0),
...
अटल स्थिर काष्ठा freq_tbl ftbl_wcss_ahb_clk_src[] = अणु
	F(24000000, P_XO, 1, 0, 0),
	F(133333333, P_GPLL0, 6, 0, 0),
	अणु पूर्ण
पूर्ण;

अटल स्थिर काष्ठा freq_tbl ftbl_q6_axi_clk_src[] = अणु
	F(24000000, P_XO, 1, 0, 0),
	F(400000000, P_GPLL0, 2, 0, 0),
	अणु पूर्ण
पूर्ण;

अटल काष्ठा clk_rcg2 wcss_ahb_clk_src = अणु
	.cmd_rcgr = 0x59020,
...
अटल स्थिर काष्ठा clk_parent_data gcc_xo_gpll0_gpll2_gpll4_gpll6[] = अणु
	अणु .fw_name = "xo" पूर्ण,
	अणु .hw = &gpll0.clkr.hw पूर्ण,
	अणु .hw = &gpll2.clkr.hw पूर्ण,
	अणु .hw = &gpll4.clkr.hw पूर्ण,
...
अटल स्थिर काष्ठा parent_map gcc_xo_gpll0_gpll2_gpll4_gpll6_map[] = अणु
	अणु P_XO, 0 पूर्ण,
	अणु P_GPLL0, 1 पूर्ण,
	अणु P_GPLL2, 2 पूर्ण,
	अणु P_GPLL4, 3 पूर्ण,
...
अटल काष्ठा clk_rcg2 q6_axi_clk_src = अणु
	.cmd_rcgr = 0x59120,
...
अटल स्थिर काष्ठा freq_tbl ftbl_lpass_core_axim_clk_src[] = अणु
	F(24000000, P_XO, 1, 0, 0),
	F(100000000, P_GPLL0, 8, 0, 0),
	अणु पूर्ण
पूर्ण;

अटल काष्ठा clk_rcg2 lpass_core_axim_clk_src = अणु
	.cmd_rcgr = 0x1F020,
...
अटल स्थिर काष्ठा freq_tbl ftbl_lpass_snoc_cfg_clk_src[] = अणु
	F(24000000, P_XO, 1, 0, 0),
	F(266666667, P_GPLL0, 3, 0, 0),
	अणु पूर्ण
पूर्ण;

अटल काष्ठा clk_rcg2 lpass_snoc_cfg_clk_src = अणु
	.cmd_rcgr = 0x1F040,
...
अटल स्थिर काष्ठा freq_tbl ftbl_lpass_q6_axim_clk_src[] = अणु
	F(24000000, P_XO, 1, 0, 0),
	F(400000000, P_GPLL0, 2, 0, 0),
	अणु पूर्ण
पूर्ण;

अटल काष्ठा clk_rcg2 lpass_q6_axim_clk_src = अणु
	.cmd_rcgr = 0x1F008,
...
अटल काष्ठा freq_tbl ftbl_rbcpr_wcss_clk_src[] = अणु
	F(24000000, P_XO, 1, 0, 0),
	F(50000000, P_GPLL0, 16, 0, 0),
	अणु पूर्ण
पूर्ण;

अटल काष्ठा clk_rcg2 rbcpr_wcss_clk_src = अणु
	.cmd_rcgr = 0x3a00c,
...
अटल काष्ठा clk_branch gcc_lpass_core_axim_clk = अणु
	.halt_reg = 0x1F028,
	.clkr = अणु
		.enable_reg = 0x1F028,
		.enable_mask = BIT(0),
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&lpass_core_axim_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_lpass_snoc_cfg_clk = अणु
	.halt_reg = 0x1F048,
	.clkr = अणु
		.enable_reg = 0x1F048,
		.enable_mask = BIT(0),
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&lpass_snoc_cfg_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_lpass_q6_axim_clk = अणु
	.halt_reg = 0x1F010,
	.clkr = अणु
		.enable_reg = 0x1F010,
		.enable_mask = BIT(0),
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&lpass_q6_axim_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_lpass_q6_atbm_at_clk = अणु
	.halt_reg = 0x1F018,
	.clkr = अणु
		.enable_reg = 0x1F018,
		.enable_mask = BIT(0),
...
अटल काष्ठा clk_branch gcc_lpass_q6_pclkdbg_clk = अणु
	.halt_reg = 0x1F01C,
	.clkr = अणु
		.enable_reg = 0x1F01C,
		.enable_mask = BIT(0),
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&qdss_dap_sync_clk_src.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_lpass_q6ss_tsctr_1to2_clk = अणु
	.halt_reg = 0x1F014,
	.clkr = अणु
		.enable_reg = 0x1F014,
		.enable_mask = BIT(0),
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&qdss_tsctr_भाग2_clk_src.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_lpass_q6ss_trig_clk = अणु
	.halt_reg = 0x1F038,
	.clkr = अणु
		.enable_reg = 0x1F038,
		.enable_mask = BIT(0),
...
अटल काष्ठा clk_branch gcc_lpass_tbu_clk = अणु
	.halt_reg = 0x12094,
	.clkr = अणु
		.enable_reg = 0xb00c,
		.enable_mask = BIT(10),
...
अटल काष्ठा clk_branch gcc_pcnoc_lpass_clk = अणु
	.halt_reg = 0x27020,
	.clkr = अणु
		.enable_reg = 0x27020,
		.enable_mask = BIT(0),
...
अटल काष्ठा clk_branch gcc_mem_noc_lpass_clk = अणु
	.halt_reg = 0x1D044,
	.clkr = अणु
		.enable_reg = 0x1D044,
		.enable_mask = BIT(0),
...
अटल काष्ठा clk_branch gcc_snoc_lpass_cfg_clk = अणु
	.halt_reg = 0x26074,
	.clkr = अणु
		.enable_reg = 0x26074,
		.enable_mask = BIT(0),
...
अटल काष्ठा clk_branch gcc_mem_noc_ubi32_clk = अणु
	.halt_reg = 0x1D03C,
	.clkr = अणु
		.enable_reg = 0x1D03C,
		.enable_mask = BIT(0),
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&ubi32_mem_noc_bfdcd_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_nss_port1_rx_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port1_rx_भाग_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_nss_port1_tx_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port1_tx_भाग_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_nss_port2_rx_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port2_rx_भाग_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_nss_port2_tx_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port2_tx_भाग_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_nss_port3_rx_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port3_rx_भाग_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_nss_port3_tx_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port3_tx_भाग_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_nss_port4_rx_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port4_rx_भाग_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_nss_port4_tx_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port4_tx_भाग_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_nss_port5_rx_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port5_rx_भाग_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_nss_port5_tx_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_port5_tx_भाग_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_nssnoc_snoc_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&प्रणाली_noc_bfdcd_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_ubi0_core_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&nss_ubi0_भाग_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_pcie0_aux_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&pcie0_aux_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_pcie0_axi_m_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&pcie0_axi_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_pcie0_pipe_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&pcie0_pipe_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_sdcc1_apps_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&sdcc1_apps_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_usb0_aux_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&usb0_aux_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_usb0_master_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&usb0_master_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_snoc_bus_समयout2_ahb_clk = अणु
	.halt_reg = 0x47014,
	.clkr = अणु
		.enable_reg = 0x47014,
		.enable_mask = BIT(0),
...
अटल काष्ठा clk_branch gcc_pcie0_rchng_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&pcie0_rchng_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_usb0_mock_uपंचांगi_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&usb0_mock_uपंचांगi_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_usb0_pipe_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&usb0_pipe_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_usb0_sleep_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&gcc_sleep_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_usb1_mock_uपंचांगi_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&usb1_mock_uपंचांगi_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल काष्ठा clk_branch gcc_sdcc1_ice_core_clk = अणु
	...
	.clkr = अणु
		...
		.hw.init = &(काष्ठा clk_init_data)अणु
			...
			.parent_hws = (स्थिर काष्ठा clk_hw *[])अणु
					&sdcc1_ice_core_clk_src.clkr.hw पूर्ण,
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
		पूर्ण,
...
अटल स्थिर काष्ठा alpha_pll_config ubi32_pll_config = अणु
	.l = 0x3e,
	.alpha = 0x57,
	...
	.pre_भाग_mask = BIT(12),
	.post_भाग_val = 0x0,
	.post_भाग_mask = GENMASK(9, 8),
पूर्ण;

अटल स्थिर काष्ठा alpha_pll_config nss_crypto_pll_config = अणु
	.l = 0x32,
	.alpha = 0x0,
	.alpha_hi = 0x0,
	...
	.मुख्य_output_mask = BIT(0),
	.pre_भाग_val = 0x0,
	.pre_भाग_mask = GENMASK(14, 12),
	.post_भाग_val = 0x1 << 8,
	.post_भाग_mask = GENMASK(11, 8),
	.vco_mask = GENMASK(21, 20),
	.vco_val = 0x0,
	.alpha_en_mask = BIT(24),
पूर्ण;

अटल काष्ठा clk_hw *gcc_ipq6018_hws[] = अणु
	&gpll0_out_मुख्य_भाग2.hw,
	&gcc_xo_भाग4_clk_src.hw,
	&nss_ppe_cभाग_clk_src.hw,
	&gpll6_out_मुख्य_भाग2.hw,
	&qdss_dap_sync_clk_src.hw,
	&qdss_tsctr_भाग2_clk_src.hw,
पूर्ण;

अटल काष्ठा clk_regmap *gcc_ipq6018_clks[] = अणु
	...
	[APSS_AHB_POSTDIV_CLK_SRC] = &apss_ahb_postभाग_clk_src.clkr,
	...
	[GCC_SNOC_BUS_TIMEOUT2_AHB_CLK] = &gcc_snoc_bus_समयout2_ahb_clk.clkr,
	...
	[QDSS_STM_CLK_SRC] = &qdss_sपंचांग_clk_src.clkr,
	[QDSS_TRACECLKIN_CLK_SRC] = &qdss_traceclkin_clk_src.clkr,
पूर्ण;

अटल स्थिर काष्ठा qcom_reset_map gcc_ipq6018_resets[] = अणु
	...
	[GCC_SNOC_BUS_TIMEOUT1_BCR] = अणु 0x47008, 0 पूर्ण,
	[GCC_SNOC_BUS_TIMEOUT2_BCR] = अणु 0x47010, 0 पूर्ण,
	...
	[GCC_UBI0_UTCM_ARES] = अणु 0x68010, 6 पूर्ण,
	[GCC_UBI0_CORE_ARES] = अणु 0x68010, 7 पूर्ण,
	...
	[GCC_PPE_FULL_RESET] = अणु 0x68014, 0 पूर्ण,
	[GCC_UNIPHY0_SOFT_RESET] = अणु 0x56004, 0 पूर्ण,
	[GCC_UNIPHY0_XPCS_RESET] = अणु 0x56004, 2 पूर्ण,
	[GCC_UNIPHY1_SOFT_RESET] = अणु 0x56104, 0 पूर्ण,
	[GCC_UNIPHY1_XPCS_RESET] = अणु 0x56104, 2 पूर्ण,
	[GCC_EDMA_HW_RESET] = अणु 0x68014, 0 पूर्ण,
	[GCC_NSSPORT1_RESET] = अणु 0x68014, 0 पूर्ण,
	[GCC_NSSPORT2_RESET] = अणु 0x68014, 0 पूर्ण,
	[GCC_NSSPORT3_RESET] = अणु 0x68014, 0 पूर्ण,
	[GCC_NSSPORT4_RESET] = अणु 0x68014, 0 पूर्ण,
	[GCC_NSSPORT5_RESET] = अणु 0x68014, 0 पूर्ण,
	[GCC_UNIPHY0_PORT1_ARES] = अणु 0x56004, 0 पूर्ण,
	[GCC_UNIPHY0_PORT2_ARES] = अणु 0x56004, 0 पूर्ण,
	[GCC_UNIPHY0_PORT3_ARES] = अणु 0x56004, 0 पूर्ण,
	[GCC_UNIPHY0_PORT4_ARES] = अणु 0x56004, 0 पूर्ण,
	[GCC_UNIPHY0_PORT5_ARES] = अणु 0x56004, 0 पूर्ण,
	[GCC_UNIPHY0_PORT_4_5_RESET] = अणु 0x56004, 0 पूर्ण,
	[GCC_UNIPHY0_PORT_4_RESET] = अणु 0x56004, 0 पूर्ण,
	[GCC_LPASS_BCR] = अणु0x1F000, 0पूर्ण,
	[GCC_UBI32_TBU_BCR] = अणु0x65000, 0पूर्ण,
	[GCC_LPASS_TBU_BCR] = अणु0x6C000, 0पूर्ण,
	[GCC_WCSSAON_RESET] = अणु0x59010, 0पूर्ण,
	[GCC_LPASS_Q6_AXIM_ARES] = अणु0x1F004, 0पूर्ण,
	[GCC_LPASS_Q6SS_TSCTR_1TO2_ARES] = अणु0x1F004, 1पूर्ण,
	[GCC_LPASS_Q6SS_TRIG_ARES] = अणु0x1F004, 2पूर्ण,
	[GCC_LPASS_Q6_ATBM_AT_ARES] = अणु0x1F004, 3पूर्ण,
	[GCC_LPASS_Q6_PCLKDBG_ARES] = अणु0x1F004, 4पूर्ण,
	[GCC_LPASS_CORE_AXIM_ARES] = अणु0x1F004, 5पूर्ण,
	[GCC_LPASS_SNOC_CFG_ARES] = अणु0x1F004, 6पूर्ण,
	[GCC_WCSS_DBG_ARES] = अणु0x59008, 0पूर्ण,
	[GCC_WCSS_ECAHB_ARES] = अणु0x59008, 1पूर्ण,
	[GCC_WCSS_ACMT_ARES] = अणु0x59008, 2पूर्ण,
	[GCC_WCSS_DBG_BDG_ARES] = अणु0x59008, 3पूर्ण,
	[GCC_WCSS_AHB_S_ARES] = अणु0x59008, 4पूर्ण,
	[GCC_WCSS_AXI_M_ARES] = अणु0x59008, 5पूर्ण,
	[GCC_Q6SS_DBG_ARES] = अणु0x59110, 0पूर्ण,
	[GCC_Q6_AHB_S_ARES] = अणु0x59110, 1पूर्ण,
	[GCC_Q6_AHB_ARES] = अणु0x59110, 2पूर्ण,
	[GCC_Q6_AXIM2_ARES] = अणु0x59110, 3पूर्ण,
	[GCC_Q6_AXIM_ARES] = अणु0x59110, 4पूर्ण,
पूर्ण;

अटल स्थिर काष्ठा of_device_id gcc_ipq6018_match_table[] = अणु
	अणु .compatible = "qcom,gcc-ipq6018" पूर्ण,
	अणु पूर्ण
पूर्ण;
MODULE_DEVICE_TABLE(of, gcc_ipq6018_match_table);

अटल स्थिर काष्ठा regmap_config gcc_ipq6018_regmap_config = अणु
	.reg_bits       = 32,
	.reg_stride     = 4,
	.val_bits       = 32,
...
अटल स्थिर काष्ठा qcom_cc_desc gcc_ipq6018_desc = अणु
...
अटल पूर्णांक gcc_ipq6018_probe(काष्ठा platक्रमm_device *pdev)
अणु
	...
	/* Disable SW_COLLAPSE क्रम USB0 GDSCR */
	regmap_update_bits(regmap, 0x3e078, BIT(0), 0x0);
	/* Enable SW_OVERRIDE क्रम USB0 GDSCR */
	regmap_update_bits(regmap, 0x3e078, BIT(2), BIT(2));
	/* Disable SW_COLLAPSE क्रम USB1 GDSCR */
	regmap_update_bits(regmap, 0x3f078, BIT(0), 0x0);
	/* Enable SW_OVERRIDE क्रम USB1 GDSCR */
	regmap_update_bits(regmap, 0x3f078, BIT(2), BIT(2));

	/* SW Workaround क्रम UBI Huyara PLL */
	regmap_update_bits(regmap, 0x2501c, BIT(26), BIT(26));

	clk_alpha_pll_configure(&ubi32_pll_मुख्य, regmap, &ubi32_pll_config);

	clk_alpha_pll_configure(&nss_crypto_pll_मुख्य, regmap,
				&nss_crypto_pll_config);

	वापस qcom_cc_really_probe(pdev, &gcc_ipq6018_desc, regmap);
पूर्ण

अटल काष्ठा platक्रमm_driver gcc_ipq6018_driver = अणु
...
अटल पूर्णांक __init gcc_ipq6018_init(व्योम)
अणु
	वापस platक्रमm_driver_रेजिस्टर(&gcc_ipq6018_driver);
पूर्ण
core_initcall(gcc_ipq6018_init);

अटल व्योम __निकास gcc_ipq6018_निकास(व्योम)
अणु
	platक्रमm_driver_unरेजिस्टर(&gcc_ipq6018_driver);
पूर्ण
module_निकास(gcc_ipq6018_निकास);
