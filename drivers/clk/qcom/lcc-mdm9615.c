...
#समावेश <dt-bindings/घड़ी/qcom,lcc-mdm9615.h>
...
अटल स्थिर काष्ठा parent_map lcc_cxo_pll4_map[] = अणु
	अणु P_CXO, 0 पूर्ण,
	अणु P_PLL4, 2 पूर्ण
पूर्ण;

अटल स्थिर अक्षर * स्थिर lcc_cxo_pll4[] = अणु
	"cxo",
	"pll4_vote",
पूर्ण;
...
अटल काष्ठा freq_tbl clk_tbl_aअगर_osr_492[] = अणु
	...
	अणु 27000000, P_CXO,  1, 0,   0 पूर्ण,
	अणु पूर्ण
पूर्ण;
...
अटल काष्ठा clk_regmap *lcc_mdm9615_clks[] = अणु
	[PLL4] = &pll4.clkr,
...
अटल स्थिर काष्ठा regmap_config lcc_mdm9615_regmap_config = अणु
	.reg_bits	= 32,
	.reg_stride	= 4,
	.val_bits	= 32,
	.max_रेजिस्टर	= 0xfc,
...
अटल स्थिर काष्ठा qcom_cc_desc lcc_mdm9615_desc = अणु
	.config = &lcc_mdm9615_regmap_config,
	.clks = lcc_mdm9615_clks,
	.num_clks = ARRAY_SIZE(lcc_mdm9615_clks),
पूर्ण;

अटल स्थिर काष्ठा of_device_id lcc_mdm9615_match_table[] = अणु
	अणु .compatible = "qcom,lcc-mdm9615" पूर्ण,
	अणु पूर्ण
पूर्ण;
MODULE_DEVICE_TABLE(of, lcc_mdm9615_match_table);

अटल पूर्णांक lcc_mdm9615_probe(काष्ठा platक्रमm_device *pdev)
अणु
	u32 val;
	...
	वापस qcom_cc_really_probe(pdev, &lcc_mdm9615_desc, regmap);
पूर्ण

अटल काष्ठा platक्रमm_driver lcc_mdm9615_driver = अणु
	...
	पूर्ण,
पूर्ण;
module_platक्रमm_driver(lcc_mdm9615_driver);
