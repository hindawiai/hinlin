<शैली गुरु>
/*
 * pxa168 घड़ी framework source file
 *
...
#समावेश <dt-bindings/घड़ी/marvell,pxa168.h>
...
#घोषणा APBC_TIMER	0x34
#घोषणा APBC_SSP0	0x81c
#घोषणा APBC_SSP1	0x820
#घोषणा APBC_SSP2	0x84c
#घोषणा APBC_SSP3	0x858
#घोषणा APBC_SSP4	0x85c
#घोषणा APBC_TWSI1	0x6c
#घोषणा APBC_UART2	0x70
...
अटल काष्ठा mmp_param_fixed_rate_clk fixed_rate_clks[] = अणु
	अणुPXA168_CLK_CLK32, "clk32", शून्य, 0, 32768पूर्ण,
	अणुPXA168_CLK_VCTCXO, "vctcxo", शून्य, 0, 26000000पूर्ण,
	अणुPXA168_CLK_PLL1, "pll1", शून्य, 0, 624000000पूर्ण,
	अणुPXA168_CLK_USB_PLL, "usb_pll", शून्य, 0, 480000000पूर्ण,
पूर्ण;

अटल काष्ठा mmp_param_fixed_factor_clk fixed_factor_clks[] = अणु
	अणुPXA168_CLK_PLL1_2, "pll1_2", "pll1", 1, 2, 0पूर्ण,
	अणुPXA168_CLK_PLL1_4, "pll1_4", "pll1_2", 1, 2, 0पूर्ण,
	अणुPXA168_CLK_PLL1_8, "pll1_8", "pll1_4", 1, 2, 0पूर्ण,
	अणुPXA168_CLK_PLL1_16, "pll1_16", "pll1_8", 1, 2, 0पूर्ण,
	अणुPXA168_CLK_PLL1_6, "pll1_6", "pll1_2", 1, 3, 0पूर्ण,
	अणुPXA168_CLK_PLL1_12, "pll1_12", "pll1_6", 1, 2, 0पूर्ण,
	अणुPXA168_CLK_PLL1_24, "pll1_24", "pll1_12", 1, 2, 0पूर्ण,
	अणुPXA168_CLK_PLL1_48, "pll1_48", "pll1_24", 1, 2, 0पूर्ण,
	अणुPXA168_CLK_PLL1_96, "pll1_96", "pll1_48", 1, 2, 0पूर्ण,
	अणुPXA168_CLK_PLL1_192, "pll1_192", "pll1_96", 1, 2, 0पूर्ण,
	अणुPXA168_CLK_PLL1_13, "pll1_13", "pll1", 1, 13, 0पूर्ण,
	अणुPXA168_CLK_PLL1_13_1_5, "pll1_13_1_5", "pll1_13", 2, 3, 0पूर्ण,
	अणुPXA168_CLK_PLL1_2_1_5, "pll1_2_1_5", "pll1_2", 2, 3, 0पूर्ण,
	अणुPXA168_CLK_PLL1_3_16, "pll1_3_16", "pll1", 3, 16, 0पूर्ण,
पूर्ण;
...
अटल व्योम pxa168_pll_init(काष्ठा pxa168_clk_unit *pxa_unit)
अणु
	काष्ठा clk *clk;
...
अटल DEFINE_SPINLOCK(ssp4_lock);
अटल स्थिर अक्षर *ssp_parent_names[] = अणु"pll1_96", "pll1_48", "pll1_24", "pll1_12"पूर्ण;

अटल DEFINE_SPINLOCK(समयr_lock);
अटल स्थिर अक्षर *समयr_parent_names[] = अणु"pll1_48", "clk32", "pll1_96", "pll1_192"पूर्ण;
...
अटल काष्ठा mmp_param_mux_clk apbc_mux_clks[] = अणु
	...
	अणु0, "ssp4_mux", ssp_parent_names, ARRAY_SIZE(ssp_parent_names), CLK_SET_RATE_PARENT, APBC_SSP4, 4, 3, 0, &ssp4_lockपूर्ण,
...
अटल काष्ठा mmp_param_gate_clk apbc_gate_clks[] = अणु
	अणुPXA168_CLK_TWSI0, "twsi0_clk", "pll1_13_1_5", CLK_SET_RATE_PARENT, APBC_TWSI0, 0x3, 0x3, 0x0, 0, &reset_lockपूर्ण,
	अणुPXA168_CLK_TWSI1, "twsi1_clk", "pll1_13_1_5", CLK_SET_RATE_PARENT, APBC_TWSI1, 0x3, 0x3, 0x0, 0, &reset_lockपूर्ण,
	अणुPXA168_CLK_GPIO, "gpio_clk", "vctcxo", CLK_SET_RATE_PARENT, APBC_GPIO, 0x3, 0x3, 0x0, 0, &reset_lockपूर्ण,
	अणुPXA168_CLK_KPC, "kpc_clk", "clk32", CLK_SET_RATE_PARENT, APBC_KPC, 0x3, 0x3, 0x0, MMP_CLK_GATE_NEED_DELAY, शून्यपूर्ण,
	अणुPXA168_CLK_RTC, "rtc_clk", "clk32", CLK_SET_RATE_PARENT, APBC_RTC, 0x83, 0x83, 0x0, MMP_CLK_GATE_NEED_DELAY, शून्यपूर्ण,
	अणुPXA168_CLK_PWM0, "pwm0_clk", "pll1_48", CLK_SET_RATE_PARENT, APBC_PWM0, 0x3, 0x3, 0x0, 0, &reset_lockपूर्ण,
	अणुPXA168_CLK_PWM1, "pwm1_clk", "pll1_48", CLK_SET_RATE_PARENT, APBC_PWM1, 0x3, 0x3, 0x0, 0, &reset_lockपूर्ण,
	अणुPXA168_CLK_PWM2, "pwm2_clk", "pll1_48", CLK_SET_RATE_PARENT, APBC_PWM2, 0x3, 0x3, 0x0, 0, &reset_lockपूर्ण,
	अणुPXA168_CLK_PWM3, "pwm3_clk", "pll1_48", CLK_SET_RATE_PARENT, APBC_PWM3, 0x3, 0x3, 0x0, 0, &reset_lockपूर्ण,
	/* The gate घड़ीs has mux parent. */
	अणुPXA168_CLK_UART0, "uart0_clk", "uart0_mux", CLK_SET_RATE_PARENT, APBC_UART0, 0x3, 0x3, 0x0, 0, &uart0_lockपूर्ण,
	अणुPXA168_CLK_UART1, "uart1_clk", "uart1_mux", CLK_SET_RATE_PARENT, APBC_UART1, 0x3, 0x3, 0x0, 0, &uart1_lockपूर्ण,
	अणुPXA168_CLK_UART2, "uart2_clk", "uart2_mux", CLK_SET_RATE_PARENT, APBC_UART2, 0x3, 0x3, 0x0, 0, &uart2_lockपूर्ण,
	अणुPXA168_CLK_SSP0, "ssp0_clk", "ssp0_mux", CLK_SET_RATE_PARENT, APBC_SSP0, 0x3, 0x3, 0x0, 0, &ssp0_lockपूर्ण,
	अणुPXA168_CLK_SSP1, "ssp1_clk", "ssp1_mux", CLK_SET_RATE_PARENT, APBC_SSP1, 0x3, 0x3, 0x0, 0, &ssp1_lockपूर्ण,
	अणुPXA168_CLK_SSP2, "ssp2_clk", "ssp2_mux", CLK_SET_RATE_PARENT, APBC_SSP2, 0x3, 0x3, 0x0, 0, &ssp2_lockपूर्ण,
	अणुPXA168_CLK_SSP3, "ssp3_clk", "ssp3_mux", CLK_SET_RATE_PARENT, APBC_SSP3, 0x3, 0x3, 0x0, 0, &ssp3_lockपूर्ण,
	अणुPXA168_CLK_SSP4, "ssp4_clk", "ssp4_mux", CLK_SET_RATE_PARENT, APBC_SSP4, 0x3, 0x3, 0x0, 0, &ssp4_lockपूर्ण,
	अणुPXA168_CLK_TIMER, "timer_clk", "timer_mux", CLK_SET_RATE_PARENT, APBC_TIMER, 0x3, 0x3, 0x0, 0, &समयr_lockपूर्ण,
पूर्ण;

अटल व्योम pxa168_apb_periph_clk_init(काष्ठा pxa168_clk_unit *pxa_unit)
अणु
	काष्ठा mmp_clk_unit *unit = &pxa_unit->unit;
...
अटल काष्ठा mmp_param_gate_clk apmu_gate_clks[] = अणु
	अणुPXA168_CLK_DFC, "dfc_clk", "pll1_4", CLK_SET_RATE_PARENT, APMU_DFC, 0x19b, 0x19b, 0x0, 0, शून्यपूर्ण,
	अणुPXA168_CLK_USB, "usb_clk", "usb_pll", 0, APMU_USB, 0x9, 0x9, 0x0, 0, &usb_lockपूर्ण,
	अणुPXA168_CLK_SPH, "sph_clk", "usb_pll", 0, APMU_USB, 0x12, 0x12, 0x0, 0, &usb_lockपूर्ण,
	/* The gate घड़ीs has mux parent. */
	अणुPXA168_CLK_SDH0, "sdh0_clk", "sdh0_mux", CLK_SET_RATE_PARENT, APMU_SDH0, 0x1b, 0x1b, 0x0, 0, &sdh0_lockपूर्ण,
	अणुPXA168_CLK_SDH1, "sdh1_clk", "sdh1_mux", CLK_SET_RATE_PARENT, APMU_SDH1, 0x1b, 0x1b, 0x0, 0, &sdh1_lockपूर्ण,
	अणुPXA168_CLK_DISP0, "disp0_clk", "disp0_mux", CLK_SET_RATE_PARENT, APMU_DISP0, 0x1b, 0x1b, 0x0, 0, &disp0_lockपूर्ण,
	अणुPXA168_CLK_CCIC0, "ccic0_clk", "ccic0_mux", CLK_SET_RATE_PARENT, APMU_CCIC0, 0x1b, 0x1b, 0x0, 0, &ccic0_lockपूर्ण,
	अणुPXA168_CLK_CCIC0_PHY, "ccic0_phy_clk", "ccic0_phy_mux", CLK_SET_RATE_PARENT, APMU_CCIC0, 0x24, 0x24, 0x0, 0, &ccic0_lockपूर्ण,
	अणुPXA168_CLK_CCIC0_SPHY, "ccic0_sphy_clk", "ccic0_sphy_div", CLK_SET_RATE_PARENT, APMU_CCIC0, 0x300, 0x300, 0x0, 0, &ccic0_lockपूर्ण,
पूर्ण;

अटल व्योम pxa168_axi_periph_clk_init(काष्ठा pxa168_clk_unit *pxa_unit)
अणु
	काष्ठा mmp_clk_unit *unit = &pxa_unit->unit;
...
अटल व्योम pxa168_clk_reset_init(काष्ठा device_node *np,
				काष्ठा pxa168_clk_unit *pxa_unit)
अणु
...
अटल व्योम __init pxa168_clk_init(काष्ठा device_node *np)
अणु
	काष्ठा pxa168_clk_unit *pxa_unit;
