...
#समावेश "clk.h"
#समावेश <dt-bindings/घड़ी/exynos7-clk.h>

/* Register Offset definitions क्रम CMU_TOPC (0x10570000) */
#घोषणा CC_PLL_LOCK		0x0000
#घोषणा BUS0_PLL_LOCK		0x0004
#घोषणा BUS1_DPLL_LOCK		0x0008
#घोषणा MFC_PLL_LOCK		0x000C
#घोषणा AUD_PLL_LOCK		0x0010
#घोषणा CC_PLL_CON0		0x0100
#घोषणा BUS0_PLL_CON0		0x0110
#घोषणा BUS1_DPLL_CON0		0x0120
#घोषणा MFC_PLL_CON0		0x0130
#घोषणा AUD_PLL_CON0		0x0140
#घोषणा MUX_SEL_TOPC0		0x0200
#घोषणा MUX_SEL_TOPC1		0x0204
#घोषणा MUX_SEL_TOPC2		0x0208
#घोषणा MUX_SEL_TOPC3		0x020C
#घोषणा DIV_TOPC0		0x0600
#घोषणा DIV_TOPC1		0x0604
#घोषणा DIV_TOPC3		0x060C
#घोषणा ENABLE_ACLK_TOPC0	0x0800
#घोषणा ENABLE_ACLK_TOPC1	0x0804
#घोषणा ENABLE_SCLK_TOPC1	0x0A04

अटल स्थिर काष्ठा samsung_fixed_factor_घड़ी topc_fixed_factor_clks[] __initस्थिर = अणु
...
/* List of parent घड़ीs क्रम Muxes in CMU_TOPC */
PNAME(mout_topc_aud_pll_ctrl_p)	= अणु "fin_pll", "fout_aud_pll" पूर्ण;
PNAME(mout_topc_bus0_pll_ctrl_p)	= अणु "fin_pll", "fout_bus0_pll" पूर्ण;
PNAME(mout_topc_bus1_pll_ctrl_p)	= अणु "fin_pll", "fout_bus1_pll" पूर्ण;
PNAME(mout_topc_cc_pll_ctrl_p)	= अणु "fin_pll", "fout_cc_pll" पूर्ण;
PNAME(mout_topc_mfc_pll_ctrl_p)	= अणु "fin_pll", "fout_mfc_pll" पूर्ण;

PNAME(mout_topc_group2) = अणु "mout_topc_bus0_pll_half",
	"mout_topc_bus1_pll_half", "mout_topc_cc_pll_half",
	"mout_topc_mfc_pll_half" पूर्ण;

PNAME(mout_topc_bus0_pll_half_p) = अणु "mout_topc_bus0_pll",
	"ffac_topc_bus0_pll_div2", "ffac_topc_bus0_pll_div4"पूर्ण;
PNAME(mout_topc_bus1_pll_half_p) = अणु "mout_topc_bus1_pll",
	"ffac_topc_bus1_pll_div2"पूर्ण;
PNAME(mout_topc_cc_pll_half_p) = अणु "mout_topc_cc_pll",
	"ffac_topc_cc_pll_div2"पूर्ण;
PNAME(mout_topc_mfc_pll_half_p) = अणु "mout_topc_mfc_pll",
	"ffac_topc_mfc_pll_div2"पूर्ण;


PNAME(mout_topc_bus0_pll_out_p) = अणु"mout_topc_bus0_pll",
	"ffac_topc_bus0_pll_div2"पूर्ण;

अटल स्थिर अचिन्हित दीर्घ topc_clk_regs[] __initस्थिर = अणु
	CC_PLL_LOCK,
	BUS0_PLL_LOCK,
	BUS1_DPLL_LOCK,
	MFC_PLL_LOCK,
...
अटल स्थिर काष्ठा samsung_mux_घड़ी topc_mux_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_भाग_घड़ी topc_भाग_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_pll_rate_table pll1460x_24mhz_tbl[] __initस्थिर = अणु
	PLL_36XX_RATE(24 * MHZ, 491519897, 20, 1, 0, 31457),
	अणुपूर्ण,
पूर्ण;

अटल स्थिर काष्ठा samsung_gate_घड़ी topc_gate_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_pll_घड़ी topc_pll_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_cmu_info topc_cmu_info __initस्थिर = अणु
	.pll_clks		= topc_pll_clks,
	.nr_pll_clks		= ARRAY_SIZE(topc_pll_clks),
	.mux_clks		= topc_mux_clks,
	.nr_mux_clks		= ARRAY_SIZE(topc_mux_clks),
	.भाग_clks		= topc_भाग_clks,
	.nr_भाग_clks		= ARRAY_SIZE(topc_भाग_clks),
...
अटल व्योम __init exynos7_clk_topc_init(काष्ठा device_node *np)
अणु
	samsung_cmu_रेजिस्टर_one(np, &topc_cmu_info);
पूर्ण

CLK_OF_DECLARE(exynos7_clk_topc, "samsung,exynos7-clock-topc",
	exynos7_clk_topc_init);

/* Register Offset definitions क्रम CMU_TOP0 (0x105D0000) */
#घोषणा MUX_SEL_TOP00			0x0200
#घोषणा MUX_SEL_TOP01			0x0204
#घोषणा MUX_SEL_TOP03			0x020C
#घोषणा MUX_SEL_TOP0_PERIC0		0x0230
#घोषणा MUX_SEL_TOP0_PERIC1		0x0234
#घोषणा MUX_SEL_TOP0_PERIC2		0x0238
#घोषणा MUX_SEL_TOP0_PERIC3		0x023C
#घोषणा DIV_TOP03			0x060C
#घोषणा DIV_TOP0_PERIC0			0x0630
#घोषणा DIV_TOP0_PERIC1			0x0634
#घोषणा DIV_TOP0_PERIC2			0x0638
#घोषणा DIV_TOP0_PERIC3			0x063C
#घोषणा ENABLE_ACLK_TOP03		0x080C
#घोषणा ENABLE_SCLK_TOP0_PERIC0		0x0A30
#घोषणा ENABLE_SCLK_TOP0_PERIC1		0x0A34
#घोषणा ENABLE_SCLK_TOP0_PERIC2		0x0A38
#घोषणा ENABLE_SCLK_TOP0_PERIC3		0x0A3C

/* List of parent घड़ीs क्रम Muxes in CMU_TOP0 */
PNAME(mout_top0_bus0_pll_user_p)	= अणु "fin_pll", "sclk_bus0_pll_a" पूर्ण;
PNAME(mout_top0_bus1_pll_user_p)	= अणु "fin_pll", "sclk_bus1_pll_a" पूर्ण;
PNAME(mout_top0_cc_pll_user_p)	= अणु "fin_pll", "sclk_cc_pll_a" पूर्ण;
PNAME(mout_top0_mfc_pll_user_p)	= अणु "fin_pll", "sclk_mfc_pll_a" पूर्ण;
PNAME(mout_top0_aud_pll_user_p)	= अणु "fin_pll", "sclk_aud_pll" पूर्ण;

PNAME(mout_top0_bus0_pll_half_p) = अणु"mout_top0_bus0_pll_user",
	"ffac_top0_bus0_pll_div2"पूर्ण;
PNAME(mout_top0_bus1_pll_half_p) = अणु"mout_top0_bus1_pll_user",
	"ffac_top0_bus1_pll_div2"पूर्ण;
PNAME(mout_top0_cc_pll_half_p) = अणु"mout_top0_cc_pll_user",
	"ffac_top0_cc_pll_div2"पूर्ण;
PNAME(mout_top0_mfc_pll_half_p) = अणु"mout_top0_mfc_pll_user",
	"ffac_top0_mfc_pll_div2"पूर्ण;

PNAME(mout_top0_group1) = अणु"mout_top0_bus0_pll_half",
	"mout_top0_bus1_pll_half", "mout_top0_cc_pll_half",
	"mout_top0_mfc_pll_half"पूर्ण;
PNAME(mout_top0_group3) = अणु"ioclk_audiocdclk0",
	"ioclk_audiocdclk1", "ioclk_spdif_extclk",
	"mout_top0_aud_pll_user", "mout_top0_bus0_pll_half",
	"mout_top0_bus1_pll_half"पूर्ण;
PNAME(mout_top0_group4) = अणु"ioclk_audiocdclk1", "mout_top0_aud_pll_user",
	"mout_top0_bus0_pll_half", "mout_top0_bus1_pll_half"पूर्ण;

अटल स्थिर अचिन्हित दीर्घ top0_clk_regs[] __initस्थिर = अणु
	MUX_SEL_TOP00,
	MUX_SEL_TOP01,
	MUX_SEL_TOP03,
	MUX_SEL_TOP0_PERIC0,
...
अटल स्थिर काष्ठा samsung_mux_घड़ी top0_mux_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_भाग_घड़ी top0_भाग_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_gate_घड़ी top0_gate_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_fixed_factor_घड़ी top0_fixed_factor_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_cmu_info top0_cmu_info __initस्थिर = अणु
	.mux_clks		= top0_mux_clks,
	.nr_mux_clks		= ARRAY_SIZE(top0_mux_clks),
	.भाग_clks		= top0_भाग_clks,
	.nr_भाग_clks		= ARRAY_SIZE(top0_भाग_clks),
...
अटल व्योम __init exynos7_clk_top0_init(काष्ठा device_node *np)
अणु
	samsung_cmu_रेजिस्टर_one(np, &top0_cmu_info);
पूर्ण

CLK_OF_DECLARE(exynos7_clk_top0, "samsung,exynos7-clock-top0",
	exynos7_clk_top0_init);

/* Register Offset definitions क्रम CMU_TOP1 (0x105E0000) */
#घोषणा MUX_SEL_TOP10			0x0200
#घोषणा MUX_SEL_TOP11			0x0204
#घोषणा MUX_SEL_TOP13			0x020C
#घोषणा MUX_SEL_TOP1_FSYS0		0x0224
#घोषणा MUX_SEL_TOP1_FSYS1		0x0228
#घोषणा MUX_SEL_TOP1_FSYS11		0x022C
#घोषणा DIV_TOP13			0x060C
#घोषणा DIV_TOP1_FSYS0			0x0624
#घोषणा DIV_TOP1_FSYS1			0x0628
#घोषणा DIV_TOP1_FSYS11			0x062C
#घोषणा ENABLE_ACLK_TOP13		0x080C
#घोषणा ENABLE_SCLK_TOP1_FSYS0		0x0A24
#घोषणा ENABLE_SCLK_TOP1_FSYS1		0x0A28
#घोषणा ENABLE_SCLK_TOP1_FSYS11		0x0A2C

/* List of parent घड़ीs क्रम Muxes in CMU_TOP1 */
PNAME(mout_top1_bus0_pll_user_p)	= अणु "fin_pll", "sclk_bus0_pll_b" पूर्ण;
PNAME(mout_top1_bus1_pll_user_p)	= अणु "fin_pll", "sclk_bus1_pll_b" पूर्ण;
PNAME(mout_top1_cc_pll_user_p)	= अणु "fin_pll", "sclk_cc_pll_b" पूर्ण;
PNAME(mout_top1_mfc_pll_user_p)	= अणु "fin_pll", "sclk_mfc_pll_b" पूर्ण;

PNAME(mout_top1_bus0_pll_half_p) = अणु"mout_top1_bus0_pll_user",
	"ffac_top1_bus0_pll_div2"पूर्ण;
PNAME(mout_top1_bus1_pll_half_p) = अणु"mout_top1_bus1_pll_user",
	"ffac_top1_bus1_pll_div2"पूर्ण;
PNAME(mout_top1_cc_pll_half_p) = अणु"mout_top1_cc_pll_user",
	"ffac_top1_cc_pll_div2"पूर्ण;
PNAME(mout_top1_mfc_pll_half_p) = अणु"mout_top1_mfc_pll_user",
	"ffac_top1_mfc_pll_div2"पूर्ण;

PNAME(mout_top1_group1) = अणु"mout_top1_bus0_pll_half",
	"mout_top1_bus1_pll_half", "mout_top1_cc_pll_half",
	"mout_top1_mfc_pll_half"पूर्ण;

अटल स्थिर अचिन्हित दीर्घ top1_clk_regs[] __initस्थिर = अणु
	MUX_SEL_TOP10,
	MUX_SEL_TOP11,
	MUX_SEL_TOP13,
	MUX_SEL_TOP1_FSYS0,
...
अटल स्थिर काष्ठा samsung_mux_घड़ी top1_mux_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_भाग_घड़ी top1_भाग_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_gate_घड़ी top1_gate_clks[] __initस्थिर = अणु
	...
	GATE(CLK_ACLK_FSYS0_200, "aclk_fsys0_200", "dout_aclk_fsys0_200",
		...
		CLK_IS_CRITICAL, 0),
	/*
	 * This घड़ी is required क्रम the CMU_FSYS1 रेजिस्टरs access, keep it
	 * enabled permanently until proper runसमय PM support is added.
	 */
...
अटल स्थिर काष्ठा samsung_fixed_factor_घड़ी top1_fixed_factor_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_cmu_info top1_cmu_info __initस्थिर = अणु
	.mux_clks		= top1_mux_clks,
	.nr_mux_clks		= ARRAY_SIZE(top1_mux_clks),
	.भाग_clks		= top1_भाग_clks,
	.nr_भाग_clks		= ARRAY_SIZE(top1_भाग_clks),
...
अटल व्योम __init exynos7_clk_top1_init(काष्ठा device_node *np)
अणु
	samsung_cmu_रेजिस्टर_one(np, &top1_cmu_info);
पूर्ण

CLK_OF_DECLARE(exynos7_clk_top1, "samsung,exynos7-clock-top1",
	exynos7_clk_top1_init);

/* Register Offset definitions क्रम CMU_CCORE (0x105B0000) */
#घोषणा MUX_SEL_CCORE			0x0200
#घोषणा DIV_CCORE			0x0600
#घोषणा ENABLE_ACLK_CCORE0		0x0800
#घोषणा ENABLE_ACLK_CCORE1		0x0804
#घोषणा ENABLE_PCLK_CCORE		0x0900

/*
 * List of parent घड़ीs क्रम Muxes in CMU_CCORE
 */
PNAME(mout_aclk_ccore_133_user_p)	= अणु "fin_pll", "aclk_ccore_133" पूर्ण;

अटल स्थिर अचिन्हित दीर्घ ccore_clk_regs[] __initस्थिर = अणु
	MUX_SEL_CCORE,
	ENABLE_PCLK_CCORE,
पूर्ण;

अटल स्थिर काष्ठा samsung_mux_घड़ी ccore_mux_clks[] __initस्थिर = अणु
	MUX(0, "mout_aclk_ccore_133_user", mout_aclk_ccore_133_user_p,
		MUX_SEL_CCORE, 1, 1),
पूर्ण;

अटल स्थिर काष्ठा samsung_gate_घड़ी ccore_gate_clks[] __initस्थिर = अणु
	GATE(PCLK_RTC, "pclk_rtc", "mout_aclk_ccore_133_user",
		ENABLE_PCLK_CCORE, 8, 0, 0),
पूर्ण;

अटल स्थिर काष्ठा samsung_cmu_info ccore_cmu_info __initस्थिर = अणु
...
अटल व्योम __init exynos7_clk_ccore_init(काष्ठा device_node *np)
अणु
	samsung_cmu_रेजिस्टर_one(np, &ccore_cmu_info);
पूर्ण

CLK_OF_DECLARE(exynos7_clk_ccore, "samsung,exynos7-clock-ccore",
	exynos7_clk_ccore_init);

/* Register Offset definitions क्रम CMU_PERIC0 (0x13610000) */
#घोषणा MUX_SEL_PERIC0			0x0200
#घोषणा ENABLE_PCLK_PERIC0		0x0900
#घोषणा ENABLE_SCLK_PERIC0		0x0A00

/* List of parent घड़ीs क्रम Muxes in CMU_PERIC0 */
PNAME(mout_aclk_peric0_66_user_p)	= अणु "fin_pll", "aclk_peric0_66" पूर्ण;
PNAME(mout_sclk_uart0_user_p)	= अणु "fin_pll", "sclk_uart0" पूर्ण;

अटल स्थिर अचिन्हित दीर्घ peric0_clk_regs[] __initस्थिर = अणु
	MUX_SEL_PERIC0,
	ENABLE_PCLK_PERIC0,
	ENABLE_SCLK_PERIC0,
पूर्ण;

अटल स्थिर काष्ठा samsung_mux_घड़ी peric0_mux_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_gate_घड़ी peric0_gate_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_cmu_info peric0_cmu_info __initस्थिर = अणु
...
अटल व्योम __init exynos7_clk_peric0_init(काष्ठा device_node *np)
अणु
	samsung_cmu_रेजिस्टर_one(np, &peric0_cmu_info);
पूर्ण

/* Register Offset definitions क्रम CMU_PERIC1 (0x14C80000) */
#घोषणा MUX_SEL_PERIC10			0x0200
#घोषणा MUX_SEL_PERIC11			0x0204
#घोषणा MUX_SEL_PERIC12			0x0208
#घोषणा ENABLE_PCLK_PERIC1		0x0900
#घोषणा ENABLE_SCLK_PERIC10		0x0A00

CLK_OF_DECLARE(exynos7_clk_peric0, "samsung,exynos7-clock-peric0",
	exynos7_clk_peric0_init);

/* List of parent घड़ीs क्रम Muxes in CMU_PERIC1 */
PNAME(mout_aclk_peric1_66_user_p)	= अणु "fin_pll", "aclk_peric1_66" पूर्ण;
PNAME(mout_sclk_uart1_user_p)	= अणु "fin_pll", "sclk_uart1" पूर्ण;
PNAME(mout_sclk_uart2_user_p)	= अणु "fin_pll", "sclk_uart2" पूर्ण;
PNAME(mout_sclk_uart3_user_p)	= अणु "fin_pll", "sclk_uart3" पूर्ण;
PNAME(mout_sclk_spi0_user_p)		= अणु "fin_pll", "sclk_spi0" पूर्ण;
PNAME(mout_sclk_spi1_user_p)		= अणु "fin_pll", "sclk_spi1" पूर्ण;
PNAME(mout_sclk_spi2_user_p)		= अणु "fin_pll", "sclk_spi2" पूर्ण;
PNAME(mout_sclk_spi3_user_p)		= अणु "fin_pll", "sclk_spi3" पूर्ण;
PNAME(mout_sclk_spi4_user_p)		= अणु "fin_pll", "sclk_spi4" पूर्ण;

अटल स्थिर अचिन्हित दीर्घ peric1_clk_regs[] __initस्थिर = अणु
	MUX_SEL_PERIC10,
	MUX_SEL_PERIC11,
	MUX_SEL_PERIC12,
	ENABLE_PCLK_PERIC1,
...
अटल स्थिर काष्ठा samsung_mux_घड़ी peric1_mux_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_gate_घड़ी peric1_gate_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_cmu_info peric1_cmu_info __initस्थिर = अणु
...
अटल व्योम __init exynos7_clk_peric1_init(काष्ठा device_node *np)
अणु
	samsung_cmu_रेजिस्टर_one(np, &peric1_cmu_info);
पूर्ण

CLK_OF_DECLARE(exynos7_clk_peric1, "samsung,exynos7-clock-peric1",
	exynos7_clk_peric1_init);

/* Register Offset definitions क्रम CMU_PERIS (0x10040000) */
#घोषणा MUX_SEL_PERIS			0x0200
#घोषणा ENABLE_PCLK_PERIS		0x0900
#घोषणा ENABLE_PCLK_PERIS_SECURE_CHIPID	0x0910
#घोषणा ENABLE_SCLK_PERIS		0x0A00
#घोषणा ENABLE_SCLK_PERIS_SECURE_CHIPID	0x0A10

/* List of parent घड़ीs क्रम Muxes in CMU_PERIS */
PNAME(mout_aclk_peris_66_user_p) = अणु "fin_pll", "aclk_peris_66" पूर्ण;
...
अटल स्थिर काष्ठा samsung_mux_घड़ी peris_mux_clks[] __initस्थिर = अणु
...
अटल व्योम __init exynos7_clk_peris_init(काष्ठा device_node *np)
अणु
...
/* Register Offset definitions क्रम CMU_FSYS0 (0x10E90000) */
#घोषणा MUX_SEL_FSYS00			0x0200
#घोषणा MUX_SEL_FSYS01			0x0204
#घोषणा MUX_SEL_FSYS02			0x0208
#घोषणा ENABLE_ACLK_FSYS00		0x0800
#घोषणा ENABLE_ACLK_FSYS01		0x0804
#घोषणा ENABLE_SCLK_FSYS01		0x0A04
#घोषणा ENABLE_SCLK_FSYS02		0x0A08
#घोषणा ENABLE_SCLK_FSYS04		0x0A10

/*
 * List of parent घड़ीs क्रम Muxes in CMU_FSYS0
 */
PNAME(mout_aclk_fsys0_200_user_p)	= अणु "fin_pll", "aclk_fsys0_200" पूर्ण;
PNAME(mout_sclk_mmc2_user_p)		= अणु "fin_pll", "sclk_mmc2" पूर्ण;

PNAME(mout_sclk_usbdrd300_user_p)	= अणु "fin_pll", "sclk_usbdrd300" पूर्ण;
PNAME(mout_phyclk_usbdrd300_udrd30_phyclk_user_p)	= अणु "fin_pll",
				"phyclk_usbdrd300_udrd30_phyclock" पूर्ण;
PNAME(mout_phyclk_usbdrd300_udrd30_pipe_pclk_user_p)	= अणु "fin_pll",
				"phyclk_usbdrd300_udrd30_pipe_pclk" पूर्ण;

/* fixed rate घड़ीs used in the FSYS0 block */
अटल स्थिर काष्ठा samsung_fixed_rate_घड़ी fixed_rate_clks_fsys0[] __initस्थिर = अणु
	FRATE(0, "phyclk_usbdrd300_udrd30_phyclock", शून्य, 0, 60000000),
	FRATE(0, "phyclk_usbdrd300_udrd30_pipe_pclk", शून्य, 0, 125000000),
पूर्ण;

अटल स्थिर अचिन्हित दीर्घ fsys0_clk_regs[] __initस्थिर = अणु
	MUX_SEL_FSYS00,
	MUX_SEL_FSYS01,
	MUX_SEL_FSYS02,
	ENABLE_ACLK_FSYS00,
...
अटल स्थिर काष्ठा samsung_mux_घड़ी fsys0_mux_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_gate_घड़ी fsys0_gate_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_cmu_info fsys0_cmu_info __initस्थिर = अणु
...
अटल व्योम __init exynos7_clk_fsys0_init(काष्ठा device_node *np)
अणु
	samsung_cmu_रेजिस्टर_one(np, &fsys0_cmu_info);
पूर्ण

CLK_OF_DECLARE(exynos7_clk_fsys0, "samsung,exynos7-clock-fsys0",
	exynos7_clk_fsys0_init);

/* Register Offset definitions क्रम CMU_FSYS1 (0x156E0000) */
#घोषणा MUX_SEL_FSYS10			0x0200
#घोषणा MUX_SEL_FSYS11			0x0204
#घोषणा MUX_SEL_FSYS12			0x0208
#घोषणा DIV_FSYS1			0x0600
#घोषणा ENABLE_ACLK_FSYS1		0x0800
#घोषणा ENABLE_PCLK_FSYS1               0x0900
#घोषणा ENABLE_SCLK_FSYS11              0x0A04
#घोषणा ENABLE_SCLK_FSYS12              0x0A08
#घोषणा ENABLE_SCLK_FSYS13              0x0A0C

/*
 * List of parent घड़ीs क्रम Muxes in CMU_FSYS1
 */
PNAME(mout_aclk_fsys1_200_user_p)	= अणु "fin_pll", "aclk_fsys1_200" पूर्ण;
PNAME(mout_fsys1_group_p)	= अणु "fin_pll", "fin_pll_26m",
				"sclk_phy_fsys1_26m" पूर्ण;
PNAME(mout_sclk_mmc0_user_p)		= अणु "fin_pll", "sclk_mmc0" पूर्ण;
PNAME(mout_sclk_mmc1_user_p)		= अणु "fin_pll", "sclk_mmc1" पूर्ण;
PNAME(mout_sclk_ufsunipro20_user_p)  = अणु "fin_pll", "sclk_ufsunipro20" पूर्ण;
PNAME(mout_phyclk_ufs20_tx0_user_p) = अणु "fin_pll", "phyclk_ufs20_tx0_symbol" पूर्ण;
PNAME(mout_phyclk_ufs20_rx0_user_p) = अणु "fin_pll", "phyclk_ufs20_rx0_symbol" पूर्ण;
PNAME(mout_phyclk_ufs20_rx1_user_p) = अणु "fin_pll", "phyclk_ufs20_rx1_symbol" पूर्ण;

/* fixed rate घड़ीs used in the FSYS1 block */
अटल स्थिर काष्ठा samsung_fixed_rate_घड़ी fixed_rate_clks_fsys1[] __initस्थिर = अणु
	FRATE(PHYCLK_UFS20_TX0_SYMBOL, "phyclk_ufs20_tx0_symbol", शून्य,
			0, 300000000),
	FRATE(PHYCLK_UFS20_RX0_SYMBOL, "phyclk_ufs20_rx0_symbol", शून्य,
			0, 300000000),
	FRATE(PHYCLK_UFS20_RX1_SYMBOL, "phyclk_ufs20_rx1_symbol", शून्य,
			0, 300000000),
पूर्ण;

अटल स्थिर अचिन्हित दीर्घ fsys1_clk_regs[] __initस्थिर = अणु
	MUX_SEL_FSYS10,
	MUX_SEL_FSYS11,
	MUX_SEL_FSYS12,
	DIV_FSYS1,
...
अटल स्थिर काष्ठा samsung_mux_घड़ी fsys1_mux_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_भाग_घड़ी fsys1_भाग_clks[] __initस्थिर = अणु
	DIV(DOUT_PCLK_FSYS1, "dout_pclk_fsys1", "mout_aclk_fsys1_200_user",
		DIV_FSYS1, 0, 2),
पूर्ण;

अटल स्थिर काष्ठा samsung_gate_घड़ी fsys1_gate_clks[] __initस्थिर = अणु
...
अटल स्थिर काष्ठा samsung_cmu_info fsys1_cmu_info __initस्थिर = अणु
	.fixed_clks		= fixed_rate_clks_fsys1,
	.nr_fixed_clks		= ARRAY_SIZE(fixed_rate_clks_fsys1),
	.mux_clks		= fsys1_mux_clks,
	.nr_mux_clks		= ARRAY_SIZE(fsys1_mux_clks),
	.भाग_clks		= fsys1_भाग_clks,
	.nr_भाग_clks		= ARRAY_SIZE(fsys1_भाग_clks),
...
अटल व्योम __init exynos7_clk_fsys1_init(काष्ठा device_node *np)
अणु
	samsung_cmu_रेजिस्टर_one(np, &fsys1_cmu_info);
पूर्ण

CLK_OF_DECLARE(exynos7_clk_fsys1, "samsung,exynos7-clock-fsys1",
	exynos7_clk_fsys1_init);

#घोषणा MUX_SEL_MSCL			0x0200
#घोषणा DIV_MSCL			0x0600
#घोषणा ENABLE_ACLK_MSCL		0x0800
#घोषणा ENABLE_PCLK_MSCL		0x0900

/* List of parent घड़ीs क्रम Muxes in CMU_MSCL */
PNAME(mout_aclk_mscl_532_user_p)	= अणु "fin_pll", "aclk_mscl_532" पूर्ण;
...
अटल व्योम __init exynos7_clk_mscl_init(काष्ठा device_node *np)
अणु
	samsung_cmu_रेजिस्टर_one(np, &mscl_cmu_info);
पूर्ण

CLK_OF_DECLARE(exynos7_clk_mscl, "samsung,exynos7-clock-mscl",
		exynos7_clk_mscl_init);

/* Register Offset definitions क्रम CMU_AUD (0x114C0000) */
...
#घोषणा	ENABLE_SCLK_AUD			0x0A00

/*
 * List of parent घड़ीs क्रम Muxes in CMU_AUD
 */
PNAME(mout_aud_pll_user_p) = अणु "fin_pll", "fout_aud_pll" पूर्ण;
PNAME(mout_aud_group_p) = अणु "dout_aud_cdclk", "ioclk_audiocdclk0" पूर्ण;
...
अटल व्योम __init exynos7_clk_aud_init(काष्ठा device_node *np)
अणु
	samsung_cmu_रेजिस्टर_one(np, &aud_cmu_info);
पूर्ण
