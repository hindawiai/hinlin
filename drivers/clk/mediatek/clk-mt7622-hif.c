...
अटल पूर्णांक clk_mt7622_ssusbsys_init(काष्ठा platक्रमm_device *pdev)
अणु
...
अटल पूर्णांक clk_mt7622_pciesys_init(काष्ठा platक्रमm_device *pdev)
अणु
	काष्ठा clk_onecell_data *clk_data;
	काष्ठा device_node *node = pdev->dev.of_node;
	पूर्णांक r;
...
अटल स्थिर काष्ठा of_device_id of_match_clk_mt7622_hअगर[] = अणु
	अणु
...
अटल पूर्णांक clk_mt7622_hअगर_probe(काष्ठा platक्रमm_device *pdev)
अणु
...
अटल काष्ठा platक्रमm_driver clk_mt7622_hअगर_drv = अणु
	.probe = clk_mt7622_hअगर_probe,
	.driver = अणु
		.name = "clk-mt7622-hif",
		.of_match_table = of_match_clk_mt7622_hअगर,
	पूर्ण,
पूर्ण;

builtin_platक्रमm_driver(clk_mt7622_hअगर_drv);
