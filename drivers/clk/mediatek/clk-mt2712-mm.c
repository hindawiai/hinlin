...
अटल स्थिर काष्ठा mtk_gate_regs mm2_cg_regs = अणु
	.set_ofs = 0x224,
	.clr_ofs = 0x228,
	.sta_ofs = 0x220,
पूर्ण;
...
#घोषणा GATE_MM2(_id, _name, _parent, _shअगरt) अणु	\
		.id = _id,				\
		.name = _name,				\
		.parent_name = _parent,			\
		.regs = &mm2_cg_regs,			\
...
अटल पूर्णांक clk_mt2712_mm_probe(काष्ठा platक्रमm_device *pdev)
अणु
...
अटल काष्ठा platक्रमm_driver clk_mt2712_mm_drv = अणु
...
builtin_platक्रमm_driver(clk_mt2712_mm_drv);
