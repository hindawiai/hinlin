...
#समावेश <dt-bindings/घड़ी/r8a7743-cpg-mssr.h>
...
अटल काष्ठा cpg_core_clk r8a7743_core_clks[] __initdata = अणु
...
अटल स्थिर काष्ठा mssr_mod_clk r8a7743_mod_clks[] __initस्थिर = अणु
...
अटल स्थिर अचिन्हित पूर्णांक r8a7743_crit_mod_clks[] __initस्थिर = अणु
	MOD_CLK_ID(402),	/* RWDT */
...
अटल पूर्णांक __init r8a7743_cpg_mssr_init(काष्ठा device *dev)
अणु
	...
	अगर (of_device_is_compatible(np, "renesas,r8a7744-cpg-mssr")) अणु
		/* RZ/G1N uses a 1/5 भागider क्रम ZG */
		क्रम (i = 0; i < ARRAY_SIZE(r8a7743_core_clks); i++)
			अगर (r8a7743_core_clks[i].id == R8A7743_CLK_ZG) अणु
				r8a7743_core_clks[i].भाग = 5;
				अवरोध;
			पूर्ण
	पूर्ण
...
स्थिर काष्ठा cpg_mssr_info r8a7743_cpg_mssr_info __initस्थिर = अणु
	/* Core Clocks */
