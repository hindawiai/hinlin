...
#समावेश <dt-bindings/घड़ी/r8a7796-cpg-mssr.h>
...
अटल स्थिर काष्ठा cpg_core_clk r8a7796_core_clks[] __initस्थिर = अणु
...
अटल काष्ठा mssr_mod_clk r8a7796_mod_clks[] __initdata = अणु
...
अटल स्थिर अचिन्हित पूर्णांक r8a7796_crit_mod_clks[] __initस्थिर = अणु
	MOD_CLK_ID(402),	/* RWDT */
...
पूर्ण;
	...
	/*
	 * Fixups क्रम R-Car M3-W+
	 */

अटल स्थिर अचिन्हित पूर्णांक r8a77961_mod_nullअगरy[] __initस्थिर = अणु
	MOD_CLK_ID(617),			/* FCPCI0  */
पूर्ण;

अटल पूर्णांक __init r8a7796_cpg_mssr_init(काष्ठा device *dev)
अणु
	...
	अगर (of_device_is_compatible(dev->of_node, "renesas,r8a77961-cpg-mssr"))
		mssr_mod_nullअगरy(r8a7796_mod_clks,
				 ARRAY_SIZE(r8a7796_mod_clks),
				 r8a77961_mod_nullअगरy,
				 ARRAY_SIZE(r8a77961_mod_nullअगरy));

	वापस rcar_gen3_cpg_init(cpg_pll_config, CLK_EXTALR, cpg_mode);
पूर्ण

स्थिर काष्ठा cpg_mssr_info r8a7796_cpg_mssr_info __initस्थिर = अणु
	/* Core Clocks */
