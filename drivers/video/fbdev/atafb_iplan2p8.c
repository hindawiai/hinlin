<शैली गुरु>
/*
 *  linux/drivers/video/iplan2p8.c -- Low level frame buffer operations क्रम
 *				      पूर्णांकerleaved bitplanes थ  la Atari (8
...
/* This expands a 8 bit color पूर्णांकo two दीर्घs क्रम two movepl (8 plane)
 * operations.
 */

व्योम atafb_iplan2p8_copyarea(काष्ठा fb_info *info, u_दीर्घ next_line,
