...
अटल अंतरभूत u16 DISPC_OVL_BASE(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		वापस 0x0080;
...
अटल अंतरभूत u16 DISPC_BA0_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
	हाल OMAP_DSS_VIDEO1:
...
अटल अंतरभूत u16 DISPC_BA1_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
	हाल OMAP_DSS_VIDEO1:
...
अटल अंतरभूत u16 DISPC_BA0_UV_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
अटल अंतरभूत u16 DISPC_BA1_UV_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
अटल अंतरभूत u16 DISPC_POS_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
	हाल OMAP_DSS_VIDEO1:
...
अटल अंतरभूत u16 DISPC_SIZE_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
	हाल OMAP_DSS_VIDEO1:
...
अटल अंतरभूत u16 DISPC_ATTR_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		वापस 0x0020;
...
अटल अंतरभूत u16 DISPC_ATTR2_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
अटल अंतरभूत u16 DISPC_FIFO_THRESH_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		वापस 0x0024;
...
अटल अंतरभूत u16 DISPC_FIFO_SIZE_STATUS_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		वापस 0x0028;
...
अटल अंतरभूत u16 DISPC_ROW_INC_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		वापस 0x002C;
...
अटल अंतरभूत u16 DISPC_PIX_INC_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		वापस 0x0030;
...
अटल अंतरभूत u16 DISPC_WINDOW_SKIP_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		वापस 0x0034;
...
अटल अंतरभूत u16 DISPC_TABLE_BA_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		वापस 0x0038;
...
अटल अंतरभूत u16 DISPC_FIR_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
अटल अंतरभूत u16 DISPC_FIR2_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
अटल अंतरभूत u16 DISPC_PIC_SIZE_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
अटल अंतरभूत u16 DISPC_ACCU0_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
अटल अंतरभूत u16 DISPC_ACCU2_0_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
अटल अंतरभूत u16 DISPC_ACCU1_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
अटल अंतरभूत u16 DISPC_ACCU2_1_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
अटल अंतरभूत u16 DISPC_FIR_COEF_H_OFFSET(क्रमागत omap_plane plane, u16 i)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
/* coef index i = अणु0, 1, 2, 3, 4, 5, 6, 7पूर्ण */
अटल अंतरभूत u16 DISPC_FIR_COEF_H2_OFFSET(क्रमागत omap_plane plane, u16 i)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
/* coef index i = अणु0, 1, 2, 3, 4, 5, 6, 7पूर्ण */
अटल अंतरभूत u16 DISPC_FIR_COEF_HV_OFFSET(क्रमागत omap_plane plane, u16 i)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
/* coef index i = अणु0, 1, 2, 3, 4, 5, 6, 7पूर्ण */
अटल अंतरभूत u16 DISPC_FIR_COEF_HV2_OFFSET(क्रमागत omap_plane plane, u16 i)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
अटल अंतरभूत u16 DISPC_CONV_COEF_OFFSET(क्रमागत omap_plane plane, u16 i)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
/* coef index i = अणु0, 1, 2, 3, 4, 5, 6, 7पूर्ण */
अटल अंतरभूत u16 DISPC_FIR_COEF_V_OFFSET(क्रमागत omap_plane plane, u16 i)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
/* coef index i = अणु0, 1, 2, 3, 4, 5, 6, 7पूर्ण */
अटल अंतरभूत u16 DISPC_FIR_COEF_V2_OFFSET(क्रमागत omap_plane plane, u16 i)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		BUG();
...
अटल अंतरभूत u16 DISPC_PRELOAD_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		वापस 0x01AC;
...
अटल अंतरभूत u16 DISPC_MFLAG_THRESHOLD_OFFSET(क्रमागत omap_plane plane)
अणु
	चयन (plane) अणु
	हाल OMAP_DSS_GFX:
		वापस 0x0860;
