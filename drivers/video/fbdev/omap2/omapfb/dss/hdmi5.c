...
अणु
	...
	/* TODO: proper पूर्णांकerlace support */
...
अणु
	...
	r = hdmi5_पढ़ो_edid(&hdmi.core,  buf, len);
...
अणु
	वापस component_add(&pdev->dev, &hdmi5_component_ops);
पूर्ण
...
पूर्णांक __init hdmi5_init_platक्रमm_driver(व्योम)
अणु
