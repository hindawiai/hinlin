...
अणु
	...
	r = FLD_MOD(r, timings->पूर्णांकerlace, 3, 3);
...
अणु
	...
	अगर (param->timings.पूर्णांकerlace)
		video_fmt->y_res /= 2;
	...
	timings->पूर्णांकerlace = param->timings.पूर्णांकerlace;
पूर्ण
...
अणु
	...
	अगर (omapdss_get_version() == OMAPDSS_VER_OMAP4430_ES1 ||
	    omapdss_get_version() == OMAPDSS_VER_OMAP4430_ES2 ||
	    omapdss_get_version() == OMAPDSS_VER_OMAP4) अणु
