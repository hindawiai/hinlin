 ...
 * SOFTWARE.
 */
#अगर_अघोषित _CQ_EXCH_DESC_H_
#घोषणा _CQ_EXCH_DESC_H_

#समावेश "cq_desc.h"

/* Exchange completion queue descriptor: 16B */
काष्ठा cq_exch_wq_desc अणु
	u16 completed_index;
	u16 q_number;
	u16 exchange_id;
	u8  पंचांगpl;
...
#घोषणा CQ_EXCH_WQ_STATUS_BITS      2
#घोषणा CQ_EXCH_WQ_STATUS_MASK      ((1 << CQ_EXCH_WQ_STATUS_BITS) - 1)

क्रमागत cq_exch_status_types अणु
	CQ_EXCH_WQ_STATUS_TYPE_COMPLETE = 0,
	CQ_EXCH_WQ_STATUS_TYPE_ABORT = 1,
	CQ_EXCH_WQ_STATUS_TYPE_SGL_खातापूर्ण = 2,
	CQ_EXCH_WQ_STATUS_TYPE_TMPL_ERR = 3,
पूर्ण;

अटल अंतरभूत व्योम cq_exch_wq_desc_dec(काष्ठा cq_exch_wq_desc *desc_ptr,
				       u8  *type,
				       u8  *color,
				       u16 *q_number,
				       u16 *completed_index,
				       u8  *exch_status)
अणु
	cq_desc_dec((काष्ठा cq_desc *)desc_ptr, type,
		    color, q_number, completed_index);
	*exch_status = desc_ptr->exch_status & CQ_EXCH_WQ_STATUS_MASK;
पूर्ण

काष्ठा cq_fcp_rq_desc अणु
...
#घोषणा CQ_FCP_RQ_DESC_FLAGS_SOP		(1 << 15)
#घोषणा CQ_FCP_RQ_DESC_FLAGS_EOP		(1 << 14)
#घोषणा CQ_FCP_RQ_DESC_FLAGS_PRT		(1 << 12)
#घोषणा CQ_FCP_RQ_DESC_TMPL_MASK		0x1f
#घोषणा CQ_FCP_RQ_DESC_BYTES_WRITTEN_MASK	0x3fff
#घोषणा CQ_FCP_RQ_DESC_PACKET_ERR_SHIFT		14
#घोषणा CQ_FCP_RQ_DESC_PACKET_ERR_MASK (1 << CQ_FCP_RQ_DESC_PACKET_ERR_SHIFT)
#घोषणा CQ_FCP_RQ_DESC_VS_STRIPPED_SHIFT	15
#घोषणा CQ_FCP_RQ_DESC_VS_STRIPPED_MASK (1 << CQ_FCP_RQ_DESC_VS_STRIPPED_SHIFT)
#घोषणा CQ_FCP_RQ_DESC_FC_CRC_OK_MASK		0x1
#घोषणा CQ_FCP_RQ_DESC_FCOE_ERR_SHIFT		1
#घोषणा CQ_FCP_RQ_DESC_FCOE_ERR_MASK (1 << CQ_FCP_RQ_DESC_FCOE_ERR_SHIFT)
#घोषणा CQ_FCP_RQ_DESC_FCS_OK_SHIFT		7
#घोषणा CQ_FCP_RQ_DESC_FCS_OK_MASK (1 << CQ_FCP_RQ_DESC_FCS_OK_SHIFT)

अटल अंतरभूत व्योम cq_fcp_rq_desc_dec(काष्ठा cq_fcp_rq_desc *desc_ptr,
				      u8  *type,
				      u8  *color,
				      u16 *q_number,
				      u16 *completed_index,
...
अणु
	...
	*पंचांगpl = desc_ptr->पंचांगpl & CQ_FCP_RQ_DESC_TMPL_MASK;
	*bytes_written =
...
#घोषणा CQ_SGL_SGL_ERR_MASK             0x1f
#घोषणा CQ_SGL_TMPL_MASK                0x1f

अटल अंतरभूत व्योम cq_sgl_desc_dec(काष्ठा cq_sgl_desc *desc_ptr,
				   u8  *type,
				   u8  *color,
				   u16 *q_number,
				   u16 *exchange_id,
