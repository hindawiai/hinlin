...
अटल काष्ठा var_t vars[] = अणु
	अणु CAPS_START, .u.s = अणु"\x05\x31\x32P" पूर्ण पूर्ण,
	अणु CAPS_STOP, .u.s = अणु"\x05\x38P" पूर्ण पूर्ण,
	अणु RATE, .u.n = अणु"\x05%dE", 8, 1, 16, 0, 0, शून्य पूर्ण पूर्ण,
	अणु PITCH, .u.n = अणु"\x05%dP", 8, 0, 16, 0, 0, शून्य पूर्ण पूर्ण,
	अणु VOL, .u.n = अणु"\x05%dV", 8, 0, 16, 0, 0, शून्य पूर्ण पूर्ण,
	अणु TONE, .u.n = अणु"\x05%dT", 8, 0, 16, 0, 0, शून्य पूर्ण पूर्ण,
...
अटल काष्ठा spk_synth synth_bns = अणु
	.name = "bns",
	.version = DRV_VERSION,
	.दीर्घ_name = "Braille 'N Speak",
	.init = "\x05Z\x05\x43",
...
module_param_named(ser, synth_bns.ser, पूर्णांक, 0444);
module_param_named(dev, synth_bns.dev_name, अक्षरp, 0444);
module_param_named(start, synth_bns.startup, लघु, 0444);
