 ...
 * camss-vfe-4-8.c
 *
 * Qualcomm MSM Camera Subप्रणाली - VFE (Video Front End) Module v4.8
 *
...
#घोषणा VFE_0_BUS_BDG_QOS_CFG_3_CFG	0xaa55aaa5
#घोषणा VFE_0_BUS_BDG_QOS_CFG_4		0x414
#घोषणा VFE_0_BUS_BDG_QOS_CFG_4_CFG	0xaa55aa55
#घोषणा VFE_0_BUS_BDG_QOS_CFG_5		0x418
#घोषणा VFE_0_BUS_BDG_QOS_CFG_6		0x41c
#घोषणा VFE_0_BUS_BDG_QOS_CFG_7		0x420
#घोषणा VFE_0_BUS_BDG_QOS_CFG_7_CFG	0x0005aa55

#घोषणा VFE_0_BUS_BDG_DS_CFG_0		0x424
#घोषणा VFE_0_BUS_BDG_DS_CFG_0_CFG	0xcccc1111
...
#घोषणा VFE_0_BUS_BDG_DS_CFG_16_CFG	0x00000110
...
#घोषणा VFE_0_BUS_IMAGE_MASTER_CMD		0xcec
#घोषणा VFE_0_BUS_IMAGE_MASTER_n_SHIFT(x)	(2 * (x))
...
अटल व्योम vfe_wm_set_framedrop_pattern(काष्ठा vfe_device *vfe, u8 wm,
					 u32 pattern)
अणु
	ग_लिखोl_relaxed(pattern, vfe->base + VFE_0_BUS_IMAGE_MASTER_n_WR_FRAMEDROP_PATTERN(wm));
पूर्ण
...
अणु
	अगर (enable)
		ग_लिखोl_relaxed(2 << VFE_0_BUS_IMAGE_MASTER_n_SHIFT(wm),
			       vfe->base + VFE_0_BUS_IMAGE_MASTER_CMD);
	अन्यथा
		ग_लिखोl_relaxed(1 << VFE_0_BUS_IMAGE_MASTER_n_SHIFT(wm),
			       vfe->base + VFE_0_BUS_IMAGE_MASTER_CMD);

	/* The WM must be enabled beक्रमe sending other commands */
	wmb();
पूर्ण
...
अणु
	...
	ग_लिखोl_relaxed(val3, vfe->base + VFE_0_BUS_BDG_QOS_CFG_3);
	ग_लिखोl_relaxed(val4, vfe->base + VFE_0_BUS_BDG_QOS_CFG_4);
	ग_लिखोl_relaxed(val4, vfe->base + VFE_0_BUS_BDG_QOS_CFG_5);
	ग_लिखोl_relaxed(val4, vfe->base + VFE_0_BUS_BDG_QOS_CFG_6);
...
अटल स्थिर काष्ठा vfe_hw_ops_gen1 vfe_ops_gen1_4_8 = अणु
...
स्थिर काष्ठा vfe_hw_ops vfe_ops_4_8 = अणु
