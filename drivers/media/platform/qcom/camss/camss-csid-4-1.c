...
#घोषणा CAMSS_CSID_RST_CMD		0x00c
#घोषणा CAMSS_CSID_CID_LUT_VC_n(n)	(0x010 + 0x4 * (n))
#घोषणा CAMSS_CSID_CID_n_CFG(n)		(0x020 + 0x4 * (n))
...
#घोषणा CAMSS_CSID_IRQ_CLEAR_CMD	0x060
#घोषणा CAMSS_CSID_IRQ_MASK		0x064
#घोषणा CAMSS_CSID_IRQ_STATUS		0x068
#घोषणा CAMSS_CSID_TG_CTRL		0x0a0
#घोषणा CAMSS_CSID_TG_CTRL_DISABLE	0xa06436
#घोषणा CAMSS_CSID_TG_CTRL_ENABLE	0xa06437
#घोषणा CAMSS_CSID_TG_VC_CFG		0x0a4
#घोषणा CAMSS_CSID_TG_VC_CFG_H_BLANKING		0x3ff
#घोषणा CAMSS_CSID_TG_VC_CFG_V_BLANKING		0x7f
#घोषणा CAMSS_CSID_TG_DT_n_CGG_0(n)	(0x0ac + 0xc * (n))
#घोषणा CAMSS_CSID_TG_DT_n_CGG_1(n)	(0x0b0 + 0xc * (n))
#घोषणा CAMSS_CSID_TG_DT_n_CGG_2(n)	(0x0b4 + 0xc * (n))
...
स्थिर काष्ठा csid_hw_ops csid_ops_4_1 = अणु
