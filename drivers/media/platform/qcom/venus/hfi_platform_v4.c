...
अणु
	...
	.caps[0] = अणुHFI_CAPABILITY_FRAME_WIDTH, 96, 4096, 1पूर्ण,
	.caps[1] = अणुHFI_CAPABILITY_FRAME_HEIGHT, 96, 4096, 1पूर्ण,
	.caps[2] = अणुHFI_CAPABILITY_MBS_PER_FRAME, 1, 36864, 1पूर्ण,
	.caps[3] = अणुHFI_CAPABILITY_BITRATE, 1, 120000000, 1पूर्ण,
	.caps[4] = अणुHFI_CAPABILITY_SCALE_X, 4096, 65536, 1पूर्ण,
	.caps[5] = अणुHFI_CAPABILITY_SCALE_Y, 4096, 65536, 1पूर्ण,
	.caps[6] = अणुHFI_CAPABILITY_MBS_PER_SECOND, 1, 2073600, 1पूर्ण,
	.caps[7] = अणुHFI_CAPABILITY_FRAMERATE, 1, 480, 1पूर्ण,
	.caps[8] = अणुHFI_CAPABILITY_MAX_VIDEOCORES, 1, 2, 1पूर्ण,
...
पूर्ण, अणु
	...
	.caps[9] = अणुHFI_CAPABILITY_MAX_WORKMODES, 1, 3, 1पूर्ण,
	.num_caps = 10,
	.pl[0] = अणुHFI_HEVC_PROखाता_MAIN, HFI_HEVC_LEVEL_6 | HFI_HEVC_TIER_HIGH0 << 28पूर्ण,
	.pl[1] = अणुHFI_HEVC_PROखाता_MAIN10, HFI_HEVC_LEVEL_6 | HFI_HEVC_TIER_HIGH0 << 28पूर्ण,
	.num_pl = 2,
	.fmts[0] = अणुHFI_BUFFER_OUTPUT, HFI_COLOR_FORMAT_NV12_UBWCपूर्ण,
...
पूर्ण, अणु
	...
	.करोमुख्य = VIDC_SESSION_TYPE_DEC,
	.cap_bufs_mode_dynamic = true,
	.caps[0] = अणुHFI_CAPABILITY_FRAME_WIDTH, 96, 1920, 1पूर्ण,
	.caps[1] = अणुHFI_CAPABILITY_FRAME_HEIGHT, 96, 1920, 1पूर्ण,
	.caps[2] = अणुHFI_CAPABILITY_MBS_PER_FRAME, 1, 8160, 1पूर्ण,
	.caps[3] = अणुHFI_CAPABILITY_BITRATE, 1, 40000000, 1पूर्ण,
	.caps[4] = अणुHFI_CAPABILITY_SCALE_X, 4096, 65536, 1पूर्ण,
	.caps[5] = अणुHFI_CAPABILITY_SCALE_Y, 4096, 65536, 1पूर्ण,
	.caps[6] = अणुHFI_CAPABILITY_MBS_PER_SECOND, 1, 244800, 1पूर्ण,
...
पूर्ण, अणु
	...
	.cap_bufs_mode_dynamic = true,
	.caps[0] = अणुHFI_CAPABILITY_FRAME_WIDTH, 96, 4096, 16पूर्ण,
	.caps[1] = अणुHFI_CAPABILITY_FRAME_HEIGHT, 96, 4096, 16पूर्ण,
	.caps[2] = अणुHFI_CAPABILITY_MBS_PER_FRAME, 1, 36864, 1पूर्ण,
	.caps[3] = अणुHFI_CAPABILITY_BITRATE, 1, 120000000, 1पूर्ण,
	.caps[4] = अणुHFI_CAPABILITY_SCALE_X, 8192, 65536, 1पूर्ण,
	.caps[5] = अणुHFI_CAPABILITY_SCALE_Y, 8192, 65536, 1पूर्ण,
	.caps[6] = अणुHFI_CAPABILITY_MBS_PER_SECOND, 1, 1036800, 1पूर्ण,
	.caps[7] = अणुHFI_CAPABILITY_FRAMERATE, 1, 480, 1पूर्ण,
	.caps[8] = अणुHFI_CAPABILITY_MAX_VIDEOCORES, 1, 3, 1पूर्ण,
	.caps[9] = अणुHFI_CAPABILITY_PEAKBITRATE, 32000, 160000000, 1पूर्ण,
	.caps[10] = अणुHFI_CAPABILITY_HIER_P_NUM_ENH_LAYERS, 0, 5, 1पूर्ण,
	.caps[11] = अणुHFI_CAPABILITY_ENC_LTR_COUNT, 0, 4, 1पूर्ण,
...
पूर्ण, अणु
	...
	.caps[13] = अणुHFI_CAPABILITY_BFRAME, 0, 1, 1पूर्ण,
	.caps[14] = अणुHFI_CAPABILITY_HIER_P_HYBRID_NUM_ENH_LAYERS, 0, 5, 1पूर्ण,
	.caps[15] = अणुHFI_CAPABILITY_I_FRAME_QP, 0, 63, 1पूर्ण,
	.caps[16] = अणुHFI_CAPABILITY_P_FRAME_QP, 0, 63, 1पूर्ण,
	.caps[17] = अणुHFI_CAPABILITY_B_FRAME_QP, 0, 63, 1पूर्ण,
	.caps[18] = अणुHFI_CAPABILITY_MAX_WORKMODES, 1, 2, 1पूर्ण,
	.caps[19] = अणुHFI_CAPABILITY_RATE_CONTROL_MODES, 0x1000001, 0x1000005, 1पूर्ण,
	.caps[20] = अणुHFI_CAPABILITY_COLOR_SPACE_CONVERSION, 0, 2, 1पूर्ण,
...
पूर्ण, अणु
	...
	.caps[5] = अणुHFI_CAPABILITY_SCALE_Y, 8192, 65536, 1पूर्ण,
	.caps[6] = अणुHFI_CAPABILITY_MBS_PER_SECOND, 1, 1036800, 1पूर्ण,
	.caps[7] = अणुHFI_CAPABILITY_FRAMERATE, 1, 240, 1पूर्ण,
	.caps[8] = अणुHFI_CAPABILITY_MAX_VIDEOCORES, 1, 3, 1पूर्ण,
	.caps[9] = अणुHFI_CAPABILITY_PEAKBITRATE, 32000, 160000000, 1पूर्ण,
...
अटल स्थिर काष्ठा hfi_platक्रमm_codec_freq_data codec_freq_data[] =  अणु
	अणु V4L2_PIX_FMT_H264, VIDC_SESSION_TYPE_ENC, 675, 10 पूर्ण,
	अणु V4L2_PIX_FMT_HEVC, VIDC_SESSION_TYPE_ENC, 675, 10 पूर्ण,
	अणु V4L2_PIX_FMT_VP8, VIDC_SESSION_TYPE_ENC, 675, 10 पूर्ण,
	अणु V4L2_PIX_FMT_MPEG2, VIDC_SESSION_TYPE_DEC, 200, 10 पूर्ण,
	अणु V4L2_PIX_FMT_H264, VIDC_SESSION_TYPE_DEC, 200, 10 पूर्ण,
	अणु V4L2_PIX_FMT_HEVC, VIDC_SESSION_TYPE_DEC, 200, 10 पूर्ण,
	अणु V4L2_PIX_FMT_VP8, VIDC_SESSION_TYPE_DEC, 200, 10 पूर्ण,
	अणु V4L2_PIX_FMT_VP9, VIDC_SESSION_TYPE_DEC, 200, 10 पूर्ण,
पूर्ण;
...
स्थिर काष्ठा hfi_platक्रमm hfi_plat_v4 = अणु
