...
#अगर_अघोषित OMAP3_ISP_CSI2_H
#घोषणा OMAP3_ISP_CSI2_H
...
क्रमागत isp_csi2_pix_क्रमmats अणु
...
क्रमागत isp_csi2_irqevents अणु
	OCP_ERR_IRQ = 0x4000,
...
क्रमागत isp_csi2_ctx_irqevents अणु
...
क्रमागत isp_csi2_frame_mode अणु
	ISP_CSI2_FRAME_IMMEDIATE,
	ISP_CSI2_FRAME_AFTERFEC,
पूर्ण;

#घोषणा ISP_CSI2_MAX_CTX_NUM	7

काष्ठा isp_csi2_ctx_cfg अणु
...
काष्ठा isp_csi2_timing_cfg अणु
...
काष्ठा isp_csi2_ctrl_cfg अणु
	bool vp_clk_enable;
	bool vp_only_enable;
	u8 vp_out_ctrl;
	क्रमागत isp_csi2_frame_mode frame_mode;
	bool ecc_enable;
	bool अगर_enable;
पूर्ण;
...
#घोषणा CSI2_OUTPUT_CCDC	(1 << 0)
#घोषणा CSI2_OUTPUT_MEMORY	(1 << 1)

काष्ठा isp_csi2_device अणु
	...
	काष्ठा isp_csi2_ctx_cfg contexts[ISP_CSI2_MAX_CTX_NUM + 1];
	काष्ठा isp_csi2_timing_cfg timing[2];
	काष्ठा isp_csi2_ctrl_cfg ctrl;
