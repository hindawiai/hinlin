 ...
 * रेजिस्टर descriptions
 * see flexcop.c क्रम copyright inक्रमmation
 */
/* This file is स्वतःmatically generated, करो not edit things here. */
#अगर_अघोषित __FLEXCOP_IBI_VALUE_INCLUDED__
#घोषणा __FLEXCOP_IBI_VALUE_INCLUDED__
...
प्रकार जोड़ अणु
	...
	पूर्ण mbox_v8_to_host_218;

	काष्ठा अणु
		u32 sysramaccess_busmuster         : 1;
		u32 sysramaccess_ग_लिखो             : 1;
		u32 unused                         : 7;
		u32 sysramaccess_addr              :15;
		u32 sysramaccess_data              : 8;
	पूर्ण mbox_host_to_v8_21c;

	काष्ठा अणु
		u32 debug_fअगरo_problem             : 1;
		u32 debug_flag_ग_लिखो_status00      : 1;
		u32 Stream2_trans                  : 1;
		u32 Stream2_PID                    :13;
	...
	काष्ठा अणु
		...
		u32 Group_trans                    : 1;
		u32 Group_PID                      :13;
	पूर्ण pid_filter_30c_ext_ind_0_7;

	काष्ठा अणु
		u32 unused                         :15;
		u32 net_master_पढ़ो                :17;
	पूर्ण pid_filter_30c_ext_ind_1;

	काष्ठा अणु
		u32 unused                         :15;
		u32 net_master_ग_लिखो               :17;
	पूर्ण pid_filter_30c_ext_ind_2;

	काष्ठा अणु
		u32 unused                         :15;
		u32 next_net_master_ग_लिखो          :17;
	पूर्ण pid_filter_30c_ext_ind_3;
	...
	काष्ठा अणु
		...
		u32 state_ग_लिखो                    :10;
		u32 unused1                        : 1;
	पूर्ण pid_filter_30c_ext_ind_4;

	काष्ठा अणु
		u32 unused                         :22;
		u32 stack_cnt                      :10;
	पूर्ण pid_filter_30c_ext_ind_5;

	काष्ठा अणु
		u32 unused                         : 4;
		u32 data_size_reg                  :12;
		u32 ग_लिखो_status4                  : 2;
		u32 ग_लिखो_status1                  : 2;
	...
	पूर्ण pid_filter_30c_ext_ind_6;
	...
	काष्ठा अणु
		...
		u32 MAC2                           : 8;
		u32 MAC1                           : 8;
	पूर्ण mac_address_418;

	काष्ठा अणु
		u32 reserved                       :16;
		u32 MAC8                           : 8;
		u32 MAC7                           : 8;
	पूर्ण mac_address_41c;
	...
	काष्ठा अणु
		...
		u32 sram_rw                        : 1;
		u32 sram_addr                      :15;
	पूर्ण sram_ctrl_reg_700;

	काष्ठा अणु
		u32 net_addr_ग_लिखो                 :16;
		u32 net_addr_पढ़ो                  :16;
	पूर्ण net_buf_reg_704;
	...
	काष्ठा अणु
		...
		u32 CAI_Dest                       : 2;
		u32 NET_Dest                       : 2;
	पूर्ण sram_dest_reg_714;

	काष्ठा अणु
		u32 reserved3                      :11;
		u32 net_addr_ग_लिखो                 : 1;
		u32 reserved2                      : 3;
		u32 net_addr_पढ़ो                  : 1;
		u32 reserved1                      : 4;
		u32 net_cnt                        :12;
	पूर्ण net_buf_reg_718;
	...
	काष्ठा अणु
		...
		u32 sram_memmap                    : 2;
		u32 sram_chip                      : 2;
		u32 wan_रुको_state                 : 8;
		u32 reserved1                      : 6;
		u32 wan_speed_sig                  : 2;
	पूर्ण wan_ctrl_reg_71c;
पूर्ण flexcop_ibi_value;
