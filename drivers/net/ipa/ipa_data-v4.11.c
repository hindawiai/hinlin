...
/** क्रमागत ipa_resource_type - IPA resource types क्रम an SoC having IPA v4.11 */
...
/* Resource groups used क्रम an SoC having IPA v4.11 */
...
/* QSB configuration data क्रम an SoC having IPA v4.11 */
...
/* Endpoपूर्णांक configuration data क्रम an SoC having IPA v4.11 */
...
/* Source resource configuration data क्रम an SoC having IPA v4.11 */
...
/* Destination resource configuration data क्रम an SoC having IPA v4.11 */
...
/* Resource configuration data क्रम an SoC having IPA v4.11 */
...
/* IPA-resident memory region data क्रम an SoC having IPA v4.11 */
...
/* Memory configuration data क्रम an SoC having IPA v4.11 */
...
/* Clock and पूर्णांकerconnect configuration data क्रम an SoC having IPA v4.11 */
...
/* Configuration data क्रम an SoC having IPA v4.11 */
स्थिर काष्ठा ipa_data ipa_data_v4_11 = अणु
