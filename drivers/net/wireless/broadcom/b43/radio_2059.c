...
अटल u16 r2059_phy_rev1_init[][2] = अणु
	अणु 0x051, 0x70 पूर्ण, अणु 0x05a, 0x03 पूर्ण, अणु 0x079, 0x01 पूर्ण, अणु 0x082, 0x70 पूर्ण,
	अणु 0x083, 0x00 पूर्ण, अणु 0x084, 0x70 पूर्ण, अणु 0x09a, 0x7f पूर्ण, अणु 0x0b6, 0x10 पूर्ण,
	अणु 0x188, 0x05 पूर्ण,
पूर्ण;

#घोषणा RADIOREGS(r00, r01, r02, r03, r04, r05, r06, r07, r08, r09, \
...
/* Extracted from MMIO dump of 6.30.223.141
 * TODO: Values क्रम channels 12 & 13 are outdated (from some old 5.x driver)!
 */
अटल स्थिर काष्ठा b43_phy_ht_channeltab_e_radio2059 b43_phy_ht_channeltab_radio2059[] = अणु
	अणु
		.freq			= 2412,
...
अणु
	...
	क्रम (i = 0; i < size; i++, table += 2)
		b43_radio_ग_लिखो(dev, R2059_ALL | table[0], table[1]);
पूर्ण
...
अणु
	...
	क्रम (i = 0; i < ARRAY_SIZE(b43_phy_ht_channeltab_radio2059); i++, e++) अणु
		अगर (e->freq == freq)
			वापस e;
	पूर्ण
