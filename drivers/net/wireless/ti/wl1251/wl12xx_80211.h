...
काष्ठा wl12xx_beacon_ढाँचा अणु
	काष्ठा ieee80211_header header;
	__le32 समय_stamp[2];
	__le16 beacon_पूर्णांकerval;
	__le16 capability;
	काष्ठा wl12xx_ie_ssid ssid;
	काष्ठा wl12xx_ie_rates rates;
	काष्ठा wl12xx_ie_rates ext_rates;
	काष्ठा wl12xx_ie_ds_params ds_params;
	काष्ठा wl12xx_ie_country country;
पूर्ण __packed;
...
काष्ठा wl12xx_qos_null_data_ढाँचा अणु
	काष्ठा ieee80211_header header;
	__le16 qos_ctl;
पूर्ण __packed;

काष्ठा wl12xx_probe_req_ढाँचा अणु
	काष्ठा ieee80211_header header;
	काष्ठा wl12xx_ie_ssid ssid;
	काष्ठा wl12xx_ie_rates rates;
	काष्ठा wl12xx_ie_rates ext_rates;
...
काष्ठा wl12xx_probe_resp_ढाँचा अणु
	काष्ठा ieee80211_header header;
	__le32 समय_stamp[2];
	__le16 beacon_पूर्णांकerval;
	__le16 capability;
