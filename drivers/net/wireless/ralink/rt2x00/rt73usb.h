...
/*
	Module: rt73usb
	Abstract: Data काष्ठाures and रेजिस्टरs क्रम the rt73usb module.
	Supported chipsets: rt2571W & rt2671.
 */

#अगर_अघोषित RT73USB_H
#घोषणा RT73USB_H
 ...
 * 8051 firmware image.
 */
#घोषणा FIRMWARE_RT2571			"rt73.bin"
#घोषणा FIRMWARE_IMAGE_BASE		0x0800
 ...
 */
#घोषणा HW_BEACON_BASE0			0x2400
#घोषणा HW_BEACON_BASE1			0x2500
#घोषणा HW_BEACON_BASE2			0x2600
#घोषणा HW_BEACON_BASE3			0x2700
 ...
 *	MAC_CSR13_सूचीx: GPIO direction: 0 = input; 1 = output
 */
...
#घोषणा MAC_CSR13_VAL6			FIELD32(0x00000040)
#घोषणा MAC_CSR13_VAL7			FIELD32(0x00000080)
...
#घोषणा MAC_CSR13_सूची6			FIELD32(0x00004000)
#घोषणा MAC_CSR13_सूची7			FIELD32(0x00008000)
...
#घोषणा PHY_CSR1_RF_RPI			FIELD32(0x00010000)
...
#घोषणा STA_CSR4_TX_NO_RETRY_COUNT	FIELD32(0x0000ffff)
#घोषणा STA_CSR4_TX_ONE_RETRY_COUNT	FIELD32(0xffff0000)

/*
 * STA_CSR5: TX Retry count.
 */
#घोषणा STA_CSR5			0x30d4
#घोषणा STA_CSR4_TX_MULTI_RETRY_COUNT	FIELD32(0x0000ffff)
#घोषणा STA_CSR4_TX_RETRY_FAIL_COUNT	FIELD32(0xffff0000)
...
#घोषणा EEPROM_NIC_EXTERNAL_LNA		FIELD16(0x0010)
 ...
 */
#घोषणा TXD_DESC_SIZE			( 6 * माप(__le32) )
#घोषणा TXINFO_SIZE			( 6 * माप(__le32) )
#घोषणा RXD_DESC_SIZE			( 6 * माप(__le32) )
 ...
 */
#घोषणा TXD_W0_BURST			FIELD32(0x00000001)
...
#घोषणा TXD_W0_BURST2			FIELD32(0x10000000)
 ...
 * PACKET_ID: Driver asचिन्हित packet ID to categorize TXResult in पूर्णांकerrupt.
...
#घोषणा TXD_W5_PACKET_ID		FIELD32(0x0000ff00)
