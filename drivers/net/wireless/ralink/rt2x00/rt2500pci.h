...
/*
	Module: rt2500pci
	Abstract: Data काष्ठाures and रेजिस्टरs क्रम the rt2500pci module.
	Supported chipsets: RT2560.
 */

#अगर_अघोषित RT2500PCI_H
#घोषणा RT2500PCI_H
 ...
 * DECRYPTION_DONE: Decryption करोne पूर्णांकerrupt.
 * ENCRYPTION_DONE: Encryption करोne पूर्णांकerrupt.
 ...
 * TIMER_CSR3_EXPIRE: TIMECSR3 समयr expired (802.1H quiet period).
...
#घोषणा CSR7_DECRYPTION_DONE		FIELD32(0x00000080)
#घोषणा CSR7_ENCRYPTION_DONE		FIELD32(0x00000100)
#घोषणा CSR7_UART1_TX_TRESHOLD		FIELD32(0x00000200)
#घोषणा CSR7_UART1_RX_TRESHOLD		FIELD32(0x00000400)
#घोषणा CSR7_UART1_IDLE_TRESHOLD	FIELD32(0x00000800)
#घोषणा CSR7_UART1_TX_BUFF_ERROR	FIELD32(0x00001000)
#घोषणा CSR7_UART1_RX_BUFF_ERROR	FIELD32(0x00002000)
#घोषणा CSR7_UART2_TX_TRESHOLD		FIELD32(0x00004000)
#घोषणा CSR7_UART2_RX_TRESHOLD		FIELD32(0x00008000)
#घोषणा CSR7_UART2_IDLE_TRESHOLD	FIELD32(0x00010000)
#घोषणा CSR7_UART2_TX_BUFF_ERROR	FIELD32(0x00020000)
#घोषणा CSR7_UART2_RX_BUFF_ERROR	FIELD32(0x00040000)
#घोषणा CSR7_TIMER_CSR3_EXPIRE		FIELD32(0x00080000)
...
#घोषणा CSR8_DECRYPTION_DONE		FIELD32(0x00000080)
#घोषणा CSR8_ENCRYPTION_DONE		FIELD32(0x00000100)
#घोषणा CSR8_UART1_TX_TRESHOLD		FIELD32(0x00000200)
#घोषणा CSR8_UART1_RX_TRESHOLD		FIELD32(0x00000400)
#घोषणा CSR8_UART1_IDLE_TRESHOLD	FIELD32(0x00000800)
#घोषणा CSR8_UART1_TX_BUFF_ERROR	FIELD32(0x00001000)
#घोषणा CSR8_UART1_RX_BUFF_ERROR	FIELD32(0x00002000)
#घोषणा CSR8_UART2_TX_TRESHOLD		FIELD32(0x00004000)
#घोषणा CSR8_UART2_RX_TRESHOLD		FIELD32(0x00008000)
#घोषणा CSR8_UART2_IDLE_TRESHOLD	FIELD32(0x00010000)
#घोषणा CSR8_UART2_TX_BUFF_ERROR	FIELD32(0x00020000)
#घोषणा CSR8_UART2_RX_BUFF_ERROR	FIELD32(0x00040000)
#घोषणा CSR8_TIMER_CSR3_EXPIRE		FIELD32(0x00080000)
 ...
 */
#घोषणा SECCSR0				0x0028
#घोषणा SECCSR0_KICK_DECRYPT		FIELD32(0x00000001)
#घोषणा SECCSR0_ONE_SHOT		FIELD32(0x00000002)
#घोषणा SECCSR0_DESC_ADDRESS		FIELD32(0xfffffffc)
...
#घोषणा CSR11_CW_SELECT			FIELD32(0x00002000)
 ...
 * CFP_MAX_DURATION: Cfp maximum duration, शेष is 100 TU.
 */
#घोषणा CSR12				0x0030
 ...
 */
#घोषणा CSR18				0x0048
#घोषणा CSR18_SIFS			FIELD32(0x000001ff)
#घोषणा CSR18_PIFS			FIELD32(0x001f0000)
...
/*
 * TXCSR8: CCK Tx BBP रेजिस्टर.
 */
#घोषणा TXCSR8				0x0098
#घोषणा TXCSR8_BBP_ID0			FIELD32(0x0000007f)
#घोषणा TXCSR8_BBP_ID0_VALID		FIELD32(0x00000080)
#घोषणा TXCSR8_BBP_ID1			FIELD32(0x00007f00)
#घोषणा TXCSR8_BBP_ID1_VALID		FIELD32(0x00008000)
#घोषणा TXCSR8_BBP_ID2			FIELD32(0x007f0000)
#घोषणा TXCSR8_BBP_ID2_VALID		FIELD32(0x00800000)
#घोषणा TXCSR8_BBP_ID3			FIELD32(0x7f000000)
#घोषणा TXCSR8_BBP_ID3_VALID		FIELD32(0x80000000)

/*
 * TXCSR9: OFDM TX BBP रेजिस्टरs
 * OFDM_SIGNAL: BBP rate field address क्रम OFDM.
 * OFDM_SERVICE: BBP service field address क्रम OFDM.
 * OFDM_LENGTH_LOW: BBP length low byte address क्रम OFDM.
 * OFDM_LENGTH_HIGH: BBP length high byte address क्रम OFDM.
 */
#घोषणा TXCSR9				0x0094
#घोषणा TXCSR9_OFDM_RATE		FIELD32(0x000000ff)
#घोषणा TXCSR9_OFDM_SERVICE		FIELD32(0x0000ff00)
#घोषणा TXCSR9_OFDM_LENGTH_LOW		FIELD32(0x00ff0000)
#घोषणा TXCSR9_OFDM_LENGTH_HIGH		FIELD32(0xff000000)
...
#घोषणा RXCSR0_PASS_PLCP		FIELD32(0x00000100)
#घोषणा RXCSR0_DROP_MCAST		FIELD32(0x00000200)
#घोषणा RXCSR0_DROP_BCAST		FIELD32(0x00000400)
#घोषणा RXCSR0_ENABLE_QOS		FIELD32(0x00000800)
 ...
 * AR_BBP_DATA#: Auto responder BBP रेजिस्टर # data.
 * AR_BBP_ID#: Auto responder BBP रेजिस्टर # Id.
 */
#घोषणा ARCSR1				0x009c
 ...
 * READ_MULTIPLE: Enable memory पढ़ो multiple.
 * WRITE_INVALID: Enable memory ग_लिखो & invalid.
 */
#घोषणा PCICSR				0x008c
...
#घोषणा PCICSR_READ_MULTIPLE		FIELD32(0x00000100)
#घोषणा PCICSR_WRITE_INVALID		FIELD32(0x00000200)
 ...
 */
#घोषणा CNT3				0x00b8
#घोषणा CNT3_FALSE_CCA			FIELD32(0x0000ffff)
...
#घोषणा RALINKCSR_AR_BBP_ID0		FIELD32(0x00007f00)
#घोषणा RALINKCSR_AR_BBP_VALID0		FIELD32(0x00008000)
#घोषणा RALINKCSR_AR_BBP_DATA1		FIELD32(0x00ff0000)
#घोषणा RALINKCSR_AR_BBP_ID1		FIELD32(0x7f000000)
#घोषणा RALINKCSR_AR_BBP_VALID1		FIELD32(0x80000000)
 ...
 * LED_DEFAULT: LED state क्रम "enable" 0: ON, 1: OFF.
 */
#घोषणा LEDCSR				0x00f8
...
#घोषणा LEDCSR_LINK_POLARITY		FIELD32(0x00040000)
#घोषणा LEDCSR_ACTIVITY_POLARITY	FIELD32(0x00080000)
#घोषणा LEDCSR_LED_DEFAULT		FIELD32(0x00100000)

/*
 * SECCSR3: AES control रेजिस्टर.
 */
#घोषणा SECCSR3				0x00fc
...
/*
 * TXACKCSR0: TX ACK समयout.
 */
#घोषणा TXACKCSR0			0x0110

/*
 * ACK समयout count रेजिस्टरs.
 * ACKCNT0: TX ACK समयout count.
 * ACKCNT1: RX ACK समयout count.
 */
#घोषणा ACKCNT0				0x0114
#घोषणा ACKCNT1				0x0118
...
/*
 * FIFO poपूर्णांकer रेजिस्टरs.
 * FIFOCSR0: TX FIFO poपूर्णांकer.
 * FIFOCSR1: RX FIFO poपूर्णांकer.
 */
#घोषणा FIFOCSR0			0x0128
#घोषणा FIFOCSR1			0x012c
...
#घोषणा BCNCSR1_BEACON_CWMIN		FIELD32(0x000f0000)
...
/*
 * TESTCSR: TEST mode selection रेजिस्टर.
 */
#घोषणा TESTCSR				0x0138
...
/*
 * ARTCSR0: CCK ACK/CTS payload consumed समय क्रम 1/2/5.5/11 mbps.
 */
#घोषणा ARTCSR0				0x014c
#घोषणा ARTCSR0_ACK_CTS_11MBS		FIELD32(0x000000ff)
#घोषणा ARTCSR0_ACK_CTS_5_5MBS		FIELD32(0x0000ff00)
#घोषणा ARTCSR0_ACK_CTS_2MBS		FIELD32(0x00ff0000)
#घोषणा ARTCSR0_ACK_CTS_1MBS		FIELD32(0xff000000)


/*
 * ARTCSR1: OFDM ACK/CTS payload consumed समय क्रम 6/9/12/18 mbps.
 */
#घोषणा ARTCSR1				0x0150
#घोषणा ARTCSR1_ACK_CTS_6MBS		FIELD32(0x000000ff)
#घोषणा ARTCSR1_ACK_CTS_9MBS		FIELD32(0x0000ff00)
#घोषणा ARTCSR1_ACK_CTS_12MBS		FIELD32(0x00ff0000)
#घोषणा ARTCSR1_ACK_CTS_18MBS		FIELD32(0xff000000)

/*
 * ARTCSR2: OFDM ACK/CTS payload consumed समय क्रम 24/36/48/54 mbps.
 */
#घोषणा ARTCSR2				0x0154
#घोषणा ARTCSR2_ACK_CTS_24MBS		FIELD32(0x000000ff)
#घोषणा ARTCSR2_ACK_CTS_36MBS		FIELD32(0x0000ff00)
#घोषणा ARTCSR2_ACK_CTS_48MBS		FIELD32(0x00ff0000)
#घोषणा ARTCSR2_ACK_CTS_54MBS		FIELD32(0xff000000)

/*
 * SECCSR1: WEP control रेजिस्टर.
 * KICK_ENCRYPT: Kick encryption engine, self-clear.
 * ONE_SHOT: 0: ring mode, 1: One shot only mode.
 * DESC_ADDRESS: Descriptor physical address of frame.
 */
#घोषणा SECCSR1				0x0158
#घोषणा SECCSR1_KICK_ENCRYPT		FIELD32(0x00000001)
#घोषणा SECCSR1_ONE_SHOT		FIELD32(0x00000002)
#घोषणा SECCSR1_DESC_ADDRESS		FIELD32(0xfffffffc)

/*
 * BBPCSR1: BBP TX configuration.
 */
#घोषणा BBPCSR1				0x015c
#घोषणा BBPCSR1_CCK			FIELD32(0x00000003)
#घोषणा BBPCSR1_CCK_FLIP		FIELD32(0x00000004)
#घोषणा BBPCSR1_OFDM			FIELD32(0x00030000)
#घोषणा BBPCSR1_OFDM_FLIP		FIELD32(0x00040000)

/*
 * Dual band configuration रेजिस्टरs.
 * DBANDCSR0: Dual band configuration रेजिस्टर 0.
 * DBANDCSR1: Dual band configuration रेजिस्टर 1.
 */
#घोषणा DBANDCSR0			0x0160
#घोषणा DBANDCSR1			0x0164

/*
 * BBPPCSR: BBP Pin control रेजिस्टर.
 */
#घोषणा BBPPCSR				0x0168

/*
 * MAC special debug mode selection रेजिस्टरs.
 * DBGSEL0: MAC special debug mode selection रेजिस्टर 0.
 * DBGSEL1: MAC special debug mode selection रेजिस्टर 1.
 */
#घोषणा DBGSEL0				0x016c
#घोषणा DBGSEL1				0x0170

/*
 * BISTCSR: BBP BIST रेजिस्टर.
 */
#घोषणा BISTCSR				0x0174

/*
 * Multicast filter रेजिस्टरs.
 * MCAST0: Multicast filter रेजिस्टर 0.
 * MCAST1: Multicast filter रेजिस्टर 1.
 */
#घोषणा MCAST0				0x0178
#घोषणा MCAST1				0x017c
...
/*
 * UART रेजिस्टरs.
 * UARTCSR0: UART1 TX रेजिस्टर.
 * UARTCSR1: UART1 RX रेजिस्टर.
 * UARTCSR3: UART1 frame control रेजिस्टर.
 * UARTCSR4: UART1 buffer control रेजिस्टर.
 * UART2CSR0: UART2 TX रेजिस्टर.
 * UART2CSR1: UART2 RX रेजिस्टर.
 * UART2CSR3: UART2 frame control रेजिस्टर.
 * UART2CSR4: UART2 buffer control रेजिस्टर.
 */
#घोषणा UARTCSR0			0x0180
#घोषणा UARTCSR1			0x0184
#घोषणा UARTCSR3			0x0188
#घोषणा UARTCSR4			0x018c
#घोषणा UART2CSR0			0x0190
#घोषणा UART2CSR1			0x0194
#घोषणा UART2CSR3			0x0198
#घोषणा UART2CSR4			0x019c
 ...
 * BBP_R70
 */
#घोषणा BBP_R70_JAPAN_FILTER		FIELD8(0x08)
 ...
 */
#घोषणा EEPROM_GEOGRAPHY		0x12
#घोषणा EEPROM_GEOGRAPHY_GEO		FIELD16(0x0f00)

/*
 * EEPROM BBP.
 */
#घोषणा EEPROM_BBP_START		0x13
 ...
 * EEPROM TXPOWER
 */
#घोषणा EEPROM_TXPOWER_START		0x23
 ...
 */
#घोषणा EEPROM_CALIBRATE_OFFSET		0x3e
#घोषणा EEPROM_CALIBRATE_OFFSET_RSSI	FIELD16(0x00ff)

/*
 * DMA descriptor defines.
 */
#घोषणा TXD_DESC_SIZE			(11 * माप(__le32))
#घोषणा RXD_DESC_SIZE			(11 * माप(__le32))
...
#घोषणा TXD_W0_CIPHER_OWNER		FIELD32(0x00001000)
 ...
 * Word2
 */
#घोषणा TXD_W2_IV_OFFSET		FIELD32(0x0000003f)
#घोषणा TXD_W2_AIFS			FIELD32(0x000000c0)
#घोषणा TXD_W2_CWMIN			FIELD32(0x00000f00)
#घोषणा TXD_W2_CWMAX			FIELD32(0x0000f000)

/*
 * Word3: PLCP inक्रमmation
 */
#घोषणा TXD_W3_PLCP_SIGNAL		FIELD32(0x000000ff)
#घोषणा TXD_W3_PLCP_SERVICE		FIELD32(0x0000ff00)
#घोषणा TXD_W3_PLCP_LENGTH_LOW		FIELD32(0x00ff0000)
#घोषणा TXD_W3_PLCP_LENGTH_HIGH		FIELD32(0xff000000)

/*
 * Word4
 */
#घोषणा TXD_W4_IV			FIELD32(0xffffffff)

/*
 * Word5
 */
#घोषणा TXD_W5_EIV			FIELD32(0xffffffff)

/*
 * Word6-9: Key
 */
#घोषणा TXD_W6_KEY			FIELD32(0xffffffff)
#घोषणा TXD_W7_KEY			FIELD32(0xffffffff)
#घोषणा TXD_W8_KEY			FIELD32(0xffffffff)
#घोषणा TXD_W9_KEY			FIELD32(0xffffffff)

/*
 * Word10
 */
#घोषणा TXD_W10_RTS			FIELD32(0x00000001)
#घोषणा TXD_W10_TX_RATE			FIELD32(0x000000fe)
...
#घोषणा RXD_W0_CIPHER_OWNER		FIELD32(0x00000100)
#घोषणा RXD_W0_ICV_ERROR		FIELD32(0x00000200)
#घोषणा RXD_W0_IV_OFFSET		FIELD32(0x0000fc00)
 ...
 * Word2
 */
#घोषणा RXD_W2_SIGNAL			FIELD32(0x000000ff)
#घोषणा RXD_W2_RSSI			FIELD32(0x0000ff00)
#घोषणा RXD_W2_TA			FIELD32(0xffff0000)

/*
 * Word3
 */
#घोषणा RXD_W3_TA			FIELD32(0xffffffff)

/*
 * Word4
 */
#घोषणा RXD_W4_IV			FIELD32(0xffffffff)

/*
 * Word5
 */
#घोषणा RXD_W5_EIV			FIELD32(0xffffffff)

/*
 * Word6-9: Key
 */
#घोषणा RXD_W6_KEY			FIELD32(0xffffffff)
#घोषणा RXD_W7_KEY			FIELD32(0xffffffff)
#घोषणा RXD_W8_KEY			FIELD32(0xffffffff)
#घोषणा RXD_W9_KEY			FIELD32(0xffffffff)

/*
 * Word10
 */
#घोषणा RXD_W10_DROP			FIELD32(0x00000001)
