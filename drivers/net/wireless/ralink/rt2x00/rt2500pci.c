...
/*
	Module: rt2500pci
	Abstract: rt2500pci device specअगरic routines.
...
अटल व्योम rt2500pci_bbp_ग_लिखो(काष्ठा rt2x00_dev *rt2x00dev,
...
अटल u8 rt2500pci_bbp_पढ़ो(काष्ठा rt2x00_dev *rt2x00dev,
...
अटल व्योम rt2500pci_rf_ग_लिखो(काष्ठा rt2x00_dev *rt2x00dev,
...
अटल व्योम rt2500pci_eepromरेजिस्टर_पढ़ो(काष्ठा eeprom_93cx6 *eeprom)
अणु
...
अटल व्योम rt2500pci_eepromरेजिस्टर_ग_लिखो(काष्ठा eeprom_93cx6 *eeprom)
अणु
	काष्ठा rt2x00_dev *rt2x00dev = eeprom->data;
	u32 reg = 0;
...
अटल स्थिर काष्ठा rt2x00debug rt2500pci_rt2x00debug = अणु
	.owner	= THIS_MODULE,
	.csr	= अणु
	...
	पूर्ण,
	.bbp	= अणु
		.पढ़ो		= rt2500pci_bbp_पढ़ो,
		.ग_लिखो		= rt2500pci_bbp_ग_लिखो,
		.word_base	= BBP_BASE,
		.word_size	= माप(u8),
...
अटल पूर्णांक rt2500pci_rfसमाप्त_poll(काष्ठा rt2x00_dev *rt2x00dev)
अणु
	u32 reg;
...
अटल व्योम rt2500pci_brightness_set(काष्ठा led_classdev *led_cdev,
...
अटल पूर्णांक rt2500pci_blink_set(काष्ठा led_classdev *led_cdev,
...
अटल व्योम rt2500pci_init_led(काष्ठा rt2x00_dev *rt2x00dev,
			       काष्ठा rt2x00_led *led,
 ...
 */
अटल व्योम rt2500pci_config_filter(काष्ठा rt2x00_dev *rt2x00dev,
...
अटल व्योम rt2500pci_config_पूर्णांकf(काष्ठा rt2x00_dev *rt2x00dev,
...
अटल व्योम rt2500pci_config_erp(काष्ठा rt2x00_dev *rt2x00dev,
...
अटल व्योम rt2500pci_config_ant(काष्ठा rt2x00_dev *rt2x00dev,
...
अणु
	...
	reg = rt2x00mmio_रेजिस्टर_पढ़ो(rt2x00dev, BBPCSR1);
	r14 = rt2500pci_bbp_पढ़ो(rt2x00dev, 14);
	r2 = rt2500pci_bbp_पढ़ो(rt2x00dev, 2);
	...
	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, BBPCSR1, reg);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 14, r14);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 2, r2);
पूर्ण

अटल व्योम rt2500pci_config_channel(काष्ठा rt2x00_dev *rt2x00dev,
...
अणु
	 ...
	 * For RT2523 devices we करो not need to update the R1 रेजिस्टर.
	 */
	अगर (!rt2x00_rf(rt2x00dev, RF2523))
	 ...
	 */
	अगर (rt2x00_rf(rt2x00dev, RF2525)) अणु
		...
		rt2500pci_rf_ग_लिखो(rt2x00dev, 1, rf->rf1);
		rt2500pci_rf_ग_लिखो(rt2x00dev, 2, vals[rf->channel - 1]);
		rt2500pci_rf_ग_लिखो(rt2x00dev, 3, rf->rf3);
		अगर (rf->rf4)
			rt2500pci_rf_ग_लिखो(rt2x00dev, 4, rf->rf4);
	पूर्ण

	rt2500pci_rf_ग_लिखो(rt2x00dev, 1, rf->rf1);
	rt2500pci_rf_ग_लिखो(rt2x00dev, 2, rf->rf2);
	rt2500pci_rf_ग_लिखो(rt2x00dev, 3, rf->rf3);
	अगर (rf->rf4)
		rt2500pci_rf_ग_लिखो(rt2x00dev, 4, rf->rf4);
	...
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 70, r70);
	 ...
	 * For RT2523 devices we करो not need to update the R1 रेजिस्टर.
	 */
	अगर (!rt2x00_rf(rt2x00dev, RF2523)) अणु
...
अटल व्योम rt2500pci_config_txघातer(काष्ठा rt2x00_dev *rt2x00dev,
...
अणु
	...
	rt2500pci_rf_ग_लिखो(rt2x00dev, 3, rf3);
पूर्ण

अटल व्योम rt2500pci_config_retry_limit(काष्ठा rt2x00_dev *rt2x00dev,
...
अटल व्योम rt2500pci_config_ps(काष्ठा rt2x00_dev *rt2x00dev,
				काष्ठा rt2x00lib_conf *libconf)
अणु
...
अटल व्योम rt2500pci_config(काष्ठा rt2x00_dev *rt2x00dev,
			     काष्ठा rt2x00lib_conf *libconf,
			     स्थिर अचिन्हित पूर्णांक flags)
अणु
	...
	अगर ((flags & IEEE80211_CONF_CHANGE_POWER) &&
		...
		rt2500pci_config_txघातer(rt2x00dev,
					 libconf->conf->घातer_level);
 ...
 * Link tuning
 */
अटल व्योम rt2500pci_link_stats(काष्ठा rt2x00_dev *rt2x00dev,
...
अणु
	 ...
	 */
	reg = rt2x00mmio_रेजिस्टर_पढ़ो(rt2x00dev, CNT3);
	qual->false_cca = rt2x00_get_field32(reg, CNT3_FALSE_CCA);
पूर्ण

अटल अंतरभूत व्योम rt2500pci_set_vgc(काष्ठा rt2x00_dev *rt2x00dev,
				     काष्ठा link_qual *qual, u8 vgc_level)
अणु
	अगर (qual->vgc_level_reg != vgc_level) अणु
		rt2500pci_bbp_ग_लिखो(rt2x00dev, 17, vgc_level);
		qual->vgc_level = vgc_level;
		qual->vgc_level_reg = vgc_level;
	पूर्ण
पूर्ण

अटल व्योम rt2500pci_reset_tuner(काष्ठा rt2x00_dev *rt2x00dev,
				  काष्ठा link_qual *qual)
अणु
	rt2500pci_set_vgc(rt2x00dev, qual, 0x48);
पूर्ण

अटल व्योम rt2500pci_link_tuner(काष्ठा rt2x00_dev *rt2x00dev,
				 काष्ठा link_qual *qual, स्थिर u32 count)
अणु
	/*
	 * To prevent collisions with MAC ASIC on chipsets
	 * up to version C the link tuning should halt after 20
	 * seconds जबतक being associated.
	 */
	अगर (rt2x00_rev(rt2x00dev) < RT2560_VERSION_D &&
	    rt2x00dev->पूर्णांकf_associated && count > 20)
		वापस;

	/*
	 * Chipset versions C and lower should directly जारी
	 ...
	 */
	अगर (qual->rssi < -80 && count > 20) अणु
		अगर (qual->vgc_level_reg >= 0x41)
	...
	/*
	 * Leave लघु or middle distance condition, restore r17
	 * to the dynamic tuning range.
	 */
	अगर (qual->vgc_level_reg >= 0x41) अणु
		rt2500pci_set_vgc(rt2x00dev, qual, qual->vgc_level);
		वापस;
	पूर्ण
...
dynamic_cca_tune:
	 ...
	 */
	अगर (qual->false_cca > 512 && qual->vgc_level_reg < 0x40)
		rt2500pci_set_vgc(rt2x00dev, qual, ++qual->vgc_level_reg);
	अन्यथा अगर (qual->false_cca < 100 && qual->vgc_level_reg > 0x32)
		rt2500pci_set_vgc(rt2x00dev, qual, --qual->vgc_level_reg);
पूर्ण
 ...
 * Queue handlers.
 */
अटल व्योम rt2500pci_start_queue(काष्ठा data_queue *queue)
अणु
...
अटल व्योम rt2500pci_kick_queue(काष्ठा data_queue *queue)
अणु
	काष्ठा rt2x00_dev *rt2x00dev = queue->rt2x00dev;
	u32 reg;
...
अटल व्योम rt2500pci_stop_queue(काष्ठा data_queue *queue)
अणु
	काष्ठा rt2x00_dev *rt2x00dev = queue->rt2x00dev;
	u32 reg;
 ...
 */
अटल bool rt2500pci_get_entry_state(काष्ठा queue_entry *entry)
अणु
...
अटल व्योम rt2500pci_clear_entry(काष्ठा queue_entry *entry)
अणु
	काष्ठा queue_entry_priv_mmio *entry_priv = entry->priv_data;
...
अटल पूर्णांक rt2500pci_init_queues(काष्ठा rt2x00_dev *rt2x00dev)
अणु
...
अटल पूर्णांक rt2500pci_init_रेजिस्टरs(काष्ठा rt2x00_dev *rt2x00dev)
अणु
	u32 reg;

	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, PSCSR0, 0x00020002);
	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, PSCSR1, 0x00000002);
	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, PSCSR2, 0x00020002);
	...
	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, CNT3, 0);

	reg = rt2x00mmio_रेजिस्टर_पढ़ो(rt2x00dev, TXCSR8);
	...
	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, TXCSR8, reg);

	reg = rt2x00mmio_रेजिस्टर_पढ़ो(rt2x00dev, ARTCSR0);
	rt2x00_set_field32(&reg, ARTCSR0_ACK_CTS_1MBS, 112);
	rt2x00_set_field32(&reg, ARTCSR0_ACK_CTS_2MBS, 56);
	rt2x00_set_field32(&reg, ARTCSR0_ACK_CTS_5_5MBS, 20);
	rt2x00_set_field32(&reg, ARTCSR0_ACK_CTS_11MBS, 10);
	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, ARTCSR0, reg);

	reg = rt2x00mmio_रेजिस्टर_पढ़ो(rt2x00dev, ARTCSR1);
	rt2x00_set_field32(&reg, ARTCSR1_ACK_CTS_6MBS, 45);
	rt2x00_set_field32(&reg, ARTCSR1_ACK_CTS_9MBS, 37);
	rt2x00_set_field32(&reg, ARTCSR1_ACK_CTS_12MBS, 33);
	rt2x00_set_field32(&reg, ARTCSR1_ACK_CTS_18MBS, 29);
	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, ARTCSR1, reg);

	reg = rt2x00mmio_रेजिस्टर_पढ़ो(rt2x00dev, ARTCSR2);
	rt2x00_set_field32(&reg, ARTCSR2_ACK_CTS_24MBS, 29);
	rt2x00_set_field32(&reg, ARTCSR2_ACK_CTS_36MBS, 25);
	rt2x00_set_field32(&reg, ARTCSR2_ACK_CTS_48MBS, 25);
	rt2x00_set_field32(&reg, ARTCSR2_ACK_CTS_54MBS, 25);
	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, ARTCSR2, reg);
	...
	reg = rt2x00mmio_रेजिस्टर_पढ़ो(rt2x00dev, PCICSR);
	...
	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, PCICSR, reg);

	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, PWRCSR0, 0x3f3b3100);

	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, GPIOCSR, 0x0000ff00);
	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, TESTCSR, 0x000000f0);

	अगर (rt2x00dev->ops->lib->set_device_state(rt2x00dev, STATE_AWAKE))
		वापस -EBUSY;

	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, MACCSR0, 0x00213223);
	...
	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, BBPCSR1, 0x82188200);

	rt2x00mmio_रेजिस्टर_ग_लिखो(rt2x00dev, TXACKCSR0, 0x00000020);
...
अटल पूर्णांक rt2500pci_रुको_bbp_पढ़ोy(काष्ठा rt2x00_dev *rt2x00dev)
अणु
	अचिन्हित पूर्णांक i;
	u8 value;

	क्रम (i = 0; i < REGISTER_BUSY_COUNT; i++) अणु
		value = rt2500pci_bbp_पढ़ो(rt2x00dev, 0);
...
अटल पूर्णांक rt2500pci_init_bbp(काष्ठा rt2x00_dev *rt2x00dev)
अणु
	अचिन्हित पूर्णांक i;
	u16 eeprom;
	u8 reg_id;
	...
	अगर (unlikely(rt2500pci_रुको_bbp_पढ़ोy(rt2x00dev)))
		वापस -EACCES;

	rt2500pci_bbp_ग_लिखो(rt2x00dev, 3, 0x02);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 4, 0x19);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 14, 0x1c);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 15, 0x30);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 16, 0xac);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 18, 0x18);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 19, 0xff);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 20, 0x1e);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 21, 0x08);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 22, 0x08);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 23, 0x08);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 24, 0x70);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 25, 0x40);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 26, 0x08);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 27, 0x23);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 30, 0x10);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 31, 0x2b);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 32, 0xb9);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 34, 0x12);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 35, 0x50);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 39, 0xc4);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 40, 0x02);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 41, 0x60);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 53, 0x10);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 54, 0x18);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 56, 0x08);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 57, 0x10);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 58, 0x08);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 61, 0x6d);
	rt2500pci_bbp_ग_लिखो(rt2x00dev, 62, 0x10);
	...
	क्रम (i = 0; i < EEPROM_BBP_SIZE; i++) अणु
		...
		अगर (eeprom != 0xffff && eeprom != 0x0000) अणु
			...
			rt2500pci_bbp_ग_लिखो(rt2x00dev, reg_id, value);
		पूर्ण
	पूर्ण
 ...
 */
अटल व्योम rt2500pci_toggle_irq(काष्ठा rt2x00_dev *rt2x00dev,
				 क्रमागत dev_state state)
अणु
...
अटल पूर्णांक rt2500pci_enable_radio(काष्ठा rt2x00_dev *rt2x00dev)
अणु
	/*
	 * Initialize all रेजिस्टरs.
	 */
	अगर (unlikely(rt2500pci_init_queues(rt2x00dev) ||
		     rt2500pci_init_रेजिस्टरs(rt2x00dev) ||
...
अटल व्योम rt2500pci_disable_radio(काष्ठा rt2x00_dev *rt2x00dev)
अणु
	/*
	 * Disable घातer
	 */
...
अटल पूर्णांक rt2500pci_set_state(काष्ठा rt2x00_dev *rt2x00dev,
			       क्रमागत dev_state state)
अणु
	u32 reg, reg2;
	अचिन्हित पूर्णांक i;
...
अटल पूर्णांक rt2500pci_set_device_state(काष्ठा rt2x00_dev *rt2x00dev,
				      क्रमागत dev_state state)
अणु
	पूर्णांक retval = 0;
 ...
 */
अटल व्योम rt2500pci_ग_लिखो_tx_desc(काष्ठा queue_entry *entry,
...
अणु
	...
	rt2x00_set_field32(&word, TXD_W2_AIFS, entry->queue->aअगरs);
	...
	word = rt2x00_desc_पढ़ो(txd, 10);
	rt2x00_set_field32(&word, TXD_W10_RTS,
			   test_bit(ENTRY_TXD_RTS_FRAME, &txdesc->flags));
	rt2x00_desc_ग_लिखो(txd, 10, word);
 ...
 */
अटल व्योम rt2500pci_ग_लिखो_beacon(काष्ठा queue_entry *entry,
				   काष्ठा txentry_desc *txdesc)
अणु
	 ...
	 */
	rt2500pci_ग_लिखो_tx_desc(entry, txdesc);
 ...
 * RX control handlers
 */
अटल व्योम rt2500pci_fill_rxकरोne(काष्ठा queue_entry *entry,
...
अणु
	 ...
	 */
	rxdesc->संकेत = rt2x00_get_field32(word2, RXD_W2_SIGNAL);
 ...
 * Interrupt functions.
 */
अटल व्योम rt2500pci_txकरोne(काष्ठा rt2x00_dev *rt2x00dev,
...
अटल अंतरभूत व्योम rt2500pci_enable_पूर्णांकerrupt(काष्ठा rt2x00_dev *rt2x00dev,
...
अटल व्योम rt2500pci_txstatus_tasklet(काष्ठा tasklet_काष्ठा *t)
अणु
	 ...
	 */
	rt2500pci_txकरोne(rt2x00dev, QID_ATIM);
	rt2500pci_txकरोne(rt2x00dev, QID_AC_VO);
	rt2500pci_txकरोne(rt2x00dev, QID_AC_VI);
...
अटल व्योम rt2500pci_tbtt_tasklet(काष्ठा tasklet_काष्ठा *t)
अणु
	...
	अगर (test_bit(DEVICE_STATE_ENABLED_RADIO, &rt2x00dev->flags))
		rt2500pci_enable_पूर्णांकerrupt(rt2x00dev, CSR8_TBCN_EXPIRE);
पूर्ण

अटल व्योम rt2500pci_rxकरोne_tasklet(काष्ठा tasklet_काष्ठा *t)
अणु
	काष्ठा rt2x00_dev *rt2x00dev = from_tasklet(rt2x00dev, t,
						    rxकरोne_tasklet);
	...
	अन्यथा अगर (test_bit(DEVICE_STATE_ENABLED_RADIO, &rt2x00dev->flags))
		rt2500pci_enable_पूर्णांकerrupt(rt2x00dev, CSR8_RXDONE);
पूर्ण

अटल irqवापस_t rt2500pci_पूर्णांकerrupt(पूर्णांक irq, व्योम *dev_instance)
अणु
 ...
 */
अटल पूर्णांक rt2500pci_validate_eeprom(काष्ठा rt2x00_dev *rt2x00dev)
अणु
	...
	eeprom.रेजिस्टर_पढ़ो = rt2500pci_eepromरेजिस्टर_पढ़ो;
	eeprom.रेजिस्टर_ग_लिखो = rt2500pci_eepromरेजिस्टर_ग_लिखो;
...
अटल पूर्णांक rt2500pci_init_eeprom(काष्ठा rt2x00_dev *rt2x00dev)
अणु
	u32 reg;
	u16 value;
	u16 eeprom;
...
#पूर्ण_अगर /* CONFIG_RT2X00_LIB_LEDS */
	 ...
	 */
	अगर (rt2x00_get_field16(eeprom, EEPROM_ANTENNA_HARDWARE_RADIO)) अणु
		__set_bit(CAPABILITY_HW_BUTTON, &rt2x00dev->cap_flags);
		/*
		 * On this device RFKILL initialized during probe करोes not work.
		 */
	...
	अगर (!rt2x00_get_field16(eeprom, EEPROM_NIC_DYN_BBP_TUNE))
...
अटल स्थिर काष्ठा rf_channel rf_vals_bg_2525e[] = अणु
	अणु 1,  0x00022020, 0x00081136, 0x00060111, 0x00000a0b पूर्ण,
	अणु 2,  0x00022020, 0x0008113a, 0x00060111, 0x00000a0b पूर्ण,
	अणु 3,  0x00022020, 0x0008113e, 0x00060111, 0x00000a0b पूर्ण,
	अणु 4,  0x00022020, 0x00081182, 0x00060111, 0x00000a0b पूर्ण,
	अणु 5,  0x00022020, 0x00081186, 0x00060111, 0x00000a0b पूर्ण,
	अणु 6,  0x00022020, 0x0008118a, 0x00060111, 0x00000a0b पूर्ण,
	अणु 7,  0x00022020, 0x0008118e, 0x00060111, 0x00000a0b पूर्ण,
	अणु 8,  0x00022020, 0x00081192, 0x00060111, 0x00000a0b पूर्ण,
	अणु 9,  0x00022020, 0x00081196, 0x00060111, 0x00000a0b पूर्ण,
	अणु 10, 0x00022020, 0x0008119a, 0x00060111, 0x00000a0b पूर्ण,
	अणु 11, 0x00022020, 0x0008119e, 0x00060111, 0x00000a0b पूर्ण,
	अणु 12, 0x00022020, 0x000811a2, 0x00060111, 0x00000a0b पूर्ण,
	अणु 13, 0x00022020, 0x000811a6, 0x00060111, 0x00000a0b पूर्ण,
	अणु 14, 0x00022020, 0x000811ae, 0x00060111, 0x00000a1b पूर्ण,
पूर्ण;
...
अटल पूर्णांक rt2500pci_probe_hw_mode(काष्ठा rt2x00_dev *rt2x00dev)
अणु
...
अटल पूर्णांक rt2500pci_probe_hw(काष्ठा rt2x00_dev *rt2x00dev)
अणु
	पूर्णांक retval;
	u32 reg;
 ...
 */
अटल u64 rt2500pci_get_tsf(काष्ठा ieee80211_hw *hw,
...
अटल पूर्णांक rt2500pci_tx_last_beacon(काष्ठा ieee80211_hw *hw)
अणु
	काष्ठा rt2x00_dev *rt2x00dev = hw->priv;
	u32 reg;
...
अटल स्थिर काष्ठा ieee80211_ops rt2500pci_mac80211_ops = अणु
	.tx			= rt2x00mac_tx,
...
अटल स्थिर काष्ठा rt2x00lib_ops rt2500pci_rt2x00_ops = अणु
	.irq_handler		= rt2500pci_पूर्णांकerrupt,
	.txstatus_tasklet	= rt2500pci_txstatus_tasklet,
	.tbtt_tasklet		= rt2500pci_tbtt_tasklet,
	.rxकरोne_tasklet		= rt2500pci_rxकरोne_tasklet,
	...
	.rfसमाप्त_poll		= rt2500pci_rfसमाप्त_poll,
	...
	.ग_लिखो_tx_desc		= rt2500pci_ग_लिखो_tx_desc,
	.ग_लिखो_beacon		= rt2500pci_ग_लिखो_beacon,
	.fill_rxकरोne		= rt2500pci_fill_rxकरोne,
	.config_filter		= rt2500pci_config_filter,
	.config_पूर्णांकf		= rt2500pci_config_पूर्णांकf,
	.config_erp		= rt2500pci_config_erp,
	.config_ant		= rt2500pci_config_ant,
	.config			= rt2500pci_config,
पूर्ण;

अटल व्योम rt2500pci_queue_init(काष्ठा data_queue *queue)
अणु
	चयन (queue->qid) अणु
	हाल QID_RX:
		queue->limit = 32;
...
अटल स्थिर काष्ठा rt2x00_ops rt2500pci_ops = अणु
	.name			= KBUILD_MODNAME,
	.max_ap_पूर्णांकf		= 1,
...
/*
 * RT2500pci module inक्रमmation.
 */
अटल स्थिर काष्ठा pci_device_id rt2500pci_device_table[] = अणु
	अणु PCI_DEVICE(0x1814, 0x0201) पूर्ण,
	अणु 0, पूर्ण
पूर्ण;
...
अटल पूर्णांक rt2500pci_probe(काष्ठा pci_dev *pci_dev,
			   स्थिर काष्ठा pci_device_id *id)
अणु
	वापस rt2x00pci_probe(pci_dev, &rt2500pci_ops);
पूर्ण

अटल काष्ठा pci_driver rt2500pci_driver = अणु
	.name		= KBUILD_MODNAME,
