...
#अगर_अघोषित __MT7921_MAC_H
#घोषणा __MT7921_MAC_H
...
#घोषणा MT_PRXV_FRAME_MODE		GENMASK(14, 12)
#घोषणा MT_PRXV_SGI			GENMASK(16, 15)
#घोषणा MT_PRXV_STBC			GENMASK(23, 22)
#घोषणा MT_PRXV_TX_MODE			GENMASK(27, 24)
...
अटल अंतरभूत काष्ठा mt7921_txp_common *
mt7921_txwi_to_txp(काष्ठा mt76_dev *dev, काष्ठा mt76_txwi_cache *t)
अणु
	u8 *txwi;
	...
	वापस (काष्ठा mt7921_txp_common *)(txwi + MT_TXD_SIZE);
पूर्ण
...
काष्ठा mt7921_hw_txp अणु
	__le16 msdu_id[MT_HW_TXP_MAX_MSDU_NUM];
	काष्ठा mt7921_txp_ptr ptr[MT_HW_TXP_MAX_BUF_NUM / 2];
पूर्ण __packed __aligned(4);

काष्ठा mt7921_txp_common अणु
	जोड़ अणु
		काष्ठा mt7921_hw_txp hw;
	पूर्ण;
पूर्ण;
