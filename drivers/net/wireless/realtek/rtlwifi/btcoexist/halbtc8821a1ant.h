...
/*===========================================
 * The following is क्रम 8821A 1ANT BT Co-exist definition
 *===========================================
 */
#घोषणा	BT_INFO_8821A_1ANT_B_FTP	BIT7
#घोषणा	BT_INFO_8821A_1ANT_B_A2DP	BIT6
#घोषणा	BT_INFO_8821A_1ANT_B_HID	BIT5
#घोषणा	BT_INFO_8821A_1ANT_B_SCO_BUSY	BIT4
#घोषणा	BT_INFO_8821A_1ANT_B_ACL_BUSY	BIT3
#घोषणा	BT_INFO_8821A_1ANT_B_INQ_PAGE	BIT2
#घोषणा	BT_INFO_8821A_1ANT_B_SCO_ESCO	BIT1
#घोषणा	BT_INFO_8821A_1ANT_B_CONNECTION	BIT0

#घोषणा	BT_INFO_8821A_1ANT_A2DP_BASIC_RATE(_BT_INFO_EXT_)	\
		(((_BT_INFO_EXT_&BIT0)) ? true : false)

#घोषणा	BTC_RSSI_COEX_THRESH_TOL_8821A_1ANT		2

क्रमागत _BT_INFO_SRC_8821A_1ANT अणु
...
क्रमागत _BT_8821A_1ANT_BT_STATUS अणु
...
क्रमागत _BT_8821A_1ANT_WIFI_STATUS अणु
...
क्रमागत BT_8821A_1ANT_COEX_ALGO अणु
...
काष्ठा coex_sta_8821a_1ant अणु
	bool	bt_disabled;
	bool	bt_link_exist;
	bool	sco_exist;
	bool	a2dp_exist;
 ...
 *===========================================
 */
व्योम ex_btc8821a1ant_init_hwconfig(काष्ठा btc_coexist *btcoexist,
				   bool wअगरi_only);
...
व्योम ex_btc8821a1ant_pnp_notअगरy(काष्ठा btc_coexist *btcoexist, u8 pnpstate);
...
व्योम ex_btc8821a1ant_display_coex_info(काष्ठा btc_coexist *btcoexist,
				       काष्ठा seq_file *m);
व्योम ex_btc8821a1ant_dbg_control(काष्ठा btc_coexist *btcoexist, u8 op_code,
				 u8 op_len, u8 *data);
