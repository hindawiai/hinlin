...
#अगर_अघोषित __RTL92DE_TRX_H__
#घोषणा __RTL92DE_TRX_H__
...
अणु
	स_रखो((व्योम *)__pdesc, 0,
	       min_t(माप_प्रकार, _size, TX_DESC_NEXT_DESC_OFFSET));
पूर्ण
...
bool rtl92de_rx_query_desc(काष्ठा ieee80211_hw *hw,
			   काष्ठा rtl_stats *stats,
			   काष्ठा ieee80211_rx_status *rx_status,
			   u8 *pdesc, काष्ठा sk_buff *skb);
व्योम rtl92de_set_desc(काष्ठा ieee80211_hw *hw, u8 *pdesc, bool istx,
		      u8 desc_name, u8 *val);
...
व्योम rtl92de_tx_fill_cmddesc(काष्ठा ieee80211_hw *hw, u8 *pdesc,
