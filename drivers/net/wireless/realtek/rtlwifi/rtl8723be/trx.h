...
#अगर_अघोषित __RTL8723BE_TRX_H__
#घोषणा __RTL8723BE_TRX_H__

#घोषणा TX_DESC_SIZE				40
...
अटल अंतरभूत व्योम set_tx_desc_hwseq_sel(__le32 *__pdesc, u32 __val)
अणु
...
अटल अंतरभूत u32 get_rx_desc_pkt_len(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*__pdesc, GENMASK(13, 0));
पूर्ण

अटल अंतरभूत u32 get_rx_desc_crc32(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*__pdesc, BIT(14));
पूर्ण

अटल अंतरभूत u32 get_rx_desc_icv(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*__pdesc, BIT(15));
पूर्ण

अटल अंतरभूत u32 get_rx_desc_drv_info_size(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*__pdesc, GENMASK(19, 16));
पूर्ण

अटल अंतरभूत u32 get_rx_desc_shअगरt(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*__pdesc, GENMASK(25, 24));
पूर्ण

अटल अंतरभूत u32 get_rx_desc_physt(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*__pdesc, BIT(26));
पूर्ण

अटल अंतरभूत u32 get_rx_desc_swdec(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*__pdesc, BIT(27));
पूर्ण

अटल अंतरभूत u32 get_rx_desc_own(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*__pdesc, BIT(31));
पूर्ण
...
अटल अंतरभूत u32 get_rx_desc_macid(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*(__pdesc + 1), GENMASK(6, 0));
पूर्ण

अटल अंतरभूत u32 get_rx_desc_paggr(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*(__pdesc + 1), BIT(15));
पूर्ण

अटल अंतरभूत u32 get_rx_status_desc_rpt_sel(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*(__pdesc + 2), BIT(28));
पूर्ण

अटल अंतरभूत u32 get_rx_desc_rxmcs(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*(__pdesc + 3), GENMASK(6, 0));
पूर्ण

अटल अंतरभूत u32 get_rx_desc_rxht(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*(__pdesc + 3), BIT(6));
पूर्ण

अटल अंतरभूत u32 get_rx_status_desc_pattern_match(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*(__pdesc + 3), BIT(29));
पूर्ण

अटल अंतरभूत u32 get_rx_status_desc_unicast_match(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*(__pdesc + 3), BIT(30));
पूर्ण

अटल अंतरभूत u32 get_rx_status_desc_magic_match(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*(__pdesc + 3), BIT(31));
पूर्ण

अटल अंतरभूत u32 get_rx_desc_splcp(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*(__pdesc + 4), BIT(0));
पूर्ण

अटल अंतरभूत u32 get_rx_desc_bw(__le32 *__pdesc)
अणु
	वापस le32_get_bits(*(__pdesc + 4), GENMASK(5, 4));
पूर्ण
...
अटल अंतरभूत u32 get_rx_rpt2_desc_macid_valid_1(__le32 *__rxstatusdesc)
अणु
	वापस le32_to_cpu(*((__rxstatusdesc + 4)));
पूर्ण

अटल अंतरभूत u32 get_rx_rpt2_desc_macid_valid_2(__le32 *__rxstatusdesc)
अणु
	वापस le32_to_cpu(*((__rxstatusdesc + 5)));
पूर्ण
...
अटल अंतरभूत व्योम clear_pci_tx_desc_content(__le32 *__pdesc, u32 _size)
अणु
...
व्योम rtl8723be_set_desc(काष्ठा ieee80211_hw *hw, u8 *pdesc,
...
व्योम rtl8723be_tx_fill_cmddesc(काष्ठा ieee80211_hw *hw, u8 *pdesc,
