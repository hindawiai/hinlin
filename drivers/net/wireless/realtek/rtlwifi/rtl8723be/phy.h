...
#अगर_अघोषित __RTL8723BE_PHY_H__
#घोषणा __RTL8723BE_PHY_H__
...
#घोषणा TARGET_CHNL_NUM_2G_5G		59
...
u32 rtl8723be_phy_query_rf_reg(काष्ठा ieee80211_hw *hw,
			       क्रमागत radio_path rfpath,
			       u32 regaddr, u32 biपंचांगask);
व्योम rtl8723be_phy_set_rf_reg(काष्ठा ieee80211_hw *hw,
			      क्रमागत radio_path rfpath,
...
व्योम rtl8723be_phy_set_txघातer_level(काष्ठा ieee80211_hw *hw,
				     u8 channel);
व्योम rtl8723be_phy_scan_operation_backup(काष्ठा ieee80211_hw *hw,
					 u8 operation);
...
व्योम rtl8723be_phy_iq_calibrate(काष्ठा ieee80211_hw *hw,
				bool b_recovery);
