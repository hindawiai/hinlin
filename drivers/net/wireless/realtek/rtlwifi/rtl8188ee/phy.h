...
/* MAX_TX_COUNT must always set to 4, otherwise पढ़ो efuse
...
u32 rtl88e_phy_query_bb_reg(काष्ठा ieee80211_hw *hw,
...
व्योम rtl88e_phy_get_txघातer_level(काष्ठा ieee80211_hw *hw,
				  दीर्घ *घातerlevel);
व्योम rtl88e_phy_set_txघातer_level(काष्ठा ieee80211_hw *hw, u8 channel);
व्योम rtl88e_phy_scan_operation_backup(काष्ठा ieee80211_hw *hw,
				      u8 operation);
