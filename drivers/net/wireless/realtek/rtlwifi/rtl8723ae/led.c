...
अटल व्योम _rtl8723e_init_led(काष्ठा ieee80211_hw *hw,
...
व्योम rtl8723e_sw_led_on(काष्ठा ieee80211_hw *hw, काष्ठा rtl_led *pled)
अणु
	u8 ledcfg;
...
व्योम rtl8723e_sw_led_off(काष्ठा ieee80211_hw *hw, काष्ठा rtl_led *pled)
अणु
	काष्ठा rtl_priv *rtlpriv = rtl_priv(hw);
	u8 ledcfg;
...
व्योम rtl8723e_init_sw_leds(काष्ठा ieee80211_hw *hw)
अणु
	काष्ठा rtl_priv *rtlpriv = rtl_priv(hw);
...
अटल व्योम _rtl8723e_sw_led_control(काष्ठा ieee80211_hw *hw,
...
व्योम rtl8723e_led_control(काष्ठा ieee80211_hw *hw,
			  क्रमागत led_ctl_mode ledaction)
अणु
	काष्ठा rtl_priv *rtlpriv = rtl_priv(hw);
