...
#अगर_अघोषित __RTL8723E_DEF_H__
#घोषणा __RTL8723E_DEF_H__
...
#घोषणा IS_81XXC(version)	((GET_CVID_IC_TYPE(version) == 0) ?\
						true : false)
#घोषणा IS_8723_SERIES(version)	((GET_CVID_IC_TYPE(version) == CHIP_8723) ? \
						true : false)
...
#घोषणा IS_2T2R(version)	((GET_CVID_RF_TYPE(version) == RF_TYPE_2T2R)\
						? true : false)
#घोषणा IS_CHIP_VENDOR_UMC(version)	((GET_CVID_MANUFACTUER(version)) ? \
						true : false)

#घोषणा IS_VENDOR_UMC_A_CUT(version)	((IS_CHIP_VENDOR_UMC(version))\
					? ((GET_CVID_CUT_VERSION(version)) ? \
					false : true) : false)
#घोषणा IS_VENDOR_8723_A_CUT(version)	((IS_8723_SERIES(version))\
					? ((GET_CVID_CUT_VERSION(version)) ? \
					false : true) : false)
#घोषणा IS_VENDOR_8723A_B_CUT(version)	((IS_8723_SERIES(version))\
		? ((GET_CVID_CUT_VERSION(version) == \
		B_CUT_VERSION) ? true : false) : false)
#घोषणा IS_81XXC_VENDOR_UMC_B_CUT(version)	((IS_CHIP_VENDOR_UMC(version))\
		? ((GET_CVID_CUT_VERSION(version) == \
		B_CUT_VERSION) ? true : false) : false)
...
क्रमागत घातer_policy_config अणु
...
काष्ठा phy_sts_cck_8723e_t अणु
	u8 adc_pwdb_X[4];
	u8 sq_rpt;
	u8 cck_agc_rpt;
पूर्ण;

काष्ठा h2c_cmd_8723e अणु
	u8 element_id;
	u32 cmd_len;
	u8 *p_cmdbuffer;
पूर्ण;
