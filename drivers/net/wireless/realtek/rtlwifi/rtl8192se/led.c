...
अटल व्योम _rtl92se_init_led(काष्ठा ieee80211_hw *hw,
...
अणु
	...
	ledcfg = rtl_पढ़ो_byte(rtlpriv, LEDCFG);

	चयन (pled->ledpin) अणु
	हाल LED_PIN_GPIO0:
		अवरोध;
	हाल LED_PIN_LED0:
		rtl_ग_लिखो_byte(rtlpriv, LEDCFG, ledcfg & 0xf0);
		अवरोध;
	हाल LED_PIN_LED1:
		rtl_ग_लिखो_byte(rtlpriv, LEDCFG, ledcfg & 0x0f);
		अवरोध;
	शेष:
...
अणु
	...
	हाल LED_PIN_LED0:
		...
		अगर (rtlpriv->ledctl.led_खोलोdrain)
			rtl_ग_लिखो_byte(rtlpriv, LEDCFG, (ledcfg | BIT(1)));
		अन्यथा
			rtl_ग_लिखो_byte(rtlpriv, LEDCFG, (ledcfg | BIT(3)));
		अवरोध;
	हाल LED_PIN_LED1:
		ledcfg &= 0x0f;
		rtl_ग_लिखो_byte(rtlpriv, LEDCFG, (ledcfg | BIT(3)));
...
अटल व्योम _rtl92se_sw_led_control(काष्ठा ieee80211_hw *hw,
