...
#अगर_अघोषित	__RTL8821AE_DM_H__
#घोषणा __RTL8821AE_DM_H__
...
#घोषणा	DM_REG_CCK_CCA_11AC			0xA0A
...
#घोषणा	DM_BIT_IGI_11AC					0xFFFFFFFF
...
#घोषणा GET_UNDECORATED_AVERAGE_RSSI(_priv)     \
	...
	(((काष्ठा rtl_priv *)(_priv))->dm.entry_min_undec_sm_pwdb) : \
	(((काष्ठा rtl_priv *)(_priv))->dm.undec_sm_pwdb))

व्योम rtl8821ae_dm_set_tx_ant_by_tx_info(काष्ठा ieee80211_hw *hw,
					u8 *pdesc, u32 mac_id);
व्योम rtl8821ae_dm_ant_sel_statistics(काष्ठा ieee80211_hw *hw,
				     u8 antsel_tr_mux, u32 mac_id,
				     u32 rx_pwdb_all);
व्योम rtl8821ae_dm_fast_antenna_training_callback(अचिन्हित दीर्घ data);
...
व्योम rtl8821ae_dm_initialize_txघातer_tracking_thermalmeter(काष्ठा ieee80211_hw *hw);
...
व्योम rtl8812ae_dm_txघातer_tracking_callback_thermalmeter(काष्ठा ieee80211_hw *hw);
व्योम rtl8821ae_dm_txघातer_tracking_callback_thermalmeter(काष्ठा ieee80211_hw *hw);
