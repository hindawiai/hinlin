...
#अगर_अघोषित __RTL8821AE_TRX_H__
#घोषणा __RTL8821AE_TRX_H__
...
अटल अंतरभूत व्योम set_tx_desc_tx_ant(__le32 *__pdesc, u32 __val)
अणु
...
अणु
	वापस le32_get_bits(*(__pdesc + 1), BIT(28));
पूर्ण
...
#घोषणा RTL8821AE_RX_HAL_IS_CCK_RATE(rxmcs)\
	(rxmcs == DESC_RATE1M ||\
	 rxmcs == DESC_RATE2M ||\
	 rxmcs == DESC_RATE5_5M ||\
	 rxmcs == DESC_RATE11M)
...
व्योम rtl8821ae_tx_fill_desc(काष्ठा ieee80211_hw *hw,
			    काष्ठा ieee80211_hdr *hdr, u8 *pdesc_tx, u8 *txbd,
...
व्योम rtl8821ae_set_desc(काष्ठा ieee80211_hw *hw, u8 *pdesc,
...
व्योम rtl8821ae_tx_fill_cmddesc(काष्ठा ieee80211_hw *hw, u8 *pdesc,
