...
/*
 * Definitions क्रम the new Marvell Yukon / SysKonnect driver.
 */
#अगर_अघोषित _SKGE_H
#घोषणा _SKGE_H
...
#घोषणा PCI_DEV_REG1	0x40
#घोषणा  PCI_PHY_COMA	0x8000000
#घोषणा  PCI_VIO	0x2000000

#घोषणा PCI_DEV_REG2	0x44
#घोषणा  PCI_VPD_ROM_SZ	7L<<14	/* VPD ROM size 0=256, 1=512, ... */
#घोषणा  PCI_REV_DESC	1<<2	/* Reverse Descriptor bytes */
...
/*	B0_CTST			16 bit	Control/Status रेजिस्टर */
क्रमागत अणु
...
क्रमागत अणु
	CHIP_ID_GENESIS	   = 0x0a, /* Chip ID क्रम GENESIS */
	CHIP_ID_YUKON	   = 0xb0, /* Chip ID क्रम YUKON */
	CHIP_ID_YUKON_LITE = 0xb1, /* Chip ID क्रम YUKON-Lite (Rev. A1-A3) */
	CHIP_ID_YUKON_LP   = 0xb2, /* Chip ID क्रम YUKON-LP */
	CHIP_ID_YUKON_XL   = 0xb3, /* Chip ID क्रम YUKON-2 XL */
	CHIP_ID_YUKON_EC   = 0xb6, /* Chip ID क्रम YUKON-2 EC */
 	CHIP_ID_YUKON_FE   = 0xb7, /* Chip ID क्रम YUKON-2 FE */

	CHIP_REV_YU_LITE_A1  = 3,	/* Chip Rev. क्रम YUKON-Lite A1,A2 */
	CHIP_REV_YU_LITE_A3  = 7,	/* Chip Rev. क्रम YUKON-Lite A3 */
पूर्ण;
...
क्रमागत अणु
	GP_सूची_9 = 1<<25, /* IO_9 direct, 0=In/1=Out */
	GP_सूची_8 = 1<<24, /* IO_8 direct, 0=In/1=Out */
	GP_सूची_7 = 1<<23, /* IO_7 direct, 0=In/1=Out */
	GP_सूची_6 = 1<<22, /* IO_6 direct, 0=In/1=Out */
	GP_सूची_5 = 1<<21, /* IO_5 direct, 0=In/1=Out */
	GP_सूची_4 = 1<<20, /* IO_4 direct, 0=In/1=Out */
	GP_सूची_3 = 1<<19, /* IO_3 direct, 0=In/1=Out */
	GP_सूची_2 = 1<<18, /* IO_2 direct, 0=In/1=Out */
	GP_सूची_1 = 1<<17, /* IO_1 direct, 0=In/1=Out */
	GP_सूची_0 = 1<<16, /* IO_0 direct, 0=In/1=Out */
...
क्रमागत अणु
	...
	BMU_खातापूर्ण		= 1<<29, /* End of Frame */
	BMU_IRQ_EOB	= 1<<28, /* Req "End of Buffer" IRQ */
	BMU_IRQ_खातापूर्ण	= 1<<27, /* Req "End of Frame" IRQ */
				/* TxCtrl specअगरic bits */
	BMU_STFWD	= 1<<26, /* (Tx)	Store & Forward Frame */
	BMU_NO_FCS	= 1<<25, /* (Tx) Disable MAC FCS (CRC) generation */
	BMU_SW	= 1<<24, /* (Tx)	1 bit res. क्रम SW use */
				/* RxCtrl specअगरic bits */
...
/* Timeout values */
#घोषणा SK_MAC_TO_53	72		/* MAC arbiter समयout */
#घोषणा SK_PKT_TO_53	0x2000		/* Packet arbiter समयout */
#घोषणा SK_PKT_TO_MAX	0xffff		/* Maximum value */
...
#घोषणा PA_ENA_TO_ALL	(PA_ENA_TO_RX1 | PA_ENA_TO_RX2 |\
...
क्रमागत अणु
	SK_PHY_XMAC	= 0,/* पूर्णांकegrated in XMAC II */
...
#घोषणा RB_ADDR(offs, queue) ((u16)B16_RAM_REGS + (u16)(queue) + (offs))

/* Receive MAC FIFO, Receive LED, and Link_Sync regs (GENESIS only) */
क्रमागत अणु
	RX_MFF_EA	= 0x0c00,/* 32 bit	Receive MAC FIFO End Address */
	RX_MFF_WP	= 0x0c04,/* 32 bit	Receive MAC FIFO Write Poपूर्णांकer */

	RX_MFF_RP	= 0x0c0c,/* 32 bit	Receive MAC FIFO Read Poपूर्णांकer */
...
क्रमागत अणु
	...
	MFF_ENA_W4E	= 1<<7,	/* Enable  Wait क्रम Empty */
	MFF_DIS_W4E	= 1<<6,	/* Disable Wait क्रम Empty */
...
क्रमागत अणु
	MFF_WSP_T_ON	= 1<<6,	/* Tx: Write Shaकरोw Ptr TestOn */
	MFF_WSP_T_OFF	= 1<<5,	/* Tx: Write Shaकरोw Ptr TstOff */
	MFF_WSP_INC	= 1<<4,	/* Tx: Write Shaकरोw Ptr Increment */
...
क्रमागत अणु
	MFF_WP_T_ON	= 1<<6,	/* Write Poपूर्णांकer Test On */
	MFF_WP_T_OFF	= 1<<5,	/* Write Poपूर्णांकer Test Off */
	MFF_WP_INC	= 1<<4,	/* Write Poपूर्णांकer Increm */

	MFF_RP_T_ON	= 1<<2,	/* Read Poपूर्णांकer Test On */
	MFF_RP_T_OFF	= 1<<1,	/* Read Poपूर्णांकer Test Off */
	MFF_RP_DEC	= 1<<0,	/* Read Poपूर्णांकer Decrement */
पूर्ण;
...
क्रमागत अणु
	...
	LED_SYNC_ON	= 1<<3,	/* Use Sync Wire to चयन LED */
	LED_SYNC_OFF	= 1<<2,	/* Disable Sync Wire Input */
	LED_REG_ON	= 1<<1,	/* चयन LED on */
	LED_REG_OFF	= 1<<0,	/* चयन LED off */
पूर्ण;
...
क्रमागत अणु
	...
	CSR_DESC_CLR	= 1<<21,	/* Clear Reset क्रम Descr */
	CSR_DESC_SET	= 1<<20,	/* Set   Reset क्रम Descr */
	CSR_FIFO_CLR	= 1<<19,	/* Clear Reset क्रम FIFO */
	CSR_FIFO_SET	= 1<<18,	/* Set   Reset क्रम FIFO */
	...
	CSR_IRQ_CL_F	= 1<<1,		/* Clear खातापूर्ण IRQ */
	CSR_IRQ_CL_C	= 1<<0,		/* Clear ERR IRQ */
पूर्ण;

#घोषणा CSR_SET_RESET	(CSR_DESC_SET | CSR_FIFO_SET | CSR_HPI_RST |\
			CSR_SV_RST | CSR_DREAD_RST | CSR_DWRITE_RST |\
			CSR_TRANS_RST)
#घोषणा CSR_CLR_RESET	(CSR_DESC_CLR | CSR_FIFO_CLR | CSR_HPI_RUN |\
...
क्रमागत अणु
	...
	F_FIFO_खातापूर्ण	= 1<<26,	/* Tag (खातापूर्ण Flag) bit in FIFO */
...
क्रमागत अणु
	...
	TX_MFF_WP	= 0x0d04,/* 32 bit	Transmit MAC FIFO WR Poपूर्णांकer */
	TX_MFF_WSP	= 0x0d08,/* 32 bit	Transmit MAC FIFO WR Shaकरोw Ptr */
	TX_MFF_RP	= 0x0d0c,/* 32 bit	Transmit MAC FIFO RD Poपूर्णांकer */
...
/* Counter and Timer स्थिरants, क्रम a host घड़ी of 62.5 MHz */
#घोषणा SK_XMIT_DUR		0x002faf08UL	/*  50 ms */
#घोषणा SK_BLK_DUR		0x01dcd650UL	/* 500 ms */

#घोषणा SK_DPOLL_DEF	0x00ee6b28UL	/* 250 ms at 62.5 MHz */

#घोषणा SK_DPOLL_MAX	0x00ffffffUL	/* 268 ms at 62.5 MHz */
					/* 215 ms at 78.12 MHz */

#घोषणा SK_FACT_62		100	/* is given in percent */
#घोषणा SK_FACT_53		 85     /* on GENESIS:	53.12 MHz */
#घोषणा SK_FACT_78		125	/* on YUKON:	78.12 MHz */
...
क्रमागत अणु
	BASE_XMAC_1	= 0x2000,/* XMAC 1 रेजिस्टरs */
	BASE_GMAC_1	= 0x2800,/* GMAC 1 रेजिस्टरs */
	BASE_XMAC_2	= 0x3000,/* XMAC 2 रेजिस्टरs */
...
क्रमागत अणु
	...
	PHY_X_RS_ABLMIS = 1<<4,	/* Bit  4:	duplex or छोड़ो cap mismatch */
	PHY_X_RS_PAUMIS = 1<<3,	/* Bit  3:	छोड़ो capability mismatch */
पूर्ण;
...
/*****  PHY_BCOM_AUX_CTRL	16 bit r/w	Auxiliary Control Reg *****/
	...
	PHY_B_AC_DIS_PRF	= 1<<7, /* Bit  7:	dis part resp filter */
									/* Bit  6:	reserved */
	PHY_B_AC_DIS_PM	= 1<<5, /* Bit  5:	dis घातer management */
									/* Bit  4:	reserved */
...
पूर्ण;
#घोषणा PHY_B_AS_PAUSE_MSK	(PHY_B_AS_PRR | PHY_B_AS_PRT)
...
क्रमागत अणु
	...
	PHY_M_EC_TRANS_DIS   = 1<<0, /* Transmitter Disable (88E1111 only) */पूर्ण;

#घोषणा PHY_M_EC_M_DSC(x)	((u16)(x)<<10) /* 00=1x; 01=2x; 10=3x; 11=4x */
#घोषणा PHY_M_EC_S_DSC(x)	((u16)(x)<<8) /* 00=dis; 01=1x; 10=2x; 11=3x */
#घोषणा PHY_M_EC_MAC_S(x)	((u16)(x)<<4) /* 01X=0; 110=2.5; 111=25 (MHz) */

#घोषणा PHY_M_EC_M_DSC_2(x)	((u16)(x)<<9) /* 000=1x; 001=2x; 010=3x; 011=4x */
...
/* values क्रम Cable Diagnostic Status (11=fail; 00=OK; 10=खोलो; 01=लघु) */
क्रमागत अणु
	CABD_STAT_NORMAL= 0,
	CABD_STAT_SHORT	= 1,
	CABD_STAT_OPEN	= 2,
...
#घोषणा PHY_M_FELP_LED2_CTRL(x)	(((x)<<8) & PHY_M_FELP_LED2_MSK)
#घोषणा PHY_M_FELP_LED1_CTRL(x)	(((x)<<4) & PHY_M_FELP_LED1_MSK)
#घोषणा PHY_M_FELP_LED0_CTRL(x)	(((x)<<0) & PHY_M_FELP_LED0_MSK)
...
/* MIB Counters */
#घोषणा GM_MIB_CNT_BASE	0x0100		/* Base Address of MIB Counters */
#घोषणा GM_MIB_CNT_SIZE	44		/* Number of MIB Counters */
...
#घोषणा GM_GPCR_AU_ALL_DIS	(GM_GPCR_AU_DUP_DIS | GM_GPCR_AU_FCT_DIS|GM_GPCR_AU_SPD_DIS)
...
#घोषणा TX_COL_DEF		0x04	/* late collision after 64 byte */
...
#घोषणा GM_SMI_CT_PHY_AD(x)	(((x)<<11) & GM_SMI_CT_PHY_A_MSK)
#घोषणा GM_SMI_CT_REG_AD(x)	(((x)<<6) & GM_SMI_CT_REG_A_MSK)
...
क्रमागत अणु
	GPC_SEL_BDT	= 1<<28, /* Select Bi-Dir. Transfer क्रम MDC/MDIO */
	...
	GPC_DIS_125	= 1<<17, /* Disable 125 MHz घड़ी */
...
#घोषणा GPC_HWCFG_GMII_COP (GPC_HWCFG_M_3|GPC_HWCFG_M_2 | GPC_HWCFG_M_1 | GPC_HWCFG_M_0)
#घोषणा GPC_HWCFG_GMII_FIB (GPC_HWCFG_M_2 | GPC_HWCFG_M_1 | GPC_HWCFG_M_0)
#घोषणा GPC_ANEG_ADV_ALL_M  (GPC_ANEG_3 | GPC_ANEG_2 | GPC_ANEG_1 | GPC_ANEG_0)

/* क्रमced speed and duplex mode (करोn't mix with other ANEG bits) */
#घोषणा GPC_FRC10MBIT_HALF	0
#घोषणा GPC_FRC10MBIT_FULL	GPC_ANEG_0
#घोषणा GPC_FRC100MBIT_HALF	GPC_ANEG_1
#घोषणा GPC_FRC100MBIT_FULL	(GPC_ANEG_0 | GPC_ANEG_1)

/* स्वतः-negotiation with limited advertised speeds */
/* mix only with master/slave settings (क्रम copper) */
#घोषणा GPC_ADV_1000_HALF	GPC_ANEG_2
#घोषणा GPC_ADV_1000_FULL	GPC_ANEG_3
#घोषणा GPC_ADV_ALL		(GPC_ANEG_2 | GPC_ANEG_3)

/* master/slave settings */
/* only क्रम copper with 1000 Mbps */
#घोषणा GPC_FORCE_MASTER	0
#घोषणा GPC_FORCE_SLAVE		GPC_ANEG_0
#घोषणा GPC_PREF_MASTER		GPC_ANEG_1
#घोषणा GPC_PREF_SLAVE		(GPC_ANEG_1 | GPC_ANEG_0)
...
#घोषणा GMAC_DEF_MSK	(GM_IS_RX_FF_OR | GM_IS_TX_FF_UR)
...
क्रमागत अणु
	...
	XM_BURST	= 0x000c, /* 32 bit r/w	Burst Register क्रम half duplex*/
	...
	XM_TX_STIME	= 0x0028, /* 16 bit r/w	Transmit Slotसमय Register */
	...
	XM_MAC_OPCODE	= 0x0074, /* 16 bit r/w	Opcode क्रम MAC control frames */
	XM_MAC_PTIME	= 0x0076, /* 16 bit r/w	Pause समय क्रम MAC ctrl frames*/
	XM_TX_STAT	= 0x0078, /* 32 bit r/o	Tx Status LIFO Register */

	XM_EXM_START	= 0x0080, /* r/w	Start Address of the EXM Regs */
#घोषणा XM_EXM(reg)	(XM_EXM_START + ((reg) << 3))
पूर्ण;
...
क्रमागत अणु
	...
	XM_TXF_ABO_COL	= 0x02b0, /* 32 bit r/o	Tx पातed due to Exces. Col. */
...
#घोषणा XM_RT_LIM_MSK	0x1f	/* Bit  4..0:	Tx Retry Limit */


/*	XM_TX_STIME	16 bit r/w	Transmit Slotसमय Register */
#घोषणा XM_STIME_MSK	0x7f	/* Bit  6..0:	Tx Slotसमय bits */


/*	XM_TX_IPG	16 bit r/w	Transmit Inter Packet Gap */
#घोषणा XM_IPG_MSK		0xff	/* Bit  7..0:	IPG value bits */


/*	XM_RX_CMD	16 bit r/w	Receive Command Register */
क्रमागत अणु
	XM_RX_LENERR_OK	= 1<<8,	/* Bit  8	करोn't set Rx Err bit क्रम */
				/*		inrange error packets */
	XM_RX_BIG_PK_OK	= 1<<7,	/* Bit  7	करोn't set Rx Err bit क्रम */
				/*		jumbo packets */
...
क्रमागत अणु
	...
	XM_GP_INP_ASS	= 1<<0,	/* Bit  0: (ro) GP Input Pin निश्चितed */
पूर्ण;
...
क्रमागत अणु
	...
	XM_IS_TX_PAGE	= 1<<8,	/* Bit  8:	Next Page Loaded क्रम Transmit */
...
क्रमागत अणु
	...
	XM_HW_COM4SIG	= 1<<2,	/* Bit  2:	use Comma Detect क्रम Sig. Det.*/
...
#घोषणा XM_TX_WM_MSK	0x01ff	/* Bit  9.. 0	Tx FIFO Watermark bits */

/*	XM_TX_THR	16 bit r/w	Tx Request Threshold */
/*	XM_HT_THR	16 bit r/w	Host Request Threshold */
/*	XM_RX_THR	16 bit r/w	Rx Request Threshold */
#घोषणा XM_THR_MSK		0x03ff	/* Bit 10.. 0	Rx/Tx Request Threshold bits */
...
#घोषणा XM_RX_WM_MSK	0x03ff		/* Bit 11.. 0:	Rx FIFO Watermark bits */


/*	XM_DEV_ID	32 bit r/o	Device ID Register */
#घोषणा XM_DEV_OUI	(0x00ffffffUL<<8)	/* Bit 31..8:	Device OUI */
#घोषणा XM_DEV_REV	(0x07L << 5)		/* Bit  7..5:	Chip Rev Num */
...
#घोषणा XM_PAUSE_MODE	(XM_MD_SPOE_E | XM_MD_SPOL_I | XM_MD_SPOH_I)
#घोषणा XM_DEF_MODE	(XM_MD_RX_RUNT | XM_MD_RX_IRLE | XM_MD_RX_LONG |\
...
#घोषणा XMR_DEF_MSK		(XMR_OK_LO_OV | XMR_OK_HI_OV)
...
#घोषणा XMT_DEF_MSK		(XMT_OK_LO_OV | XMT_OK_HI_OV)

काष्ठा skge_rx_desc अणु
	u32		control;
	u32		next_offset;
	u32		dma_lo;
	u32		dma_hi;
...
काष्ठा skge_element अणु
	काष्ठा skge_element	*next;
	व्योम			*desc;
	काष्ठा sk_buff  	*skb;
...
काष्ठा skge_ring अणु
	काष्ठा skge_element *to_clean;
	काष्ठा skge_element *to_use;
	काष्ठा skge_element *start;
...
काष्ठा skge_hw अणु
	...
	u16		     phy_addr;
	spinlock_t	     phy_lock;
	काष्ठा tasklet_काष्ठा phy_task;

	अक्षर		     irq_name[]; /* skge@pci:000:04:00.0 */
पूर्ण;

क्रमागत छोड़ो_control अणु
...
काष्ठा skge_port अणु
	...
	काष्ठा skge_ring     tx_ring;

	काष्ठा skge_ring     rx_ring ____cacheline_aligned_in_smp;
	अचिन्हित पूर्णांक	     rx_buf_size;

	काष्ठा समयr_list    link_समयr;
	क्रमागत छोड़ो_control   flow_control;
	क्रमागत छोड़ो_status    flow_status;
	u8		     blink_on;
	u8		     wol;
	u8		     स्वतःneg;	/* AUTONEG_ENABLE, AUTONEG_DISABLE */
	u8		     duplex;	/* DUPLEX_HALF, DUPLEX_FULL */
	u16		     speed;	/* SPEED_1000, SPEED_100, ... */
	u32		     advertising;

	व्योम		     *mem;	/* PCI memory क्रम rings */
	dma_addr_t	     dma;
...
अटल अंतरभूत u32 skge_पढ़ो32(स्थिर काष्ठा skge_hw *hw, पूर्णांक reg)
अणु
	वापस पढ़ोl(hw->regs + reg);
पूर्ण

अटल अंतरभूत u16 skge_पढ़ो16(स्थिर काष्ठा skge_hw *hw, पूर्णांक reg)
अणु
	वापस पढ़ोw(hw->regs + reg);
पूर्ण

अटल अंतरभूत u8 skge_पढ़ो8(स्थिर काष्ठा skge_hw *hw, पूर्णांक reg)
अणु
	वापस पढ़ोb(hw->regs + reg);
पूर्ण

अटल अंतरभूत व्योम skge_ग_लिखो32(स्थिर काष्ठा skge_hw *hw, पूर्णांक reg, u32 val)
अणु
	ग_लिखोl(val, hw->regs + reg);
पूर्ण

अटल अंतरभूत व्योम skge_ग_लिखो16(स्थिर काष्ठा skge_hw *hw, पूर्णांक reg, u16 val)
अणु
	ग_लिखोw(val, hw->regs + reg);
पूर्ण

अटल अंतरभूत व्योम skge_ग_लिखो8(स्थिर काष्ठा skge_hw *hw, पूर्णांक reg, u8 val)
अणु
	ग_लिखोb(val, hw->regs + reg);
पूर्ण

/* MAC Related Registers inside the device. */
#घोषणा SK_REG(port,reg)	(((port)<<7)+(u16)(reg))
#घोषणा SK_XMAC_REG(port, reg) \
	((BASE_XMAC_1 + (port) * (BASE_XMAC_2 - BASE_XMAC_1)) | (reg) << 1)

अटल अंतरभूत u32 xm_पढ़ो32(स्थिर काष्ठा skge_hw *hw, पूर्णांक port, पूर्णांक reg)
अणु
	u32 v;
	v = skge_पढ़ो16(hw, SK_XMAC_REG(port, reg));
	v |= (u32)skge_पढ़ो16(hw, SK_XMAC_REG(port, reg+2)) << 16;
	वापस v;
पूर्ण

अटल अंतरभूत u16 xm_पढ़ो16(स्थिर काष्ठा skge_hw *hw, पूर्णांक port, पूर्णांक reg)
अणु
	वापस skge_पढ़ो16(hw, SK_XMAC_REG(port,reg));
पूर्ण

अटल अंतरभूत व्योम xm_ग_लिखो32(स्थिर काष्ठा skge_hw *hw, पूर्णांक port, पूर्णांक r, u32 v)
अणु
	skge_ग_लिखो16(hw, SK_XMAC_REG(port,r), v & 0xffff);
	skge_ग_लिखो16(hw, SK_XMAC_REG(port,r+2), v >> 16);
पूर्ण

अटल अंतरभूत व्योम xm_ग_लिखो16(स्थिर काष्ठा skge_hw *hw, पूर्णांक port, पूर्णांक r, u16 v)
अणु
	skge_ग_लिखो16(hw, SK_XMAC_REG(port,r), v);
पूर्ण

अटल अंतरभूत व्योम xm_outhash(स्थिर काष्ठा skge_hw *hw, पूर्णांक port, पूर्णांक reg,
				   स्थिर u8 *hash)
अणु
	xm_ग_लिखो16(hw, port, reg,   (u16)hash[0] | ((u16)hash[1] << 8));
	xm_ग_लिखो16(hw, port, reg+2, (u16)hash[2] | ((u16)hash[3] << 8));
	xm_ग_लिखो16(hw, port, reg+4, (u16)hash[4] | ((u16)hash[5] << 8));
	xm_ग_लिखो16(hw, port, reg+6, (u16)hash[6] | ((u16)hash[7] << 8));
पूर्ण

अटल अंतरभूत व्योम xm_outaddr(स्थिर काष्ठा skge_hw *hw, पूर्णांक port, पूर्णांक reg,
				   स्थिर u8 *addr)
अणु
	xm_ग_लिखो16(hw, port, reg,   (u16)addr[0] | ((u16)addr[1] << 8));
	xm_ग_लिखो16(hw, port, reg+2, (u16)addr[2] | ((u16)addr[3] << 8));
	xm_ग_लिखो16(hw, port, reg+4, (u16)addr[4] | ((u16)addr[5] << 8));
पूर्ण

#घोषणा SK_GMAC_REG(port,reg) \
	(BASE_GMAC_1 + (port) * (BASE_GMAC_2-BASE_GMAC_1) + (reg))

अटल अंतरभूत u16 gma_पढ़ो16(स्थिर काष्ठा skge_hw *hw, पूर्णांक port, पूर्णांक reg)
अणु
	वापस skge_पढ़ो16(hw, SK_GMAC_REG(port,reg));
पूर्ण

अटल अंतरभूत u32 gma_पढ़ो32(स्थिर काष्ठा skge_hw *hw, पूर्णांक port, पूर्णांक reg)
अणु
	वापस (u32) skge_पढ़ो16(hw, SK_GMAC_REG(port,reg))
		| ((u32)skge_पढ़ो16(hw, SK_GMAC_REG(port,reg+4)) << 16);
पूर्ण

अटल अंतरभूत व्योम gma_ग_लिखो16(स्थिर काष्ठा skge_hw *hw, पूर्णांक port, पूर्णांक r, u16 v)
अणु
	skge_ग_लिखो16(hw, SK_GMAC_REG(port,r), v);
पूर्ण

अटल अंतरभूत व्योम gma_set_addr(काष्ठा skge_hw *hw, पूर्णांक port, पूर्णांक reg,
				    स्थिर u8 *addr)
अणु
