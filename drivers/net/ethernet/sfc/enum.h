...
#अगर_अघोषित EFX_ENUM_H
#घोषणा EFX_ENUM_H

/**
 * क्रमागत efx_loopback_mode - loopback modes
 ...
 * other valuesspecअगरy reasons, which efx_schedule_reset() will choose
 * a method क्रम.
 *
 ...
 * @RESET_TYPE_MC_FAILURE: MC reboot/निश्चितion
 * @RESET_TYPE_MCDI_TIMEOUT: MCDI समयout.
 */
क्रमागत reset_type अणु
	 ...
	 * it करोesn't fit the scope hierarchy (not well-ordered by inclusion).
	 * We encode this by having its क्रमागत value be greater than
	 * RESET_TYPE_MAX_METHOD.
	 */
