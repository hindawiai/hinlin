...
/* The trace subप्रणाली name क्रम iavf will be "iavf".
 *
 ...
 */
#अगर !defined(_IAVF_TRACE_H_) || defined(TRACE_HEADER_MULTI_READ)
#घोषणा _IAVF_TRACE_H_

#समावेश <linux/tracepoपूर्णांक.h>

/*
 * iavf_trace() macro enables shared code to refer to trace poपूर्णांकs
 * like:
 *
 * trace_iavfअणु,vfपूर्ण_example(args...)
 *
 * ... as:
 *
 ...
 * trace_iavfअणु,vfपूर्ण_<trace_name>_enabled() functions.
 */
#घोषणा _IAVF_TRACE_NAME(trace_name) (trace_ ## iavf ## _ ## trace_name)
#घोषणा IAVF_TRACE_NAME(trace_name) _IAVF_TRACE_NAME(trace_name)

#घोषणा iavf_trace(trace_name, args...) IAVF_TRACE_NAME(trace_name)(args)

#घोषणा iavf_trace_enabled(trace_name) IAVF_TRACE_NAME(trace_name##_enabled)()

/* Events common to PF and VF. Corresponding versions will be defined
 * क्रम both, named trace_iavf_* and trace_iavf_*. The iavf_trace()
...
DECLARE_EVENT_CLASS(
	...
	TP_PROTO(काष्ठा iavf_ring *ring,
		 काष्ठा iavf_tx_desc *desc,
		 काष्ठा iavf_tx_buffer *buf),
...
DEFINE_EVENT(
	iavf_tx_ढाँचा, iavf_clean_tx_irq,
	TP_PROTO(काष्ठा iavf_ring *ring,
		 काष्ठा iavf_tx_desc *desc,
		 काष्ठा iavf_tx_buffer *buf),
...
DEFINE_EVENT(
	iavf_tx_ढाँचा, iavf_clean_tx_irq_unmap,
	TP_PROTO(काष्ठा iavf_ring *ring,
		 काष्ठा iavf_tx_desc *desc,
		 काष्ठा iavf_tx_buffer *buf),
...
DEFINE_EVENT(
	iavf_rx_ढाँचा, iavf_clean_rx_irq,
	TP_PROTO(काष्ठा iavf_ring *ring,
		 जोड़ iavf_32byte_rx_desc *desc,
		 काष्ठा sk_buff *skb),
...
DEFINE_EVENT(
	iavf_rx_ढाँचा, iavf_clean_rx_irq_rx,
	TP_PROTO(काष्ठा iavf_ring *ring,
		 जोड़ iavf_32byte_rx_desc *desc,
		 काष्ठा sk_buff *skb),
...
DEFINE_EVENT(
	iavf_xmit_ढाँचा, iavf_xmit_frame_ring,
	TP_PROTO(काष्ठा sk_buff *skb,
		 काष्ठा iavf_ring *ring),
...
DEFINE_EVENT(
	iavf_xmit_ढाँचा, iavf_xmit_frame_ring_drop,
	TP_PROTO(काष्ठा sk_buff *skb,
		 काष्ठा iavf_ring *ring),
...
#पूर्ण_अगर /* _IAVF_TRACE_H_ */
/* This must be outside अगरdef _IAVF_TRACE_H */
...
#घोषणा TRACE_INCLUDE_खाता iavf_trace
