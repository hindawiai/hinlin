...
#अगर_अघोषित _E1000E_REGS_H_
#घोषणा _E1000E_REGS_H_
...
#घोषणा E1000_FEXT	0x0002C	/* Future Extended - RW */
#घोषणा E1000_FEXTNVM	0x00028	/* Future Extended NVM - RW */
#घोषणा E1000_FEXTNVM3	0x0003C	/* Future Extended NVM 3 - RW */
#घोषणा E1000_FEXTNVM4	0x00024	/* Future Extended NVM 4 - RW */
#घोषणा E1000_FEXTNVM5	0x00014	/* Future Extended NVM 5 - RW */
#घोषणा E1000_FEXTNVM6	0x00010	/* Future Extended NVM 6 - RW */
#घोषणा E1000_FEXTNVM7	0x000E4	/* Future Extended NVM 7 - RW */
#घोषणा E1000_FEXTNVM8	0x5BB0	/* Future Extended NVM 8 - RW */
#घोषणा E1000_FEXTNVM9	0x5BB4	/* Future Extended NVM 9 - RW */
#घोषणा E1000_FEXTNVM11	0x5BBC	/* Future Extended NVM 11 - RW */
#घोषणा E1000_FEXTNVM12	0x5BC0	/* Future Extended NVM 12 - RW */
#घोषणा E1000_PCIEANACFG	0x00F18	/* PCIE Analog Config */
#घोषणा E1000_DPGFR	0x00FAC	/* Dynamic Power Gate Force Control Register */
...
#घोषणा E1000_IVAR	0x000E4	/* Interrupt Vector Allocation Register - RW */
#घोषणा E1000_SVCR	0x000F0
#घोषणा E1000_SVT	0x000F4
#घोषणा E1000_LPIC	0x000FC	/* Low Power IDLE control */
...
#घोषणा E1000_PBA_ECC	0x01100	/* PBA ECC Register */
...
#घोषणा E1000_POEMB	E1000_PHY_CTRL	/* PHY OEM Bits */
#घोषणा E1000_PBA	0x01000	/* Packet Buffer Allocation - RW */
#घोषणा E1000_PBS	0x01008	/* Packet Buffer Size */
#घोषणा E1000_PBECCSTS	0x0100C	/* Packet Buffer ECC Status - RW */
#घोषणा E1000_IOSFPC	0x00F28	/* TX corrupted data  */
...
#घोषणा E1000_TXDCTL(_n)	((_n) < 4 ? (0x03828 + ((_n) * 0x100)) : \
				 (0x0E028 + ((_n) * 0x40)))
#घोषणा E1000_TARC(_n)		(0x03840 + ((_n) * 0x100))
...
#घोषणा E1000_RAH(_i)		(((_i) <= 15) ? (0x05404 + ((_i) * 8)) : \
				 (0x054E4 + ((_i - 16) * 8)))
#घोषणा E1000_SHRAL(_i)		(0x05438 + ((_i) * 8))
#घोषणा E1000_SHRAH(_i)		(0x0543C + ((_i) * 8))
...
#घोषणा E1000_ICRXPTC	0x04104	/* Interrupt Cause Rx Pkt Timer Expire Count */
#घोषणा E1000_ICRXATC	0x04108	/* Interrupt Cause Rx Abs Timer Expire Count */
#घोषणा E1000_ICTXPTC	0x0410C	/* Interrupt Cause Tx Pkt Timer Expire Count */
#घोषणा E1000_ICTXATC	0x04110	/* Interrupt Cause Tx Abs Timer Expire Count */
#घोषणा E1000_ICTXQEC	0x04118	/* Interrupt Cause Tx Queue Empty Count */
#घोषणा E1000_ICTXQMTC	0x0411C	/* Interrupt Cause Tx Queue Min Thresh Count */
#घोषणा E1000_ICRXDMTC	0x04120	/* Interrupt Cause Rx Desc Min Thresh Count */
#घोषणा E1000_ICRXOC	0x04124	/* Interrupt Cause Receiver Overrun Count */
#घोषणा E1000_CRC_OFFSET	0x05F50	/* CRC Offset रेजिस्टर */
...
#घोषणा E1000_KMRNCTRLSTA	0x00034	/* MAC-PHY पूर्णांकerface - RW */
#घोषणा E1000_MANC2H		0x05860	/* Management Control To Host - RW */
/* Management Decision Filters */
#घोषणा E1000_MDEF(_n)		(0x05890 + (4 * (_n)))
#घोषणा E1000_SW_FW_SYNC	0x05B5C	/* SW-FW Synchronization - RW */
#घोषणा E1000_GCR	0x05B00	/* PCI-Ex Control */
#घोषणा E1000_GCR2	0x05B64	/* PCI-Ex Control #2 */
...
#घोषणा E1000_RETA(_i)	(0x05C00 + ((_i) * 4))	/* Redirection Table - RW */
#घोषणा E1000_RSSRK(_i)	(0x05C80 + ((_i) * 4))	/* RSS Ranकरोm Key - RW */
...
#घोषणा E1000_SYSSTMPL  0x0B648 /* HH Timesync प्रणाली stamp low रेजिस्टर */
#घोषणा E1000_SYSSTMPH  0x0B64C /* HH Timesync प्रणाली stamp hi रेजिस्टर */
#घोषणा E1000_PLTSTMPL  0x0B640 /* HH Timesync platक्रमm stamp low रेजिस्टर */
#घोषणा E1000_PLTSTMPH  0x0B644 /* HH Timesync platक्रमm stamp hi रेजिस्टर */
#घोषणा E1000_RXMTRL	0x0B634	/* Time sync Rx EtherType and Msg Type - RW */
#घोषणा E1000_RXUDP	0x0B638	/* Time Sync Rx UDP Port - RW */

/* PHY रेजिस्टरs */
#घोषणा I82579_DFT_CTRL	PHY_REG(769, 20)
