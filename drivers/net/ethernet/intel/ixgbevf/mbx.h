...
/* Define mailbox रेजिस्टर bits */
#घोषणा IXGBE_VFMAILBOX_REQ	0x00000001 /* Request क्रम PF Ready bit */
#घोषणा IXGBE_VFMAILBOX_ACK	0x00000002 /* Ack PF message received */
#घोषणा IXGBE_VFMAILBOX_VFU	0x00000004 /* VF owns the mailbox buffer */
#घोषणा IXGBE_VFMAILBOX_PFU	0x00000008 /* PF owns the mailbox buffer */
#घोषणा IXGBE_VFMAILBOX_PFSTS	0x00000010 /* PF wrote a message in the MB */
#घोषणा IXGBE_VFMAILBOX_PFACK	0x00000020 /* PF ack the previous VF msg */
#घोषणा IXGBE_VFMAILBOX_RSTI	0x00000040 /* PF has reset indication */
#घोषणा IXGBE_VFMAILBOX_RSTD	0x00000080 /* PF has indicated reset करोne */
#घोषणा IXGBE_VFMAILBOX_R2C_BITS 0x000000B0 /* All पढ़ो to clear bits */

#घोषणा IXGBE_PFMAILBOX(x)	(0x04B00 + (4 * (x)))
#घोषणा IXGBE_PFMBMEM(vfn)	(0x13000 + (64 * (vfn)))
...
#घोषणा IXGBE_VT_MSGTYPE_ACK	0x80000000
/* Messages below or'd with this are the NACK */
#घोषणा IXGBE_VT_MSGTYPE_NACK	0x40000000
/* Indicates that VF is still clear to send requests */
#घोषणा IXGBE_VT_MSGTYPE_CTS	0x20000000
...
#घोषणा IXGBE_VF_GET_QUEUE	0x09 /* get queue configuration */
...
#घोषणा IXGBE_VF_GET_RSS_KEY	0x0b	/* get RSS hash key */
...
/* क्रमward declaration of the HW काष्ठा */
काष्ठा ixgbe_hw;
