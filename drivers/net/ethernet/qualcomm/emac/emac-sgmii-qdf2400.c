...
#घोषणा EMAC_SGMII_LN_DRVR_CTRL1		0x0010
...
#घोषणा EMAC_SGMII_LN_PARALLEL_RATE		0x007C
#घोषणा EMAC_SGMII_LN_CML_CTRL_MODE0		0x00C0
#घोषणा EMAC_SGMII_LN_MIXER_CTRL_MODE0		0x00D8
#घोषणा EMAC_SGMII_LN_VGA_INITVAL		0x013C
#घोषणा EMAC_SGMII_LN_UCDR_FO_GAIN_MODE0	0x0184
#घोषणा EMAC_SGMII_LN_UCDR_SO_GAIN_MODE0	0x0190
#घोषणा EMAC_SGMII_LN_UCDR_SO_CONFIG		0x019C
#घोषणा EMAC_SGMII_LN_RX_BAND			0x01A4
#घोषणा EMAC_SGMII_LN_RX_RCVR_PATH1_MODE0	0x01C0
#घोषणा EMAC_SGMII_LN_RSM_CONFIG		0x01F8
#घोषणा EMAC_SGMII_LN_SIGDET_ENABLES		0x0230
#घोषणा EMAC_SGMII_LN_SIGDET_CNTRL		0x0234
#घोषणा EMAC_SGMII_LN_SIGDET_DEGLITCH_CNTRL	0x0238
#घोषणा EMAC_SGMII_LN_RX_EN_SIGNAL		0x02AC
#घोषणा EMAC_SGMII_LN_RX_MISC_CNTRL0		0x02B8
#घोषणा EMAC_SGMII_LN_DRVR_LOGIC_CLKDIV		0x02C8
#घोषणा EMAC_SGMII_LN_RX_RESECODE_OFFSET	0x02CC
...
#घोषणा EN_DLL_MODE0				BIT(4)
#घोषणा EN_IQ_DCC_MODE0				BIT(3)
#घोषणा EN_IQCAL_MODE0				BIT(2)
...
अटल स्थिर काष्ठा emac_reg_ग_लिखो sgmii_laned[] = अणु
	...
	अणुEMAC_SGMII_LN_RX_MISC_CNTRL0, INVERT_PCS_RX_CLKपूर्ण,
	...
	अणुEMAC_SGMII_LN_TX_BAND_MODE, BAND_MODE0(1)पूर्ण,
	अणुEMAC_SGMII_LN_RX_BAND, BAND_MODE0(2)पूर्ण,
	अणुEMAC_SGMII_LN_DRVR_CTRL1, RESCODE_OFFSET(7)पूर्ण,
	अणुEMAC_SGMII_LN_RX_RESECODE_OFFSET, RESCODE_OFFSET(9)पूर्ण,
	अणुEMAC_SGMII_LN_LANE_MODE, LANE_MODE(26)पूर्ण,
	अणुEMAC_SGMII_LN_RX_RCVR_PATH1_MODE0, CDR_PD_SEL_MODE0(2) |
		EN_DLL_MODE0 | EN_IQ_DCC_MODE0 | EN_IQCAL_MODE0पूर्ण,
