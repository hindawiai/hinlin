...
अटल पूर्णांक st_gyro_buffer_postenable(काष्ठा iio_dev *indio_dev)
अणु
	पूर्णांक err;
	...
	अगर (err < 0)
		जाओ st_gyro_buffer_enable_all_axis;
...
अटल पूर्णांक st_gyro_buffer_predisable(काष्ठा iio_dev *indio_dev)
अणु
	पूर्णांक err;
	...
	वापस st_sensors_set_axis_enable(indio_dev, ST_SENSORS_ENABLE_ALL_AXIS);
पूर्ण

अटल स्थिर काष्ठा iio_buffer_setup_ops st_gyro_buffer_setup_ops = अणु
