...
अटल स्थिर काष्ठा regmap_config st_lsm6dsx_spi_regmap_config = अणु
	.reg_bits = 8,
	.val_bits = 8,
पूर्ण;

अटल पूर्णांक st_lsm6dsx_spi_probe(काष्ठा spi_device *spi)
अणु
	...
	वापस st_lsm6dsx_probe(&spi->dev, spi->irq, hw_id, regmap);
पूर्ण

अटल स्थिर काष्ठा of_device_id st_lsm6dsx_spi_of_match[] = अणु
	अणु
...
अटल स्थिर काष्ठा spi_device_id st_lsm6dsx_spi_id_table[] = अणु
...
अटल काष्ठा spi_driver st_lsm6dsx_driver = अणु
	.driver = अणु
		.name = "st_lsm6dsx_spi",
