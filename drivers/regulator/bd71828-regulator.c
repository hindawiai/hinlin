...
पूर्ण;
काष्ठा bd71828_regulator_data अणु
	काष्ठा regulator_desc desc;
	स्थिर काष्ठा rohm_dvs_config dvs;
	स्थिर काष्ठा reg_init *reg_inits;
	पूर्णांक reg_init_amnt;
पूर्ण;

अटल स्थिर काष्ठा reg_init buck1_inits[] = अणु
	/*
	 * DVS Buck voltages can be changed by रेजिस्टर values or via GPIO.
	 * Use रेजिस्टर accesses by शेष.
	 */
	अणु
...
अटल स्थिर काष्ठा reg_init buck2_inits[] = अणु
	अणु
		.reg = BD71828_REG_PS_CTRL_1,
...
अटल स्थिर काष्ठा reg_init buck6_inits[] = अणु
	अणु
		.reg = BD71828_REG_PS_CTRL_1,
...
अटल स्थिर काष्ठा reg_init buck7_inits[] = अणु
	अणु
		.reg = BD71828_REG_PS_CTRL_1,
...
अटल स्थिर काष्ठा linear_range bd71828_buck1267_volts[] = अणु
	REGULATOR_LINEAR_RANGE(500000, 0x00, 0xef, 6250),
	REGULATOR_LINEAR_RANGE(2000000, 0xf0, 0xff, 0),
पूर्ण;

अटल स्थिर काष्ठा linear_range bd71828_buck3_volts[] = अणु
	REGULATOR_LINEAR_RANGE(1200000, 0x00, 0x0f, 50000),
	REGULATOR_LINEAR_RANGE(2000000, 0x10, 0x1f, 0),
पूर्ण;

अटल स्थिर काष्ठा linear_range bd71828_buck4_volts[] = अणु
	REGULATOR_LINEAR_RANGE(1000000, 0x00, 0x1f, 25000),
	REGULATOR_LINEAR_RANGE(1800000, 0x20, 0x3f, 0),
पूर्ण;

अटल स्थिर काष्ठा linear_range bd71828_buck5_volts[] = अणु
	REGULATOR_LINEAR_RANGE(2500000, 0x00, 0x0f, 50000),
	REGULATOR_LINEAR_RANGE(3300000, 0x10, 0x1f, 0),
पूर्ण;

अटल स्थिर काष्ठा linear_range bd71828_lकरो_volts[] = अणु
	REGULATOR_LINEAR_RANGE(800000, 0x00, 0x31, 50000),
	REGULATOR_LINEAR_RANGE(3300000, 0x32, 0x3f, 0),
पूर्ण;

अटल स्थिर अचिन्हित पूर्णांक bd71828_ramp_delay[] = अणु 2500, 5000, 10000, 20000 पूर्ण;

अटल पूर्णांक buck_set_hw_dvs_levels(काष्ठा device_node *np,
				  स्थिर काष्ठा regulator_desc *desc,
				  काष्ठा regulator_config *cfg)
अणु
	काष्ठा bd71828_regulator_data *data;

	data = container_of(desc, काष्ठा bd71828_regulator_data, desc);

	वापस rohm_regulator_set_dvs_levels(&data->dvs, np, desc, cfg->regmap);
पूर्ण

अटल पूर्णांक lकरो6_parse_dt(काष्ठा device_node *np,
			 स्थिर काष्ठा regulator_desc *desc,
			 काष्ठा regulator_config *cfg)
अणु
	पूर्णांक ret, i;
	...
	काष्ठा regmap *regmap = cfg->regmap;
	अटल स्थिर अक्षर * स्थिर props[] = अणु "rohm,dvs-run-voltage",
					      "rohm,dvs-idle-voltage",
					      "rohm,dvs-suspend-voltage",
					      "rohm,dvs-lpsr-voltage" पूर्ण;
	अचिन्हित पूर्णांक mask[] = अणु BD71828_MASK_RUN_EN, BD71828_MASK_IDLE_EN,
			       BD71828_MASK_SUSP_EN, BD71828_MASK_LPSR_EN पूर्ण;

	क्रम (i = 0; i < ARRAY_SIZE(props); i++) अणु
		ret = of_property_पढ़ो_u32(np, props[i], &uv);
		अगर (ret) अणु
			अगर (ret != -EINVAL)
				वापस ret;
			जारी;
...
अटल स्थिर काष्ठा regulator_ops bd71828_buck_ops = अणु
...
अटल स्थिर काष्ठा regulator_ops bd71828_dvs_buck_ops = अणु
	.enable = regulator_enable_regmap,
	.disable = regulator_disable_regmap,
	.is_enabled = regulator_is_enabled_regmap,
	.list_voltage = regulator_list_voltage_linear_range,
...
अटल स्थिर काष्ठा regulator_ops bd71828_lकरो_ops = अणु
	.enable = regulator_enable_regmap,
	.disable = regulator_disable_regmap,
	.is_enabled = regulator_is_enabled_regmap,
	.list_voltage = regulator_list_voltage_linear_range,
...
अटल स्थिर काष्ठा regulator_ops bd71828_lकरो6_ops = अणु
	.enable = regulator_enable_regmap,
	.disable = regulator_disable_regmap,
	.is_enabled = regulator_is_enabled_regmap,
पूर्ण;

अटल स्थिर काष्ठा bd71828_regulator_data bd71828_rdata[] = अणु
	अणु
		.desc = अणु
			.name = "buck1",
	...
	अणु
		...
		.dvs = अणु
			/*
			 * BUCK3 only supports single voltage क्रम all states.
			 * voltage can be inभागidually enabled क्रम each state
			 * though => allow setting all states to support
			 * enabling घातer rail on dअगरferent states.
			 */
			.level_map = ROHM_DVS_LEVEL_RUN | ROHM_DVS_LEVEL_IDLE |
				     ROHM_DVS_LEVEL_SUSPEND |
				     ROHM_DVS_LEVEL_LPSR,
	...
	अणु
		...
		.dvs = अणु
			/*
			 * BUCK4 only supports single voltage क्रम all states.
			 * voltage can be inभागidually enabled क्रम each state
			 * though => allow setting all states to support
			 * enabling घातer rail on dअगरferent states.
			 */
	...
	अणु
		...
		.dvs = अणु
			/*
			 * BUCK5 only supports single voltage क्रम all states.
			 * voltage can be inभागidually enabled क्रम each state
			 * though => allow setting all states to support
			 * enabling घातer rail on dअगरferent states.
			 */
	...
	अणु
		.desc = अणु
			...
			.regulators_node = of_match_ptr("regulators"),
			.id = BD71828_LDO1,
			.ops = &bd71828_lकरो_ops,
			.type = REGULATOR_VOLTAGE,
			.linear_ranges = bd71828_lकरो_volts,
			.n_linear_ranges = ARRAY_SIZE(bd71828_lकरो_volts),
		...
		.dvs = अणु
			/*
			 * LDO1 only supports single voltage क्रम all states.
			 * voltage can be inभागidually enabled क्रम each state
			 * though => allow setting all states to support
			 * enabling घातer rail on dअगरferent states.
			 */
	...
	पूर्ण, अणु
		...
		.dvs = अणु
			/*
			 * LDO2 only supports single voltage क्रम all states.
			 * voltage can be inभागidually enabled क्रम each state
			 * though => allow setting all states to support
			 * enabling घातer rail on dअगरferent states.
			 */
	...
	पूर्ण, अणु
		...
		.dvs = अणु
			/*
			 * LDO3 only supports single voltage क्रम all states.
			 * voltage can be inभागidually enabled क्रम each state
			 * though => allow setting all states to support
			 * enabling घातer rail on dअगरferent states.
			 */
	...
	पूर्ण, अणु
		 ...
		 * from 2 dअगरferent रेजिस्टरs (by GPIO).
		 *
	...
	पूर्ण, अणु
		.desc = अणु
			...
			.owner = THIS_MODULE,
			/*
			 * LDO6 only supports enable/disable क्रम all states.
			 * Voltage क्रम LDO6 is fixed.
			 */
			.of_parse_cb = lकरो6_parse_dt,
		पूर्ण,
	पूर्ण, अणु
		.desc = अणु
		...
		.dvs = अणु
			/*
			 * LDO7 only supports single voltage क्रम all states.
			 * voltage can be inभागidually enabled क्रम each state
			 * though => allow setting all states to support
			 * enabling घातer rail on dअगरferent states.
			 */
...
अणु
	...
	क्रम (i = 0; i < ARRAY_SIZE(bd71828_rdata); i++) अणु
		काष्ठा regulator_dev *rdev;
		स्थिर काष्ठा bd71828_regulator_data *rd;
		...
		अगर (IS_ERR(rdev)) अणु
			...
			वापस PTR_ERR(rdev);
		पूर्ण
		क्रम (j = 0; j < rd->reg_init_amnt; j++) अणु
...
अटल काष्ठा platक्रमm_driver bd71828_regulator = अणु
	.driver = अणु
		.name = "bd71828-pmic"
	पूर्ण,
	.probe = bd71828_probe,
...
module_platक्रमm_driver(bd71828_regulator);
