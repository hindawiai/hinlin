...
/*
 * Pinctrl data क्रम Wondermedia WM8850 SoC
 *
 ...
 */
अटल स्थिर काष्ठा wmt_pinctrl_bank_रेजिस्टरs wm8850_banks[] = अणु
...
#घोषणा WMT_PIN_SUSGPIO1	WMT_PIN(0, 22)
...
अटल स्थिर काष्ठा pinctrl_pin_desc wm8850_pins[] = अणु
...
अटल स्थिर अक्षर * स्थिर wm8850_groups[] = अणु
	"extgpio0",
	"extgpio1",
	"extgpio2",
	"extgpio3",
...
अटल पूर्णांक wm8850_pinctrl_probe(काष्ठा platक्रमm_device *pdev)
अणु
...
अटल स्थिर काष्ठा of_device_id wmt_pinctrl_of_match[] = अणु
	अणु .compatible = "wm,wm8850-pinctrl" पूर्ण,
	अणु /* sentinel */ पूर्ण,
पूर्ण;
