...
/*
 * Pinctrl data क्रम the NVIDIA Tegra114 pinmux
 *
...
#घोषणा TEGRA_PIN_GMI_DQS_P_PJ3			_GPIO(75)
...
#घोषणा NUM_GPIOS				(TEGRA_PIN_SDMMC3_CLK_LB_IN_PEE5 + 1)
...
#घोषणा TEGRA_PIN_RESET_OUT_N			_PIN(3)
#घोषणा TEGRA_PIN_OWR				_PIN(4)
#घोषणा TEGRA_PIN_JTAG_RTCK			_PIN(5)
#घोषणा TEGRA_PIN_CLK_32K_IN			_PIN(6)
#घोषणा TEGRA_PIN_GMI_CLK_LB			_PIN(7)

अटल स्थिर काष्ठा pinctrl_pin_desc tegra114_pins[] = अणु
...
अटल स्थिर अचिन्हित gmi_dqs_p_pj3_pins[] = अणु
...
अटल काष्ठा tegra_function tegra114_functions[] = अणु
	FUNCTION(blink),
	FUNCTION(cec),
	FUNCTION(cldvfs),
	FUNCTION(clk),
...
अटल स्थिर काष्ठा tegra_pingroup tegra114_groups[] = अणु
	...
	PINGROUP(dap3_करोut_pp2,          I2S2,       SPI5,       DISPLAYA,     DISPLAYB,    0x3038, N,   N,  N),
	...
	PINGROUP(dap4_करोut_pp6,          I2S3,       RSVD2,      DTV,          RSVD4,       0x31b0, N,   N,  N),
	...
	PINGROUP(gmi_wp_n_pc7,           RSVD1,      न_अंकD,       GMI,          GMI_ALT,     0x31c0, N,   N,  N),
	PINGROUP(gmi_iordy_pi5,          SDMMC2,     RSVD2,      GMI,          TRACE,       0x31c4, N,   N,  N),
	PINGROUP(gmi_रुको_pi7,           SPI4,       न_अंकD,       GMI,          DTV,         0x31c8, N,   N,  N),
	PINGROUP(gmi_adv_n_pk0,          RSVD1,      न_अंकD,       GMI,          TRACE,       0x31cc, N,   N,  N),
	PINGROUP(gmi_clk_pk1,            SDMMC2,     न_अंकD,       GMI,          TRACE,       0x31d0, N,   N,  N),
	PINGROUP(gmi_cs0_n_pj0,          RSVD1,      न_अंकD,       GMI,          USB,         0x31d4, N,   N,  N),
	PINGROUP(gmi_cs1_n_pj2,          RSVD1,      न_अंकD,       GMI,          SOC,         0x31d8, N,   N,  N),
	PINGROUP(gmi_cs2_n_pk3,          SDMMC2,     न_अंकD,       GMI,          TRACE,       0x31dc, N,   N,  N),
	PINGROUP(gmi_cs3_n_pk4,          SDMMC2,     न_अंकD,       GMI,          GMI_ALT,     0x31e0, N,   N,  N),
	PINGROUP(gmi_cs4_n_pk2,          USB,        न_अंकD,       GMI,          TRACE,       0x31e4, N,   N,  N),
	PINGROUP(gmi_cs6_n_pi3,          न_अंकD,       न_अंकD_ALT,   GMI,          SPI4,        0x31e8, N,   N,  N),
	PINGROUP(gmi_cs7_n_pi6,          न_अंकD,       न_अंकD_ALT,   GMI,          SDMMC2,      0x31ec, N,   N,  N),
	PINGROUP(gmi_ad0_pg0,            RSVD1,      न_अंकD,       GMI,          RSVD4,       0x31f0, N,   N,  N),
	PINGROUP(gmi_ad1_pg1,            RSVD1,      न_अंकD,       GMI,          RSVD4,       0x31f4, N,   N,  N),
	PINGROUP(gmi_ad2_pg2,            RSVD1,      न_अंकD,       GMI,          RSVD4,       0x31f8, N,   N,  N),
	PINGROUP(gmi_ad3_pg3,            RSVD1,      न_अंकD,       GMI,          RSVD4,       0x31fc, N,   N,  N),
	PINGROUP(gmi_ad4_pg4,            RSVD1,      न_अंकD,       GMI,          RSVD4,       0x3200, N,   N,  N),
	PINGROUP(gmi_ad5_pg5,            RSVD1,      न_अंकD,       GMI,          SPI4,        0x3204, N,   N,  N),
	PINGROUP(gmi_ad6_pg6,            RSVD1,      न_अंकD,       GMI,          SPI4,        0x3208, N,   N,  N),
	PINGROUP(gmi_ad7_pg7,            RSVD1,      न_अंकD,       GMI,          SPI4,        0x320c, N,   N,  N),
	PINGROUP(gmi_ad8_ph0,            PWM0,       न_अंकD,       GMI,          DTV,         0x3210, N,   N,  N),
	PINGROUP(gmi_ad9_ph1,            PWM1,       न_अंकD,       GMI,          CLDVFS,      0x3214, N,   N,  N),
	PINGROUP(gmi_ad10_ph2,           PWM2,       न_अंकD,       GMI,          CLDVFS,      0x3218, N,   N,  N),
	PINGROUP(gmi_ad11_ph3,           PWM3,       न_अंकD,       GMI,          USB,         0x321c, N,   N,  N),
	PINGROUP(gmi_ad12_ph4,           SDMMC2,     न_अंकD,       GMI,          RSVD4,       0x3220, N,   N,  N),
	PINGROUP(gmi_ad13_ph5,           SDMMC2,     न_अंकD,       GMI,          RSVD4,       0x3224, N,   N,  N),
	PINGROUP(gmi_ad14_ph6,           SDMMC2,     न_अंकD,       GMI,          DTV,         0x3228, N,   N,  N),
	PINGROUP(gmi_ad15_ph7,           SDMMC2,     न_अंकD,       GMI,          DTV,         0x322c, N,   N,  N),
	...
	PINGROUP(gmi_wr_n_pi0,           RSVD1,      न_अंकD,       GMI,          SPI4,        0x3240, N,   N,  N),
	PINGROUP(gmi_oe_n_pi1,           RSVD1,      न_अंकD,       GMI,          SOC,         0x3244, N,   N,  N),
	PINGROUP(gmi_dqs_p_pj3,          SDMMC2,     न_अंकD,       GMI,          TRACE,       0x3248, N,   N,  N),
	PINGROUP(gmi_rst_n_pi4,          न_अंकD,       न_अंकD_ALT,   GMI,          RSVD4,       0x324c, N,   N,  N),
	...
	PINGROUP(dap1_करोut_pn2,          I2S0,       HDA,        GMI,          RSVD4,       0x3340, N,   N,  N),
	...
	PINGROUP(spdअगर_in_pk6,           SPDIF,      USB,        RSVD3,        RSVD4,       0x3350, N,   N,  N),
	PINGROUP(spdअगर_out_pk5,          SPDIF,      RSVD2,      RSVD3,        RSVD4,       0x3354, N,   N,  N),
	PINGROUP(dap2_fs_pa2,            I2S1,       HDA,        RSVD3,        RSVD4,       0x3358, N,   N,  N),
	PINGROUP(dap2_din_pa4,           I2S1,       HDA,        RSVD3,        RSVD4,       0x335c, N,   N,  N),
	PINGROUP(dap2_करोut_pa5,          I2S1,       HDA,        RSVD3,        RSVD4,       0x3360, N,   N,  N),
	...
	PINGROUP(gmi_clk_lb,             SDMMC2,     न_अंकD,       GMI,          RSVD4,       0x3404, N,   N,  N),
...
अटल स्थिर काष्ठा tegra_pinctrl_soc_data tegra114_pinctrl = अणु
	.ngpios = NUM_GPIOS,
...
अटल पूर्णांक tegra114_pinctrl_probe(काष्ठा platक्रमm_device *pdev)
अणु
	वापस tegra_pinctrl_probe(pdev, &tegra114_pinctrl);
पूर्ण

अटल स्थिर काष्ठा of_device_id tegra114_pinctrl_of_match[] = अणु
	अणु .compatible = "nvidia,tegra114-pinmux", पूर्ण,
	अणु पूर्ण,
पूर्ण;

अटल काष्ठा platक्रमm_driver tegra114_pinctrl_driver = अणु
	.driver = अणु
...
अटल पूर्णांक __init tegra114_pinctrl_init(व्योम)
अणु
	वापस platक्रमm_driver_रेजिस्टर(&tegra114_pinctrl_driver);
पूर्ण
