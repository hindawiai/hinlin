...
क्रमागत imx8mn_pads अणु
	...
	MX8MN_IOMUXC_न_अंकD_ALE = 61,
	MX8MN_IOMUXC_न_अंकD_CE0 = 62,
	MX8MN_IOMUXC_न_अंकD_CE1 = 63,
	MX8MN_IOMUXC_न_अंकD_CE2 = 64,
	MX8MN_IOMUXC_न_अंकD_CE3 = 65,
	MX8MN_IOMUXC_न_अंकD_CLE = 66,
	MX8MN_IOMUXC_न_अंकD_DATA00 = 67,
	MX8MN_IOMUXC_न_अंकD_DATA01 = 68,
	MX8MN_IOMUXC_न_अंकD_DATA02 = 69,
	MX8MN_IOMUXC_न_अंकD_DATA03 = 70,
	MX8MN_IOMUXC_न_अंकD_DATA04 = 71,
	MX8MN_IOMUXC_न_अंकD_DATA05 = 72,
	MX8MN_IOMUXC_न_अंकD_DATA06 = 73,
	MX8MN_IOMUXC_न_अंकD_DATA07 = 74,
	MX8MN_IOMUXC_न_अंकD_DQS = 75,
	MX8MN_IOMUXC_न_अंकD_RE_B = 76,
	MX8MN_IOMUXC_न_अंकD_READY_B = 77,
	MX8MN_IOMUXC_न_अंकD_WE_B = 78,
	MX8MN_IOMUXC_न_अंकD_WP_B = 79,
...
अटल स्थिर काष्ठा pinctrl_pin_desc imx8mn_pinctrl_pads[] = अणु
	...
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_ALE),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_CE0),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_CE1),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_CE2),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_CE3),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_CLE),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_DATA00),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_DATA01),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_DATA02),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_DATA03),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_DATA04),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_DATA05),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_DATA06),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_DATA07),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_DQS),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_RE_B),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_READY_B),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_WE_B),
	IMX_PINCTRL_PIN(MX8MN_IOMUXC_न_अंकD_WP_B),
...
अटल काष्ठा imx_pinctrl_soc_info imx8mn_pinctrl_info = अणु
	.pins = imx8mn_pinctrl_pads,
	.npins = ARRAY_SIZE(imx8mn_pinctrl_pads),
	.gpr_compatible = "fsl,imx8mn-iomuxc-gpr",
पूर्ण;

अटल स्थिर काष्ठा of_device_id imx8mn_pinctrl_of_match[] = अणु
	अणु .compatible = "fsl,imx8mn-iomuxc", .data = &imx8mn_pinctrl_info, पूर्ण,
	अणु /* sentinel */ पूर्ण
पूर्ण;
MODULE_DEVICE_TABLE(of, imx8mn_pinctrl_of_match);

अटल पूर्णांक imx8mn_pinctrl_probe(काष्ठा platक्रमm_device *pdev)
अणु
	वापस imx_pinctrl_probe(pdev, &imx8mn_pinctrl_info);
पूर्ण

अटल काष्ठा platक्रमm_driver imx8mn_pinctrl_driver = अणु
	.driver = अणु
		.name = "imx8mn-pinctrl",
...
अटल पूर्णांक __init imx8mn_pinctrl_init(व्योम)
अणु
	वापस platक्रमm_driver_रेजिस्टर(&imx8mn_pinctrl_driver);
पूर्ण
