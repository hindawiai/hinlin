...
/*
 * Even अगर the pin controller is the same the MMP available depend on the SoC
 * पूर्णांकegration.
 *  - In Armada7K (single CP) almost all the MPPs are available (except the
 *    MMP 39 to 43)
 *  - In Armada8K (dual CP) the MPPs are split पूर्णांकo 2 parts, MPPs 0-31 from
 *    CPS, and MPPs 32-62 from CPM, the below flags (V_ARMADA_8K_CPM,
 *    V_ARMADA_8K_CPS) set which MPP is available to the CPx.
 * The x_PLUS क्रमागत mean that the MPP available क्रम CPx and क्रम Armada70x0
 */
क्रमागत अणु
	V_ARMADA_7K = BIT(0),
...
अटल काष्ठा mvebu_mpp_mode armada_cp110_mpp_modes[] = अणु
	MPP_MODE(0,
	...
	MPP_MODE(27,
		 ...
		 MPP_FUNCTION(3,	"mss_gpio4",	शून्य),
	...
	MPP_MODE(28,
		 ...
		 MPP_FUNCTION(3,	"mss_gpio5",	शून्य),
	...
	MPP_MODE(29,
		 ...
		 MPP_FUNCTION(3,	"mss_gpio6",	शून्य),
	...
	MPP_MODE(30,
		 ...
		 MPP_FUNCTION(3,	"mss_gpio7",	शून्य),
	...
	MPP_MODE(32,
		 ...
		 MPP_FUNCTION(10,	"mss_gpio0",	शून्य)),
	MPP_MODE(33,
		 MPP_FUNCTION(0,	"gpio",		शून्य),
		 ...
		 MPP_FUNCTION(10,	"mss_gpio1",	शून्य)),
	MPP_MODE(34,
		 MPP_FUNCTION(0,	"gpio",		शून्य),
		 ...
		 MPP_FUNCTION(10,	"mss_gpio2",	शून्य)),
	MPP_MODE(35,
		 MPP_FUNCTION(0,	"gpio",		शून्य),
		 ...
		 MPP_FUNCTION(10,	"mss_gpio3",	शून्य)),
	MPP_MODE(36,
		 MPP_FUNCTION(0,	"gpio",		शून्य),
		 ...
		 MPP_FUNCTION(8,	"ge",		"mdc"),
		 MPP_FUNCTION(9,	"pcie2",	"clkreq"),
		 MPP_FUNCTION(10,	"mss_gpio5",	शून्य)),
	MPP_MODE(37,
		 MPP_FUNCTION(0,	"gpio",		शून्य),
		 ...
		 MPP_FUNCTION(9,	"pcie1",	"clkreq"),
		 MPP_FUNCTION(10,	"mss_gpio6",	शून्य),
	...
	MPP_MODE(38,
		 ...
		 MPP_FUNCTION(10,	"mss_gpio7",	शून्य),
		 MPP_FUNCTION(11,	"ptp",		"pulse_cp2cp")),
	MPP_MODE(39,
		 MPP_FUNCTION(0,	"gpio",		शून्य),
	...
	MPP_MODE(42,
		 ...
		 MPP_FUNCTION(8,	"xg",		"mdc"),
		 MPP_FUNCTION(9,	"sata0",	"present_act"),
		 MPP_FUNCTION(10,	"mss_gpio4",	शून्य)),
	MPP_MODE(43,
		 MPP_FUNCTION(0,	"gpio",		शून्य),
	...
	MPP_MODE(59,
		 MPP_FUNCTION(0,	"gpio",		शून्य),
		 MPP_FUNCTION(1,	"mss_gpio7",	शून्य),
		 MPP_FUNCTION(2,	"synce2",	"clk"),
		 MPP_FUNCTION(4,	"tdm",		"fsync"),
		 MPP_FUNCTION(5,	"au",		"i2slrclk"),
		 MPP_FUNCTION(6,	"spi0",		"csn0"),
	...
	MPP_MODE(60,
		 MPP_FUNCTION(0,	"gpio",		शून्य),
		 MPP_FUNCTION(1,	"mss_gpio6",	शून्य),
		 MPP_FUNCTION(3,	"ptp",		"pulse"),
		 MPP_FUNCTION(4,	"tdm",		"dtx"),
		 MPP_FUNCTION(5,	"au",		"i2smclk"),
		 MPP_FUNCTION(6,	"spi0",		"csn1"),
	...
	MPP_MODE(61,
		 MPP_FUNCTION(0,	"gpio",		शून्य),
		 MPP_FUNCTION(1,	"mss_gpio5",	शून्य),
		 MPP_FUNCTION(3,	"ptp",		"clk"),
		 MPP_FUNCTION(4,	"tdm",		"pclk"),
		 MPP_FUNCTION(5,	"au",		"i2sextclk"),
	...
	MPP_MODE(62,
		 MPP_FUNCTION(0,	"gpio",		शून्य),
		 MPP_FUNCTION(1,	"mss_gpio4",	शून्य),
		 MPP_FUNCTION(2,	"synce1",	"clk"),
		 MPP_FUNCTION(3,	"ptp",		"pclk_out"),
...
अटल स्थिर काष्ठा of_device_id armada_cp110_pinctrl_of_match[] = अणु
	अणु
		.compatible	= "marvell,armada-7k-pinctrl",
		.data		= (व्योम *) V_ARMADA_7K,
	पूर्ण,
	अणु
		.compatible	= "marvell,armada-8k-cpm-pinctrl",
		.data		= (व्योम *) V_ARMADA_8K_CPM,
	पूर्ण,
	अणु
		.compatible	= "marvell,armada-8k-cps-pinctrl",
		.data		= (व्योम *) V_ARMADA_8K_CPS,
	पूर्ण,
	अणु
		.compatible	= "marvell,cp115-standalone-pinctrl",
		.data		= (व्योम *) V_CP115_STANDALONE,
	पूर्ण,
	अणु पूर्ण,
पूर्ण;

अटल स्थिर काष्ठा mvebu_mpp_ctrl armada_cp110_mpp_controls[] = अणु
	MPP_FUNC_CTRL(0, 62, शून्य, mvebu_regmap_mpp_ctrl),
पूर्ण;

अटल व्योम mvebu_pinctrl_assign_variant(काष्ठा mvebu_mpp_mode *m,
					 u8 variant)
अणु
	काष्ठा mvebu_mpp_ctrl_setting *s;

	क्रम (s = m->settings ; s->name ; s++)
		s->variant = variant;
पूर्ण

अटल पूर्णांक armada_cp110_pinctrl_probe(काष्ठा platक्रमm_device *pdev)
अणु
	...
	soc = devm_kzalloc(&pdev->dev,
			   माप(काष्ठा mvebu_pinctrl_soc_info), GFP_KERNEL);
	अगर (!soc)
		वापस -ENOMEM;

	soc->variant = (अचिन्हित दीर्घ) match->data & 0xff;
	...
	क्रम (i = 0; i < ARRAY_SIZE(armada_cp110_mpp_modes); i++) अणु
		काष्ठा mvebu_mpp_mode *m = &armada_cp110_mpp_modes[i];
...
अटल काष्ठा platक्रमm_driver armada_cp110_pinctrl_driver = अणु
	.driver = अणु
...
builtin_platक्रमm_driver(armada_cp110_pinctrl_driver);
