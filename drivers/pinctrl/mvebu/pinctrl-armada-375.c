...
अटल काष्ठा mvebu_mpp_mode mv88f6720_mpp_modes[] = अणु
	MPP_MODE(0,
...
अटल काष्ठा mvebu_pinctrl_soc_info armada_375_pinctrl_info;

अटल स्थिर काष्ठा of_device_id armada_375_pinctrl_of_match[] = अणु
	अणु .compatible = "marvell,mv88f6720-pinctrl" पूर्ण,
	अणु पूर्ण,
पूर्ण;

अटल स्थिर काष्ठा mvebu_mpp_ctrl mv88f6720_mpp_controls[] = अणु
	MPP_FUNC_CTRL(0, 69, शून्य, mvebu_mmio_mpp_ctrl),
पूर्ण;

अटल काष्ठा pinctrl_gpio_range mv88f6720_mpp_gpio_ranges[] = अणु
	MPP_GPIO_RANGE(0,   0,  0, 32),
	MPP_GPIO_RANGE(1,  32, 32, 32),
	MPP_GPIO_RANGE(2,  64, 64,  3),
पूर्ण;

अटल पूर्णांक armada_375_pinctrl_probe(काष्ठा platक्रमm_device *pdev)
अणु
	काष्ठा mvebu_pinctrl_soc_info *soc = &armada_375_pinctrl_info;

	soc->variant = 0; /* no variants क्रम Armada 375 */
...
अटल काष्ठा platक्रमm_driver armada_375_pinctrl_driver = अणु
	.driver = अणु
...
पूर्ण;
builtin_platक्रमm_driver(armada_375_pinctrl_driver);
