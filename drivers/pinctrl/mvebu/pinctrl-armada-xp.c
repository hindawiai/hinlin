 ...
 * both have 67 MPP pins (more GPIOs and address lines क्रम the memory
 * bus मुख्यly).
 */
...
अटल u32 *mpp_saved_regs;

क्रमागत armada_xp_variant अणु
	V_MV78230	= BIT(0),
	V_MV78260	= BIT(1),
	V_MV78460	= BIT(2),
...
अटल काष्ठा mvebu_mpp_mode armada_xp_mpp_modes[] = अणु
	MPP_MODE(0,
		 MPP_VAR_FUNCTION(0x0, "gpio", शून्य,        V_MV78230_PLUS),
	...
	MPP_MODE(49,
		 MPP_VAR_FUNCTION(0x0, "gpio", शून्य,        V_MV78260_PLUS),
...
अटल काष्ठा mvebu_mpp_mode mv98dx3236_mpp_modes[] = अणु
	MPP_MODE(0,
		 MPP_VAR_FUNCTION(0x0, "gpo", शून्य,          V_98DX3236_PLUS),
		 MPP_VAR_FUNCTION(0x2, "spi0", "mosi",       V_98DX3236_PLUS),
		 MPP_VAR_FUNCTION(0x4, "dev", "ad8",         V_98DX3236_PLUS)),
	MPP_MODE(1,
		 MPP_VAR_FUNCTION(0x0, "gpio", शून्य,         V_98DX3236_PLUS),
...
अटल काष्ठा mvebu_pinctrl_soc_info armada_xp_pinctrl_info;

अटल स्थिर काष्ठा of_device_id armada_xp_pinctrl_of_match[] = अणु
	अणु
		.compatible = "marvell,mv78230-pinctrl",
		.data       = (व्योम *) V_MV78230,
	पूर्ण,
	अणु
		.compatible = "marvell,mv78260-pinctrl",
		.data       = (व्योम *) V_MV78260,
	पूर्ण,
	अणु
		.compatible = "marvell,mv78460-pinctrl",
		.data       = (व्योम *) V_MV78460,
	पूर्ण,
	अणु
		.compatible = "marvell,98dx3236-pinctrl",
		.data       = (व्योम *) V_98DX3236,
	पूर्ण,
	अणु
		.compatible = "marvell,98dx4251-pinctrl",
		.data       = (व्योम *) V_98DX4251,
	पूर्ण,
	अणु पूर्ण,
पूर्ण;

अटल स्थिर काष्ठा mvebu_mpp_ctrl mv78230_mpp_controls[] = अणु
	MPP_FUNC_CTRL(0, 48, शून्य, mvebu_mmio_mpp_ctrl),
पूर्ण;

अटल काष्ठा pinctrl_gpio_range mv78230_mpp_gpio_ranges[] = अणु
	MPP_GPIO_RANGE(0,   0,  0, 32),
	MPP_GPIO_RANGE(1,  32, 32, 17),
पूर्ण;

अटल स्थिर काष्ठा mvebu_mpp_ctrl mv78260_mpp_controls[] = अणु
	MPP_FUNC_CTRL(0, 66, शून्य, mvebu_mmio_mpp_ctrl),
पूर्ण;

अटल काष्ठा pinctrl_gpio_range mv78260_mpp_gpio_ranges[] = अणु
	MPP_GPIO_RANGE(0,   0,  0, 32),
	MPP_GPIO_RANGE(1,  32, 32, 32),
	MPP_GPIO_RANGE(2,  64, 64,  3),
पूर्ण;

अटल स्थिर काष्ठा mvebu_mpp_ctrl mv78460_mpp_controls[] = अणु
	MPP_FUNC_CTRL(0, 66, शून्य, mvebu_mmio_mpp_ctrl),
पूर्ण;

अटल काष्ठा pinctrl_gpio_range mv78460_mpp_gpio_ranges[] = अणु
	MPP_GPIO_RANGE(0,   0,  0, 32),
	MPP_GPIO_RANGE(1,  32, 32, 32),
	MPP_GPIO_RANGE(2,  64, 64,  3),
पूर्ण;

अटल काष्ठा mvebu_mpp_ctrl mv98dx3236_mpp_controls[] = अणु
	MPP_FUNC_CTRL(0, 32, शून्य, mvebu_mmio_mpp_ctrl),
पूर्ण;

अटल काष्ठा pinctrl_gpio_range mv98dx3236_mpp_gpio_ranges[] = अणु
	MPP_GPIO_RANGE(0, 0, 0, 32),
पूर्ण;

अटल पूर्णांक armada_xp_pinctrl_suspend(काष्ठा platक्रमm_device *pdev,
				     pm_message_t state)
अणु
	काष्ठा mvebu_pinctrl_soc_info *soc =
	...
	क्रम (i = 0; i < nregs; i++)
		mpp_saved_regs[i] = पढ़ोl(soc->control_data[0].base + i * 4);

	वापस 0;
पूर्ण

अटल पूर्णांक armada_xp_pinctrl_resume(काष्ठा platक्रमm_device *pdev)
अणु
	काष्ठा mvebu_pinctrl_soc_info *soc =
		platक्रमm_get_drvdata(pdev);
	पूर्णांक i, nregs;
	...
	क्रम (i = 0; i < nregs; i++)
		ग_लिखोl(mpp_saved_regs[i], soc->control_data[0].base + i * 4);

	वापस 0;
पूर्ण

अटल पूर्णांक armada_xp_pinctrl_probe(काष्ठा platक्रमm_device *pdev)
अणु
	काष्ठा mvebu_pinctrl_soc_info *soc = &armada_xp_pinctrl_info;
	...
	soc->variant = (अचिन्हित) match->data & 0xff;
	...
	हाल V_MV78230:
		...
		/* We करोn't necessarily want the full list of the
	...
	mpp_saved_regs = devm_kदो_स्मृति_array(&pdev->dev, nregs, माप(u32),
					    GFP_KERNEL);
	अगर (!mpp_saved_regs)
		वापस -ENOMEM;
...
अटल काष्ठा platक्रमm_driver armada_xp_pinctrl_driver = अणु
	.driver = अणु
...
पूर्ण;
builtin_platक्रमm_driver(armada_xp_pinctrl_driver);
