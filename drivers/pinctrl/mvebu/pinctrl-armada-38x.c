...
अटल काष्ठा mvebu_mpp_mode armada_38x_mpp_modes[] = अणु
	MPP_MODE(0,
		 MPP_VAR_FUNCTION(0, "gpio",  शून्य,         V_88F6810_PLUS),
...
अटल काष्ठा mvebu_pinctrl_soc_info armada_38x_pinctrl_info;

अटल स्थिर काष्ठा of_device_id armada_38x_pinctrl_of_match[] = अणु
	अणु
		.compatible = "marvell,mv88f6810-pinctrl",
		.data       = (व्योम *) V_88F6810,
	पूर्ण,
	अणु
		.compatible = "marvell,mv88f6820-pinctrl",
		.data       = (व्योम *) V_88F6820,
	पूर्ण,
	अणु
		.compatible = "marvell,mv88f6828-pinctrl",
		.data       = (व्योम *) V_88F6828,
	पूर्ण,
	अणु पूर्ण,
पूर्ण;

अटल स्थिर काष्ठा mvebu_mpp_ctrl armada_38x_mpp_controls[] = अणु
	MPP_FUNC_CTRL(0, 59, शून्य, mvebu_mmio_mpp_ctrl),
पूर्ण;

अटल काष्ठा pinctrl_gpio_range armada_38x_mpp_gpio_ranges[] = अणु
	MPP_GPIO_RANGE(0,   0,  0, 32),
	MPP_GPIO_RANGE(1,  32, 32, 28),
पूर्ण;

अटल पूर्णांक armada_38x_pinctrl_probe(काष्ठा platक्रमm_device *pdev)
अणु
	काष्ठा mvebu_pinctrl_soc_info *soc = &armada_38x_pinctrl_info;
...
अटल काष्ठा platक्रमm_driver armada_38x_pinctrl_driver = अणु
	.driver = अणु
...
पूर्ण;
builtin_platक्रमm_driver(armada_38x_pinctrl_driver);
