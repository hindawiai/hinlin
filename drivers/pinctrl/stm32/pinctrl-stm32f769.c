...
अटल स्थिर काष्ठा sपंचांग32_desc_pin sपंचांग32f769_pins[] = अणु
	STM32_PIN(
		PINCTRL_PIN(0, "PA0"),
...
अटल काष्ठा sपंचांग32_pinctrl_match_data sपंचांग32f769_match_data = अणु
	.pins = sपंचांग32f769_pins,
	.npins = ARRAY_SIZE(sपंचांग32f769_pins),
पूर्ण;

अटल स्थिर काष्ठा of_device_id sपंचांग32f769_pctrl_match[] = अणु
	अणु
		.compatible = "st,stm32f769-pinctrl",
		.data = &sपंचांग32f769_match_data,
	पूर्ण,
	अणु पूर्ण
पूर्ण;

अटल काष्ठा platक्रमm_driver sपंचांग32f769_pinctrl_driver = अणु
	.probe = sपंचांग32_pctl_probe,
	.driver = अणु
		.name = "stm32f769-pinctrl",
		.of_match_table = sपंचांग32f769_pctrl_match,
	पूर्ण,
पूर्ण;

अटल पूर्णांक __init sपंचांग32f769_pinctrl_init(व्योम)
अणु
	वापस platक्रमm_driver_रेजिस्टर(&sपंचांग32f769_pinctrl_driver);
पूर्ण
arch_initcall(sपंचांग32f769_pinctrl_init);
