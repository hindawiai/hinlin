...
/* Wrap some of the common macros क्रम clarity */
#घोषणा SIG_EXPR_DECL_SINGLE(sig, func, ...) \
	SIG_EXPR_DECL(sig, func, func, __VA_ARGS__)

#घोषणा SIG_EXPR_LIST_DECL_SINGLE SIG_EXPR_LIST_DECL_SESG
#घोषणा SIG_EXPR_LIST_DECL_DUAL SIG_EXPR_LIST_DECL_DESG

/*
 * The "Multi-function Pins Mapping and Control" table in the SoC datasheet
 * references रेजिस्टरs by the device/offset mnemonic. The रेजिस्टर macros
 * below are named the same way to ease transcription and verअगरication (as
 * opposed to naming them e.g. PINMUX_CTRL_[0-9]). Further, संकेत expressions
 * reference रेजिस्टरs beyond those dedicated to pinmux, such as the प्रणाली
 * reset control and MAC घड़ी configuration रेजिस्टरs. The AST2500 goes a step
 * further and references रेजिस्टरs in the graphics IP block.
 */
#घोषणा SCU2C           0x2C /* Misc. Control Register */
#घोषणा SCU3C           0x3C /* System Reset Control/Status Register */
#घोषणा SCU48           0x48 /* MAC Interface Clock Delay Setting */
#घोषणा HW_STRAP1       0x70 /* AST2400 strapping is 33 bits, is split */
#घोषणा HW_REVISION_ID  0x7C /* Silicon revision ID रेजिस्टर */
#घोषणा SCU80           0x80 /* Multi-function Pin Control #1 */
#घोषणा SCU84           0x84 /* Multi-function Pin Control #2 */
#घोषणा SCU88           0x88 /* Multi-function Pin Control #3 */
#घोषणा SCU8C           0x8C /* Multi-function Pin Control #4 */
#घोषणा SCU90           0x90 /* Multi-function Pin Control #5 */
#घोषणा SCU94           0x94 /* Multi-function Pin Control #6 */
#घोषणा SCUA0           0xA0 /* Multi-function Pin Control #7 */
#घोषणा SCUA4           0xA4 /* Multi-function Pin Control #8 */
#घोषणा SCUA8           0xA8 /* Multi-function Pin Control #9 */
#घोषणा SCUAC           0xAC /* Multi-function Pin Control #10 */
#घोषणा HW_STRAP2       0xD0 /* Strapping */

#घोषणा ASPEED_G5_NR_PINS 236

#घोषणा COND1		अणु ASPEED_IP_SCU, SCU90, BIT(6), 0, 0 पूर्ण
#घोषणा COND2		अणु ASPEED_IP_SCU, SCU94, GENMASK(1, 0), 0, 0 पूर्ण

/* LHCR0 is offset from the end of the H8S/2168-compatible रेजिस्टरs */
#घोषणा LHCR0		0xa0
#घोषणा GFX064		0x64
...
#घोषणा I2C9_DESC	SIG_DESC_SET(SCU90, 22)
...
#घोषणा MDIO2_DESC	SIG_DESC_SET(SCU90, 2)
...
#घोषणा H21 13
#घोषणा H21_DESC	SIG_DESC_SET(SCU80, 13)
...
#घोषणा SD1_DESC	SIG_DESC_SET(SCU90, 0)

#घोषणा C12 16
#घोषणा I2C10_DESC	SIG_DESC_SET(SCU90, 23)
...
#घोषणा B12 18
#घोषणा I2C11_DESC	SIG_DESC_SET(SCU90, 24)
...
#घोषणा D10 20
#घोषणा I2C12_DESC	SIG_DESC_SET(SCU90, 25)
...
#घोषणा C11 22
#घोषणा I2C13_DESC	SIG_DESC_SET(SCU90, 26)
...
#घोषणा SD2_DESC        SIG_DESC_SET(SCU90, 1)
#घोषणा GPID0_DESC      SIG_DESC_SET(SCU8C, 8)
#घोषणा GPID_DESC       SIG_DESC_SET(HW_STRAP1, 21)
...
#घोषणा GPID2_DESC      SIG_DESC_SET(SCU8C, 9)
...
#घोषणा GPID4_DESC      SIG_DESC_SET(SCU8C, 10)
...
#घोषणा GPID6_DESC      SIG_DESC_SET(SCU8C, 11)
...
#घोषणा GPIE_DESC	SIG_DESC_SET(HW_STRAP1, 22)
#घोषणा GPIE0_DESC	SIG_DESC_SET(SCU8C, 12)
...
#घोषणा GPIE2_DESC	SIG_DESC_SET(SCU8C, 13)
...
#घोषणा GPIE4_DESC	SIG_DESC_SET(SCU8C, 14)
...
#घोषणा GPIE6_DESC	SIG_DESC_SET(SCU8C, 15)
...
#घोषणा LPCHC_DESC	SIG_DESC_IP_SET(ASPEED_IP_LPC, LHCR0, 0)
#घोषणा LPCPLUS_DESC	SIG_DESC_SET(SCU90, 30)
...
#घोषणा SGPS2_DESC	SIG_DESC_SET(SCU94, 12)
...
#घोषणा UART6_DESC	SIG_DESC_SET(SCU90, 7)
...
#घोषणा SPI1_DESC \
	अणु ASPEED_IP_SCU, HW_STRAP1, GENMASK(13, 12), 1, 0 पूर्ण
#घोषणा SPI1DEBUG_DESC \
	अणु ASPEED_IP_SCU, HW_STRAP1, GENMASK(13, 12), 2, 0 पूर्ण
#घोषणा SPI1PASSTHRU_DESC \
	अणु ASPEED_IP_SCU, HW_STRAP1, GENMASK(13, 12), 3, 0 पूर्ण
...
#घोषणा VB_DESC	SIG_DESC_SET(HW_STRAP1, 5)
...
#घोषणा I2C5_DESC       SIG_DESC_SET(SCU90, 18)
...
#घोषणा I2C6_DESC       SIG_DESC_SET(SCU90, 19)
...
#घोषणा I2C7_DESC       SIG_DESC_SET(SCU90, 20)
...
#घोषणा I2C8_DESC       SIG_DESC_SET(SCU90, 21)
...
#घोषणा VPIOFF0_DESC    अणु ASPEED_IP_SCU, SCU90, GENMASK(5, 4), 0, 0 पूर्ण
#घोषणा VPIOFF1_DESC    अणु ASPEED_IP_SCU, SCU90, GENMASK(5, 4), 1, 0 पूर्ण
#घोषणा VPI24_DESC      अणु ASPEED_IP_SCU, SCU90, GENMASK(5, 4), 2, 0 पूर्ण
#घोषणा VPIRSVD_DESC    अणु ASPEED_IP_SCU, SCU90, GENMASK(5, 4), 3, 0 पूर्ण
#घोषणा VPI_24_RSVD_DESC	SIG_DESC_SET(SCU90, 5)

#घोषणा T1 89
#घोषणा T1_DESC		SIG_DESC_SET(SCU84, 17)
...
#घोषणा U1 90
#घोषणा U1_DESC		SIG_DESC_SET(SCU84, 18)
...
#घोषणा U2 91
#घोषणा U2_DESC		SIG_DESC_SET(SCU84, 19)
...
#घोषणा P4 92
#घोषणा P4_DESC		SIG_DESC_SET(SCU84, 20)
...
#घोषणा P3 93
#घोषणा P3_DESC		SIG_DESC_SET(SCU84, 21)
...
#घोषणा V1 94
#घोषणा V1_DESC		SIG_DESC_SET(SCU84, 22)
...
#घोषणा W1 95
#घोषणा W1_DESC		SIG_DESC_SET(SCU84, 23)
...
#घोषणा Y1 96
#घोषणा Y1_DESC		SIG_DESC_SET(SCU84, 24)
...
#घोषणा AB2 97
#घोषणा AB2_DESC	SIG_DESC_SET(SCU84, 25)
...
#घोषणा AA1 98
#घोषणा AA1_DESC	SIG_DESC_SET(SCU84, 26)
...
#घोषणा Y2 99
#घोषणा Y2_DESC		SIG_DESC_SET(SCU84, 27)
...
#घोषणा AA2 100
#घोषणा AA2_DESC	SIG_DESC_SET(SCU84, 28)
...
#घोषणा P5 101
#घोषणा P5_DESC	SIG_DESC_SET(SCU84, 29)
...
#घोषणा R5 102
#घोषणा R5_DESC	SIG_DESC_SET(SCU84, 30)
...
#घोषणा T5 103
#घोषणा T5_DESC	SIG_DESC_SET(SCU84, 31)
...
#घोषणा V2 104
#घोषणा V2_DESC         SIG_DESC_SET(SCU88, 0)
...
#घोषणा W2 105
#घोषणा W2_DESC         SIG_DESC_SET(SCU88, 1)
...
#घोषणा V3 106
#घोषणा V3_DESC         SIG_DESC_SET(SCU88, 2)
...
#घोषणा U3 107
#घोषणा U3_DESC         SIG_DESC_SET(SCU88, 3)
...
#घोषणा W3 108
#घोषणा W3_DESC         SIG_DESC_SET(SCU88, 4)
...
#घोषणा AA3 109
#घोषणा AA3_DESC        SIG_DESC_SET(SCU88, 5)
...
#घोषणा Y3 110
#घोषणा Y3_DESC         SIG_DESC_SET(SCU88, 6)
...
#घोषणा T4 111
#घोषणा T4_DESC         SIG_DESC_SET(SCU88, 7)
...
#घोषणा I2C3_DESC	SIG_DESC_SET(SCU90, 16)
...
#घोषणा I2C4_DESC	SIG_DESC_SET(SCU90, 17)
...
#घोषणा I2C14_DESC	SIG_DESC_SET(SCU90, 27)
...
#घोषणा VPOOFF0_DESC	अणु ASPEED_IP_SCU, SCU94, GENMASK(1, 0), 0, 0 पूर्ण
#घोषणा VPO_DESC	अणु ASPEED_IP_SCU, SCU94, GENMASK(1, 0), 1, 0 पूर्ण
#घोषणा VPOOFF1_DESC	अणु ASPEED_IP_SCU, SCU94, GENMASK(1, 0), 2, 0 पूर्ण
#घोषणा VPOOFF2_DESC	अणु ASPEED_IP_SCU, SCU94, GENMASK(1, 0), 3, 0 पूर्ण

#घोषणा CRT_DVO_EN_DESC	SIG_DESC_IP_SET(ASPEED_IP_GFX, GFX064, 7)

#घोषणा V20 144
#घोषणा V20_DESC	SIG_DESC_SET(SCU8C, 0)
...
#घोषणा U19 145
#घोषणा U19_DESC	SIG_DESC_SET(SCU8C, 1)
...
#घोषणा R18 146
#घोषणा R18_DESC	SIG_DESC_SET(SCU8C, 2)
...
#घोषणा P18 147
#घोषणा P18_DESC	SIG_DESC_SET(SCU8C, 3)
...
#घोषणा R19 148
#घोषणा R19_DESC	SIG_DESC_SET(SCU8C, 4)
...
#घोषणा W20 149
#घोषणा W20_DESC	SIG_DESC_SET(SCU8C, 5)
...
#घोषणा U20 150
#घोषणा U20_DESC	SIG_DESC_SET(SCU8C, 6)
...
#घोषणा AA20 151
#घोषणा AA20_DESC	SIG_DESC_SET(SCU8C, 7)
...
#घोषणा RMII1_DESC      SIG_DESC_BIT(HW_STRAP1, 6, 0)
#घोषणा RMII2_DESC      SIG_DESC_BIT(HW_STRAP1, 7, 0)
...
#घोषणा ACPI_DESC	SIG_DESC_SET(HW_STRAP1, 19)
...
#घोषणा PNOR_DESC	SIG_DESC_SET(SCU90, 31)

#घोषणा Y20 200
#घोषणा Y20_DESC	SIG_DESC_SET(SCUA4, 16)
...
#घोषणा AB20 201
#घोषणा AB20_DESC	SIG_DESC_SET(SCUA4, 17)
...
#घोषणा AB21 202
#घोषणा AB21_DESC	SIG_DESC_SET(SCUA4, 18)
...
#घोषणा AA21 203
#घोषणा AA21_DESC	SIG_DESC_SET(SCUA4, 19)
...
/* CRT DVO disabled, configured क्रम single-edge mode */
#घोषणा CRT_DVO_DS_DESC अणु ASPEED_IP_GFX, GFX064, GENMASK(7, 6), 0, 0 पूर्ण

/* CRT DVO disabled, configured क्रम dual-edge mode */
#घोषणा CRT_DVO_DD_DESC अणु ASPEED_IP_GFX, GFX064, GENMASK(7, 6), 1, 1 पूर्ण

/* CRT DVO enabled, configured क्रम single-edge mode */
#घोषणा CRT_DVO_ES_DESC अणु ASPEED_IP_GFX, GFX064, GENMASK(7, 6), 2, 2 पूर्ण

/* CRT DVO enabled, configured क्रम dual-edge mode */
#घोषणा CRT_DVO_ED_DESC अणु ASPEED_IP_GFX, GFX064, GENMASK(7, 6), 3, 3 पूर्ण

#घोषणा U21 204
#घोषणा U21_DESC	SIG_DESC_SET(SCUA4, 20)
...
#घोषणा W22 205
#घोषणा W22_DESC	SIG_DESC_SET(SCUA4, 21)
...
#घोषणा V22 206
#घोषणा V22_DESC	SIG_DESC_SET(SCUA4, 22)
...
#घोषणा W21 207
#घोषणा W21_DESC	SIG_DESC_SET(SCUA4, 23)
...
#घोषणा Y21 208
#घोषणा Y21_DESC	SIG_DESC_SET(SCUA4, 24)
...
#घोषणा V21 209
#घोषणा V21_DESC	SIG_DESC_SET(SCUA4, 25)
...
#घोषणा Y22 210
#घोषणा Y22_DESC	SIG_DESC_SET(SCUA4, 26)
...
#घोषणा AA22 211
#घोषणा AA22_DESC	SIG_DESC_SET(SCUA4, 27)
...
#घोषणा U22 212
#घोषणा U22_DESC	SIG_DESC_SET(SCUA4, 28)
...
#घोषणा T20 213
#घोषणा T20_DESC	SIG_DESC_SET(SCUA4, 29)
...
#घोषणा N18 214
#घोषणा N18_DESC	SIG_DESC_SET(SCUA4, 30)
...
#घोषणा P19 215
#घोषणा P19_DESC	SIG_DESC_SET(SCUA4, 31)
...
#घोषणा N19 216
#घोषणा N19_DESC	SIG_DESC_SET(SCUA8, 0)
...
#घोषणा T21 217
#घोषणा T21_DESC	SIG_DESC_SET(SCUA8, 1)
...
#घोषणा T22 218
#घोषणा T22_DESC	SIG_DESC_SET(SCUA8, 2)
...
#घोषणा R20 219
#घोषणा R20_DESC	SIG_DESC_SET(SCUA8, 3)
...
#घोषणा ESPI_DESC	SIG_DESC_SET(HW_STRAP1, 25)
...
#घोषणा USB11BHID_DESC  अणु ASPEED_IP_SCU, SCU94, GENMASK(14, 13), 0, 0 पूर्ण
#घोषणा USB2BD_DESC   अणु ASPEED_IP_SCU, SCU94, GENMASK(14, 13), 1, 0 पूर्ण
#घोषणा USB2BH1_DESC अणु ASPEED_IP_SCU, SCU94, GENMASK(14, 13), 2, 0 पूर्ण
#घोषणा USB2BH2_DESC अणु ASPEED_IP_SCU, SCU94, GENMASK(14, 13), 3, 0 पूर्ण
...
/* Pins, groups and functions are sort(1):ed alphabetically क्रम sanity */

अटल काष्ठा pinctrl_pin_desc aspeed_g5_pins[ASPEED_G5_NR_PINS] = अणु
...
अटल स्थिर काष्ठा aspeed_pin_group aspeed_g5_groups[] = अणु
...
अटल स्थिर काष्ठा aspeed_pin_function aspeed_g5_functions[] = अणु
...
अटल काष्ठा aspeed_pin_config aspeed_g5_configs[] = अणु
	/* GPIOA, GPIOQ */
	...
	/*
	 * Debounce settings क्रम GPIOs D and E passthrough mode are in
	 * SCUA8[27:20] and so are managed by pinctrl. Normal GPIO debounce क्रम
	 ...
	 * controller. Due to this tangle between GPIO and pinctrl we करोn't yet
...
अटल काष्ठा regmap *aspeed_g5_acquire_regmap(काष्ठा aspeed_pinmux_data *ctx,
					       पूर्णांक ip)
अणु
	अगर (ip == ASPEED_IP_SCU) अणु
		WARN(!ctx->maps[ip], "Missing SCU syscon!");
		वापस ctx->maps[ip];
	पूर्ण

	अगर (ip >= ASPEED_NR_PINMUX_IPS)
		वापस ERR_PTR(-EINVAL);

	अगर (likely(ctx->maps[ip]))
		वापस ctx->maps[ip];

	अगर (ip == ASPEED_IP_GFX) अणु
	...
	अगर (ip == ASPEED_IP_LPC) अणु
		...
		अगर (np) अणु
			अगर (!of_device_is_compatible(np->parent, "aspeed,ast2400-lpc-v2") &&
...
अटल पूर्णांक aspeed_g5_sig_expr_eval(काष्ठा aspeed_pinmux_data *ctx,
...
/**
 * aspeed_g5_sig_expr_set() - Configure a pin's संकेत by applying an
 * expression's descriptor state क्रम all descriptors in the expression.
 *
 * @ctx: The pinmux context
 * @expr: The expression associated with the function whose संकेत is to be
 *        configured
 * @enable: true to enable an function's signal through a pin's संकेत
 *          expression, false to disable the function's संकेत
 *
 * Return: 0 अगर the expression is configured as requested and a negative error
 * code otherwise
 */
अटल पूर्णांक aspeed_g5_sig_expr_set(काष्ठा aspeed_pinmux_data *ctx,
				  स्थिर काष्ठा aspeed_sig_expr *expr,
				  bool enable)
अणु
	पूर्णांक ret;
	...
	क्रम (i = 0; i < expr->ndescs; i++) अणु
		...
		/*
		 * Strap रेजिस्टरs are configured in hardware or by early-boot
		 * firmware. Treat them as पढ़ो-only despite that we can ग_लिखो
		 ...
		 * normal operation of the host when the BMC is घातered off or
		 * fails to boot. Once the BMC has booted, the loopback mode
		 * must be disabled क्रम the BMC to control host घातer-on and
		 * reset.
		 */
		अगर (desc->ip == ASPEED_IP_SCU && desc->reg == HW_STRAP1 &&
		    !(desc->mask & (BIT(21) | BIT(22))))
			जारी;

		अगर (desc->ip == ASPEED_IP_SCU && desc->reg == HW_STRAP2)
			जारी;

		/* On AST2500, Set bits in SCU70 are cleared from SCU7C */
		अगर (desc->ip == ASPEED_IP_SCU && desc->reg == HW_STRAP1) अणु
			u32 value = ~val & desc->mask;

			अगर (value) अणु
				ret = regmap_ग_लिखो(ctx->maps[desc->ip],
...
अटल स्थिर काष्ठा aspeed_pin_config_map aspeed_g5_pin_config_map[] = अणु
	अणु PIN_CONFIG_BIAS_PULL_DOWN,  0, 1, BIT_MASK(0)पूर्ण,
	अणु PIN_CONFIG_BIAS_PULL_DOWN, -1, 0, BIT_MASK(0)पूर्ण,
	अणु PIN_CONFIG_BIAS_DISABLE,   -1, 1, BIT_MASK(0)पूर्ण,
	अणु PIN_CONFIG_DRIVE_STRENGTH,  8, 0, BIT_MASK(0)पूर्ण,
	अणु PIN_CONFIG_DRIVE_STRENGTH, 16, 1, BIT_MASK(0)पूर्ण,
पूर्ण;

अटल स्थिर काष्ठा aspeed_pinmux_ops aspeed_g5_ops = अणु
	.eval = aspeed_g5_sig_expr_eval,
	.set = aspeed_g5_sig_expr_set,
पूर्ण;

अटल काष्ठा aspeed_pinctrl_data aspeed_g5_pinctrl_data = अणु
	.pins = aspeed_g5_pins,
...
अटल स्थिर काष्ठा pinmux_ops aspeed_g5_pinmux_ops = अणु
...
अटल स्थिर काष्ठा pinctrl_ops aspeed_g5_pinctrl_ops = अणु
...
अटल स्थिर काष्ठा pinconf_ops aspeed_g5_conf_ops = अणु
	.is_generic = true,
...
अटल काष्ठा pinctrl_desc aspeed_g5_pinctrl_desc = अणु
...
अटल पूर्णांक aspeed_g5_pinctrl_probe(काष्ठा platक्रमm_device *pdev)
अणु
	पूर्णांक i;

	क्रम (i = 0; i < ARRAY_SIZE(aspeed_g5_pins); i++)
		aspeed_g5_pins[i].number = i;

	aspeed_g5_pinctrl_data.pinmux.dev = &pdev->dev;

	वापस aspeed_pinctrl_probe(pdev, &aspeed_g5_pinctrl_desc,
			&aspeed_g5_pinctrl_data);
पूर्ण

अटल स्थिर काष्ठा of_device_id aspeed_g5_pinctrl_of_match[] = अणु
	अणु .compatible = "aspeed,ast2500-pinctrl", पूर्ण,
	/*
	 * The aspeed,g5-pinctrl compatible has been हटाओd the from the
	 * bindings, but keep the match in हाल of old devicetrees.
	 */
	अणु .compatible = "aspeed,g5-pinctrl", पूर्ण,
	अणु पूर्ण,
पूर्ण;

अटल काष्ठा platक्रमm_driver aspeed_g5_pinctrl_driver = अणु
...
अटल पूर्णांक aspeed_g5_pinctrl_init(व्योम)
अणु
	वापस platक्रमm_driver_रेजिस्टर(&aspeed_g5_pinctrl_driver);
पूर्ण
