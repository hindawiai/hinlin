...
#घोषणा SCU400		0x400 /* Multi-function Pin Control #1  */
#घोषणा SCU404		0x404 /* Multi-function Pin Control #2  */
#घोषणा SCU40C		0x40C /* Multi-function Pin Control #3  */
#घोषणा SCU410		0x410 /* Multi-function Pin Control #4  */
#घोषणा SCU414		0x414 /* Multi-function Pin Control #5  */
#घोषणा SCU418		0x418 /* Multi-function Pin Control #6  */
#घोषणा SCU41C		0x41C /* Multi-function Pin Control #7  */
#घोषणा SCU430		0x430 /* Multi-function Pin Control #8  */
#घोषणा SCU434		0x434 /* Multi-function Pin Control #9  */
#घोषणा SCU438		0x438 /* Multi-function Pin Control #10 */
#घोषणा SCU440		0x440 /* USB Multi-function Pin Control #12 */
#घोषणा SCU450		0x450 /* Multi-function Pin Control #14 */
#घोषणा SCU454		0x454 /* Multi-function Pin Control #15 */
#घोषणा SCU458		0x458 /* Multi-function Pin Control #16 */
#घोषणा SCU4B0		0x4B0 /* Multi-function Pin Control #17 */
#घोषणा SCU4B4		0x4B4 /* Multi-function Pin Control #18 */
#घोषणा SCU4B8		0x4B8 /* Multi-function Pin Control #19 */
#घोषणा SCU4BC		0x4BC /* Multi-function Pin Control #20 */
#घोषणा SCU4D4		0x4D4 /* Multi-function Pin Control #22 */
#घोषणा SCU4D8		0x4D8 /* Multi-function Pin Control #23 */
#घोषणा SCU500		0x500 /* Hardware Strap 1 */
#घोषणा SCU510		0x510 /* Hardware Strap 2 */
#घोषणा SCU610		0x610 /* Disable GPIO Internal Pull-Down #0 */
#घोषणा SCU614		0x614 /* Disable GPIO Internal Pull-Down #1 */
#घोषणा SCU618		0x618 /* Disable GPIO Internal Pull-Down #2 */
#घोषणा SCU61C		0x61c /* Disable GPIO Internal Pull-Down #3 */
#घोषणा SCU620		0x620 /* Disable GPIO Internal Pull-Down #4 */
#घोषणा SCU634		0x634 /* Disable GPIO Internal Pull-Down #5 */
#घोषणा SCU638		0x638 /* Disable GPIO Internal Pull-Down #6 */
#घोषणा SCU694		0x694 /* Multi-function Pin Control #25 */
#घोषणा SCU69C		0x69C /* Multi-function Pin Control #27 */
#घोषणा SCUC20		0xC20 /* PCIE configuration Setting Control */

#घोषणा ASPEED_G6_NR_PINS 256
...
/*
 * FIXME: Confirm bits and priorities are the right way around क्रम the
 * following 4 pins
 */
#घोषणा AF25 244
...
#घोषणा USB2ADP_DESC   अणु ASPEED_IP_SCU, SCU440, GENMASK(25, 24), 0, 0 पूर्ण
#घोषणा USB2AD_DESC    अणु ASPEED_IP_SCU, SCU440, GENMASK(25, 24), 1, 0 पूर्ण
#घोषणा USB2AH_DESC    अणु ASPEED_IP_SCU, SCU440, GENMASK(25, 24), 2, 0 पूर्ण
#घोषणा USB2AHP_DESC   अणु ASPEED_IP_SCU, SCU440, GENMASK(25, 24), 3, 0 पूर्ण
#घोषणा USB11BHID_DESC अणु ASPEED_IP_SCU, SCU440, GENMASK(29, 28), 0, 0 पूर्ण
#घोषणा USB2BD_DESC    अणु ASPEED_IP_SCU, SCU440, GENMASK(29, 28), 1, 0 पूर्ण
#घोषणा USB2BH_DESC    अणु ASPEED_IP_SCU, SCU440, GENMASK(29, 28), 2, 0 पूर्ण
...
अटल काष्ठा pinctrl_pin_desc aspeed_g6_pins[ASPEED_G6_NR_PINS] = अणु
...
अटल स्थिर काष्ठा aspeed_pin_group aspeed_g6_groups[] = अणु
...
अटल स्थिर काष्ठा aspeed_pin_function aspeed_g6_functions[] = अणु
...
अटल काष्ठा aspeed_pin_config aspeed_g6_configs[] = अणु
	/* GPIOB7 */
	...
	/* LAD3 */
	अणु PIN_CONFIG_DRIVE_STRENGTH, अणु AC7, AC7 पूर्ण, SCU454, GENMASK(31, 30)पूर्ण,
	/* LAD2 */
	अणु PIN_CONFIG_DRIVE_STRENGTH, अणु AC8, AC8 पूर्ण, SCU454, GENMASK(29, 28)पूर्ण,
	/* LAD1 */
	अणु PIN_CONFIG_DRIVE_STRENGTH, अणु AB8, AB8 पूर्ण, SCU454, GENMASK(27, 26)पूर्ण,
	/* LAD0 */
	अणु PIN_CONFIG_DRIVE_STRENGTH, अणु AB7, AB7 पूर्ण, SCU454, GENMASK(25, 24)पूर्ण,

	/* MAC3 */
	अणु PIN_CONFIG_POWER_SOURCE,   अणु H24, E26 पूर्ण, SCU458, BIT_MASK(4)पूर्ण,
	अणु PIN_CONFIG_DRIVE_STRENGTH, अणु H24, E26 पूर्ण, SCU458, GENMASK(1, 0)पूर्ण,
	/* MAC4 */
	अणु PIN_CONFIG_POWER_SOURCE,   अणु F24, B24 पूर्ण, SCU458, BIT_MASK(5)पूर्ण,
	अणु PIN_CONFIG_DRIVE_STRENGTH, अणु F24, B24 पूर्ण, SCU458, GENMASK(3, 2)पूर्ण,
...
/**
 * aspeed_g6_sig_expr_set() - Configure a pin's संकेत by applying an
 ...
 * code otherwise
 */
अटल पूर्णांक aspeed_g6_sig_expr_set(काष्ठा aspeed_pinmux_data *ctx,
...
अणु
	...
	क्रम (i = 0; i < expr->ndescs; i++) अणु
		...
		अगर (is_strap) अणु
			/*
			 * The AST2600 has ग_लिखो protection mask रेजिस्टरs क्रम
			 * the hardware strapping in SCU508 and SCU518. Assume
			 * that अगर the platक्रमm करोesn't want the strapping
			 * values changed that it has set the ग_लिखो mask.
			 *
			 * The strapping रेजिस्टरs implement ग_लिखो-1-clear
			 * behaviour. SCU500 is paired with clear ग_लिखोs on
...
अटल स्थिर काष्ठा aspeed_pin_config_map aspeed_g6_pin_config_map[] = अणु
	अणु PIN_CONFIG_BIAS_PULL_DOWN,  0,   1, BIT_MASK(0)पूर्ण,
	अणु PIN_CONFIG_BIAS_PULL_DOWN, -1,   0, BIT_MASK(0)पूर्ण,
	अणु PIN_CONFIG_BIAS_PULL_UP,    0,   1, BIT_MASK(0)पूर्ण,
	अणु PIN_CONFIG_BIAS_PULL_UP,   -1,   0, BIT_MASK(0)पूर्ण,
	अणु PIN_CONFIG_BIAS_DISABLE,   -1,   1, BIT_MASK(0)पूर्ण,
	अणु PIN_CONFIG_DRIVE_STRENGTH,  4,   0, GENMASK(1, 0)पूर्ण,
	अणु PIN_CONFIG_DRIVE_STRENGTH,  8,   1, GENMASK(1, 0)पूर्ण,
	अणु PIN_CONFIG_DRIVE_STRENGTH, 12,   2, GENMASK(1, 0)पूर्ण,
	अणु PIN_CONFIG_DRIVE_STRENGTH, 16,   3, GENMASK(1, 0)पूर्ण,
	अणु PIN_CONFIG_POWER_SOURCE,   3300, 0, BIT_MASK(0)पूर्ण,
	अणु PIN_CONFIG_POWER_SOURCE,   1800, 1, BIT_MASK(0)पूर्ण,
पूर्ण;
...
अटल काष्ठा aspeed_pinctrl_data aspeed_g6_pinctrl_data = अणु
	.pins = aspeed_g6_pins,
...
अटल स्थिर काष्ठा pinmux_ops aspeed_g6_pinmux_ops = अणु
...
अटल स्थिर काष्ठा pinctrl_ops aspeed_g6_pinctrl_ops = अणु
...
अटल स्थिर काष्ठा pinconf_ops aspeed_g6_conf_ops = अणु
	.is_generic = true,
...
अटल काष्ठा pinctrl_desc aspeed_g6_pinctrl_desc = अणु
...
अटल पूर्णांक aspeed_g6_pinctrl_probe(काष्ठा platक्रमm_device *pdev)
अणु
	पूर्णांक i;

	क्रम (i = 0; i < ARRAY_SIZE(aspeed_g6_pins); i++)
		aspeed_g6_pins[i].number = i;

	वापस aspeed_pinctrl_probe(pdev, &aspeed_g6_pinctrl_desc,
			&aspeed_g6_pinctrl_data);
पूर्ण

अटल स्थिर काष्ठा of_device_id aspeed_g6_pinctrl_of_match[] = अणु
	अणु .compatible = "aspeed,ast2600-pinctrl", पूर्ण,
	अणु पूर्ण,
पूर्ण;

अटल काष्ठा platक्रमm_driver aspeed_g6_pinctrl_driver = अणु
...
अटल पूर्णांक aspeed_g6_pinctrl_init(व्योम)
अणु
	वापस platक्रमm_driver_रेजिस्टर(&aspeed_g6_pinctrl_driver);
पूर्ण
