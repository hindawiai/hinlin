...
अटल स्थिर काष्ठा pinmux_cfg_reg pinmux_config_regs[] = अणु
	अणु PINMUX_CFG_REG("PABCR", 0xffc70000, 32, 2, GROUP(
	...
	पूर्ण,
	अणु PINMUX_CFG_REG("PCDCR", 0xffc70004, 32, 2, GROUP(
	...
	पूर्ण,
	अणु PINMUX_CFG_REG("PEFCR", 0xffc70008, 32, 2, GROUP(
	...
	पूर्ण,
	अणु PINMUX_CFG_REG("PGHCR", 0xffc7000c, 32, 2, GROUP(
...
अटल स्थिर काष्ठा pinmux_data_reg pinmux_data_regs[] = अणु
	अणु PINMUX_DATA_REG("PABDR", 0xffc70010, 32, GROUP(
		0, 0, 0, 0, 0, 0, 0, 0,
		PA7_DATA, PA6_DATA, PA5_DATA, PA4_DATA,
		PA3_DATA, PA2_DATA, PA1_DATA, PA0_DATA,
		0, 0, 0, 0, 0, 0, 0, 0,
		...
		PB3_DATA, PB2_DATA, PB1_DATA, PB0_DATA, ))
	पूर्ण,
	अणु PINMUX_DATA_REG("PCDDR", 0xffc70014, 32, GROUP(
		0, 0, 0, 0, 0, 0, 0, 0,
		PC7_DATA, PC6_DATA, PC5_DATA, PC4_DATA,
		PC3_DATA, PC2_DATA, PC1_DATA, PC0_DATA,
		0, 0, 0, 0, 0, 0, 0, 0,
		...
		PD3_DATA, PD2_DATA, PD1_DATA, PD0_DATA, ))
	पूर्ण,
	अणु PINMUX_DATA_REG("PEFDR", 0xffc70018, 32, GROUP(
		0, 0, 0, 0, 0, 0, 0, 0,
		PE7_DATA, PE6_DATA, PE5_DATA, PE4_DATA,
		PE3_DATA, PE2_DATA, PE1_DATA, PE0_DATA,
		0, 0, 0, 0, 0, 0, 0, 0,
		...
		PF3_DATA, PF2_DATA, PF1_DATA, PF0_DATA, ))
	पूर्ण,
	अणु PINMUX_DATA_REG("PGHDR", 0xffc7001c, 32, GROUP(
		0, 0, 0, 0, 0, 0, 0, 0,
		PG7_DATA, PG6_DATA, PG5_DATA, PG4_DATA,
		PG3_DATA, PG2_DATA, PG1_DATA, PG0_DATA,
		0, 0, 0, 0, 0, 0, 0, 0,
...
स्थिर काष्ठा sh_pfc_soc_info shx3_pinmux_info = अणु
	.name		= "shx3_pfc",
