...
/* - AVB -------------------------------------------------------------------- */
अटल स्थिर अचिन्हित पूर्णांक avb_col_pins[] = अणु
	RCAR_GP_PIN(5, 18),
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक avb_col_mux[] = अणु
	AVB_COL_MARK,
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक avb_crs_pins[] = अणु
	RCAR_GP_PIN(5, 17),
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक avb_crs_mux[] = अणु
	AVB_CRS_MARK,
पूर्ण;
...
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक avb_mii_tx_rx_pins[] = अणु
	...
	RCAR_GP_PIN(3, 10),
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक avb_mii_tx_rx_mux[] = अणु
...
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक avb_mii_tx_er_pins[] = अणु
	RCAR_GP_PIN(5, 23),
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक avb_mii_tx_er_mux[] = अणु
	AVB_TX_ER_MARK,
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक avb_gmii_tx_rx_pins[] = अणु
...
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक avb_gmii_tx_rx_mux[] = अणु
...
पूर्ण;
/* - I2C0 ------------------------------------------------------------------- */
अटल स्थिर अचिन्हित पूर्णांक i2c0_a_pins[] = अणु
	/* SCL, SDA */
	RCAR_GP_PIN(4, 0), RCAR_GP_PIN(4, 1),
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक i2c0_a_mux[] = अणु
...
पूर्ण;
/* - I2C4 ------------------------------------------------------------------- */
अटल स्थिर अचिन्हित पूर्णांक i2c4_a_pins[] = अणु
	/* SCL, SDA */
	RCAR_GP_PIN(4, 10), RCAR_GP_PIN(4, 11),
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक i2c4_a_mux[] = अणु
...
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक scअगर5_data_e_pins[] = अणु
	/* RX, TX */
	RCAR_GP_PIN(0, 9), RCAR_GP_PIN(0, 10),
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक scअगर5_data_e_mux[] = अणु
	RX5_E_MARK, TX5_E_MARK,
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक scअगर5_data_f_pins[] = अणु
	/* RX, TX */
	RCAR_GP_PIN(3, 27), RCAR_GP_PIN(3, 28),
पूर्ण;
अटल स्थिर अचिन्हित पूर्णांक scअगर5_data_f_mux[] = अणु
...
अटल स्थिर काष्ठा sh_pfc_pin_group pinmux_groups[] = अणु
	...
	SH_PFC_PIN_GROUP(scअगर5_data_e),
	SH_PFC_PIN_GROUP(scअगर5_data_f),
...
अटल स्थिर काष्ठा pinmux_cfg_reg pinmux_config_regs[] = अणु
	...
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR0", 0xE6060040, 32,
		...
		0, 0, 0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR1", 0xE6060044, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP1_31_28 [4] */
		...
		0, 0, 0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR2", 0xE6060048, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP2_31_28 [4] */
		...
		0, 0, 0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR3", 0xE606004C, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP3_31_28 [4] */
		...
		0, 0, 0, 0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR4", 0xE6060050, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP4_31_28 [4] */
		...
		0, 0, 0, 0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR5", 0xE6060054, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP5_31_28 [4] */
		...
		0, 0, 0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR6", 0xE6060058, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP6_31_28 [4] */
		...
		0, 0, 0, 0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR7", 0xE606005C, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP7_31_28 [4] */
		...
		0, 0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR8", 0xE6060060, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP8_31_28 [4] */
		...
		0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR9", 0xE6060064, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP9_31_28 [4] */
		...
		0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR10", 0xE6060068, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP10_31_28 [4] */
		...
		0, 0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR11", 0xE606006C, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP11_31_28 [4] */
	...
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR12", 0xE6060070, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP12_31_28 [4] */
		...
		0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR13", 0xE6060074, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP13_31_28 [4] */
		...
		0, 0, 0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR14", 0xE6060078, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP14_31_28 [4] */
		...
		0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR15", 0xE606007C, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP15_31_28 [4] */
	...
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR16", 0xE6060080, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP16_31_28 [4] */
		...
		0, 0, 0, 0, 0, 0, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("IPSR17", 0xE6060084, 32,
			     GROUP(4, 4, 4, 4, 4, 4, 4, 4),
			     GROUP(
		/* IP17_31_28 [4] */
	...
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("MOD_SEL0", 0xE60600C0, 32,
		...
		FN_SEL_AVB_0, FN_SEL_AVB_1, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("MOD_SEL1", 0xE60600C4, 32,
		...
		FN_SEL_HSCIF0_0, FN_SEL_HSCIF0_1, ))
	पूर्ण,
	अणु PINMUX_CFG_REG_VAR("MOD_SEL2", 0xE60600C8, 32,
...
अटल पूर्णांक r8a77470_pin_to_pocctrl(काष्ठा sh_pfc *pfc, अचिन्हित पूर्णांक pin,
				   u32 *pocctrl)
अणु
	पूर्णांक bit = -EINVAL;
	...
	*pocctrl = 0xe60600b0;
	...
	अगर (pin >= RCAR_GP_PIN(0, 5) && pin <= RCAR_GP_PIN(0, 10))
		bit = 0;

	अगर (pin >= RCAR_GP_PIN(0, 13) && pin <= RCAR_GP_PIN(0, 22))
		bit = 2;

	अगर (pin >= RCAR_GP_PIN(4, 14) && pin <= RCAR_GP_PIN(4, 19))
		bit = 1;

	वापस bit;
पूर्ण

अटल स्थिर काष्ठा sh_pfc_soc_operations r8a77470_pinmux_ops = अणु
	.pin_to_pocctrl = r8a77470_pin_to_pocctrl,
पूर्ण;

#अगर_घोषित CONFIG_PINCTRL_PFC_R8A77470
स्थिर काष्ठा sh_pfc_soc_info r8a77470_pinmux_info = अणु
	.name = "r8a77470_pfc",
