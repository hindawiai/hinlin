...
क्रमागत अणु
	...
	सूचीECTION_MARK, EXBUF_ENB_MARK, IDERST_MARK, IODACK_MARK,
...
अटल स्थिर u16 pinmux_data[] = अणु
	...
	/* PTE FN */
	PINMUX_DATA(सूचीECTION_MARK, PSA11_PSA10_FN1, PTE5_FN),
...
अटल स्थिर काष्ठा pinmux_cfg_reg pinmux_config_regs[] = अणु
	...
	पूर्ण,
	अणु PINMUX_CFG_REG("PSELA", 0xa405014e, 16, 2, GROUP(
		...
		0, 0, 0, 0 ))
	पूर्ण,
	अणु PINMUX_CFG_REG("PSELB", 0xa4050150, 16, 2, GROUP(
		...
		0, 0, 0, 0 ))
	पूर्ण,
	अणु PINMUX_CFG_REG("PSELC", 0xa4050152, 16, 2, GROUP(
		...
		0, 0, 0, 0 ))
	पूर्ण,
	अणु PINMUX_CFG_REG("PSELD", 0xa4050154, 16, 2, GROUP(
...
स्थिर काष्ठा sh_pfc_soc_info sh7723_pinmux_info = अणु
	.name = "sh7723_pfc",
