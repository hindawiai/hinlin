...
#समावेश "odm_EdcaTurboCheck.h"
#समावेश "odm_DIG.h"
#समावेश "odm_PathDiv.h"
#समावेश "odm_DynamicBBPowerSaving.h"
#समावेश "odm_DynamicTxPower.h"
#समावेश "odm_CfoTracking.h"
#समावेश "odm_NoiseMonitor.h"
...
#घोषणा TXSCALE_TABLE_SIZE		37
#घोषणा TXPWR_TRACK_TABLE_SIZE	30
#घोषणा DELTA_SWINGIDX_SIZE     30
#घोषणा BAND_NUM				4
...
#घोषणा	PSD_TH2		3
#घोषणा	PSD_CHMIN		20   /*  Minimum channel number क्रम BT AFH */
...
#घोषणा		DM_DIG_LOW_PWR_THRESHOLD	0x14

/* ANT Test */
#घोषणा			ANTTESTALL		0x00		/* Ant A or B will be Testing */
#घोषणा		ANTTESTA		0x01		/* Ant A will be Testing */
#घोषणा		ANTTESTB		0x02		/* Ant B will be testing */

#घोषणा	PS_MODE_ACTIVE 0x01

/* क्रम 8723A Ant Definition--2012--06--07 due to dअगरferent IC may be dअगरferent ANT define */
#घोषणा		MAIN_ANT		1		/* Ant A or Ant Main */
#घोषणा		AUX_ANT		2		/* AntB or Ant Aux */
#घोषणा		MAX_ANT		3		/*  3 क्रम AP using */
...
/* Remoce BB घातer saving by Yuchn */
...
/*  In SWAW_STEP_PEAK, driver needs to चयन antenna and listen to the संकेत on the air. */
/*  In SWAW_STEP_DETERMINE, driver just compares the संकेत captured in SWAW_STEP_PEAK */
...
#घोषणा	TRAFFIC_LOW	0
#घोषणा	TRAFFIC_HIGH	1
#घोषणा	TRAFFIC_UltraLOW	2

काष्ठा swat_t अणु /* _SW_Antenna_Switch_ */
	u8 Double_chk_flag;
	u8 try_flag;
	s32 PreRSSI;
	u8 CurAntenna;
	...
	काष्ठा समयr_list SwAntennaSwitchTimer_8723B;
...
काष्ठा odm_rate_adaptive अणु
	u8 Type;				/*  DM_Type_ByFW/DM_Type_ByDriver */
	u8 LdpcThres;			/*  अगर RSSI > LdpcThres => चयन from LPDC to BCC */
	bool bUseLdpc;
	bool bLowerRtsRate;
...
/*  */
#घोषणा MAX_PATH_NUM_92CS		2
#घोषणा MAX_PATH_NUM_8188E		1
#घोषणा MAX_PATH_NUM_8192E		2
#घोषणा MAX_PATH_NUM_8723B		1
#घोषणा MAX_PATH_NUM_8812A		2
#घोषणा MAX_PATH_NUM_8821A		1
#घोषणा MAX_PATH_NUM_8814A		4
#घोषणा MAX_PATH_NUM_8822B		2

#घोषणा IQK_THRESHOLD			8
#घोषणा DPK_THRESHOLD			4

काष्ठा odm_phy_info अणु
	/*
	 *  Be care, अगर you want to add any element, please insert it between
	 *  rx_pwd_ball and संकेत_strength.
	 */
	u8 rx_pwd_ba11;

	u8 संकेत_quality;             /* in 0-100 index. */
	...
	s8 rx_घातer;                   /* in dBm Translate from PWdB */

	/*
	 * Real घातer in dBm क्रम this packet, no beautअगरication and
	 * aggregation. Keep this raw info to be used क्रम the other procedures.
	 */
	s8 recv_संकेत_घातer;
	u8 bt_rx_rssi_percentage;
	u8 संकेत_strength;	       /* in 0-100 index. */
...
क्रमागत अणु /* _ODM_Support_Ability_Definition */
	/*  */
...
क्रमागत अणु /* tag_ODM_Support_Interface_Definition */
	ODM_ITRF_SDIO	=	0x4,
	ODM_ITRF_ALL	=	0x7,
पूर्ण;

/*  ODM_CMNINFO_IC_TYPE */
क्रमागत अणु /* tag_ODM_Support_IC_Type_Definition */
	ODM_RTL8723B	=	BIT8,
पूर्ण;

/* ODM_CMNINFO_CUT_VER */
क्रमागत अणु /* tag_ODM_Cut_Version_Definition */
	ODM_CUT_A		=	0,
	ODM_CUT_B		=	1,
	ODM_CUT_C		=	2,
	ODM_CUT_D		=	3,
...
/*  ODM_CMNINFO_FAB_VER */
क्रमागत अणु /* tag_ODM_Fab_Version_Definition */
	ODM_TSMC	=	0,
	ODM_UMC		=	1,
पूर्ण;
...
/*  */
क्रमागत अणु /* tag_ODM_RF_Type_Definition */
	ODM_1T1R	=	0,
	ODM_1T2R	=	1,
	ODM_2T2R	=	2,
	ODM_2T3R	=	3,
...
/*  ODM_CMNINFO_WM_MODE */
क्रमागत अणु /* tag_Wireless_Mode_Definition */
	ODM_WM_UNKNOWN    = 0x0,
	ODM_WM_B          = BIT0,
	ODM_WM_G          = BIT1,
	ODM_WM_A          = BIT2,
...
/*  ODM_CMNINFO_BAND */
क्रमागत अणु /* tag_Band_Type_Definition */
	ODM_BAND_2_4G = 0,
	ODM_BAND_5G,
	ODM_BAND_ON_BOTH,
	ODM_BANDMAX
...
/*  ODM_CMNINFO_BW */
क्रमागत अणु /* tag_Bandwidth_Definition */
	ODM_BW20M		= 0,
	ODM_BW40M		= 1,
	ODM_BW80M		= 2,
	ODM_BW160M		= 3,
...
/*  For AC-series IC, बाह्यal PA & LNA can be inभागisuallly added on 2.4G and/or 5G */

क्रमागत odm_type_gpa_e अणु /* tag_ODM_TYPE_GPA_Definition */
	TYPE_GPA0 = 0,
	TYPE_GPA1 = BIT(1)|BIT(0)
पूर्ण;

क्रमागत odm_type_apa_e अणु /* tag_ODM_TYPE_APA_Definition */
	TYPE_APA0 = 0,
	TYPE_APA1 = BIT(1)|BIT(0)
पूर्ण;

क्रमागत odm_type_glna_e अणु /* tag_ODM_TYPE_GLNA_Definition */
	TYPE_GLNA0 = 0,
...
क्रमागत odm_type_alna_e अणु /* tag_ODM_TYPE_ALNA_Definition */
	TYPE_ALNA0 = 0,
...
काष्ठा iqk_matrix_regs_setting अणु /* _IQK_MATRIX_REGS_SETTING */
	bool bIQKDone;
	s32 Value[3][IQK_Matrix_REG_NUM];
	bool bBWIqkResultSaved[3];
पूर्ण;

/* Remove PATHDIV_PARA काष्ठा to odm_PathDiv.h */

काष्ठा odm_rf_cal_t अणु /* ODM_RF_Calibration_Structure */
	...
	u8 TxPowerTrackControl; /* क्रम mp mode, turn off txpwrtracking as शेष */
	u8 TM_Trigger;
	u8 InternalPA5G[2];	/* pathA / pathB */

	u8 ThermalMeter[2];    /*  ThermalMeter, index 0 क्रम RFIC0, and 1 क्रम RFIC1 */
	u8 ThermalValue;
	u8 ThermalValue_LCK;
	u8 ThermalValue_IQK;
	u8 ThermalValue_DPK;
	...
	काष्ठा iqk_matrix_regs_setting IQKMatrixRegSetting[IQK_Matrix_Settings_NUM];
	bool bNeedIQK;
	bool bIQKInProgress;
	u8 Delta_IQK;
	u8 Delta_LCK;
	s8 BBSwingDअगरf2G, BBSwingDअगरf5G; /*  Unit: dB */
	...
	u32 TxIQC_8723B[2][3][2]; /*  अणु अणुS1: 0xc94, 0xc80, 0xc4cपूर्ण , अणुS0: 0xc9c, 0xc88, 0xc4cपूर्णपूर्ण */
	u32 RxIQC_8723B[2][2][2]; /*  अणु अणुS1: 0xc14, 0xca0पूर्ण ,           अणुS0: 0xc14, 0xca0पूर्णपूर्ण */
...
काष्ठा fat_t अणु /* _FAST_ANTENNA_TRAINNING_ */
	u8 Bssid[6];
	u8 antsel_rx_keep_0;
	u8 antsel_rx_keep_1;
	u8 antsel_rx_keep_2;
	...
	u32 AntDiv_2G_5G;
	u32 CCK_counter_मुख्य;
	u32 CCK_counter_aux;
	u32 OFDM_counter_मुख्य;
	u32 OFDM_counter_aux;

	u32 CCK_CtrlFrame_Cnt_मुख्य;
	u32 CCK_CtrlFrame_Cnt_aux;
	u32 OFDM_CtrlFrame_Cnt_मुख्य;
...
क्रमागत अणु
	...
	S0S1_SW_ANTDIV          = 0x06 /* 8723B पूर्णांकrnal चयन S0 S1 */
पूर्ण;

काष्ठा pathभाग_प्रकार अणु /* _ODM_PATH_DIVERSITY_ */
	u8 RespTxPath;
...
क्रमागत phy_reg_pg_type अणु /* _BASEBAND_CONFIG_PHY_REG_PG_VALUE_TYPE */
	PHY_REG_PG_RELATIVE_VALUE = 0,
	PHY_REG_PG_EXACT_VALUE = 1
पूर्ण;

/*  */
/*  Antenna detection inक्रमmation from single tone mechanism, added by Roger, 2012.11.27. */
/*  */
काष्ठा ant_detected_info अणु
	bool bAntDetected;
	u32 dBForAntA;
	u32 dBForAntB;
	u32 dBForAntO;
...
/*  */
/*  2011/09/22 MH Copy from SD4 defined काष्ठाure. We use to support PHY DM पूर्णांकegration. */
/*  */
काष्ठा dm_odm_t अणु /* DM_Out_Source_Dynamic_Mechanism_Structure */
	/* काष्ठा समयr_list	FastAntTrainingTimer; */
	/*  */
	/* 	Add क्रम dअगरferent team use temporarily */
	/*  */
	काष्ठा adapter *Adapter;		/*  For CE/NIC team */
	/*  WHen you use Adapter or priv poपूर्णांकer, you must make sure the poपूर्णांकer is पढ़ोy. */
	bool odm_पढ़ोy;

	क्रमागत phy_reg_pg_type PhyRegPgValueType;
	u8 PhyRegPgVersion;
...
/* REMOVED COMMON INFO---------- */
	/* u8 		PseuकरोMacPhyMode; */
	/* bool			*BTCoexist; */
	/* bool			PseuकरोBtCoexist; */
	/* u8 		OPMode; */
	/* bool			bAPMode; */
	/* bool			bClientMode; */
	/* bool			bAdHocMode; */
...
/* CALL BY VALUE------------- */
	...
	u8 btHsRssi;				/*  BT HS mode wअगरi rssi value. */
	bool bBtHsOperation;		/*  BT HS mode is under progress */
	bool bBtDisableEdcaTurbo;	/*  Under some condition, करोn't enable the EDCA Turbo */
...
/* CALL BY VALUE------------- */
	...
	/*  add by Yu Cehn क्रम adaptivtiy */
	...
	काष्ठा odm_noise_monitor noise_level;/* ODM_MAX_CHANNEL_NUM]; */
	/*  */
	/* 2 Define STA info. */
	/*  _ODM_STA_INFO */
	/*  2012/01/12 MH For MP, we need to reduce one array poपूर्णांकer क्रम शेष port.?? */
	...
	/* ODM Structure */
	/*  */
	काष्ठा fat_t DM_FatTable;
	काष्ठा dig_t DM_DigTable;
	काष्ठा ps_t DM_PSTable;
	काष्ठा dynamic_primary_CCA DM_PriCCA;
	काष्ठा rxhp_t dM_RXHP_Table;
	काष्ठा ra_t DM_RA_Table;
	काष्ठा false_ALARM_STATISTICS FalseAlmCnt;
	काष्ठा false_ALARM_STATISTICS FlaseAlmCntBuddyAdapter;
	काष्ठा swat_t DM_SWAT_Table;
	bool RSSI_test;
	काष्ठा cfo_tracking DM_CfoTrack;

	काष्ठा edca_t DM_EDCA_Table;
	u32 WMMEDCA_BE;
	काष्ठा pathभाग_प्रकार DM_PathDiv;
	...
	/* u8 binitialized;  क्रम dm_initial_gain_Multi_STA use. */
	/* क्रम Antenna भागersity */
	...
	/* MPT DIG */
	काष्ठा समयr_list MPT_DIGTimer;

	/* क्रम rate adaptive, in fact,  88c/92c fw will handle this */
	u8 bUseRAMask;

	काष्ठा odm_rate_adaptive RateAdaptive;

	काष्ठा ant_detected_info AntDetectedInfo; /*  Antenna detected inक्रमmation क्रम RSSI tool */

	काष्ठा odm_rf_cal_t RFCalibrateInfo;
	...
	s8 Modअगरy_TxAGC_Value;       /* Remnat compensate value at TxAGC */
	bool Modअगरy_TxAGC_Flag_PathA;
	bool Modअगरy_TxAGC_Flag_PathB;
	bool Modअगरy_TxAGC_Flag_PathC;
	bool Modअगरy_TxAGC_Flag_PathD;
	bool Modअगरy_TxAGC_Flag_PathA_CCK;

	s8 Kमुक्तOffset[MAX_RF_PATH];
	/*  */
	...
	#अगर (BEAMFORMING_SUPPORT == 1)
	RT_BEAMFORMING_INFO Beamक्रमmingInfo;
	#पूर्ण_अगर
पूर्ण;

#घोषणा ODM_RF_PATH_MAX 2

क्रमागत odm_rf_radio_path_e अणु
...
क्रमागत ODM_BB_Config_Type अणु
	CONFIG_BB_PHY_REG,
	CONFIG_BB_AGC_TAB,
...
क्रमागत ODM_RF_Config_Type अणु
	CONFIG_RF_RADIO,
	CONFIG_RF_TXPWR_LMT,
पूर्ण;

क्रमागत ODM_FW_Config_Type अणु
	CONFIG_FW_NIC,
	CONFIG_FW_NIC_2,
	CONFIG_FW_AP,
	CONFIG_FW_WoWLAN,
...
क्रमागत अणु /* tag_1R_CCA_Type_Definition */
	CCA_1R = 0,
	CCA_2R = 1,
	CCA_MAX = 2,
पूर्ण;

क्रमागत अणु /* tag_RF_Type_Definition */
	RF_Save = 0,
	RF_Normal = 1,
	RF_MAX = 2,
पूर्ण;

/*  Maximal number of antenna detection mechanism needs to perक्रमm, added by Roger, 2011.12.28. */
#घोषणा	MAX_ANTENNA_DETECTION_CNT	10

/*  */
/*  Extern Global Variables. */
/*  */
बाह्य	u32 OFDMSwingTable[OFDM_TABLE_SIZE];
बाह्य	u8 CCKSwingTable_Ch1_Ch13[CCK_TABLE_SIZE][8];
बाह्य	u8 CCKSwingTable_Ch14[CCK_TABLE_SIZE][8];

बाह्य	u32 OFDMSwingTable_New[OFDM_TABLE_SIZE];
बाह्य	u8 CCKSwingTable_Ch1_Ch13_New[CCK_TABLE_SIZE][8];
बाह्य	u8 CCKSwingTable_Ch14_New[CCK_TABLE_SIZE][8];

बाह्य  u32 TxScalingTable_Jaguar[TXSCALE_TABLE_SIZE];
...
#घोषणा dm_SWAW_RSSI_Check	ODM_SwAntDivChkPerPktRssi
व्योम ODM_SwAntDivChkPerPktRssi(
	काष्ठा dm_odm_t *pDM_Odm,
	u8 StationID,
...
#अगर (BEAMFORMING_SUPPORT == 1)
BEAMFORMING_CAP Beamक्रमming_GetEntryBeamCapByMacId(PMGNT_INFO pMgntInfo, u8 MacId);
#पूर्ण_अगर
...
व्योम ODM_DMWatchकरोg(काष्ठा dm_odm_t *pDM_Odm); /*  For common use in the future */
...
व्योम ODM_InitAllTimers(काष्ठा dm_odm_t *pDM_Odm);

व्योम ODM_CancelAllTimers(काष्ठा dm_odm_t *pDM_Odm);

व्योम ODM_ReleaseAllTimers(काष्ठा dm_odm_t *pDM_Odm);

व्योम ODM_AntselStatistics_88C(
	काष्ठा dm_odm_t *pDM_Odm,
	u8 MacId,
	u32 PWDBAll,
	bool isCCKrate
...
व्योम ODM_DynamicARFBSelect(काष्ठा dm_odm_t *pDM_Odm, u8 rate, bool Collision_State);
