...
#अगर_अघोषित __ISYS_STREAM2MMIO_H_INCLUDED__
#घोषणा __ISYS_STREAM2MMIO_H_INCLUDED__
 ...
 * - निजी: प्रणाली dependent, cell specअगरic पूर्णांकerfaces &
 *   अंतरभूत implementations
...
#समावेश "isys_stream2mmio_local.h"

#अगर_अघोषित __INLINE_STREAM2MMIO__
#घोषणा STORAGE_CLASS_STREAM2MMIO_H बाह्य
#घोषणा STORAGE_CLASS_STREAM2MMIO_C
#समावेश "isys_stream2mmio_public.h"
#अन्यथा  /* __INLINE_STREAM2MMIO__ */
#घोषणा STORAGE_CLASS_STREAM2MMIO_H अटल अंतरभूत
#घोषणा STORAGE_CLASS_STREAM2MMIO_C अटल अंतरभूत
#समावेश "isys_stream2mmio_private.h"
#पूर्ण_अगर /* __INLINE_STREAM2MMIO__ */

#पूर्ण_अगर /* __ISYS_STREAM2MMIO_H_INCLUDED__ */
