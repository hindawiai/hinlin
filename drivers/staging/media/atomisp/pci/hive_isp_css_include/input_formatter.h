...
#अगर_अघोषित __INPUT_FORMATTER_H_INCLUDED__
#घोषणा __INPUT_FORMATTER_H_INCLUDED__
...
#समावेश "input_formatter_local.h"

#अगर_अघोषित __INLINE_INPUT_FORMATTER__
#घोषणा STORAGE_CLASS_INPUT_FORMATTER_H बाह्य
#घोषणा STORAGE_CLASS_INPUT_FORMATTER_C
#समावेश "input_formatter_public.h"
#अन्यथा  /* __INLINE_INPUT_FORMATTER__ */
#घोषणा STORAGE_CLASS_INPUT_FORMATTER_H अटल अंतरभूत
#घोषणा STORAGE_CLASS_INPUT_FORMATTER_C अटल अंतरभूत
#समावेश "input_formatter_private.h"
#पूर्ण_अगर /* __INLINE_INPUT_FORMATTER__ */

#पूर्ण_अगर /* __INPUT_FORMATTER_H_INCLUDED__ */
