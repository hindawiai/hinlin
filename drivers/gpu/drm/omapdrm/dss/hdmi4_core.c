...
काष्ठा hdmi4_features अणु
	bool cts_swmode;
	bool audio_use_mclk;
पूर्ण;

अटल स्थिर काष्ठा hdmi4_features hdmi4430_es1_features = अणु
	.cts_swmode = false,
	.audio_use_mclk = false,
पूर्ण;

अटल स्थिर काष्ठा hdmi4_features hdmi4430_es2_features = अणु
	.cts_swmode = true,
	.audio_use_mclk = false,
पूर्ण;

अटल स्थिर काष्ठा hdmi4_features hdmi4_features = अणु
	.cts_swmode = true,
	.audio_use_mclk = true,
पूर्ण;

अटल स्थिर काष्ठा soc_device_attribute hdmi4_soc_devices[] = अणु
	अणु
		.machine = "OMAP4430",
		.revision = "ES1.?",
...
अणु
	स्थिर काष्ठा hdmi4_features *features;
	काष्ठा resource *res;
