...
#अगर_अघोषित HOST1X_HW_HOST1X04_CHANNEL_H
#घोषणा HOST1X_HW_HOST1X04_CHANNEL_H
...
अटल अंतरभूत u32 host1x_channel_channelctrl_r(व्योम)
अणु
	वापस 0x98;
पूर्ण
#घोषणा HOST1X_CHANNEL_CHANNELCTRL \
	host1x_channel_channelctrl_r()
अटल अंतरभूत u32 host1x_channel_channelctrl_kernel_filter_gbuffer_f(u32 v)
अणु
	वापस (v & 0x1) << 2;
पूर्ण
#घोषणा HOST1X_CHANNEL_CHANNELCTRL_KERNEL_FILTER_GBUFFER(v) \
