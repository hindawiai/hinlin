...
#अगर_अघोषित __DT_POWER_DELIVERY_H
#घोषणा __DT_POWER_DELIVERY_H

/* Power delivery Power Data Object definitions */
#घोषणा PDO_TYPE_FIXED		0
#घोषणा PDO_TYPE_BATT		1
#घोषणा PDO_TYPE_VAR		2
#घोषणा PDO_TYPE_APDO		3
...
#घोषणा PDO_FIXED_DUAL_ROLE	(1 << 29) /* Power role swap supported */
#घोषणा PDO_FIXED_SUSPEND	(1 << 28) /* USB Suspend supported (Source) */
#घोषणा PDO_FIXED_HIGHER_CAP	(1 << 28) /* Requires more than vSafe5V (Sink) */
#घोषणा PDO_FIXED_EXTPOWER	(1 << 27) /* Externally घातered */
#घोषणा PDO_FIXED_USB_COMM	(1 << 26) /* USB communications capable */
#घोषणा PDO_FIXED_DATA_SWAP	(1 << 25) /* Data role swap supported */
...
/* Device Capability */
#घोषणा DEV_USB2_CAPABLE	(1 << 0)
#घोषणा DEV_USB2_BILLBOARD	(1 << 1)
#घोषणा DEV_USB3_CAPABLE	(1 << 2)
#घोषणा DEV_USB4_CAPABLE	(1 << 3)
...
#घोषणा UFP_ALTMODE_TBT3	(1 << 0)
#घोषणा UFP_ALTMODE_RECFG	(1 << 1)
#घोषणा UFP_ALTMODE_NO_RECFG	(1 << 2)
...
#घोषणा HOST_USB2_CAPABLE	(1 << 0)
#घोषणा HOST_USB3_CAPABLE	(1 << 1)
#घोषणा HOST_USB4_CAPABLE	(1 << 2)
...
#पूर्ण_अगर /* __DT_POWER_DELIVERY_H */
