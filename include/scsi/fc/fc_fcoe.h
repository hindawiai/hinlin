 ...
 */
#घोषणा	FC_FCOE_OUI	0x0efc00	/* upper 24 bits of FCOE MAC */

/*
 * Fabric Login (FLOGI) MAC क्रम non-FIP use.  Non-FIP use is deprecated.
 */
#घोषणा	FC_FCOE_FLOGI_MAC अणु 0x0e, 0xfc, 0x00, 0xff, 0xff, 0xfe पूर्ण

#घोषणा	FC_FCOE_VER	0			/* version */

/*
 * Ethernet Addresses based on FC S_ID and D_ID.
 * Generated by FC_FCOE_OUI | S_ID/D_ID
 */
#घोषणा	FC_FCOE_ENCAPS_ID(n)	(((u64) FC_FCOE_OUI << 24) | (n))
#घोषणा	FC_FCOE_DECAPS_ID(n)	((n) >> 24)
...
#घोषणा FC_FCOE_DECAPS_VER(hp)	    ((hp)->fcoe_ver >> 4)
#घोषणा FC_FCOE_ENCAPS_VER(hp, ver) ((hp)->fcoe_ver = (ver) << 4)

/*
 * FCoE CRC & खातापूर्ण - 8 bytes.
 */
काष्ठा fcoe_crc_eof अणु
	__le32		fcoe_crc32;	/* CRC क्रम FC packet */
	__u8		fcoe_eof;	/* खातापूर्ण from RFC 3643 */
...
/*
 * fc_fcoe_set_mac - Store OUI + DID पूर्णांकo MAC address field.
 * @mac: mac address to be set
 * @did: fc dest id to use
 */
अटल अंतरभूत व्योम fc_fcoe_set_mac(u8 *mac, u8 *did)
अणु
