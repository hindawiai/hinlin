 ...
 * corresponding to some real काष्ठा.
 * So we have a sequence of |tla, len|<nested nla sequence>
 *
 * nested nla sequence:
 * may be empty, or contain a sequence of netlink attributes
 * representing the काष्ठा fields.
 *
 * The tag number of any field (regardless of containing काष्ठा)
 * will be available as T_ ## field_name,
 * so you cannot have the same field name in two dअगरfernt काष्ठाs.
 *
 * The tag numbers themselves are per काष्ठा, though,
 ...
 *
 * GENL_काष्ठा(tag_name, tag_number, काष्ठा name, काष्ठा fields) - काष्ठा and policy
 *	genl_magic_काष्ठा.h
 *		generates the काष्ठा declaration,
 *		generates an entry in the tla क्रमागत,
 *	genl_magic_func.h
 *		generates an entry in the अटल tla policy
 *		with .type = NLA_NESTED
 *		generates the अटल <काष्ठा_name>_nl_policy definition,
 *		and अटल conversion functions
 *
 *	genl_magic_func.h
 *
 * GENL_mc_group(group)
 ...
 *		करोes nothing
 *	genl_magic_func.h
 *		defines and रेजिस्टरs the mcast group,
 *		and provides a send helper
 *
 * GENL_notअगरication(op_name, op_num, mcast_group, tla list)
 *	These are notअगरications to userspace.
 *
 *	genl_magic_काष्ठा.h
 *		generates an entry in the genl_ops क्रमागत,
 *	genl_magic_func.h
 *		करोes nothing
 *
 *	mcast group: the name of the mcast group this notअगरication should be
 *	expected on
 *	tla list: the list of expected top level attributes,
 *	क्रम करोcumentation and sanity checking.
 *
 * GENL_op(op_name, op_num, flags and handler, tla list) - "genl operations"
 *	These are requests from userspace.
 *
 *	_op and _notअगरication share the same "number space",
 *	op_nr will be asचिन्हित to "genlmsghdr->cmd"
 *
 *	genl_magic_काष्ठा.h
 *		generates an entry in the genl_ops क्रमागत,
 *	genl_magic_func.h
 *		generates an entry in the अटल genl_ops array,
 *		and अटल रेजिस्टर/unरेजिस्टर functions to
 *		genl_रेजिस्टर_family().
 *
 *	flags and handler:
 *		GENL_op_init( .करोit = x, .dumpit = y, .flags = something)
 *		GENL_करोit(x) => .dumpit = शून्य, .flags = GENL_ADMIN_PERM
 *	tla list: the list of expected top level attributes,
 *	क्रम करोcumentation and sanity checking.
 */
 ...
 * inक्रमmational textual info, which is supposedly human पढ़ोable.
 * The computer relevant वापस code is in the drbd_genlmsghdr.
 */
GENL_काष्ठा(DRBD_NLA_CFG_REPLY, 1, drbd_cfg_reply,
...
GENL_काष्ठा(DRBD_NLA_CFG_CONTEXT, 2, drbd_cfg_context,
...
GENL_काष्ठा(DRBD_NLA_DISK_CONF, 3, disk_conf,
	...
	__u32_field_def(20,     DRBD_GENLA_F_MANDATORY, disk_समयout, DRBD_DISK_TIMEOUT_DEF)
	__u32_field_def(21,     0 /* OPTIONAL */,       पढ़ो_balancing, DRBD_READ_BALANCING_DEF)
	...
	__flg_field_def(24,     0 /* OPTIONAL */,	discard_zeroes_अगर_aligned, DRBD_DISCARD_ZEROES_IF_ALIGNED_DEF)
	__flg_field_def(26,     0 /* OPTIONAL */,	disable_ग_लिखो_same, DRBD_DISABLE_WRITE_SAME_DEF)
)

GENL_काष्ठा(DRBD_NLA_RESOURCE_OPTS, 4, res_opts,
	__str_field_def(1,	DRBD_GENLA_F_MANDATORY,	cpu_mask,       DRBD_CPU_MASK_SIZE)
	__u32_field_def(2,	DRBD_GENLA_F_MANDATORY,	on_no_data, DRBD_ON_NO_DATA_DEF)
)

GENL_काष्ठा(DRBD_NLA_NET_CONF, 5, net_conf,
	...
	__str_field_def(3,	DRBD_GENLA_F_MANDATORY,	पूर्णांकegrity_alg,	SHARED_SECRET_MAX)
	__str_field_def(4,	DRBD_GENLA_F_MANDATORY,	verअगरy_alg,     SHARED_SECRET_MAX)
	...
	__u32_field_def(7,	DRBD_GENLA_F_MANDATORY,	connect_पूर्णांक, DRBD_CONNECT_INT_DEF)
	__u32_field_def(8,	DRBD_GENLA_F_MANDATORY,	समयout, DRBD_TIMEOUT_DEF)
	__u32_field_def(9,	DRBD_GENLA_F_MANDATORY,	ping_पूर्णांक, DRBD_PING_INT_DEF)
	__u32_field_def(10,	DRBD_GENLA_F_MANDATORY,	ping_समयo, DRBD_PING_TIMEO_DEF)
	...
	__u32_field_def(34, 0 /* OPTIONAL */, sock_check_समयo, DRBD_SOCKET_CHECK_TIMEO_DEF)
)

GENL_काष्ठा(DRBD_NLA_SET_ROLE_PARMS, 6, set_role_parms,
	__flg_field(1, DRBD_GENLA_F_MANDATORY,	assume_uptodate)
)

GENL_काष्ठा(DRBD_NLA_RESIZE_PARMS, 7, resize_parms,
	__u64_field(1, DRBD_GENLA_F_MANDATORY,	resize_size)
	__flg_field(2, DRBD_GENLA_F_MANDATORY,	resize_क्रमce)
	__flg_field(3, DRBD_GENLA_F_MANDATORY,	no_resync)
	__u32_field_def(4, 0 /* OPTIONAL */, al_stripes, DRBD_AL_STRIPES_DEF)
	__u32_field_def(5, 0 /* OPTIONAL */, al_stripe_size, DRBD_AL_STRIPE_SIZE_DEF)
)

GENL_काष्ठा(DRBD_NLA_STATE_INFO, 8, state_info,
	/* the reason of the broadcast,
	 * अगर this is an event triggered broadcast. */
	...
	/* These are क्रम broadcast from after state change work.
	...
	/* अगर we have a local disk: */
	__bin_field(7, DRBD_GENLA_F_MANDATORY,	uuids, (UI_SIZE*माप(__u64)))
	...
	/* and in हाल resync or online verअगरy is active */
	__u64_field(11, DRBD_GENLA_F_MANDATORY,	bits_rs_total)
	__u64_field(12, DRBD_GENLA_F_MANDATORY,	bits_rs_failed)

	/* क्रम pre and post notअगरications of helper execution */
	__str_field(13, DRBD_GENLA_F_MANDATORY,	helper, 32)
	__u32_field(14, DRBD_GENLA_F_MANDATORY,	helper_निकास_code)

	__u64_field(15,                      0, send_cnt)
	__u64_field(16,                      0, recv_cnt)
	__u64_field(17,                      0, पढ़ो_cnt)
...
GENL_काष्ठा(DRBD_NLA_START_OV_PARMS, 9, start_ov_parms,
	__u64_field(1, DRBD_GENLA_F_MANDATORY,	ov_start_sector)
	__u64_field(2, DRBD_GENLA_F_MANDATORY,	ov_stop_sector)
)

GENL_काष्ठा(DRBD_NLA_NEW_C_UUID_PARMS, 10, new_c_uuid_parms,
	__flg_field(1, DRBD_GENLA_F_MANDATORY, clear_bm)
)

GENL_काष्ठा(DRBD_NLA_TIMEOUT_PARMS, 11, समयout_parms,
	__u32_field(1,	DRBD_F_REQUIRED,	समयout_type)
)

GENL_काष्ठा(DRBD_NLA_DISCONNECT_PARMS, 12, disconnect_parms,
	__flg_field(1, DRBD_GENLA_F_MANDATORY,	क्रमce_disconnect)
)

GENL_काष्ठा(DRBD_NLA_DETACH_PARMS, 13, detach_parms,
	__flg_field(1, DRBD_GENLA_F_MANDATORY,	क्रमce_detach)
)

GENL_काष्ठा(DRBD_NLA_RESOURCE_INFO, 15, resource_info,
...
GENL_काष्ठा(DRBD_NLA_DEVICE_INFO, 16, device_info,
	__u32_field(1, 0, dev_disk_state)
)

GENL_काष्ठा(DRBD_NLA_CONNECTION_INFO, 17, connection_info,
	__u32_field(1, 0, conn_connection_state)
	__u32_field(2, 0, conn_role)
)

GENL_काष्ठा(DRBD_NLA_PEER_DEVICE_INFO, 18, peer_device_info,
...
GENL_काष्ठा(DRBD_NLA_RESOURCE_STATISTICS, 19, resource_statistics,
	__u32_field(1, 0, res_stat_ग_लिखो_ordering)
)

GENL_काष्ठा(DRBD_NLA_DEVICE_STATISTICS, 20, device_statistics,
	__u64_field(1, 0, dev_size)  /* (sectors) */
	__u64_field(2, 0, dev_पढ़ो)  /* (sectors) */
	__u64_field(3, 0, dev_ग_लिखो)  /* (sectors) */
	__u64_field(4, 0, dev_al_ग_लिखोs)  /* activity log ग_लिखोs (count) */
	__u64_field(5, 0, dev_bm_ग_लिखोs)  /*  biपंचांगap ग_लिखोs  (count) */
	...
	__bin_field(14, 0, history_uuids, HISTORY_UUIDS * माप(__u64))
)

GENL_काष्ठा(DRBD_NLA_CONNECTION_STATISTICS, 21, connection_statistics,
	__flg_field(1, 0, conn_congested)
)

GENL_काष्ठा(DRBD_NLA_PEER_DEVICE_STATISTICS, 22, peer_device_statistics,
	...
	__u64_field(7, 0, peer_dev_biपंचांगap_uuid)
	__u32_field(9, 0, peer_dev_flags)
)

GENL_काष्ठा(DRBD_NLA_NOTIFICATION_HEADER, 23, drbd_notअगरication_header,
	__u32_field(1, DRBD_GENLA_F_MANDATORY, nh_type)
)

GENL_काष्ठा(DRBD_NLA_HELPER, 24, drbd_helper_info,
	__str_field(1, DRBD_GENLA_F_MANDATORY, helper_name, 32)
	__u32_field(2, DRBD_GENLA_F_MANDATORY, helper_status)
)

/*
 * Notअगरications and commands (genlmsghdr->cmd)
 */
...
GENL_notअगरication(
	...
	/* query kernel क्रम specअगरic or all info */
GENL_op(
	DRBD_ADM_GET_STATUS, 2,
	GENL_op_init(
		.करोit = drbd_adm_get_status,
		.dumpit = drbd_adm_get_status_all,
		/* anyone may ask क्रम the status,
		 * it is broadcasted anyways */
	),
	/* To select the object .करोit.
	 * Or a subset of objects in .dumpit. */
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_GENLA_F_MANDATORY)
)

	/* add DRBD minor devices as volumes to resources */
GENL_op(DRBD_ADM_NEW_MINOR, 5, GENL_करोit(drbd_adm_new_minor),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))
GENL_op(DRBD_ADM_DEL_MINOR, 6, GENL_करोit(drbd_adm_del_minor),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))

	/* add or delete resources */
GENL_op(DRBD_ADM_NEW_RESOURCE, 7, GENL_करोit(drbd_adm_new_resource),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))
GENL_op(DRBD_ADM_DEL_RESOURCE, 8, GENL_करोit(drbd_adm_del_resource),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))

GENL_op(DRBD_ADM_RESOURCE_OPTS, 9,
	GENL_करोit(drbd_adm_resource_opts),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED)
...
GENL_op(
	...
	GENL_करोit(drbd_adm_net_opts),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED)
	GENL_tla_expected(DRBD_NLA_NET_CONF, DRBD_F_REQUIRED)
)

GENL_op(DRBD_ADM_DISCONNECT, 11, GENL_करोit(drbd_adm_disconnect),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))

GENL_op(DRBD_ADM_ATTACH, 12,
	GENL_करोit(drbd_adm_attach),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED)
	GENL_tla_expected(DRBD_NLA_DISK_CONF, DRBD_F_REQUIRED)
)

GENL_op(DRBD_ADM_CHG_DISK_OPTS, 28,
	GENL_करोit(drbd_adm_disk_opts),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED)
...
GENL_op(
	...
	GENL_करोit(drbd_adm_new_c_uuid),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED)
...
GENL_op(
	...
	GENL_करोit(drbd_adm_start_ov),
	GENL_tla_expected(DRBD_NLA_START_OV_PARMS, DRBD_GENLA_F_MANDATORY)
)

GENL_op(DRBD_ADM_DETACH,	18, GENL_करोit(drbd_adm_detach),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED)
	GENL_tla_expected(DRBD_NLA_DETACH_PARMS, DRBD_GENLA_F_MANDATORY))

GENL_op(DRBD_ADM_INVALIDATE,	19, GENL_करोit(drbd_adm_invalidate),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))
GENL_op(DRBD_ADM_INVAL_PEER,	20, GENL_करोit(drbd_adm_invalidate_peer),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))
GENL_op(DRBD_ADM_PAUSE_SYNC,	21, GENL_करोit(drbd_adm_छोड़ो_sync),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))
GENL_op(DRBD_ADM_RESUME_SYNC,	22, GENL_करोit(drbd_adm_resume_sync),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))
GENL_op(DRBD_ADM_SUSPEND_IO,	23, GENL_करोit(drbd_adm_suspend_io),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))
GENL_op(DRBD_ADM_RESUME_IO,	24, GENL_करोit(drbd_adm_resume_io),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))
GENL_op(DRBD_ADM_OUTDATE,	25, GENL_करोit(drbd_adm_outdate),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))
GENL_op(DRBD_ADM_GET_TIMEOUT_TYPE, 26, GENL_करोit(drbd_adm_get_समयout_type),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))
GENL_op(DRBD_ADM_DOWN,		27, GENL_करोit(drbd_adm_करोwn),
	GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_F_REQUIRED))
...
GENL_op(DRBD_ADM_GET_DEVICES, 31,
	 GENL_op_init(
		 ...
		 .करोne = drbd_adm_dump_devices_करोne,
	 ),
	 GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_GENLA_F_MANDATORY)
...
GENL_op(DRBD_ADM_GET_CONNECTIONS, 32,
	 GENL_op_init(
		 ...
		 .करोne = drbd_adm_dump_connections_करोne,
	 ),
	 GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_GENLA_F_MANDATORY)
...
GENL_op(DRBD_ADM_GET_PEER_DEVICES, 33,
	 GENL_op_init(
		 ...
		 .करोne = drbd_adm_dump_peer_devices_करोne,
	 ),
	 GENL_tla_expected(DRBD_NLA_CFG_CONTEXT, DRBD_GENLA_F_MANDATORY)
