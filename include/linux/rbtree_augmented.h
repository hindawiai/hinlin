...
#अगर_अघोषित _LINUX_RBTREE_AUGMENTED_H
#घोषणा _LINUX_RBTREE_AUGMENTED_H
...
अटल अंतरभूत व्योम
__rb_change_child_rcu(काष्ठा rb_node *old, काष्ठा rb_node *new,
		      काष्ठा rb_node *parent, काष्ठा rb_root *root)
अणु
	अगर (parent) अणु
		अगर (parent->rb_left == old)
			rcu_assign_poपूर्णांकer(parent->rb_left, new);
		अन्यथा
			rcu_assign_poपूर्णांकer(parent->rb_right, new);
	पूर्ण अन्यथा
		rcu_assign_poपूर्णांकer(root->rb_node, new);
पूर्ण
...
अणु
	...
	पूर्ण अन्यथा अणु
		...
		अगर (child2) अणु
			...
			rebalance = शून्य;
		पूर्ण अन्यथा अणु
			rebalance = rb_is_black(successor) ? parent : शून्य;
		पूर्ण
...
#पूर्ण_अगर	/* _LINUX_RBTREE_AUGMENTED_H */
