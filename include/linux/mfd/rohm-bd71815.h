...
#अगर_अघोषित _MFD_BD71815_H
#घोषणा _MFD_BD71815_H
...
क्रमागत अणु
	...
	BD71815_LDO2,
	BD71815_LDO3,
	/* LDOs क्रम SD Card and SD Card Interface */
	BD71815_LDO4,
	BD71815_LDO5,
	/* LDO क्रम DDR Reference Voltage */
	BD71815_LDODVREF,
	/* LDO क्रम Low-Power State Retention */
	BD71815_LDOLPSR,
	BD71815_WLED,
	BD71815_REGULATOR_CNT,
पूर्ण;

#घोषणा BD71815_SUPPLY_STATE_ENABLED    0x1
...
#घोषणा BD71815_BUCK_RAMPRATE_MASK		0xC0
#घोषणा BD71815_BUCK_RAMPRATE_10P00MV		0x0
#घोषणा BD71815_BUCK_RAMPRATE_5P00MV		0x01
#घोषणा BD71815_BUCK_RAMPRATE_2P50MV		0x02
#घोषणा BD71815_BUCK_RAMPRATE_1P25MV		0x03

#घोषणा BD71815_BUCK_PWM_FIXED			BIT(4)
#घोषणा BD71815_BUCK_SNVS_ON			BIT(3)
#घोषणा BD71815_BUCK_RUN_ON			BIT(2)
#घोषणा BD71815_BUCK_LPSR_ON			BIT(1)
#घोषणा BD71815_BUCK_SUSP_ON			BIT(0)

/* BD71815_REG_BUCK1_VOLT_H bits */
#घोषणा BD71815_BUCK_DVSSEL			BIT(7)
#घोषणा BD71815_BUCK_STBY_DVS			BIT(6)
#घोषणा BD71815_VOLT_MASK			0x3F
#घोषणा BD71815_BUCK1_H_DEFAULT			0x14
#घोषणा BD71815_BUCK1_L_DEFAULT			0x14

/* BD71815_REG_BUCK2_VOLT_H bits */
#घोषणा BD71815_BUCK2_H_DEFAULT			0x14
#घोषणा BD71815_BUCK2_L_DEFAULT			0x14

/* WLED output */
/* current रेजिस्टर mask */
#घोषणा LED_DIMM_MASK				0x3f
/* LED enable bits at LED_CTRL reg */
#घोषणा LED_CHGDONE_EN				BIT(4)
#घोषणा LED_RUN_ON				BIT(2)
#घोषणा LED_LPSR_ON				BIT(1)
#घोषणा LED_SUSP_ON				BIT(0)

/* BD71815_REG_LDO1_CTRL bits */
#घोषणा LDO1_EN					BIT(0)
#घोषणा LDO2_EN					BIT(1)
#घोषणा LDO3_EN					BIT(2)
#घोषणा DVREF_EN				BIT(3)
#घोषणा VOSNVS_SW_EN				BIT(4)

/* LDO_MODE1_रेजिस्टर */
#घोषणा LDO1_SNVS_ON				BIT(7)
#घोषणा LDO1_RUN_ON				BIT(6)
#घोषणा LDO1_LPSR_ON				BIT(5)
#घोषणा LDO1_SUSP_ON				BIT(4)
/* set => रेजिस्टर control, unset => GPIO control */
#घोषणा LDO4_MODE_MASK				BIT(3)
#घोषणा LDO4_MODE_I2C				BIT(3)
#घोषणा LDO4_MODE_GPIO				0
/* set => रेजिस्टर control, unset => start when DCIN connected */
#घोषणा LDO3_MODE_MASK				BIT(2)
#घोषणा LDO3_MODE_I2C				BIT(2)
#घोषणा LDO3_MODE_DCIN				0

/* LDO_MODE2 रेजिस्टर */
#घोषणा LDO3_SNVS_ON				BIT(7)
#घोषणा LDO3_RUN_ON				BIT(6)
#घोषणा LDO3_LPSR_ON				BIT(5)
#घोषणा LDO3_SUSP_ON				BIT(4)
#घोषणा LDO2_SNVS_ON				BIT(3)
#घोषणा LDO2_RUN_ON				BIT(2)
#घोषणा LDO2_LPSR_ON				BIT(1)
#घोषणा LDO2_SUSP_ON				BIT(0)


/* LDO_MODE3 रेजिस्टर */
#घोषणा LDO5_SNVS_ON				BIT(7)
#घोषणा LDO5_RUN_ON				BIT(6)
#घोषणा LDO5_LPSR_ON				BIT(5)
#घोषणा LDO5_SUSP_ON				BIT(4)
#घोषणा LDO4_SNVS_ON				BIT(3)
#घोषणा LDO4_RUN_ON				BIT(2)
#घोषणा LDO4_LPSR_ON				BIT(1)
#घोषणा LDO4_SUSP_ON				BIT(0)

/* LDO_MODE4 रेजिस्टर */
#घोषणा DVREF_SNVS_ON				BIT(7)
#घोषणा DVREF_RUN_ON				BIT(6)
#घोषणा DVREF_LPSR_ON				BIT(5)
#घोषणा DVREF_SUSP_ON				BIT(4)
#घोषणा LDO_LPSR_SNVS_ON			BIT(3)
#घोषणा LDO_LPSR_RUN_ON				BIT(2)
#घोषणा LDO_LPSR_LPSR_ON			BIT(1)
#घोषणा LDO_LPSR_SUSP_ON			BIT(0)

/* BD71815_REG_OUT32K bits */
#घोषणा OUT32K_EN				BIT(0)
#घोषणा OUT32K_MODE				BIT(1)
#घोषणा OUT32K_MODE_CMOS			BIT(1)
#घोषणा OUT32K_MODE_OPEN_DRAIN			0

/* BD71815_REG_BAT_STAT bits */
#घोषणा BAT_DET					BIT(5)
#घोषणा BAT_DET_OFFSET				5
#घोषणा BAT_DET_DONE				BIT(4)
#घोषणा VBAT_OV					BIT(3)
#घोषणा DBAT_DET				BIT(0)

/* BD71815_REG_VBUS_STAT bits */
#घोषणा VBUS_DET				BIT(0)

#घोषणा BD71815_REG_RTC_START			BD71815_REG_SEC
#घोषणा BD71815_REG_RTC_ALM_START		BD71815_REG_ALM0_SEC

/* BD71815_REG_ALM0_MASK bits */
#घोषणा A0_ONESEC				BIT(7)

/* BD71815_REG_INT_EN_00 bits */
#घोषणा ALMALE					BIT(0)

/* BD71815_REG_INT_STAT_03 bits */
#घोषणा DCIN_MON_DET				BIT(1)
#घोषणा DCIN_MON_RES				BIT(0)
#घोषणा POWERON_LONG				BIT(2)
#घोषणा POWERON_MID				BIT(3)
#घोषणा POWERON_SHORT				BIT(4)
#घोषणा POWERON_PRESS				BIT(5)

/* BD71805_REG_INT_STAT_08 bits */
#घोषणा VBAT_MON_DET				BIT(1)
#घोषणा VBAT_MON_RES				BIT(0)

/* BD71805_REG_INT_STAT_11 bits */
#घोषणा	INT_STAT_11_VF_DET			BIT(7)
#घोषणा	INT_STAT_11_VF_RES			BIT(6)
#घोषणा	INT_STAT_11_VF125_DET			BIT(5)
#घोषणा	INT_STAT_11_VF125_RES			BIT(4)
#घोषणा	INT_STAT_11_OVTMP_DET			BIT(3)
#घोषणा	INT_STAT_11_OVTMP_RES			BIT(2)
#घोषणा	INT_STAT_11_LOTMP_DET			BIT(1)
#घोषणा	INT_STAT_11_LOTMP_RES			BIT(0)

#घोषणा VBAT_MON_DET				BIT(1)
#घोषणा VBAT_MON_RES				BIT(0)

/* BD71815_REG_PWRCTRL bits */
#घोषणा RESTARTEN				BIT(0)

/* BD71815_REG_GPO bits */
#घोषणा READY_FORCE_LOW				BIT(2)
#घोषणा BD71815_GPIO_DRIVE_MASK			BIT(4)
#घोषणा BD71815_GPIO_OPEN_DRAIN			0
#घोषणा BD71815_GPIO_CMOS			BIT(4)

/* BD71815 पूर्णांकerrupt masks */
क्रमागत अणु
...
#घोषणा BD71815_INT_BUCK1_OCP_MASK			BIT(0)
#घोषणा BD71815_INT_BUCK2_OCP_MASK			BIT(1)
#घोषणा BD71815_INT_BUCK3_OCP_MASK			BIT(2)
#घोषणा BD71815_INT_BUCK4_OCP_MASK			BIT(3)
#घोषणा BD71815_INT_BUCK5_OCP_MASK			BIT(4)
#घोषणा BD71815_INT_LED_OVP_MASK			BIT(5)
#घोषणा BD71815_INT_LED_OCP_MASK			BIT(6)
#घोषणा BD71815_INT_LED_SCP_MASK			BIT(7)

#घोषणा BD71815_INT_DCIN_RMV_MASK			BIT(1)
#घोषणा BD71815_INT_CLPS_OUT_MASK			BIT(2)
#घोषणा BD71815_INT_CLPS_IN_MASK			BIT(3)
#घोषणा BD71815_INT_DCIN_OVP_RES_MASK			BIT(4)
#घोषणा BD71815_INT_DCIN_OVP_DET_MASK			BIT(5)

#घोषणा BD71815_INT_DCIN_MON_RES_MASK			BIT(0)
#घोषणा BD71815_INT_DCIN_MON_DET_MASK			BIT(1)
#घोषणा BD71815_INT_WDOG_MASK				BIT(6)

#घोषणा BD71815_INT_VSYS_UV_RES_MASK			BIT(0)
#घोषणा BD71815_INT_VSYS_UV_DET_MASK			BIT(1)
#घोषणा BD71815_INT_VSYS_LOW_RES_MASK			BIT(2)
#घोषणा BD71815_INT_VSYS_LOW_DET_MASK			BIT(3)
#घोषणा BD71815_INT_VSYS_MON_RES_MASK			BIT(6)
#घोषणा BD71815_INT_VSYS_MON_DET_MASK			BIT(7)

#घोषणा BD71815_INT_CHG_WDG_TEMP_MASK			BIT(2)
#घोषणा BD71815_INT_CHG_WDG_TIME_MASK			BIT(3)
#घोषणा BD71815_INT_CHG_RECHARGE_RES_MASK		BIT(4)
#घोषणा BD71815_INT_CHG_RECHARGE_DET_MASK		BIT(5)
#घोषणा BD71815_INT_CHG_RANGED_TEMP_TRANSITION_MASK	BIT(6)
#घोषणा BD71815_INT_CHG_STATE_TRANSITION_MASK		BIT(7)

#घोषणा BD71815_INT_BAT_TEMP_NORMAL_MASK		BIT(0)
#घोषणा BD71815_INT_BAT_TEMP_दुस्फल_MASK		BIT(1)
#घोषणा BD71815_INT_BAT_REMOVED_MASK			BIT(4)
#घोषणा BD71815_INT_BAT_DETECTED_MASK			BIT(5)
#घोषणा BD71815_INT_THERM_REMOVED_MASK			BIT(6)
#घोषणा BD71815_INT_THERM_DETECTED_MASK			BIT(7)

#घोषणा BD71815_INT_BAT_DEAD_MASK			BIT(1)
#घोषणा BD71815_INT_BAT_SHORTC_RES_MASK			BIT(2)
#घोषणा BD71815_INT_BAT_SHORTC_DET_MASK			BIT(3)
#घोषणा BD71815_INT_BAT_LOW_VOLT_RES_MASK		BIT(4)
#घोषणा BD71815_INT_BAT_LOW_VOLT_DET_MASK		BIT(5)
#घोषणा BD71815_INT_BAT_OVER_VOLT_RES_MASK		BIT(6)
#घोषणा BD71815_INT_BAT_OVER_VOLT_DET_MASK		BIT(7)

#घोषणा BD71815_INT_BAT_MON_RES_MASK			BIT(0)
#घोषणा BD71815_INT_BAT_MON_DET_MASK			BIT(1)

#घोषणा BD71815_INT_BAT_CC_MON1_MASK			BIT(0)
#घोषणा BD71815_INT_BAT_CC_MON2_MASK			BIT(1)
#घोषणा BD71815_INT_BAT_CC_MON3_MASK			BIT(2)

#घोषणा BD71815_INT_BAT_OVER_CURR_1_RES_MASK		BIT(0)
#घोषणा BD71815_INT_BAT_OVER_CURR_1_DET_MASK		BIT(1)
#घोषणा BD71815_INT_BAT_OVER_CURR_2_RES_MASK		BIT(2)
#घोषणा BD71815_INT_BAT_OVER_CURR_2_DET_MASK		BIT(3)
#घोषणा BD71815_INT_BAT_OVER_CURR_3_RES_MASK		BIT(4)
#घोषणा BD71815_INT_BAT_OVER_CURR_3_DET_MASK		BIT(5)

#घोषणा BD71815_INT_TEMP_BAT_LOW_RES_MASK		BIT(0)
#घोषणा BD71815_INT_TEMP_BAT_LOW_DET_MASK		BIT(1)
#घोषणा BD71815_INT_TEMP_BAT_HI_RES_MASK		BIT(2)
#घोषणा BD71815_INT_TEMP_BAT_HI_DET_MASK		BIT(3)
#घोषणा BD71815_INT_TEMP_CHIP_OVER_125_RES_MASK		BIT(4)
#घोषणा BD71815_INT_TEMP_CHIP_OVER_125_DET_MASK		BIT(5)
#घोषणा BD71815_INT_TEMP_CHIP_OVER_VF_RES_MASK		BIT(6)
#घोषणा BD71815_INT_TEMP_CHIP_OVER_VF_DET_MASK		BIT(7)

#घोषणा BD71815_INT_RTC0_MASK				BIT(0)
#घोषणा BD71815_INT_RTC1_MASK				BIT(1)
#घोषणा BD71815_INT_RTC2_MASK				BIT(2)
...
#घोषणा CURसूची_Disअक्षरging				0x8000

/* BD71815_REG_VM_SA_IBAT */
#घोषणा IBAT_SA_सूची_Disअक्षरging				0x8000

/* BD71815_REG_REX_CTRL_1 bits */
#घोषणा REX_CLR						BIT(4)

/* BD71815_REG_REX_CTRL_1 bits */
#घोषणा REX_PMU_STATE_MASK				BIT(2)

/* BD71815_REG_LED_CTRL bits */
#घोषणा CHGDONE_LED_EN					BIT(4)

#पूर्ण_अगर /* __LINUX_MFD_BD71815_H */
