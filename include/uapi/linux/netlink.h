 ...
 * @NLMSGERR_ATTR_POLICY: policy क्रम a rejected attribute
...
/*
 * policy descriptions - it's specअगरic to each family how this is used
 * Normally, it should be retrieved via a dump inside another attribute
 * specअगरying where it applies.
 */

/**
 * क्रमागत netlink_attribute_type - type of an attribute
 * @NL_ATTR_TYPE_INVALID: unused
 * @NL_ATTR_TYPE_FLAG: flag attribute (present/not present)
 * @NL_ATTR_TYPE_U8: 8-bit अचिन्हित attribute
 * @NL_ATTR_TYPE_U16: 16-bit अचिन्हित attribute
 * @NL_ATTR_TYPE_U32: 32-bit अचिन्हित attribute
 * @NL_ATTR_TYPE_U64: 64-bit अचिन्हित attribute
 * @NL_ATTR_TYPE_S8: 8-bit चिन्हित attribute
 * @NL_ATTR_TYPE_S16: 16-bit चिन्हित attribute
 * @NL_ATTR_TYPE_S32: 32-bit चिन्हित attribute
 * @NL_ATTR_TYPE_S64: 64-bit चिन्हित attribute
 * @NL_ATTR_TYPE_BINARY: binary data, min/max length may be specअगरied
 * @NL_ATTR_TYPE_STRING: string, min/max length may be specअगरied
 * @NL_ATTR_TYPE_NUL_STRING: NUL-terminated string,
 *	min/max length may be specअगरied
 * @NL_ATTR_TYPE_NESTED: nested, i.e. the content of this attribute
 *	consists of sub-attributes. The nested policy and maxtype
 *	inside may be specअगरied.
 * @NL_ATTR_TYPE_NESTED_ARRAY: nested array, i.e. the content of this
 *	attribute contains sub-attributes whose type is irrelevant
 *	(just used to separate the array entries) and each such array
 *	entry has attributes again, the policy क्रम those inner ones
 *	and the corresponding maxtype may be specअगरied.
 * @NL_ATTR_TYPE_BITFIELD32: &काष्ठा nla_bitfield32 attribute
 */
क्रमागत netlink_attribute_type अणु
...
/**
 * क्रमागत netlink_policy_type_attr - policy type attributes
 * @NL_POLICY_TYPE_ATTR_UNSPEC: unused
 * @NL_POLICY_TYPE_ATTR_TYPE: type of the attribute,
 *	&क्रमागत netlink_attribute_type (U32)
 * @NL_POLICY_TYPE_ATTR_MIN_VALUE_S: minimum value क्रम चिन्हित
 *	पूर्णांकegers (S64)
 * @NL_POLICY_TYPE_ATTR_MAX_VALUE_S: maximum value क्रम चिन्हित
 *	पूर्णांकegers (S64)
 * @NL_POLICY_TYPE_ATTR_MIN_VALUE_U: minimum value क्रम अचिन्हित
 *	पूर्णांकegers (U64)
 * @NL_POLICY_TYPE_ATTR_MAX_VALUE_U: maximum value क्रम अचिन्हित
 *	पूर्णांकegers (U64)
 * @NL_POLICY_TYPE_ATTR_MIN_LENGTH: minimum length क्रम binary
 *	attributes, no minimum अगर not given (U32)
 * @NL_POLICY_TYPE_ATTR_MAX_LENGTH: maximum length क्रम binary
 *	attributes, no maximum अगर not given (U32)
 * @NL_POLICY_TYPE_ATTR_POLICY_IDX: sub policy क्रम nested and
 *	nested array types (U32)
 * @NL_POLICY_TYPE_ATTR_POLICY_MAXTYPE: maximum sub policy
 *	attribute क्रम nested and nested array types, this can
 *	in theory be < the size of the policy poपूर्णांकed to by
 *	the index, अगर limited inside the nesting (U32)
 * @NL_POLICY_TYPE_ATTR_BITFIELD32_MASK: valid mask क्रम the
 *	bitfield32 type (U32)
 * @NL_POLICY_TYPE_ATTR_MASK: mask of valid bits क्रम अचिन्हित पूर्णांकegers (U64)
 * @NL_POLICY_TYPE_ATTR_PAD: pad attribute क्रम 64-bit alignment
 */
क्रमागत netlink_policy_type_attr अणु
