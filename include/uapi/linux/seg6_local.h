 ...
 * correct alignment.
 * Each counter is identअगरied by a dअगरferent attribute type (i.e.
 * SEG6_LOCAL_CNT_PACKETS).
 *
 * - SEG6_LOCAL_CNT_PACKETS: identअगरies a counter that counts the number of
 ...
 *
 * - SEG6_LOCAL_CNT_BYTES: identअगरies a counter that counts the total amount
 ...
 *
 * - SEG6_LOCAL_CNT_ERRORS: identअगरies a counter that counts the number of
...
क्रमागत अणु
	...
	SEG6_LOCAL_CNT_PAD,		/* pad क्रम 64 bits values */
	SEG6_LOCAL_CNT_PACKETS,
...
#घोषणा SEG6_LOCAL_CNT_MAX (__SEG6_LOCAL_CNT_MAX - 1)
