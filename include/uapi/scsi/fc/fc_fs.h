...
काष्ठा fc_frame_header अणु
	...
	__u8          fh_type;		/* see क्रमागत fc_fh_type below */
...
#घोषणा FC_FRAME_HEADER_LEN 24	/* expected length of काष्ठाure */

#घोषणा FC_MAX_PAYLOAD  2112U		/* max payload length in bytes */
#घोषणा FC_MIN_MAX_PAYLOAD  256U 	/* lower limit on max payload */

#घोषणा FC_MAX_FRAME	(FC_MAX_PAYLOAD + FC_FRAME_HEADER_LEN)
#घोषणा FC_MIN_MAX_FRAME (FC_MIN_MAX_PAYLOAD + FC_FRAME_HEADER_LEN)
 ...
 */
     ...
     */
क्रमागत fc_rctl अणु
	FC_RCTL_DD_UNCAT = 0x00,	/* uncategorized inक्रमmation */
...
#घोषणा FC_RCTL_ILS_REQ FC_RCTL_DD_UNSOL_CTL	/* ILS request */
#घोषणा FC_RCTL_ILS_REP FC_RCTL_DD_SOL_CTL	/* ILS reply */
	 ...
	 */
	FC_RCTL_VFTH = 0x50,	/* भव fabric tagging header */
	FC_RCTL_IFRH = 0x51,	/* पूर्णांकer-fabric routing header */
	FC_RCTL_ENCH = 0x52,	/* encapsulation header */
	/*
	 * Basic Link Services fh_r_ctl values.
	 */
	FC_RCTL_BA_NOP = 0x80,	/* basic link service NOP */
	FC_RCTL_BA_ABTS = 0x81,	/* basic link service पात */
	FC_RCTL_BA_RMC = 0x82,	/* हटाओ connection */
	FC_RCTL_BA_ACC = 0x84,	/* basic accept */
	FC_RCTL_BA_RJT = 0x85,	/* basic reject */
	FC_RCTL_BA_PRMT = 0x86,	/* dedicated connection preempted */
	/*
	 * Link Control Inक्रमmation.
	 */
 ...
 */
क्रमागत fc_well_known_fid अणु
	FC_FID_NONE =           0x000000,       /* No destination */
	FC_FID_BCAST =		0xffffff,	/* broadcast */
	FC_FID_FLOGI =		0xfffffe,	/* fabric login */
	FC_FID_FCTRL =		0xfffffd,	/* fabric controller */
	FC_FID_सूची_SERV =	0xfffffc,	/* directory server */
	FC_FID_TIME_SERV =	0xfffffb,	/* समय server */
	...
	FC_FID_CLOCK =		0xfffff6,	/* घड़ी synch server */
	FC_FID_MCAST_SERV =	0xfffff5,	/* multicast server */
पूर्ण;

#घोषणा	FC_FID_WELL_KNOWN_MAX	0xffffff /* highest well-known fabric ID */
#घोषणा	FC_FID_WELL_KNOWN_BASE	0xfffff5 /* start of well-known fabric ID */

/*
 * Other well-known addresses, outside the above contiguous range.
 */
#घोषणा	FC_FID_DOM_MGR		0xfffc00	/* करोमुख्य manager base */

/*
 * Fabric ID bytes.
 */
#घोषणा	FC_FID_DOMAIN		0
#घोषणा	FC_FID_PORT		1
#घोषणा	FC_FID_LINK		2
 ...
 * fh_type codes
 */
क्रमागत fc_fh_type अणु
	FC_TYPE_BLS =	0x00,	/* basic link service */
	FC_TYPE_ELS =	0x01,	/* extended link service */
	FC_TYPE_IP =	0x05,	/* IP over FC, RFC 4338 */
	FC_TYPE_FCP =	0x08,	/* SCSI FCP */
	FC_TYPE_CT =	0x20,	/* Fibre Channel Services (FC-CT) */
	FC_TYPE_ILS =	0x22,	/* पूर्णांकernal link service */
 ...
 * Exchange IDs.
 */
#घोषणा FC_XID_UNKNOWN  0xffff	/* unknown exchange ID */
#घोषणा FC_XID_MIN	0x0	/* supported min exchange ID */
#घोषणा FC_XID_MAX	0xfffe	/* supported max exchange ID */

/*
 * fh_f_ctl - Frame control flags.
 */
#घोषणा	FC_FC_EX_CTX	(1 << 23)	/* sent by responder to exchange */
#घोषणा	FC_FC_SEQ_CTX	(1 << 22)	/* sent by responder to sequence */
#घोषणा	FC_FC_FIRST_SEQ (1 << 21)	/* first sequence of this exchange */
#घोषणा	FC_FC_LAST_SEQ	(1 << 20)	/* last sequence of this exchange */
#घोषणा	FC_FC_END_SEQ	(1 << 19)	/* last frame of sequence */
#घोषणा	FC_FC_END_CONN	(1 << 18)	/* end of class 1 connection pending */
#घोषणा	FC_FC_RES_B17	(1 << 17)	/* reserved */
#घोषणा	FC_FC_SEQ_INIT	(1 << 16)	/* transfer of sequence initiative */
#घोषणा	FC_FC_X_ID_REASS (1 << 15)	/* exchange ID has been changed */
#घोषणा	FC_FC_X_ID_INVAL (1 << 14)	/* exchange ID invalidated */

#घोषणा	FC_FC_ACK_1	(1 << 12)	/* 13:12 = 1: ACK_1 expected */
#घोषणा	FC_FC_ACK_N	(2 << 12)	/* 13:12 = 2: ACK_N expected */
#घोषणा	FC_FC_ACK_0	(3 << 12)	/* 13:12 = 3: ACK_0 expected */

#घोषणा	FC_FC_RES_B11	(1 << 11)	/* reserved */
#घोषणा	FC_FC_RES_B10	(1 << 10)	/* reserved */
#घोषणा	FC_FC_RETX_SEQ	(1 << 9)	/* retransmitted sequence */
#घोषणा	FC_FC_UNI_TX	(1 << 8)	/* unidirectional transmit (class 1) */
#घोषणा	FC_FC_CONT_SEQ(i) ((i) << 6)
#घोषणा	FC_FC_ABT_SEQ(i) ((i) << 4)
#घोषणा	FC_FC_REL_OFF	(1 << 3)	/* parameter is relative offset */
#घोषणा	FC_FC_RES2	(1 << 2)	/* reserved */
#घोषणा	FC_FC_FILL(i)	((i) & 3)	/* 1:0: bytes of trailing fill */

/*
 * BA_ACC payload.
 */
काष्ठा fc_ba_acc अणु
	__u8		ba_seq_id_val;	/* SEQ_ID validity */
#घोषणा FC_BA_SEQ_ID_VAL 0x80
	__u8		ba_seq_id;	/* SEQ_ID of seq last deliverable */
	__u8		ba_resvd[2];	/* reserved */
	__be16		ba_ox_id;	/* OX_ID क्रम पातed seq or exch */
	__be16		ba_rx_id;	/* RX_ID क्रम पातed seq or exch */
	__be16		ba_low_seq_cnt;	/* low SEQ_CNT of पातed seq */
	__be16		ba_high_seq_cnt; /* high SEQ_CNT of पातed seq */
पूर्ण;

/*
 * BA_RJT: Basic Reject payload.
 */
काष्ठा fc_ba_rjt अणु
	__u8		br_resvd;	/* reserved */
	__u8		br_reason;	/* reason code */
	__u8		br_explan;	/* reason explanation */
	__u8		br_venकरोr;	/* venकरोr unique code */
पूर्ण;
...
क्रमागत fc_pf_rjt_reason अणु
	...
	FC_RJT_INSUF_RES =	0x1d,	/* insuff. resources क्रम VC (Class 4) */
	...
	FC_RJT_VENDOR =		0xff,	/* venकरोr specअगरic reject */
पूर्ण;

/* शेष समयout values */

#घोषणा FC_DEF_E_D_TOV	2000UL
#घोषणा FC_DEF_R_A_TOV	10000UL
