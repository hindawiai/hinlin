...
#अगर_अघोषित _UAPI_ASM_GENERIC_TERMIOS_H
#घोषणा _UAPI_ASM_GENERIC_TERMIOS_H
/*
 * Most architectures have straight copies of the x86 code, with
 * varying levels of bug fixes on top. Usually it's a good idea
 * to use this generic version instead, but be careful to aव्योम
 * ABI changes.
...
#पूर्ण_अगर /* _UAPI_ASM_GENERIC_TERMIOS_H */
